...
written in compact mode are limited to a single boot ID. The **trie_offset** field
stores the offset to the leaf Trie Node object that stores this Entry object's Data
object offsets.
