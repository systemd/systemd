...
Nothing reports this: the accessing process simply sits on the autofs wait queue
while the queued mount job waits for the network, and the boot stalls silently.
