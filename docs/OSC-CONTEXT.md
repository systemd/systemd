---
title: OSC 3008: Hierarchial Context Signalling
category: Interfaces
layout: default
SPDX-License-Identifier: LGPL-2.1-or-later
---

# OSC 3008: Hierarchial Context Signalling
...
This OSC sequence is invented by systemd. Currently, no terminal application is
known that consumes these sequences.
...
3. `vm` → a VMM initialized a terminal connection to a VM. (`systemd-vmspawn`
...
Contexts in the sense of OSC 3008 are hierarchial, and describe a tree
...
| `cwd=`        | `command`     | The current working directory                                                                               |
...
| `targetuser=` | `elevate`, `chpriv`, `vm`, `container`, `remote` | Target UNIX user name                                                    |
...
STARTFIELD   = TYPE / USER / HOSTNAME / MACHINEID / BOOTID / PID / PIDFDID / COMM / CWD / CMDLINE / VM / CONTAINER / TARGETUSER / TARGETHOST
