...
* The
  [`systemd-factory-reset-uki.service`](https://www.freedesktop.org/software/systemd/man/latest/systemd-factory-reset-uki.service.html)
...
the ESP (via `systemd-factory-reset-uki.service`, see above).
