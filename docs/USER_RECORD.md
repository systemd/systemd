...
retreavable and resolvable under every name listed here, pretty much everywhere
where the primary user name is allowed too. If logging in is attempted via an
alias name it should be normalized to the primary name.
