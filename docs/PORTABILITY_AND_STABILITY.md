...
* **The protocol spoken on the socket referred to by `$NOTIFY_SOCKET`**, as documented in
  ...
  libsystemd should be preferred, this protocol can also be trivially reimplemented without external
  dependencies, as demonstrated in the example listed in
