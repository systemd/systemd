...
very strong reasons. At a minimum, the most recent LTS releases of each mainstream distribution should be supported by the current
main branch for optional components. For core components, all currently maintained (i.e.: not EOL) LTS versions of mainstream
