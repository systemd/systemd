...
22. [FINAL] Tag the devel version of the next release: `version=vXXY~devel && git tag -s "${version}" -m "systemd ${version}"`. This tag is required to make sure `git describe --abbrev=7` does the right thing.
