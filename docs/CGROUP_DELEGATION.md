...
3. 🙁 The *i-like-continents* option. In this option you'd leave your manager
   ...
   `Delegate=` turned on, and it would contain PID of this process; all your
   managed processes sunsequently created should also be moved into this scope.
   From systemd's PoV there'd be two units: your manager service and the big
   scope that contains all your managed processes in one.
