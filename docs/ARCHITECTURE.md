...
From a user's perspective, the third is a wrapper for the second. To implement a new directive,
...
directives being parsed by common helpers, with the definition in the generator file
