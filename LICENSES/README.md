...
and conditions of
**LGPL-2.0-or-later** (**GNU Lesser General Public License v2.1 or later**).

Unless otherwise noted, compiled programs and all shared or static libraries
include sources under **LGPL-2.0-or-later** along with more permissive
licenses, and are effectively licensed **LGPL-2.0-or-later**.
