...
EOF
    ...
    assert_in "$imgs/zero1 : start=        2048, size=       20480, type=4F68BCE3-E8CD-4DB1-96E7-FBCAF984B709, uuid=00000000-0000-0000-0000-000000000000, name=\"root-${architecture}\", attrs=\"GUID:59\"" "$output"
}
