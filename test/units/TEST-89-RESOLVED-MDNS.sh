...
ref_scenario_responder_legacy_ttl_cap() {
    : "Legacy replies cap record TTLs at ten seconds (RFC 6762 section 6.7)"
    ...
    # coherent, hence section 6.7: the TTL should be capped at ten seconds.
...
testcase_bonjour_reference_behavior() {
    ...
    local -A known_failures=(
        ...
        [responder_legacy_ttl_cap]="legacy reply TTLs are not capped to ten seconds"
