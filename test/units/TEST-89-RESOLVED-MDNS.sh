...
# scenarios, each of which cites the RFC 6762/6763 requirement it checks, or
# the interoperability report that motivated it. The peer is a deterministic,
# packet-exact instrument implementing the slice of mDNS the scenarios need.
#
...
testcase_conformance_scorecard() {
    ...
    local -A known_failures=(
        ...
        [responder_legacy_ttl_cap]="legacy reply TTLs are not capped to ten seconds (a SHOULD)"
