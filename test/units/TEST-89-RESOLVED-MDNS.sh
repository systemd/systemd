...
export CONTAINER_ZONE CONTAINER_1 BRIDGE_INDEX FIXTURE_SERVICE_NAME_PREFIX FIXTURE_SERVICE_TYPE_PREFIX FIXTURE_SERVICE_PORT FIXTURE_SERVICE_INSTANCE FIXTURE_SERVICE_TYPE
run_subtests
