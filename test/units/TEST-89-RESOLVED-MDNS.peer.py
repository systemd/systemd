...
class Publisher:
    ...
    def run(self):
        ...
        if self.goodbye_on_exit:
            ...
            # would space them. Note this is the spacing that trips resolved
            ...
            # told until the maintenance ladder comes round. The scenarios
            # that watch for a goodbye say so in the flaky table.
            for i in range(2):
                if i > 0:
...
def main():
    ...
    publish_parser.add_argument(
        ...
        type=float,
        default=1.0,
        help='seconds between the repeated goodbyes',
    )
    publish_parser.add_argument(
