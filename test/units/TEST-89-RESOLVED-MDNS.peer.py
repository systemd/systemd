...
packet level. It implements exactly the slice of mDNS that the conformance
scorecard testcase needs, written from the RFCs: it contains no code or
captured data from any other implementation.
