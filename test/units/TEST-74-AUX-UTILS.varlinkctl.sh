...
varlinkctl list-methods /run/systemd/metrics/io.systemd.Manager
varlinkctl list-methods -j /run/systemd/metrics/io.systemd.Manager io.systemd.Metrics | jq .

varlinkctl introspect /run/systemd/metrics/io.systemd.Manager
varlinkctl introspect -j /run/systemd/metrics/io.systemd.Manager io.systemd.Metrics | jq .
