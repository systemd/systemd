...
echo '{"userName":"filtered-user","uuid":"bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"}' | (! userdbctl -j --uuid=bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb -F- user)
echo '{"userName":"filtered-user","disposition":"regular"}' | (! userdbctl -j --disposition=regular -F- user)
...
echo '{"groupName":"filtered-group","uuid":"bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"}' | (! userdbctl -j --uuid=bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb -F- group)
echo '{"groupName":"filtered-group","disposition":"regular"}' | (! userdbctl -j --disposition=regular -F- group)
