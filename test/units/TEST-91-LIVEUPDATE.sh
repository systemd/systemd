...
if grep -qw luo_nboot=1 /proc/cmdline; then
    ...
    test "${ts_shutdown_start}" -gt 0
    test "${ts_shutdown_finish}" -gt 0
    test "${ts_shutdown_binary_start}" -gt 0
    test "${ts_shutdown_binary_finish}" -gt 0

    test "${ts_shutdown_start}" -le "${ts_shutdown_finish}"
    test "${ts_shutdown_finish}" -le "${ts_shutdown_binary_start}"
    test "${ts_shutdown_binary_start}" -le "${ts_shutdown_binary_finish}"
