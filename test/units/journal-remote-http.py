...
class Connection(socket.socket):
    ...
    def begin(self, encoding=None, keep_alive=False):
        headers = [
    ...
    def request(self, body, encoding=None, keep_alive=False):
    ...
    def post(self, body, encoding=None, keep_alive=False):
        self.request(body, encoding, keep_alive)
        return self.status()
...
class ReceiverTestCase(unittest.TestCase):
    ...
    def assert_closes_after(self, connection, seconds):
