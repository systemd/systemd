...
systemd-analyze compare-versions 1 lt 2
systemd-analyze compare-versions 1 le 2
systemd-analyze compare-versions 1 ne 2
( ! systemd-analyze compare-versions 1 ge 2 )
( ! systemd-analyze compare-versions 1 eq 2 )
( ! systemd-analyze compare-versions 1 gt 2 )

systemd-analyze compare-versions 1 2 | grep ' < '
systemd-analyze compare-versions 2 2 | grep ' == '
systemd-analyze compare-versions 2 1 | grep ' > '

set +e

systemd-analyze compare-versions 1 2; ret1=$?
systemd-analyze compare-versions 2 2; ret2=$?
systemd-analyze compare-versions 2 1; ret3=$?
