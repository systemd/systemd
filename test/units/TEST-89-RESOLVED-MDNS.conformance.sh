...
testcase_conformance_scorecard() {
    ...
    local -A known_failures=(
        ...
        [known_answer_continuation]="TODO (RFC 6762 section 7.2): known answers in a follow-up packet are ignored, see the TODO in mdns_scope_process_query()"
    ...
    local scenarios=(
        ...
        shared_record_response_delay
        known_answer_continuation
