...
systemd-run --wait -u test-07-pid1-issue-40916.service -pLogExtraFields=FD{1..1000}=1 true
(! systemd-run --wait -u test-07-pid1-issue-40916.service -pLogExtraFields=FD{1..2000}=1 true)

# We implicitly test serialization-deserialization in the reload in cleanup.
