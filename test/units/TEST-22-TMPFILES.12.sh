...
# The ~ age modifier on R cleans below the target but keeps the target itself.
mkdir -p /tmp/ageby-remove/keep-root/old-child
touch --date "3 minutes ago" /tmp/ageby-remove/keep-root/old-child /tmp/ageby-remove/keep-root
systemd-tmpfiles --clean --inline "R /tmp/ageby-remove/keep-root - - - ~M:1m -"
test -d /tmp/ageby-remove/keep-root
test ! -e /tmp/ageby-remove/keep-root/old-child
