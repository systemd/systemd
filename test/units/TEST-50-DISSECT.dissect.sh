...
systemd-run --wait -p RootImage="$MINIMAL_IMAGE.raw" --service-type=notify --pipe systemd-notify --ready --exec ";" ls /run/host/notify
systemd-run --wait -p RootImage="$MINIMAL_IMAGE.raw" --service-type=notify --pipe systemd-notify --ready --exec ";" env | grep NOTIFY_SOCKET=/run/host/notify
