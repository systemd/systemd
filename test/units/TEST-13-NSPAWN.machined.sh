...
# It's here to work-around check in end.service (end.sh). Read https://github.com/systemd/systemd/pull/34867 for more details
echo "Parameters for method io.systemd.Machine.Open() didn't pass validation on field 'mode'" >/varlink-didnt-pass-validation-exceptions
