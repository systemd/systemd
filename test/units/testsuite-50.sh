...
systemd-dissect --no-pager /run/extensions/testkit.raw | grep -q '✗ confext extension for system'
systemd-dissect --no-pager /run/extensions/testkit.raw | grep -q '✗ confext extension for portable service'
systemd-sysext merge
...
systemd-dissect --no-pager /run/confexts/testjob.raw | grep -q '✗ sysext extension for system'
systemd-dissect --no-pager /run/confexts/testjob.raw | grep -q '✗ sysext extension for portable service'
