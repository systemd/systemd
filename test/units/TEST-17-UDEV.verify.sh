...
test_syntax_error 'OWNER!="b"' 'Invalid operator for OWNER.'
test_syntax_error 'OWNER+="systemd-coredump"' "OWNER key takes '=' or ':=' operator, assuming '='."
# invalid user name
...
test_syntax_error 'GROUP!="b"' 'Invalid operator for GROUP.'
test_syntax_error 'GROUP+="systemd-coredump"' "GROUP key takes '=' or ':=' operator, assuming '='."
# invalid group name
