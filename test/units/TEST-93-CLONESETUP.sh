...
testcase_region_size() {
    ...
    # Custom region-size=8K — verify a non-default bytes value is accepted.
    $CLONESETUP_BIN add testregion "$region_loop_src" "$region_loop_dst" "$region_loop_meta" region-size=8K
