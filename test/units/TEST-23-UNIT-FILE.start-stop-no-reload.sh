...
[Unit]
Conflicts=TEST-23-UNIT-FILE-no-reload.service
...
systemctl start TEST-23-UNIT-FILE-no-reload-2.service
(! systemctl is-active TEST-23-UNIT-FILE-no-reload.service )
...
[[ "$(systemctl show --property LoadState --value TEST-23-UNIT-FILE-no-reload-3.service)" == loaded ]]
[[ "$(systemctl show --property ConflictedBy --value TEST-23-UNIT-FILE-no-reload.service)" =~ TEST-23-UNIT-FILE-no-reload-2.service ]]
[[ "$(systemctl show --property ConflictedBy --value TEST-23-UNIT-FILE-no-reload.service)" =~ TEST-23-UNIT-FILE-no-reload-3.service ]]
