...
[[ "$(systemctl show --property ConflictedBy --value TEST-23-UNIT-FILE-no-reload.target)" =~ TEST-23-UNIT-FILE-no-reload.service ]]
[[ "$(systemctl show --property ConflictedBy --value TEST-23-UNIT-FILE-no-reload.target)" =~ TEST-23-UNIT-FILE-no-reload-2.service ]]
