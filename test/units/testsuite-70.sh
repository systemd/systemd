...
#arg_fido2_lock_with
systemd-cryptenroll --fido2-with-client-pin=true $img_2
...
systemd-cryptenroll --unlock-fido2-device=auto $img_2
systemd-cryptenroll --unlock-fido2-device=auto --unlock-key-file=/tmp/unlock $img_2
systemd-cryptenroll --unlock-key-file=/tmp/unlock $img_2
