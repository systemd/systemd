...
# Extend PCRs (they might be invalid, i.e. zeroes)
...
echo YES | cryptsetup luksFormat test.img /tmp/passphrase
...
! env PIN=123457 /usr/lib/systemd/systemd-cryptsetup attach test-volume /test.img - tpm2-device=auto,headless=1
