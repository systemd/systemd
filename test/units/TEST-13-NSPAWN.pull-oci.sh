...
run0 -u testuser --pipe systemd-run -q --unit=fimpel --user -p PrivateUsers=managed -p User=0 -p RootMStack=/home/testuser/.local/state/machines/ocicombo.mstack --pipe /sbin/init | grep -q luftikus
