...
systemctl start --wait testsuite-59-1.service
systemctl start --wait testsuite-59-2.service
systemctl start --wait testsuite-59-3.service
systemctl start --wait testsuite-59-4.service
systemctl start --wait testsuite-59-5.service
