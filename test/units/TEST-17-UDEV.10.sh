...
udevadm info -a --json-format=off /sys/class/net/$netdev
udevadm info -a --json-format=pretty /sys/class/net/$netdev | jq . >/dev/null
udevadm info -a --json-format=short /sys/class/net/$netdev | jq . >/dev/null
