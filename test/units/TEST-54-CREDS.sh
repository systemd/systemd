...
run0 -u testuser --pipe systemd-run --user --pipe -p ImportCredential=brummbaer -p ExecStartPre='ls -l $CREDENTIALS_DIRECTORY' systemd-creds cat brummbaer | cmp /tmp/brummbaer.data
