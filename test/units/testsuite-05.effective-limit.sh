...
assert_le "$(systemctl show -P MemoryMaxEffective "$srv")" "5242880"
assert_le "$(systemctl show -P MemoryHighEffective "$srv")" "5242880"
assert_le "$(systemctl show -P TasksMaxEffective "$srv")" "50"
...
assert_le "$(systemctl show -P MemoryMaxEffective "$srv")" "10485760"
assert_le "$(systemctl show -P MemoryHighEffective "$srv")" "10485760"
assert_le "$(systemctl show -P TasksMaxEffective "$srv")" "100"
