...
# CN=noskid, serial 0x8112131415161718, no extensions, signed by the mkosi key
cat > "/etc/voa/$ID/kernel-keyring/dm-verity/x509/noskid-certificate.pem" <<'CERT'
-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
CERT
