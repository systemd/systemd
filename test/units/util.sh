...
install_extension_images() {
        local os_release=$(test -e /etc/os-release && echo /etc/os-release || echo /usr/lib/os-release)
...
EOF
        ...
        mksquashfs "$initdir" /usr/share/app0.raw -noappend
        ...
        mksquashfs "$initdir" /usr/share/conf0.raw -noappend
...
EOF
        ...
        mksquashfs "$initdir" /usr/share/app1.raw -noappend
        ...
        echo MARKER=1 >"$initdir/usr/lib/systemd/system/some_file"
        mksquashfs "$initdir" /usr/share/app-nodistro.raw -noappend
...
EOF
        ...
        mksquashfs "$initdir" /usr/share/app-reload.raw -noappend
}
