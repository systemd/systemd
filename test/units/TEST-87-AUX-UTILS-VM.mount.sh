...
systemd-mount --tmpfs --options="x-systemd.graceful_option=idefinitelydontexist,x-systemd.graceful_option=nr_inodes=4711,x-systemd.graceful_option=idonexisteither" "$GRACEFULTEST"
