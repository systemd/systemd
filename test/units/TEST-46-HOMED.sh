...
testcase_fscrypt() {
    ...
    trap "homectl deactivate fscrypttest 2>/dev/null || true; homectl remove fscrypttest 2>/dev/null || true; umount '$MNT' 2>/dev/null || true; rm -rf '$MNT' '$IMAGE'" RETURN
    ...
    "${R0[@]}" bash -c 'keyctl link @u @s; echo "hello fscrypt" > /home/fscrypttest/file1'
    [[ "$("${R0[@]}" bash -c 'keyctl link @u @s; cat /home/fscrypttest/file1')" == "hello fscrypt" ]]
    "${R0[@]}" bash -c 'keyctl link @u @s; mkdir /home/fscrypttest/subdir'
    "${R0[@]}" bash -c 'keyctl link @u @s; dd if=/dev/urandom of=/home/fscrypttest/subdir/blob bs=4096 count=8 status=none'
    "${R0[@]}" bash -c 'keyctl link @u @s; cp /home/fscrypttest/subdir/blob /home/fscrypttest/subdir/blob.copy && cmp /home/fscrypttest/subdir/blob /home/fscrypttest/subdir/blob.copy'
    "${R0[@]}" bash -c 'keyctl link @u @s; echo appended >> /home/fscrypttest/file1 && grep -F appended /home/fscrypttest/file1 >/dev/null'
    "${R0[@]}" bash -c 'keyctl link @u @s; rm /home/fscrypttest/subdir/blob.copy && test ! -e /home/fscrypttest/subdir/blob.copy'
    ...
    PASSWORD=fsfsfs1234 homectl activate fscrypttest
    [[ "$("${R0[@]}" bash -c 'keyctl link @u @s; head -n1 /home/fscrypttest/file1')" == "hello fscrypt" ]]
    systemctl stop user@"$(id -u fscrypttest)".service 2>/dev/null || true
    homectl deactivate fscrypttest 2>/dev/null || true
    wait_for_state fscrypttest inactive
    ...
    [[ "$("${R0NEW[@]}" bash -c 'keyctl link @u @s; head -n1 /home/fscrypttest/file1')" == "hello fscrypt" ]]
    "${R0NEW[@]}" bash -c 'keyctl link @u @s; rm -r /home/fscrypttest/subdir /home/fscrypttest/file1'
    systemctl stop user@"$(id -u fscrypttest)".service 2>/dev/null || true
    homectl deactivate fscrypttest 2>/dev/null || true
    wait_for_state fscrypttest inactive
