...
testcase_update_auto_resize_mode_without_space() {
    local blocks bsize fill_mbytes fill_size image user
    ...
    cleanup_update_auto_resize_mode_without_space() {
        ...
        rm -f /home/no-space-update.filler
    ...
    trap cleanup_update_auto_resize_mode_without_space RETURN
    ...
    dd if=/dev/zero of=/home/no-space-update.filler bs=1M count="$fill_mbytes"

    systemctl restart systemd-homed.service

    PASSWORD=xEhErW0ndafV4s homectl update "$user" --auto-resize-mode=off
