...
# test deny
(! systemd-run --wait --pipe --property 'DNSDeniedDomains=*' resolvectl query unsigned.test) |& tee "$RUN_OUT"
...
(! systemd-run --wait --pipe --property 'DNSAllowedDomains=*' --property 'DNSDeniedDomains=*.test' resolvectl query unsigned.test) |& tee "$RUN_OUT"
grep -qF "Access to hostname 'unsigned.test' denied" "$RUN_OUT"
...
(! systemd-run --wait --pipe --property 'DNSAllowedDomains=*.doesnotexist' --property 'DNSDeniedDomains=*.nomatch' resolvectl query unsigned.test) |& tee "$RUN_OUT"
grep -qF "Access to hostname 'unsigned.test' denied" "$RUN_OUT"
