...
: "write 2M of data to runtime journal"
set +x
...
: "Write 3M of data to volatile journal"
set +x
dd if=/dev/urandom bs=1M count=3 | base64 | systemd-cat -t "$SYSLOG_ID"
set -x
journalctl --sync
