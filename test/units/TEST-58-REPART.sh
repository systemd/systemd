...
EOF
    ...
    # shellcheck disable=SC2064
    trap "losetup -d '${loop}'; umount '${btfrs_mntpoint_encrypted}'; losetup -d '${loop_btrfs_encrypted}'; umount '${btfrs_mntpoint_plain}'; losetup -d '${loop_btrfs_plain}'; rm -rf '$defs' '$imgs' '$btfrs_mntpoint_plain' '$btfrs_mntpoint_encrypted'" RETURN
