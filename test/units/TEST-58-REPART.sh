...
testcase_btrfs_replace() {
    ...
    btfrs_mntpoint_encrypted="$(mktemp --directory "/tmp/test-repart.btfrs-mntpoint-encrypted.XXXXXXXXXX")"
    defs="$(mktemp --directory "/tmp/test-repart.defs.XXXXXXXXXX")"
    imgs="$(mktemp --directory "/var/tmp/test-repart.imgs.XXXXXXXXXX")"
    # shellcheck disable=SC2064
    trap "rm -rf '$defs' '$imgs' '$btfrs_mntpoint_plain' '$btfrs_mntpoint_encrypted'" RETURN
    chmod 0755 "$defs"
    ...
    # shellcheck disable=SC2064
    trap "losetup -d '${loop_btrfs_plain}'; rm -rf '$defs' '$imgs' '$btfrs_mntpoint_plain' '$btfrs_mntpoint_encrypted'" RETURN

    mount "${loop_btrfs_plain}" "${btfrs_mntpoint_plain}"

    # shellcheck disable=SC2064
    trap "umount '${btfrs_mntpoint_plain}'; losetup -d '${loop_btrfs_plain}'; rm -rf '$defs' '$imgs' '$btfrs_mntpoint_plain' '$btfrs_mntpoint_encrypted'" RETURN
    ...
    # shellcheck disable=SC2064
    trap "losetup -d '${loop_btrfs_encrypted}'; umount '${btfrs_mntpoint_plain}'; losetup -d '${loop_btrfs_plain}'; rm -rf '$defs' '$imgs' '$btfrs_mntpoint_plain' '$btfrs_mntpoint_encrypted'" RETURN

    mount "${loop_btrfs_encrypted}" "${btfrs_mntpoint_encrypted}"
    # shellcheck disable=SC2064
    trap "umount '${btfrs_mntpoint_encrypted}'; losetup -d '${loop_btrfs_encrypted}'; umount '${btfrs_mntpoint_plain}'; losetup -d '${loop_btrfs_plain}'; rm -rf '$defs' '$imgs' '$btfrs_mntpoint_plain' '$btfrs_mntpoint_encrypted'" RETURN
...
EOF
    ...
    # shellcheck disable=SC2064
    trap "umount '${btfrs_mntpoint_encrypted}'; losetup -d '${loop_btrfs_encrypted}'; umount '${btfrs_mntpoint_plain}'; losetup -d '${loop_btrfs_plain}'; losetup -d '${loop}'; rm -rf '$defs' '$imgs' '$btfrs_mntpoint_plain' '$btfrs_mntpoint_encrypted'" RETURN
    ...
    # shellcheck disable=SC2064
    trap "umount '${btfrs_mntpoint_encrypted}'; cryptsetup close btrfs-replace-encrypted; losetup -d '${loop_btrfs_encrypted}'; umount '${btfrs_mntpoint_plain}'; losetup -d '${loop_btrfs_plain}'; losetup -d '${loop}'; rm -rf '$defs' '$imgs' '$btfrs_mntpoint_plain' '$btfrs_mntpoint_encrypted'" RETURN
