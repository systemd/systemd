...
testcase_btrfs_replace() {
    ...
    # shellcheck disable=SC2064
    trap "losetup -d '${loop_btrfs_plain}'; rm -rf '$defs' '$imgs''" RETURN

    mount "${loop_btrfs_plain}" "${btfrs_mntpoint_plain}"

    # shellcheck disable=SC2064
    trap "umount '${btfrs_mntpoint_plain}'; losetup -d '${loop_btrfs_plain}'; rm -rf '$defs' '$imgs'" RETURN
    ...
    # shellcheck disable=SC2064
    trap "losetup -d '${loop_btrfs_encrypted}'; umount '${btfrs_mntpoint_plain}'; losetup -d '${loop_btrfs_plain}'; rm -rf '$defs' '$imgs'" RETURN

    mount "${loop_btrfs_encrypted}" "${btfrs_mntpoint_encrypted}"
    # shellcheck disable=SC2064
    trap "umount '${btfrs_mntpoint_encrypted}'; losetup -d '${loop_btrfs_encrypted}'; umount '${btfrs_mntpoint_plain}'; losetup -d '${loop_btrfs_plain}'; rm -rf '$defs' '$imgs'" RETURN
...
EOF
    ...
    # shellcheck disable=SC2064
    trap "losetup -d '${loop}'; umount '${btfrs_mntpoint_encrypted}'; losetup -d '${loop_btrfs_encrypted}'; umount '${btfrs_mntpoint_plain}'; losetup -d '${loop_btrfs_plain}'; rm -rf '$defs' '$imgs'" RETURN
