...
dd if=/dev/urandom of=/var/tmp/storagetm.test bs=1024 count=10024

systemd-run -u teststoragetm.service -p Type=notify /usr/lib/systemd/systemd-storagetm /var/tmp/storagetm.test --name=quux
