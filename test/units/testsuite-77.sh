...
OpenFile=/test-77-open.dat:open:0
OpenFile=/test-77-file.dat:file:0
EOF
touch /test-77-new-file.dat
systemd-run --wait -p OpenFile=/test-77-new-file.dat:new-file:rw "$(dirname "$0")"/testsuite-77-run.sh
