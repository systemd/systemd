...
assert_rc 0 systemd-run --wait -p OpenFile=/test-77-new-file.dat:new-file:ro -p OpenFile=/test-77-mssing-file.dat:missing-file:ro,ignore "$(dirname "$0")"/testsuite-77-run.sh
