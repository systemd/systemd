...
# Use a Python harness because bash's default signal dispositions interfere.
...
journalctl -u notify-reload-toggle-handler.service --since=-10s | grep -q "lacks handler for reload signal"
