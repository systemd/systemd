...
# mount path wins, that it disappears from the report once remounted read-only, and that a device mapper
# device stacked on top of it is reported with the loop device as originating source.
