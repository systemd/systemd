...
[Service]
ManagedOOMMemoryPressureDurationSec=100ms
ManagedOOMMemoryPressure=kill
EOF

# Verify memory pressure duration will use default if set to 0
...
oomctl | grep -A 2 "/TEST-55-OOMD-testmunch.service" | grep "Memory Pressure Duration: 100ms"
...
[[ "$(systemctl show -P ManagedOOMMemoryPressureDurationUSec TEST-55-OOMD-testmunch.service)" == "100ms" ]]
