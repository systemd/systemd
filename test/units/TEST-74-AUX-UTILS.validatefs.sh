...
setfattr -n "user.validatefs.mount_point" -v "/tmp/validatefs-test.fake" /tmp/validatefs-test.fake
/usr/lib/systemd/systemd-validatefs /tmp/validatefs-test.fake
setfattr -n "user.validatefs.mount_point" -v "/tmp/validatefs-testxx.fake" /tmp/validatefs-test.fake
(! /usr/lib/systemd/systemd-validatefs /tmp/validatefs-test.fake )
