...
compare_initrd_main "rw root=dissect mount.usr=dissect mount.crypt.interactive_recovery=false" "$OUT_DIR" "root"
compare_initrd_main "rw root=dissect mount.usr=dissect mount.crypt.interactive_recovery=false" "$OUT_DIR" "usr"

compare_initrd_main "rw root=dissect rootfstype=crypto_LUKS mount.usr=dissect mount.crypt.interactive_recovery=false" "$OUT_DIR" "root"
compare_initrd_main "rw root=dissect rootfstype=crypto_LUKS mount.usr=dissect mount.crypt.interactive_recovery=false" "$OUT_DIR" "usr"
