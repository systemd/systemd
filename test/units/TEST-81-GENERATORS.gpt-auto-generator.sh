...
run_for_cmdline "ro root=gpt-auto-force" initrd
...
run_for_cmdline "ro root=dissect-force" initrd
...
# mount.cryptsetup.interactive_recovery=no turns on headless-recovery and adds a OnFailure target
