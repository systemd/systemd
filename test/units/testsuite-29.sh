...
EOF
        ...
        if keyctl padd asymmetric "minimal_0" %keyring:.fs-verity < /tmp/minimal_0.cer; then
            ...
            file /tmp/minimal_0/usr/lib/systemd/system/minimal-app0.service.p7s
            ls -lh /tmp/minimal_0/usr/lib/systemd/system/minimal-app0.service.p7s
            openssl smime -verify -binary -inform DER -in /tmp/minimal_0/usr/lib/systemd/system/minimal-app0.service.p7s -content /tmp/digest -certfile /tmp/minimal_0.crt -nointern -noverify > /dev/null
