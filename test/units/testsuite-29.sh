...
systemd-dissect --no-pager /etc/minimal_00.raw | grep -q '✓ portable service'
...
portablectl "${ARGS[@]}" attach --now --runtime --extension /etc/app00.raw /etc/minimal_00.raw app00
