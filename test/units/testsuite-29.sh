...
grep -q -F "LogExtraFields=PORTABLE_ROOT=/usr/share/minimal_0.raw" /run/systemd/system.attached/app0.service.d/20-portable.conf
grep -q -F "LogExtraFields=PORTABLE_EXTENSION=/usr/share/app0.raw" /run/systemd/system.attached/app0.service.d/20-portable.conf
...
grep -q -F "LogExtraFields=PORTABLE_ROOT=/usr/share/minimal_1.raw" /run/systemd/system.attached/app0.service.d/20-portable.conf
grep -q -F "LogExtraFields=PORTABLE_EXTENSION=/usr/share/app0.raw" /run/systemd/system.attached/app0.service.d/20-portable.conf
