...
grep -q -F "LogExtraFields=PORTABLE_EXTENSION_ID=app" /run/systemd/system.attached/app0.service.d/20-portable.conf
...
grep -q -F "LogExtraFields=PORTABLE_EXTENSION_ID=app_1" /run/systemd/system.attached/app0.service.d/20-portable.conf
...
grep -q -F "LogExtraFields=PORTABLE_EXTENSION_ID=app" /run/systemd/system.attached/app1.service.d/20-portable.conf
grep -q -F "LogExtraFields=PORTABLE_EXTENSION=app1" /run/systemd/system.attached/app1.service.d/20-portable.conf
grep -q -F "LogExtraFields=PORTABLE_EXTENSION_ID=app_1" /run/systemd/system.attached/app1.service.d/20-portable.conf
