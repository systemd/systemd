...
# The special values UINT64_MAX and 0 are written as TasksMax=infinity and CPUWeight=idle
defer_transient_cleanup varlink-transient-cgroup-special.service
varlinkctl call "$MANAGER_SOCKET" io.systemd.Unit.StartTransient \
    '{"context":{"ID":"varlink-transient-cgroup-special.service","CGroup":{"TasksMax":18446744073709551615,"CPUWeight":0},"Service":{"Type":"oneshot","RemainAfterExit":true,"ExecStart":[{"path":"/bin/true"}]}}}' >/dev/null
