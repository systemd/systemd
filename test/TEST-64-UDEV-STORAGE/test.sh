...
name="first_part", size=5M
uuid="deadbeef-dead-dead-beef-000000000000", name="second_part", size=5M
EOF
    udevadm settle
    mkfs.ext4 -U "deadbeef-dead-dead-beef-111111111111" -L "data_vol" "${lodev}p2"
    losetup -d "$lodev"
