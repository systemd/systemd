...
class NetworkdIPv6PrefixTests(unittest.TestCase, Utilities):
    ...
    def test_ipv6_route_prefix(self):
        ...
        # PREF64 or NAT64
        j = json.loads(output)
        prefix = bytearray(j["NDisc"]['PREF64']['Prefix'])
        self.assertIn('64:ff9b::', socket.inet_ntop(socket.AF_INET6, prefix))

        self.assertIn('96', j["NDisc"]['PREF64']['PrefixLength'])
        self.assertIn('68086310925', j["NDisc"]['PREF64']['LifetimeUSec'])
