...
'''
    ...
    def test_dhcp6_address_registration(self):
        ...
        # global addresses (SLAAC and static): the server registers them into its lease
        # database, except for the ULA which is outside of the configured prefix.
        ...
        for address in ('2001:db8:1:0:1034:56ff:fe78:9abc', '2001:db8:1::4242', '2001:db8:1::4343'):
