...
class NetworkdSysctlTest(unittest.TestCase, Utilities):
    ...
    def check_sysctl_watch(self):
        ...
        self.assertRegex(log, r"Foreign process 'sysctl\[\d+\]' changed sysctl 'net/ipv6/conf/dummy98/accept_ra' from '0' to '1', conflicting with our setting to '0'")
        self.assertRegex(log, r"Foreign process 'sysctl\[\d+\]' changed sysctl 'net/ipv6/conf/dummy98/mtu' from '1550' to '1360', conflicting with our setting to '1550'")
        self.assertRegex(log, r"Foreign process 'sysctl\[\d+\]' changed sysctl 'net/ipv4/conf/dummy98/promote_secondaries' from '1' to '0', conflicting with our setting to '1'")
        self.assertRegex(log, r"Foreign process 'sysctl\[\d+\]' changed sysctl 'net/ipv6/conf/dummy98/proxy_ndp' from '0' to '1', conflicting with our setting to '0'")
        self.assertNotIn("changed sysctl 'net/ipv6/conf/dummy98/hop_limit'", log)
        self.assertNotIn("changed sysctl 'net/ipv6/conf/dummy98/max_addresses'", log)
