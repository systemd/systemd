...
class NetworkdDHCPPDTests(unittest.TestCase, Utilities):
    ...
    def test_dhcp6pd_dbus_prefix(self):
        def get_dbus_dhcp6_prefix(IF):
            ...
            self.assertIn('DHCPv6AllocatedPrefixes', description.keys())

            prefixInfo = description['DHCPv6AllocatedPrefixes']

            self.assertGreater(len(prefixInfo), 0)
        ...
        self.assertGreater(prefixInfo[0]['PreferredLifetime'], 0)
        self.assertGreater(prefixInfo[0]['ValidLifetime'], 0)
    ...
    def test_dhcp4_6rd_dbus_prefix(self):
        def get_dbus_dhcp_6rd_prefix(IF):
            ...
            self.assertIn('6rdAllocatedPrefix', description.keys())
