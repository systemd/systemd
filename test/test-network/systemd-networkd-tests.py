...
class Utilities():
    ...
    def wait_online(self, links_with_operstate, timeout='20s', bool_any=False, ipv4=False, ipv6=False, setup_state='configured', setup_timeout=5):
        ...
        This is applied only for the operational state 'degraded' or exceeded.
...
class NetworkdNetworkTests(unittest.TestCase, Utilities):
    ...
    units = [
        ...
        'dhcp-client-ipv4-ipv6-prefix-with-delay.network',
        'dhcp-server-with-ipv6-prefix.network',
        'ipv6-prefix-veth-with-static-ipv4-address.network',
    ...
    def test_wait_online_ipv4(self):
        copy_unit_to_networkd_unit_path('25-veth.netdev', 'dhcp-server-with-ipv6-prefix.network', 'dhcp-client-ipv4-ipv6-prefix-with-delay.network')
        start_networkd()
    ...
    def test_wait_online_ipv6(self):
        copy_unit_to_networkd_unit_path('25-veth.netdev', 'ipv6-prefix-with-delay.network', 'ipv6-prefix-veth-with-static-ipv4-address.network')
        start_networkd()
