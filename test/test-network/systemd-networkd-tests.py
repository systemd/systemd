...
class NetworkdNetworkTests(unittest.TestCase, Utilities):
    ...
    def test_address_ipv4acd(self):
        ...
        print(check_output('ip link show veth99'))
        print(check_output('ip netns exec ns99 ip link show veth-peer'))

        copy_unit_to_networkd_unit_path('25-address-ipv4acd-veth99.network')
        start_networkd()
