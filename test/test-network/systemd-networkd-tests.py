...
class NetworkdNetDevTests(unittest.TestCase, Utilities):
    ...
    def test_wireguard(self):
        ...
        cp(os.path.join(networkd_ci_temp_dir, '25-wireguard-no-peer-private-key-cred.txt'),
           os.path.join(credstore_dir, 'network.wireguard.private.25-wireguard-no-peer'))
