...
class NetworkctlTests(unittest.TestCase, Utilities):
    ...
    units = [
        ...
        '25-veth.netdev',
        '25-netdev-link-local-addressing-yes.network',
    ]
    ...
    def test_altname(self):
        copy_unit_to_networkd_unit_path('25-netdev-link-local-addressing-yes.network', '12-dummy.netdev', '12-dummy.link')
    ...
    def test_delete_links(self):
        copy_unit_to_networkd_unit_path('11-dummy.netdev', '11-dummy.network',
                                        '25-veth.netdev', '25-netdev-link-local-addressing-yes.network')
        start_networkd()
...
class NetworkdNetDevTests(unittest.TestCase, Utilities):
    ...
    def test_bareudp(self):
        copy_unit_to_networkd_unit_path('25-bareudp.netdev', '25-netdev-link-local-addressing-yes.network')
        start_networkd()
    ...
    def test_batadv(self):
        copy_unit_to_networkd_unit_path('25-batadv.netdev', '25-netdev-link-local-addressing-yes.network')
        start_networkd()
    ...
    def test_macvtap(self):
        for mode in ['private', 'vepa', 'bridge', 'passthru']:
            with self.subTest(mode=mode):
                if mode != 'private':
                    self.tearDown()
                copy_unit_to_networkd_unit_path('21-macvtap.netdev', '25-netdev-link-local-addressing-yes.network',
    ...
    def test_macvlan(self):
        for mode in ['private', 'vepa', 'bridge', 'passthru']:
            with self.subTest(mode=mode):
                if mode != 'private':
                    self.tearDown()
                copy_unit_to_networkd_unit_path('21-macvlan.netdev', '25-netdev-link-local-addressing-yes.network',
    ...
    def test_ipvlan(self):
        for mode, flag in [['L2', 'private'], ['L3', 'vepa'], ['L3S', 'bridge']]:
            with self.subTest(mode=mode, flag=flag):
                if mode != 'L2':
                    self.tearDown()
                copy_unit_to_networkd_unit_path('25-ipvlan.netdev', '25-netdev-link-local-addressing-yes.network',
    ...
    def test_ipvtap(self):
        for mode, flag in [['L2', 'private'], ['L3', 'vepa'], ['L3S', 'bridge']]:
            with self.subTest(mode=mode, flag=flag):
                if mode != 'L2':
                    self.tearDown()
                copy_unit_to_networkd_unit_path('25-ipvtap.netdev', '25-netdev-link-local-addressing-yes.network',
    ...
    def test_veth(self):
        copy_unit_to_networkd_unit_path('25-veth.netdev', '25-netdev-link-local-addressing-yes.network',
                                        '25-veth-mtu.netdev')
        start_networkd()
    ...
    def test_vrf(self):
        copy_unit_to_networkd_unit_path('25-vrf.netdev', '25-netdev-link-local-addressing-yes.network')
        start_networkd()
    ...
    def test_vcan(self):
        copy_unit_to_networkd_unit_path('25-vcan.netdev', '25-netdev-link-local-addressing-yes.network')
        start_networkd()
    ...
    def test_vxcan(self):
        copy_unit_to_networkd_unit_path('25-vxcan.netdev', '25-netdev-link-local-addressing-yes.network')
        start_networkd()
    ...
    def test_geneve(self):
        copy_unit_to_networkd_unit_path('25-geneve.netdev', '25-netdev-link-local-addressing-yes.network')
        start_networkd()
    ...
    def test_ip6tnl_tunnel(self):
        copy_unit_to_networkd_unit_path('12-dummy.netdev', '25-ip6tnl.network',
                                        ...
                                        '25-ip6tnl-external.netdev', '25-netdev-link-local-addressing-yes.network')
        start_networkd()
    ...
    def test_tunnel_independent(self):
        copy_unit_to_networkd_unit_path('25-ipip-tunnel-independent.netdev', '25-netdev-link-local-addressing-yes.network')
        start_networkd()

        self.wait_online(['ipiptun99:carrier'])

    def test_tunnel_independent_loopback(self):
        copy_unit_to_networkd_unit_path('25-ipip-tunnel-independent-loopback.netdev', '25-netdev-link-local-addressing-yes.network')
        start_networkd()
    ...
    def test_vxlan(self):
        copy_unit_to_networkd_unit_path('11-dummy.netdev', '25-vxlan-test1.network',
                                        ...
                                        '25-vxlan-independent.netdev', '25-netdev-link-local-addressing-yes.network',
    ...
    def test_nlmon(self):
        copy_unit_to_networkd_unit_path('25-nlmon.netdev', '25-netdev-link-local-addressing-yes.network')
        start_networkd()
    ...
    def test_ifb(self):
        copy_unit_to_networkd_unit_path('25-ifb.netdev', '25-netdev-link-local-addressing-yes.network')
        start_networkd()
