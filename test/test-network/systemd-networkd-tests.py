...
class NetworkdNetworkTests(unittest.TestCase, Utilities):
    ...
    units = [
        ...
        'ipv6ra-prefix-client-veth-with-static-ipv4-address.network',
    ...
    def test_wait_online_ipv6(self):
        copy_unit_to_networkd_unit_path('25-veth.netdev', 'ipv6-prefix-with-delay.network', 'ipv6ra-prefix-client-veth-with-static-ipv4-address.network')
        start_networkd()
