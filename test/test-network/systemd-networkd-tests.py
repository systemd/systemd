...
def setUpModule():
    ...
    create_service_dropin('systemd-networkd-dhcp-server', None,
                          ['[Service]',
                           'ExecStart=',
                           f'ExecStart={networkctl_bin} dhcp-server start',
                           'ExecStop=',
                           f'ExecStop={networkctl_bin} dhcp-server stop'])
    ...
    print(check_output('systemctl cat systemd-networkd-dhcp-server.service'))
...
def tearDownModule():
    ...
    rm_rf('/run/systemd/system/systemd-networkd-dhcp-server.service.d')
