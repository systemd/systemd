...
class NetworkdNetworkTests(unittest.TestCase, Utilities):
    ...
    def _test_route_static(self, manage_foreign_routes):
        ...
        self.assertIn('192.168.10.4 via inet6 fe80:0:222:4dff:ff:ff:ff:ff proto static', output)
    ...
    def test_nexthop(self):
        def check_nexthop(self):
            ...
            self.assertIn('id 8 via fe80::222:4dff:ff:ff:ff:ff dev veth99', output)
