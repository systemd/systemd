...
class NetworkdNetworkTests(unittest.TestCase, Utilities):
    ...
    def test_address_static(self):
        ...
        self.check_netlabel(self, 'Address.NetLabel', 'dummy98', '10.4.3.0/24')
...
class NetworkdRATests(unittest.TestCase, Utilities):
    ...
    def test_ipv6_prefix_delegation(self):
        ...
        self.check_netlabel(self, 'IPv6AcceptRA.NetLabel', 'veth99', '2002:da8:1:0/64')
...
class NetworkdDHCPClientTests(unittest.TestCase, Utilities):
    ...
    def test_dhcp_client_ipv4_only(self):
        ...
        self.check_netlabel(self, 'DHCPv4.NetLabel', 'veth99', '192.168.5.250/24')
...
class NetworkdDHCPPDTests(unittest.TestCase, Utilities):
    ...
    def test_dhcp6pd(self):
        ...
        self.check_netlabel(self, 'DHCPPrefixDelegation.NetLabel', 'dummy99', '3ffe:501:ffff:[2-9a-f]02::/64')
