...
class NetworkdNetworkTests(unittest.TestCase, Utilities):
    ...
    def test_nexthop(self):
        ...
        print(output)
        self.assertIn('id 1 via 192.168.5.1 dev veth99 scope link proto static', output)
        self.assertIn('id 2 dev veth99 scope link proto static', output)
        self.assertIn('id 3 dev veth99 scope link proto static', output)
