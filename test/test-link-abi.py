...
# (e.g. libc.musl-x86_64.so.1, libc.musl-aarch64.so.1). libintl is part of glibc
# but ships as a standalone library on musl; allow it either way until gettext use
# is made optional/dlopen()'d.
