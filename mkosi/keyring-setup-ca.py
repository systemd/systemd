...
The subtests for the serial-number fallback of certificate_key_id() need certificates without a
subjectKeyIdentifier extension. OpenSSL's x509 tool adds one to every certificate it signs, no
