...
*Usage:* ``introspect <SERVICE> <OBJECT> [<INTERFACE>]``
...
*Usage:* ``call <SERVICE> <OBJECT> <INTERFACE> <METHOD> [<SIGNATURE>[<ARGUMENT>...]]``
...
*Usage:* ``emit <OBJECT> <INTERFACE> <SIGNAL> [<SIGNATURE>[<ARGUMENT>...]]``
...
*Usage:* ``get-property <SERVICE> <OBJECT> <INTERFACE> <PROPERTY>``
...
*Usage:* ``set-property <SERVICE> <OBJECT> <INTERFACE> <PROPERTY> <SIGNATURE> <ARGUMENT>``
...
*Usage:* ``--allow-interactive-authorization=<BOOL>``
