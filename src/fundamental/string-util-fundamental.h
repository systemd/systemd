...
#define startswith(s, prefix) const_generic(s, const sd_char*, startswith_internal(s, prefix))

sd_char *startswith_no_case_internal(const sd_char *s, const sd_char *prefix) _pure_;
#define startswith_no_case(s, prefix) const_generic(s, const sd_char*, startswith_no_case_internal(s, prefix))

sd_char *endswith_internal(const sd_char *s, const sd_char *suffix) _pure_;
#define endswith(s, suffix) const_generic(s, const sd_char*, endswith_internal(s, suffix))

sd_char *endswith_no_case_internal(const sd_char *s, const sd_char *suffix) _pure_;
#define endswith_no_case(s, suffix) const_generic(s, const sd_char*, endswith_no_case_internal(s, suffix))
