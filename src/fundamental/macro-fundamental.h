...
#define ALIGN2_PTR(l) ((void*) ALIGN_TO((uintptr_t) l, 2))
#define ALIGN4_PTR(l) ((void*) ALIGN_TO((uintptr_t) l, 4))
#define ALIGN8_PTR(l) ((void*) ALIGN_TO((uintptr_t) l, 8))
#ifndef SD_BOOT
...
#define ALIGNED16_P(p) (((uintptr_t) p) % __alignof__(uint16_t) == 0)
#define ALIGNED32_P(p) (((uintptr_t) p) % __alignof__(uint32_t) == 0)
#define ALIGNED64_P(p) (((uintptr_t) p) % __alignof__(uint64_t) == 0)
