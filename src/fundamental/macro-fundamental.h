...
static inline uint64_t ALIGN_TO_64(uint64_t l, uint64_t ali) {
        assert(ISPOWEROF2(ali));
...
static inline uint64_t ALIGN_DOWN_64(uint64_t l, uint64_t ali) {
        assert(ISPOWEROF2(ali));
...
static inline uint64_t ALIGN_OFFSET_64(uint64_t l, uint64_t ali) {
        assert(ISPOWEROF2(ali));
