...
#define ISALIGNED16(p) (((uintptr_t) p) % __alignof__(uint16_t) == 0)
#define ISALIGNED32(p) (((uintptr_t) p) % __alignof__(uint32_t) == 0)
#define ISALIGNED64(p) (((uintptr_t) p) % __alignof__(uint64_t) == 0)
