...
#define _cleanup_clear(x) _cleanup_(x ## _clear)
#define _cleanup_close(x) _cleanup_(x ## _closep)
#define _cleanup_destroy(x) _cleanup_(x ## _destroy)
#define _cleanup_done(x) _cleanup_(x ## _done)
#define _cleanup_free(x) _cleanup_(x ## _freep)
