...
static int write_on_failure(FILE *f, const char *where, const char *opts) {
        return write_dependency(f, where, opts,
                                "x-systemd.onfailure\0", NULL, STRV_MAKE_CONST("OnFailure"));
}
