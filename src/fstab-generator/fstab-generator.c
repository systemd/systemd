...
static int add_sysroot_mount(void) {
        ...
        log_debug("Found entry what=%s where=/sysroot type=%s opts=%s", what, strna(arg_root_fstype), strna(opts));
...
static int add_sysroot_usr_mount(void) {
        ...
        log_debug("Found entry what=%s where=/sysusr/usr type=%s opts=%s", what, strna(arg_usr_fstype), strna(opts));
