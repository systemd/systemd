...
static int apply_fcaps(int fd, const char *path, bool append, const struct FcapsUpdate *set) {
        ...
        if (append) {
                ...
                struct vfs_ns_cap_data original = {};
                ...
                if (r == -ENODATA)
                        ...
                        if (!IN_SET(xattr_data_len, XATTR_CAPS_SZ_1, XATTR_CAPS_SZ_2, XATTR_CAPS_SZ_3))
