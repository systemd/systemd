...
int vconsole_convert_to_x11(const VCContext *vc, X11Context *ret) {
        ...
        /* No custom mapping has been found, see if it's the keymap is a converted one as in such case deduce
         * the conversion to the corresponding x11 layout is easy. */
