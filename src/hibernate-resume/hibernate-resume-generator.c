...
static int parse_efi_hibernate_location(void) {
        ...
        static const JsonDispatch dispatch_table[] = {
                ...
                { "kernelVersion",         JSON_VARIANT_STRING,   json_dispatch_const_string, offsetof(EFIHibernateLocation, kernel_version), JSON_MANDATORY             },
        ...
        if (!streq(uts.release, location.kernel_version) ||
