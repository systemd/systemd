...
static void fscrypt_v2_key_undo_arm(
                FscryptV2KeyUndo *u,
                const char *image_path,
                const struct fscrypt_key_specifier *spec) {
...
int home_setup_fscrypt(
        ...
        fscrypt_v2_key_undo_arm(&v2_key_undo, ip, &setup->fscrypt_key_spec);
...
int home_create_fscrypt(
        ...
        fscrypt_v2_key_undo_arm(&v2_key_undo, temporary, &setup->fscrypt_key_spec);
