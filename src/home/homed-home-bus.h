...
int bus_home_method_delay_lock(sd_bus_message *message, void *userdata, sd_bus_error *error);
...
int bus_home_delay_lock(Home *home, sd_bus_message *message, sd_bus_error *error);
