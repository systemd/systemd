...
TEST(incomplete_thin_binding) {
        ...
        ASSERT_OK(user_record_add_thin_pool_binding(u, "homes/pool", "homed-alice", /* volume_uuid= */ NULL));
        ASSERT_STREQ(u->thin_pool, "homes/pool");
        ASSERT_STREQ(u->thin_volume, "homed-alice");
        ASSERT_NULL(u->thin_volume_uuid);
        ...
        ASSERT_STREQ(clone->thin_pool, "homes/pool");
        ASSERT_STREQ(clone->thin_volume, "homed-alice");
        ASSERT_NULL(clone->thin_volume_uuid);
