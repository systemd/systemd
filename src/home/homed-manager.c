...
int manager_new(Manager **ret) {
        ...
        *m = (Manager) {
                ...
                .rebalance_interval_usec = 2 * USEC_PER_MINUTE, /* initially, rebalance all 2min */
        };
...
static int manager_rebalance_calculate(Manager *m) {
        ...
        weight_sum = 20; /* Grant the underlying pool directory a fixed weight of 20 (home dirs get 100 by
                          * default, i.e. 5x more). This weight is not configurable, the per-home weights
                          * are. */
...
static int manager_rebalance_now(Manager *m) {
        ...
        for (;;) {
                ...
                case REBALANCE_WAITING:
                         ...
                         * calls the pending ones, and flush out any pending onces (which shouldn't exist at
                         * this time anyway) */
