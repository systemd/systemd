...
static int parse_argv(int argc, char *argv[]) {
        ...
        for (;;) {
                ...
                case ARG_DISK_SIZE:
                        ...
                        /* Automatically turn of the rebalance logic if user configured a size explicitly */
                        r = json_variant_set_field_unsigned(&arg_identity_extra, "rebalanceWeight", REBALANCE_WEIGHT_OFF);
                        if (r < 0)
