...
static void clear_resource_limit_changes(void) {
        ...
        arg_identity_filter_this_machine_rlimits = strv_free(arg_identity_filter_this_machine_rlimits);
        arg_identity_filter_other_machines_rlimits = strv_free(arg_identity_filter_other_machines_rlimits);

        arg_identity_drop_rlimits = false;
        arg_identity_drop_this_machine_rlimits = false;
        arg_identity_drop_other_machines_rlimits = false;
}
