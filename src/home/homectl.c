...
static int help(int argc, char *argv[], void *userdata) {
        ...
        printf("%1$s [OPTIONS...] COMMAND ...\n\n"
               ...
               "                               to create\n"
               "     --prompt-groups=no        In first-boot mode, don't prompt for auxiliary group memberships\n"
               "     --prompt-shell=no         In first-boot mode, don't prompt for shells\n"
               "     --chrome=no               In first-boot mode, don't show colour bar at top and bottom of terminal\n"
               "     --mute-console=yes        In first-boot mode, tell kernel/PID 1 to not write to the console while running\n"
