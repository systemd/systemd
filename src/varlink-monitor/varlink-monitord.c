...
static int vl_dispatch_filters(
        ...
        JSON_VARIANT_ARRAY_FOREACH(e, v) {
                ...
                static const sd_json_dispatch_field filter_dispatch[] = {
                        ...
                        { "pid",        _SD_JSON_VARIANT_TYPE_INVALID, sd_json_dispatch_uint32,  voffsetof(p, pid),       SD_JSON_NULLABLE },
                        { "pidfdId",    _SD_JSON_VARIANT_TYPE_INVALID, sd_json_dispatch_uint64,  voffsetof(p, pidfd_id),  SD_JSON_NULLABLE },
                ...
                if (p.uid == UID_INVALID && sd_json_variant_by_key(e, "uid"))
                        return sd_varlink_errorbo(link, "io.systemd.VarlinkMonitor.BadFilter", SD_JSON_BUILD_PAIR_STRING("parameter", "uid"));

                if (p.pid == 0 && sd_json_variant_by_key(e, "pid"))
                        return sd_varlink_errorbo(link, "io.systemd.VarlinkMonitor.BadFilter", SD_JSON_BUILD_PAIR_STRING("parameter", "pid"));

                if (p.pidfd_id == 0 && sd_json_variant_by_key(e, "pidfdId"))
                        return sd_varlink_errorbo(link, "io.systemd.VarlinkMonitor.BadFilter", SD_JSON_BUILD_PAIR_STRING("parameter", "pidfdId"));
