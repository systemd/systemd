...
static uint32_t arg_tpm2_handle_index = TPM2_SRK_HANDLE;
...
static int help(void) {
        ...
        printf("%s [OPTIONS...] BLOCK-DEVICE\n"
               ...
               "     --tpm2-handle-index=INDEX\n"
               "                       Specify index of key to use for sealing\n"
...
static int parse_argv(int argc, char *argv[]) {
        ...
        static const struct option options[] = {
                ...
                { "tpm2-handle-index",            required_argument, NULL, ARG_TPM2_HANDLE_INDEX     },
        ...
        while ((c = getopt_long(argc, argv, "h", options, NULL)) >= 0) {
                ...
                case ARG_TPM2_HANDLE_INDEX:
                        r = safe_atou32(optarg, &arg_tpm2_handle_index);
                        if (r < 0)
                                return r;
...
static int run(int argc, char *argv[]) {
        ...
        case ENROLL_TPM2:
                slot = enroll_tpm2(cd, vk, vks, arg_tpm2_device, arg_tpm2_handle_index, arg_tpm2_external_key, arg_tpm2_hash_pcr_values, arg_tpm2_n_hash_pcr_values, arg_tpm2_public_key, arg_tpm2_public_key_pcr_mask, arg_tpm2_signature, arg_tpm2_pin);
                break;
