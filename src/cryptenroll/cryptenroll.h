...
#include "libfido2-util.h"      /* for the complete Fido2EnrollFlags enum used below */
...
typedef struct EnrollContext {
         ...
         * sole input, and fail with ENOKEY if a required piece of input is missing. CLI and
