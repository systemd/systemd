...
enum devlink_attr_selftest_result {
        ...
        DEVLINK_ATTR_SELFTEST_RESULT_MAX =
                __DEVLINK_ATTR_SELFTEST_RESULT_MAX - 1
};
...
#define DEVLINK_RELOAD_LIMITS_VALID_MASK \
        (_BITUL(__DEVLINK_RELOAD_LIMIT_MAX) - 1)
...
#define DEVLINK_PORT_FN_CAP_IPSEC_CRYPTO \
        _BITUL(DEVLINK_PORT_FN_ATTR_CAP_IPSEC_CRYPTO_BIT)
#define DEVLINK_PORT_FN_CAP_IPSEC_PACKET \
        _BITUL(DEVLINK_PORT_FN_ATTR_CAP_IPSEC_PACKET_BIT)
