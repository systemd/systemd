...
#undef fsopen
extern typeof(missing_fsopen) fsopen __attribute__((weak));
...
#undef fsmount
extern typeof(missing_fsmount) fsmount __attribute__((weak));
...
#undef move_mount
extern typeof(missing_move_mount) move_mount __attribute__((weak));
...
#undef fsconfig
extern typeof(missing_fsconfig) fsconfig __attribute__((weak));
...
#undef open_tree
extern typeof(missing_open_tree) open_tree __attribute__((weak));
...
#undef mount_setattr
extern typeof(missing_mount_setattr) mount_setattr __attribute__((weak));
...
extern typeof(missing_open_tree_attr) open_tree_attr __attribute__((weak));
