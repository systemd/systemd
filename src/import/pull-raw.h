...
int raw_pull_start(RawPull *p, const char *url, const char *local, int local_fd, uint64_t offset, uint64_t size_max, ImportFlags flags, ImportVerify verify, const struct iovec *checksum);
