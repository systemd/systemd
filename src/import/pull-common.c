...
int pull_make_auxiliary_job(
        ...
        job->calc_checksum = IN_SET(verify, IMPORT_VERIFY_CHECKSUM, IMPORT_VERIFY_SIGNATURE, IMPORT_VERIFY_X509);
...
int pull_make_verification_jobs(
        ...
        if (IN_SET(verify, IMPORT_VERIFY_SIGNATURE, IMPORT_VERIFY_X509) && signature_style_from_filename(fn) < 0) {
