...
static int generate_clone_units(
        ...
        _cleanup_free_ char *source_unit = NULL, *dest_unit = NULL, *metadata_unit = NULL,
                            *escaped_clone_name = NULL, *escaped_source = NULL,
                            *escaped_dest = NULL, *escaped_metadata = NULL,
                            *escaped_options = NULL, *e = NULL, *unit = NULL, *clone_dev_path = NULL,
                            *dmname = NULL;
        int r;
        ...
        /* Escape clone name for ExecStart command */
        escaped_clone_name = cescape(clone_name);
        ...
        if (options) {
                escaped_options = cescape(options);
                if (!escaped_options)
                        return log_oom();
        }
