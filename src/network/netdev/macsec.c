...
static int macsec_read_key_file(NetDev *netdev, SecurityAssociation *sa) {
        ...
        r = read_full_file_full(
                        AT_FDCWD, sa->key_file, UINT64_MAX, 16,
                        READ_FULL_FILE_SECURE | READ_FULL_FILE_UNHEX | READ_FULL_FILE_WARN_WORLD_READABLE | READ_FULL_FILE_CONNECT_SOCKET | READ_FULL_FILE_FAIL_WHEN_LARGER,
