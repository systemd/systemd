...
DEFINE_CONFIG_PARSE_ENUM(config_parse_bond_lacp_rate,
                         bond_lacp_rate,
                         BondLacpRate,
...
DEFINE_CONFIG_PARSE_ENUM(config_parse_bond_fail_over_mac,
                         bond_fail_over_mac,
                         BondFailOverMac,
...
DEFINE_CONFIG_PARSE_ENUM(config_parse_bond_arp_validate,
                         bond_arp_validate,
                         BondArpValidate,
...
DEFINE_CONFIG_PARSE_ENUM(config_parse_bond_arp_all_targets,
...
static int netdev_bond_fill_message_create(NetDev *netdev, Link *link, sd_netlink_message *m) {
        ...
        if (b->mode != _NETDEV_BOND_MODE_INVALID) {
                ...
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_MODE attribute: %m");
        }

        if (b->xmit_hash_policy != _NETDEV_BOND_XMIT_HASH_POLICY_INVALID) {
                r = sd_netlink_message_append_u8(
                        m, IFLA_BOND_XMIT_HASH_POLICY, bond_xmit_hash_policy_to_kernel(b->xmit_hash_policy));
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_XMIT_HASH_POLICY attribute: %m");
        }
        ...
        if (b->lacp_rate != _NETDEV_BOND_LACP_RATE_INVALID && b->mode == NETDEV_BOND_MODE_802_3AD) {
                ...
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_AD_LACP_RATE attribute: %m");
        }

        if (b->miimon != 0) {
                r = sd_netlink_message_append_u32(m, IFLA_BOND_MIIMON, b->miimon / USEC_PER_MSEC);
                if (r < 0)
                        log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_BOND_MIIMON attribute: %m");
        }
        ...
        if (b->downdelay != 0) {
                ...
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_DOWNDELAY attribute: %m");
        }
        ...
        if (b->updelay != 0) {
                ...
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_UPDELAY attribute: %m");
        }
        ...
        if (b->arp_interval != 0) {
                ...
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_ARP_INTERVAL attribute: %m");
                ...
                if ((b->lp_interval >= LEARNING_PACKETS_INTERVAL_MIN_SEC) &&
                    (b->lp_interval <= LEARNING_PACKETS_INTERVAL_MAX_SEC)) {
                        r = sd_netlink_message_append_u32(
                                m, IFLA_BOND_LP_INTERVAL, b->lp_interval / USEC_PER_SEC);
                        if (r < 0)
                                return log_netdev_error_errno(
                                        netdev, r, "Could not append IFLA_BOND_LP_INTERVAL attribute: %m");
                }
        }
        ...
        if (b->ad_select != _NETDEV_BOND_AD_SELECT_INVALID && b->mode == NETDEV_BOND_MODE_802_3AD) {
                ...
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_AD_SELECT attribute: %m");
        }
        ...
        if (b->fail_over_mac != _NETDEV_BOND_FAIL_OVER_MAC_INVALID &&
            b->mode == NETDEV_BOND_MODE_ACTIVE_BACKUP) {
                ...
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_FAIL_OVER_MAC attribute: %m");
        }
        ...
        if (b->arp_validate != _NETDEV_BOND_ARP_VALIDATE_INVALID) {
                ...
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_ARP_VALIDATE attribute: %m");
        }
        ...
        if (b->arp_all_targets != _NETDEV_BOND_ARP_ALL_TARGETS_INVALID) {
                ...
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_ARP_ALL_TARGETS attribute: %m");
        }
        ...
        if (b->primary_reselect != _NETDEV_BOND_PRIMARY_RESELECT_INVALID) {
                ...
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_PRIMARY_RESELECT attribute: %m");
        }
        ...
        if (b->resend_igmp <= RESEND_IGMP_MAX) {
                ...
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_RESEND_IGMP attribute: %m");
        }
        ...
        if (b->packets_per_slave <= PACKETS_PER_SLAVE_MAX && b->mode == NETDEV_BOND_MODE_BALANCE_RR) {
                ...
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_PACKETS_PER_SLAVE attribute: %m");
        }
        ...
        if (b->num_grat_arp <= GRATUITOUS_ARP_MAX) {
                ...
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_NUM_PEER_NOTIF attribute: %m");
        }
        ...
        if (b->min_links != 0) {
                ...
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_MIN_LINKS attribute: %m");
        }
        ...
        if (b->ad_actor_sys_prio != 0) {
                ...
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_AD_ACTOR_SYS_PRIO attribute: %m");
        }
        ...
        if (b->ad_user_port_key != 0) {
                ...
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_AD_USER_PORT_KEY attribute: %m");
        }
        ...
        if (b->ad_actor_system) {
                ...
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_AD_ACTOR_SYSTEM attribute: %m");
        }

        r = sd_netlink_message_append_u8(m, IFLA_BOND_ALL_SLAVES_ACTIVE, b->all_slaves_active);
        if (r < 0)
                return log_netdev_error_errno(
                        netdev, r, "Could not append IFLA_BOND_ALL_SLAVES_ACTIVE attribute: %m");

        if (b->tlb_dynamic_lb >= 0) {
                r = sd_netlink_message_append_u8(m, IFLA_BOND_TLB_DYNAMIC_LB, b->tlb_dynamic_lb);
                if (r < 0)
                        return log_netdev_error_errno(
                                netdev, r, "Could not append IFLA_BOND_TLB_DYNAMIC_LB attribute: %m");
        }
        ...
        if (b->arp_interval > 0) {
                if (b->n_arp_ip_targets > 0) {
                        ...
                        if (r < 0)
                                return log_netdev_error_errno(
                                        netdev, r, "Could not open contaniner IFLA_BOND_ARP_IP_TARGET : %m");
                        ...
                        if (r < 0)
                                return log_netdev_error_errno(
                                        netdev, r, "Could not close contaniner IFLA_BOND_ARP_IP_TARGET : %m");
                }
        }
        ...
        for (;;) {
                ...
                if (r < 0) {
                        log_syntax(unit,
                                   ...
                                   line,
                                   r,
                                   "Bond ARP ip target address is invalid, ignoring assignment: %s",
                                   n);
                        return 0;
                }
...
int config_parse_ad_actor_sys_prio(const char *unit,
        ...
        if (r < 0) {
                log_syntax(unit,
                           ...
                           line,
                           r,
                           "Failed to parse actor system priority '%s', ignoring: %m",
                           rvalue);
                return 0;
        }
...
int config_parse_ad_user_port_key(const char *unit,
        ...
        if (r < 0) {
                log_syntax(unit,
                           ...
                           line,
                           r,
                           "Failed to parse user port key '%s', ignoring: %m",
                           rvalue);
                return 0;
        }
        ...
        if (v > 1023) {
                log_syntax(unit,
                           ...
                           line,
                           0,
                           "Failed to parse user port key '%s'. Range is [0,1023], ignoring.",
                           rvalue);
                return 0;
        }
