...
const char* ovs_bridge_fail_mode_to_string(OVSBridgeFailMode i);
OVSBridgeFailMode ovs_bridge_fail_mode_from_string(const char *s);

const char* ovs_protocol_to_string(OVSProtocol i);
OVSProtocol ovs_protocol_from_string(const char *s);
