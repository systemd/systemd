...
static int networkctl_main(int argc, char *argv[]) {
        static const Verb verbs[] = {
                ...
                { "up",                 2,        VERB_ANY, 0,                             link_varlink_simple_method },
                { "down",               2,        VERB_ANY, 0,                             link_varlink_simple_method },
                { "renew",              2,        VERB_ANY, VERB_ONLINE_ONLY,              link_varlink_simple_method },
                { "forcerenew",         2,        VERB_ANY, VERB_ONLINE_ONLY,              link_varlink_simple_method },
                { "reconfigure",        2,        VERB_ANY, VERB_ONLINE_ONLY,              link_varlink_simple_method },
