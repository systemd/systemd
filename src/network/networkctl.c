...
static int networkctl_main(int argc, char *argv[]) {
        static const Verb verbs[] = {
                ...
                { "renew",              2,        VERB_ANY, VERB_ONLINE_ONLY,              link_bus_method         },
                { "forcerenew",         2,        VERB_ANY, VERB_ONLINE_ONLY,              link_bus_method         },
                { "reconfigure",        2,        VERB_ANY, VERB_ONLINE_ONLY,              link_bus_method         },
