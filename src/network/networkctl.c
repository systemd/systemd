...
static int link_status_one(
        ...
        _cleanup_strv_free_ char **dns = NULL, **ntp = NULL, **sip = NULL, **search_domains = NULL, **route_domains = NULL,
                **pop3_server = NULL, **smtp_server = NULL, **log_servers = NULL;
        ...
        (void) sd_network_link_get_log_servers(info->ifindex, &log_servers);
        ...
        if (r < 0)
                return r;
        r = dump_list(table, "LOG servers:", log_servers);
        if (r < 0)
                return r;
