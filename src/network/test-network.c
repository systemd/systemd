...
TEST(vrf_table) {
        ...
        ASSERT_OK(config_parse_vrf_table("netdev", "filename", 1, "VRF", 1, "Table", 0, "vrf-test", &vrf.table, &vrf.meta));
        ASSERT_EQ(vrf.table, 1234U);

        ASSERT_OK(config_parse_vrf_table("netdev", "filename", 1, "VRF", 1, "Table", 0, "5678", &vrf.table, &vrf.meta));
        ASSERT_EQ(vrf.table, 5678U);

        ASSERT_OK(config_parse_vrf_table("netdev", "filename", 1, "VRF", 1, "Table", 0, "no-such-table", &vrf.table, &vrf.meta));
        ASSERT_EQ(vrf.table, 5678U);
}
