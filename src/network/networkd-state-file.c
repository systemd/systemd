...
int manager_save(Manager *m) {
        ...
        LinkOnlineState online_state = _LINK_ONLINE_STATE_INVALID;
        ...
        if (links_online && !links_offline)
                online_state = LINK_ONLINE_STATE_ONLINE;
        else if (links_online && links_offline)
                online_state = LINK_ONLINE_STATE_PARTIAL;
        else if (links_offline)
