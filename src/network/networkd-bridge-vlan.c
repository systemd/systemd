                ...
                if (vid == 0) {
                        if (vid_end == 0)
                                log_syntax(unit, LOG_WARNING, filename, line, 0,
                                           "VLAN id 0 is reserved (IEEE 802.1Q priority-tagged frames), ignoring in %s=: %s",
                                           lvalue, word);
                        else
                                log_syntax(unit, LOG_WARNING, filename, line, 0,
                                           "VLAN id 0 is reserved (IEEE 802.1Q priority-tagged frames), skipping VID 0 in range %s=%s",
                                           lvalue, word);
                        vid = 1;
                }
