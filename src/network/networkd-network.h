...
typedef struct Network {
        ...
        usec_t dhcp6_address_registration_initial_retransmission_time_usec;
        unsigned dhcp6_address_registration_max_retransmissions;
        usec_t dhcp6_static_address_registration_refresh_interval_usec;
