...
static int ndisc_router_process_reachable_time(Link *link, sd_ndisc_router *rt) {
        ...
        r = sysctl_write_ip_neighbor_property_uint32(AF_INET6, link->ifname, "base_reachable_time_ms", (uint32_t) msec, &link->sysctl_shadow);
        if (r < 0)
...
static int ndisc_router_process_retransmission_time(Link *link, sd_ndisc_router *rt) {
        ...
        r = sysctl_write_ip_neighbor_property_uint32(AF_INET6, link->ifname, "retrans_time_ms", (uint32_t) msec, &link->sysctl_shadow);
        if (r < 0)
...
static int ndisc_router_process_hop_limit(Link *link, sd_ndisc_router *rt) {
        ...
        r = sysctl_write_ip_property_uint32(AF_INET6, link->ifname, "hop_limit", (uint32_t) hop_limit, &link->sysctl_shadow);
        if (r < 0)
