...
static int address_build_json(Address *address, JsonVariant **ret) {
        ...
        r = json_build(&v, JSON_BUILD_OBJECT(
                                ...
                                JSON_BUILD_PAIR("Source", JSON_BUILD_STRING(network_config_source_to_string(address->source))),
                                JSON_BUILD_PAIR("State", JSON_BUILD_STRING(state)),
                                JSON_BUILD_PAIR_CONDITION(in_addr_is_set(address->family, &address->provider), "Provider",
