...
static int vl_method_get_states(sd_varlink *link, sd_json_variant *parameters, sd_varlink_method_flags_t flags, void *userdata) {
        ...
        return sd_varlink_replybo(
                        ...
                        JSON_BUILD_PAIR_ENUM("CarrierState", link_carrier_state_to_string(m->carrier_state)),
                        ...
                        JSON_BUILD_PAIR_ENUM("OperationalState", link_operstate_to_string(m->operational_state)));
}
