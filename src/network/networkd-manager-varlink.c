...
static int vl_method_get_lldp_neighbors(Varlink *vlink, JsonVariant *parameters, VarlinkMethodFlags flags, Manager *manager) {
        ...
        if (link) {
                ...
                return varlink_replyb(vlink,
                                JSON_BUILD_OBJECT(
                                        JSON_BUILD_PAIR_CONDITION(w, "Neighbors", JSON_BUILD_VARIANT(w)),
                                        JSON_BUILD_PAIR_CONDITION(!w, "Neighbors", JSON_BUILD_EMPTY_ARRAY)));
        }
        ...
        return varlink_replyb(vlink,
                        JSON_BUILD_OBJECT(
                                JSON_BUILD_PAIR_CONDITION(v, "NeighborsByInterface", JSON_BUILD_VARIANT(v)),
                                JSON_BUILD_PAIR_CONDITION(!v, "NeighborsByInterface", JSON_BUILD_EMPTY_ARRAY)));
}
