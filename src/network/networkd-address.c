...
bool link_check_addresses_ready(Link *link, NetworkConfigSource source) {
         ...
         * addresses are static or foreign, and there is no other dynamic addressing protocol enabled, the
         * link will never enter configured state. See also link_check_readh(). */
        SET_FOREACH(a, link->addresses) {
