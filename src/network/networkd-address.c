...
int address_dup(const Address *src, Address **ret) {
        ...
        dest->label = NULL;
        dest->netlabel = NULL;
        dest->ipv4_nft_set_contexts.contexts = NULL;
        dest->ipv4_nft_set_contexts.n_contexts = 0;
        dest->ipv6_nft_set_contexts.contexts = NULL;
        dest->ipv6_nft_set_contexts.n_contexts = 0;
...
static void address_modify_nft_set_contexts(Address *address, bool add, NFTSetContexts *nft_set_contexts) {
        ...
        FOREACH_ARRAY(ctx, nft_set_contexts->contexts, nft_set_contexts->n_contexts) {
                assert(ctx);
...
int manager_rtnl_process_address(sd_netlink *rtnl, sd_netlink_message *message, Manager *m) {
        ...
        if (req && req->waiting_reply) {
                ...
                nft_set_context_free_many(&address->ipv4_nft_set_contexts);
                (void) nft_set_context_dup(&a->ipv4_nft_set_contexts, &address->ipv4_nft_set_contexts);
                nft_set_context_free_many(&address->ipv6_nft_set_contexts);
                (void) nft_set_context_dup(&a->ipv6_nft_set_contexts, &address->ipv6_nft_set_contexts);
