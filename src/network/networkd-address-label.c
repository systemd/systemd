...
static const ConfigSectionParser address_label_conf_parser_table[_IPV6_ADDRESS_LABEL_CONF_PARSER_MAX] = {
...
int config_parse_ipv6_address_label_section(
        ...
        r = config_section_parse(address_label_conf_parser_table, ELEMENTSOF(address_label_conf_parser_table),
