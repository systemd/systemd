...
int main(int argc, char *argv[]) {
        ...
        test_network_one(
                        "eth0",
                        "ip",
                        "eth0:dhcp:1530:00:11:22:33:44:55",
                        "[Match]\n"
                        "Name=eth0\n"
                        "\n[Link]\n"
        ...
        test_network_one(
                        "eth0",
                        "ip",
                        "192.168.0.10::192.168.0.1:255.255.255.0:hogehoge:eth0:on",
                        "[Match]\n"
                        "Name=eth0\n"
                        "\n[Link]\n"
                        "\n[Network]\n"
        ...
        test_network_one(
                        "eth0",
                        "ip",
                        "192.168.0.10:192.168.0.2:192.168.0.1:255.255.255.0:hogehoge:eth0:on",
                        "[Match]\n"
                        "Name=eth0\n"
                        "\n[Link]\n"
                        "\n[Network]\n"
        ...
        test_network_one(
                        "eth0",
                        "ip",
                        "192.168.0.10:192.168.0.2:192.168.0.1:255.255.255.0:hogehoge:eth0:on:1530",
                        "[Match]\n"
                        "Name=eth0\n"
                        "\n[Link]\n"
                        "MTUBytes=1530\n"
        ...
        test_network_one(
                        "eth0",
                        "ip",
                        "192.168.0.10:192.168.0.2:192.168.0.1:255.255.255.0:hogehoge:eth0:on:1530:00:11:22:33:44:55",
                        "[Match]\n"
                        "Name=eth0\n"
                        "\n[Link]\n"
                        "MACAddress=00:11:22:33:44:55\n"
        ...
        test_network_one(
                        "eth0",
                        "ip",
                        "192.168.0.10:192.168.0.2:192.168.0.1:255.255.255.0:hogehoge:eth0:on:10.10.10.10",
                        "[Match]\n"
                        "Name=eth0\n"
                        "\n[Link]\n"
                        "\n[Network]\n"
        ...
        test_network_one(
                        "eth0",
                        "ip",
                        "192.168.0.10:192.168.0.2:192.168.0.1:255.255.255.0:hogehoge:eth0:on:10.10.10.10:10.10.10.11",
                        "[Match]\n"
                        "Name=eth0\n"
                        "\n[Link]\n"
                        "\n[Network]\n"
        ...
        test_network_one(
                        "eth0",
                        "ip",
                        "[2001:1234:56:8f63::10]::[2001:1234:56:8f63::1]:64:hogehoge:eth0:on",
                        "[Match]\n"
                        "Name=eth0\n"
                        "\n[Link]\n"
                        "\n[Network]\n"
        ...
        test_link_one("hogehoge",
                      "ifname",
                      "hogehoge:00:11:22:33:44:55",
                      "[Match]\n"
                      "MACAddress=00:11:22:33:44:55\n"
                      "\n[Link]\n"
                      "Name=hogehoge\n");

        test_link_one("001122334455",
                      "net.ifname-policy",
                      "keep,kernel,database,onboard,slot,path,mac,00:11:22:33:44:55",
                      "[Match]\n"
                      "MACAddress=00:11:22:33:44:55\n"
                      "\n[Link]\n"
        ...
        test_link_one("default",
                      "net.ifname-policy",
                      "keep,kernel,database,onboard,slot,path,mac",
                      "[Match]\n"
                      "OriginalName=*\n"
                      "\n[Link]\n"
                      "NamePolicy=keep kernel database onboard slot path mac\n"
