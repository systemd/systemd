...
static const char *const request_type_table[_REQUEST_TYPE_MAX] = {
        ...
        [REQUEST_TYPE_GET_LINK_BRIDGE_VLAN]             = "bridge VLAN configurations (getting current state)",
        [REQUEST_TYPE_DEL_LINK_BRIDGE_VLAN]             = "bridge VLAN configurations (removing unnecessary IDs)",
        [REQUEST_TYPE_SET_LINK_BRIDGE_VLAN]             = "bridge VLAN configurations (applying/updating)",
