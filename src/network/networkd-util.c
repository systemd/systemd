...
/* For backward compatibility, IPMasquerade=yes means IPMasquerade=ipv4. */
DEFINE_PRIVATE_STRING_TABLE_LOOKUP_FROM_STRING_WITH_BOOLEAN(ip_masquerade_address_family, AddressFamily, ADDRESS_FAMILY_IPV4);
DEFINE_CONFIG_PARSE_ENUM(config_parse_ip_masquerade_address_family, ip_masquerade_address_family,
                         AddressFamily, "Failed to parse option");
