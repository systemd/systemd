...
static const char * const network_config_source_table[_NETWORK_CONFIG_SOURCE_MAX] = {
        ...
        [NETWORK_CONFIG_SORUCE_IPV4LL]  = "IPv4LL",
        [NETWORK_CONFIG_SOURCE_DHCP4]   = "DHCP4",
        [NETWORK_CONFIG_SOURCE_DHCP6]   = "DHCP6",
        [NETWORK_CONFIG_SOURCE_DHCP6PD] = "DHCP6PD",
...
int network_config_status_to_string_alloc(NetworkConfigStatus s, char **ret) {
        static const struct {
                ...
                { .status = NETWORK_CONFIG_STATUS_REQUESTING,  .str = "requesting",  },
                { .status = NETWORK_CONFIG_STATUS_PROBING,     .str = "probing",     },
                { .status = NETWORK_CONFIG_STATUS_ANNOUNCED,   .str = "announced",   },
                { .status = NETWORK_CONFIG_STATUS_CONFIGURING, .str = "configuring", },
                { .status = NETWORK_CONFIG_STATUS_NOT_READY,   .str = "not-ready",   },
                { .status = NETWORK_CONFIG_STATUS_CONFIGURED,  .str = "configured",  },
                { .status = NETWORK_CONFIG_STATUS_MARKED,      .str = "marked",      },
                { .status = NETWORK_CONFIG_STATUS_REMOVING,    .str = "removing",    },
        };
