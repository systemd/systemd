...
static int sysctl_overwrite_check(sd_event_source *source, const struct inotify_event *event, Hashmap *sysctl_shadow) {
...
static int sysctl_inotify_manager(sd_event_source *source, const struct inotify_event *event, void *userdata) {
        ...
        (void) sysctl_overwrite_check(source, event, manager->sysctl_shadow);
...
static int sysctl_inotify_link(sd_event_source *source, const struct inotify_event *event, void *userdata) {
        ...
        (void) sysctl_overwrite_check(source, event, link->sysctl_shadow);
