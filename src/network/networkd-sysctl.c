...
static void manager_set_ip_forwarding(Manager *manager, int family) {
        ...
        r = sysctl_write_ip_property_boolean(family, "default", "forwarding", t, true);
        if (r < 0)
        ...
        r = sysctl_write_ip_property_boolean(family, "all", "forwarding", t, true);
        if (r < 0)
...
static int link_update_ipv6_sysctl(Link *link) {
        ...
        return sysctl_write_ip_property_boolean(AF_INET6, link->ifname, "disable_ipv6", false, true);
}
...
static int link_set_proxy_arp(Link *link) {
        ...
        return sysctl_write_ip_property_boolean(AF_INET, link->ifname, "proxy_arp", link->network->proxy_arp > 0, true);
}
...
static int link_set_proxy_arp_pvlan(Link *link) {
        ...
        return sysctl_write_ip_property_boolean(AF_INET, link->ifname, "proxy_arp_pvlan", link->network->proxy_arp_pvlan > 0, true);
}
...
static int link_set_ip_forwarding(Link *link, int family) {
        ...
        r = sysctl_write_ip_property_boolean(family, link->ifname, "forwarding", t, true);
        if (r < 0)
...
static int link_set_ipv4_rp_filter(Link *link) {
        ...
        return sysctl_write_ip_property_int(AF_INET, link->ifname, "rp_filter", link->network->ipv4_rp_filter, true);
}
...
static int link_set_ipv6_privacy_extensions(Link *link) {
        ...
        return sysctl_write_ip_property_int(AF_INET6, link->ifname, "use_tempaddr", (int) val, true);
}
...
static int link_set_ipv6_accept_ra(Link *link) {
        ...
        return sysctl_write_ip_property(AF_INET6, link->ifname, "accept_ra", "0", true);
}
...
static int link_set_ipv6_dad_transmits(Link *link) {
        ...
        return sysctl_write_ip_property_int(AF_INET6, link->ifname, "dad_transmits", link->network->ipv6_dad_transmits, true);
}
...
static int link_set_ipv6_hop_limit(Link *link) {
        ...
        return sysctl_write_ip_property_int(AF_INET6, link->ifname, "hop_limit", link->network->ipv6_hop_limit, true);
}
...
static int link_set_ipv6_retransmission_time(Link *link) {
        ...
        return sysctl_write_ip_neighbor_property_uint32(AF_INET6, link->ifname, "retrans_time_ms", retrans_time_ms, true);
}
...
static int link_set_ipv6_proxy_ndp(Link *link) {
        ...
        return sysctl_write_ip_property_boolean(AF_INET6, link->ifname, "proxy_ndp", v, true);
}
...
int link_set_ipv6_mtu(Link *link) {
        ...
        return sysctl_write_ip_property_uint32(AF_INET6, link->ifname, "mtu", mtu, true);
}
...
static int link_set_ipv4_accept_local(Link *link) {
        ...
        return sysctl_write_ip_property_boolean(AF_INET, link->ifname, "accept_local", link->network->ipv4_accept_local > 0, true);
}
...
static int link_set_ipv4_route_localnet(Link *link) {
        ...
        return sysctl_write_ip_property_boolean(AF_INET, link->ifname, "route_localnet", link->network->ipv4_route_localnet > 0, true);
}
...
static int link_set_ipv4_promote_secondaries(Link *link) {
        ...
        return sysctl_write_ip_property_boolean(AF_INET, link->ifname, "promote_secondaries", true, true);
}
