...
static Network *network_free(Network *network) {
        ...
        nft_set_context_free(&network->dhcp_nft_set_context);
        ...
        nft_set_context_free(&network->dhcp6_nft_set_context);

        /* DHCP PD */
        free(network->dhcp_pd_uplink_name);
        set_free(network->dhcp_pd_tokens);
        free(network->dhcp_pd_netlabel);
        nft_set_context_free(&network->dhcp_pd_nft_set_context);
        ...
        nft_set_context_free(&network->ndisc_nft_set_context);
