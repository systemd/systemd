...
static Network *network_free(Network *network) {
        ...
        nft_set_context_free_many(&network->dhcp_nft_set_contexts);
        ...
        nft_set_context_free_many(&network->dhcp6_nft_set_contexts);

        /* DHCP PD */
        free(network->dhcp_pd_uplink_name);
        set_free(network->dhcp_pd_tokens);
        free(network->dhcp_pd_netlabel);
        nft_set_context_free_many(&network->dhcp_pd_nft_set_contexts);
        ...
        nft_set_context_free_many(&network->ndisc_nft_set_contexts);
