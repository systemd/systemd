...
typedef enum DHCP4AddressType {
        DHCP4_ADDRESS_TYPE_DHCP4_IP,
        DHCP4_ADDRESS_TYPE_DHCP4_GATEWAY,
        _DHCP4_ADDRESS_TYPE_MAX,
        _DHCP4_ADDRESS_TYPE_INVALID = -1,
} DHCP4AddressType;
...
typedef struct RoutingPolicyRule {
        ...
        DHCP4AddressType to_type;
        DHCP4AddressType from_type;
