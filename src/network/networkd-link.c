        ...
        ORDERED_SET_FOREACH(req, link->manager->request_queue) {
                ...
                case REQUEST_TYPE_ADDRESS: {
                        ...
                        if (req->waiting_reply && link->state != LINK_STATE_LINGER &&
                            address_get(link, address, /* ret= */ NULL) < 0)
                ...
                case REQUEST_TYPE_NEIGHBOR: {
                        ...
                        if (req->waiting_reply && link->state != LINK_STATE_LINGER &&
                            neighbor_get(link, neighbor, /* ret= */ NULL) < 0)
                ...
                case REQUEST_TYPE_NEXTHOP: {
                        ...
                        if (req->waiting_reply && link->state != LINK_STATE_LINGER &&
                            nexthop_get_by_id(link->manager, nexthop->id, /* ret= */ NULL) < 0)
                ...
                case REQUEST_TYPE_ROUTE: {
                        ...
                        if (req->waiting_reply && link->state != LINK_STATE_LINGER &&
                            route_get(link->manager, route, /* ret= */ NULL) < 0)
