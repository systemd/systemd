...
static int link_update_flags(Link *link, sd_netlink_message *message) {
        ...
        if (!had_carrier && link_has_carrier(link)) {
                ...
                /* At this stage, both wlan and link information should be up-to-date. Hence, it is not
                 * necessary to call RTM_GETLINK, NL80211_CMD_GET_INTERFACE, or NL80211_CMD_GET_STATION
                 * commands, and simply call link_reconfigure_impl(). */
