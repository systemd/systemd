...
static int link_carrier_gained(Link *link) {
        ...
        /* If the SSID is changed, then the connected wireless network should be changed. So, always
         * reconfigure the link. That makes e.g. DHCP client being restarted, and the correct network
