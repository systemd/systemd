...
static int link_carrier_lost(Link *link) {
        ...
        if (link->network->ignore_carrier_loss_set)
                ...
                /* Enslaving wlan interface to a bond disconnects from AP, and causes carrier loss.
                 * See #19832. */
                usec = 3 * USEC_PER_SEC;
                ...
                /* Some drivers reset interfaces when changing MTU, and causes carrier loss. Resetting
                 * interfaces by the static MTU should not cause any issues. However, setting MTU
