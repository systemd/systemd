...
static int link_initialized(Link *link, sd_device *device) {
        ...
        /* Do no ignore unamanaged state case here. If an interface is renamed after once configured,
         * and the corresponding .network file has Name= in [Match] section, then the interface may be
         * already in unmanaged state. See #20657. */
