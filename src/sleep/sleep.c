...
static int execute_s2h(const SleepConfig *sleep_config) {
        ...
        do {
                ...
                int last_capacity, current_capacity, estimated_total_discharge_time;
                ...
                if (!FLAGS_SET(r, POLLIN))  { /* We woke up before the alarm time, calculate battery discharged and estimate rate. */
                        ...
                        log_debug("%d percentage battery discharged in %s time",
                        ...
                        log_debug("Battery will discharge in %d time", estimated_total_discharge_time);
                        return 0;
                }
                tfd = safe_close(tfd);
                ...
                if (estimated_total_discharge_time < 1)
                        suspend_interval = 30 * USEC_PER_MINUTE;
