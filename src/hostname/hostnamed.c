...
static int method_describe(sd_bus_message *m, void *userdata, sd_bus_error *error) {
        ...
        r = json_build(&v, JSON_BUILD_OBJECT(
                                       ...
                                       JSON_BUILD_PAIR_CONDITION(local_cid != VMADDR_CID_ANY, "VSockContextIdentifier", JSON_BUILD_UNSIGNED(local_cid))));
...
static const sd_bus_vtable hostname_vtable[] = {
        ...
        SD_BUS_PROPERTY("VSockContextIdentifier", "u", property_get_vsock_cid, 0, SD_BUS_VTABLE_PROPERTY_CONST),
