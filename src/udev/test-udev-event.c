...
static void test_event_spawn_test1(const char *self, bool with_pidfd) {
        _cleanup_strv_free_ char **lines = NULL;
        _cleanup_free_ char *cmd = NULL;
        char result_buf[BUF_SIZE], **p;
        ...
        assert_se(cmd = strjoin(self, " test1"));
...
int main(int argc, char *argv[]) {
        ...
        self = path_simplify(self, true);

        test_event_spawn_test1(self, true);
        test_event_spawn_test1(self, false);
