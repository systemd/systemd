...
int udev_watch_begin(int inotify_fd, sd_device *dev) {
         ...
         * DEVNAME= has already been removed, and may already be assigned to another device. Consider that
         * e.g. a USB stick memory was unplugged and then another one is plugged. */
