...
#define UDEVADM_VERB(fn, name, args, flags, help)                       \
        VERB_SCOPE_NS(, fn, name, "udevadm-" name, args, VERB_ANY, VERB_ANY, flags, help)
...
UDEVADM_VERB(verb_settle_main,  "settle",       NULL,               0, "Wait for pending udev events");
UDEVADM_VERB(verb_control_main, "control",      NULL,               VERB_OPTION_REQUIRED, "Control the udev daemon");
UDEVADM_VERB(verb_monitor_main, "monitor",      NULL,               0, "Listen to kernel and udev events");
...
UDEVADM_VERB(verb_hwdb_main,    "hwdb",         NULL,               0, /* help= */ NULL); /* deprecated */
