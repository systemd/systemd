...
static int find_real_nvme_parent(sd_device *dev, sd_device **ret) {
        ...
        /* If the device belongs to "nvme-subsystem" (not to be confused with "nvme"), which happens
         * when multipath is enabled, then the syspath is something like the following:
