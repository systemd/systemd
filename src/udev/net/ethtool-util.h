...
typedef enum NetDevAdvertise {
        NET_DEV_ADVERTISE_10BASET_HALF        =  ETHTOOL_LINK_MODE_10baseT_Half_BIT,
        NET_DEV_ADVERTISE_10BASET_FULL        =  ETHTOOL_LINK_MODE_10baseT_Full_BIT,
        NET_DEV_ADVERTISE_100BASET_HALF       =  ETHTOOL_LINK_MODE_100baseT_Half_BIT,
        NET_DEV_ADVERTISE_100BASET_FULL       =  ETHTOOL_LINK_MODE_100baseT_Full_BIT,
        NET_DEV_ADVERTISE_1000BASET_HALF      =  ETHTOOL_LINK_MODE_1000baseT_Half_BIT,
        NET_DEV_ADVERTISE_1000BASET_FULL      =  ETHTOOL_LINK_MODE_1000baseT_Full_BIT,
        NET_DEV_ADVERTISE_10000BASET_FULL     =  ETHTOOL_LINK_MODE_10000baseT_Full_BIT,
        NET_DEV_ADVERTISE_2500BASEX_FULL      =  ETHTOOL_LINK_MODE_2500baseX_Full_BIT,
        NET_DEV_ADVERTISE_1000BASEKX_FULL     =  ETHTOOL_LINK_MODE_1000baseKX_Full_BIT,
        NET_DEV_ADVERTISE_10000BASEKX4_FULL   =  ETHTOOL_LINK_MODE_10000baseKX4_Full_BIT,
        NET_DEV_ADVERTISE_10000BASEKR_FULL    =  ETHTOOL_LINK_MODE_10000baseKR_Full_BIT,
        NET_DEV_ADVERTISE_10000BASER_FEC      =  ETHTOOL_LINK_MODE_10000baseR_FEC_BIT,
        NET_DEV_ADVERTISE_20000BASEMLD2_Full  =  ETHTOOL_LINK_MODE_20000baseMLD2_Full_BIT,
        NET_DEV_ADVERTISE_20000BASEKR2_Full   =  ETHTOOL_LINK_MODE_20000baseKR2_Full_BIT,
