...
// TODO: add function that tries to parse the partition type into more options, such as:
// ID_PART_ENTRY_TYPE_NAME = "root" or "usr" or "var" or etc
// ID_PART_ENTRTY_TYPE_NAME_ARCH = "root-amd64" or "usr-amd64" or etc
