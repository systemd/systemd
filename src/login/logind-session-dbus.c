...
static int method_set_type(sd_bus_message *message, void *userdata, sd_bus_error *error) {
        ...
        if (!SESSION_CLASS_CAN_CHANGE_TYPE(s->class))
                return sd_bus_error_set(error, SD_BUS_ERROR_INVALID_ARGS, "Session class doesn't support changing type.");
...
static int method_take_device(sd_bus_message *message, void *userdata, sd_bus_error *error) {
        ...
        if (!SESSION_CLASS_CAN_TAKE_DEVICE(s->class))
                return sd_bus_error_set(error, SD_BUS_ERROR_INVALID_ARGS, "Session class doesn't support taking device control.");
