...
static const sd_bus_vtable manager_vtable[] = {
        ...
        SD_BUS_PROPERTY("HandleCapslockEscKeyLongPress", "s", property_get_handle_action, offsetof(Manager, handle_capslock_esc_key_long_press), SD_BUS_VTABLE_PROPERTY_CONST),
        ...
        SD_BUS_SIGNAL_WITH_ARGS("SeatWantsGreeter",
