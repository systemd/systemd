...
static int create_session(sd_bus_message *message,
                          void *userdata,
                          sd_bus_error *error,
                          uid_t uid,
                          pid_t pid,
        ...
        session->leader_pidfd = dup(pidfd);
...
static int method_create_session(sd_bus_message *message, void *userdata, sd_bus_error *error) {
        ...
        return create_session(message, userdata, error,
                              uid, leader, -EBADF, service, type, class, desktop, cseat, vtnr, tty, display, remote, remote_user, remote_host);
}
...
static int method_create_session_pidfd(sd_bus_message *message, void *userdata, sd_bus_error *error) {
        ...
        return create_session(message, userdata, error,
                              uid, -1, leaderfd, service, type, class, desktop, cseat, vtnr, tty, display, remote, remote_user, remote_host);
}
