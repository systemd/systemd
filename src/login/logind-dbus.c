...
static const sd_bus_vtable manager_vtable[] = {
        ...
        SD_BUS_PROPERTY("HandleSAKSequenceLongPress", "s", property_get_handle_action, offsetof(Manager, handle_sak_sequence_long_press), SD_BUS_VTABLE_PROPERTY_CONST),
