...
static void button_stop_long_press(Button *b, sd_event_source **e) {
        assert(b);
        assert(e);
...
Button *button_free(Button *b) {
        ...
        button_stop_long_press(b, &b->manager->power_key_long_press_event_source);
        button_stop_long_press(b, &b->manager->reboot_key_long_press_event_source);
        button_stop_long_press(b, &b->manager->suspend_key_long_press_event_source);
        button_stop_long_press(b, &b->manager->hibernate_key_long_press_event_source);
