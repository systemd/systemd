...
/* To avoid the delay caused by hibernation, we don't enable hybrid-sleep or hibernate by default */
#define HANDLE_ACTION_SLEEP_MASK_DEFAULT (HANDLE_SLEEP_SUSPEND_THEN_HIBERNATE_MASK|HANDLE_SLEEP_SUSPEND_MASK)
