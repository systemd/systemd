...
int inhibitor_build_json(Inhibitor *i, sd_json_variant **ret) {
        ...
        return sd_json_buildo(
                        ret,
                        JSON_BUILD_PAIR_STRING_NON_EMPTY("Id", i->id),
                        JSON_BUILD_PAIR_STRING_NON_EMPTY("What", inhibit_what_to_string(i->what)),
                        ...
                        JSON_BUILD_PAIR_DUAL_TIMESTAMP("Since", &i->since));
}
