...
static int md_list_get(MountPoint **head) {
        ...
        FOREACH_DEVICE(e, d) {
                ...
                /* Container is special type of MD device, used by external metadata.
                 * One or more active arrays could have reference to the one container.
                 * It doesn't provide RAID functionality itself, it don't need to be stopped.*/
