...
def pe_add_sections(opts: UkifyConfig, uki: UKI, output: str) -> None:
    ...
    if symbol_table_start := pe.FILE_HEADER.PointerToSymbolTable:
        ...
        if string_table_size := pe.get_dword_from_offset(symbol_table_start + symbol_table_size):
        ...
        # Adjust existing sections pointing beyond the symbol table, e.g. offline PCR signing involving
        # older ukify.
