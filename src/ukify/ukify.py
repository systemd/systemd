...
def finalize_options(opts):
    ...
    if bool(opts.sb_key) ^ bool(opts.sb_cert):
        ...
        if not bool(opts.sb_cert_name):
            raise ValueError('Please provide --secureboot-certificate-name for --signtool=pesign or --secureboot-private-key= and --secureboot-certificate= for --signtool=sbsign')
