...
static int parse_uki_protect_version(const char *rvalue, char ***ret_protected_versions) {
        ...
        r = find_esp_and_xbootldr_paths_and_warn(arg_root,
                                                 /* esp_path= */ NULL,
                                                 /* xbootldr_path= */ NULL,
        ...
        r = strv_extend(ret_protected_versions, version);
        if (r < 0)
                return log_oom_debug();
