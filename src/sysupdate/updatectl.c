...
static int describe_feature(sd_bus *bus, const char *feature, Feature *ret) {
        ...
        static const sd_json_dispatch_field dispatch_table[] = {
                ...
                { "suggested",       SD_JSON_VARIANT_BOOLEAN, sd_json_dispatch_stdbool, offsetof(Feature, suggested),          SD_JSON_MANDATORY },
                { "documentation",   SD_JSON_VARIANT_ARRAY,   sd_json_dispatch_strv,    offsetof(Feature, documentation),       0                 },
...
static int list_features(sd_bus *bus) {
        ...
        STRV_FOREACH(feature, features) {
                ...
                r = table_add_many(table,
                                   ...
                                   TABLE_SET_URL, f.documentation[0],
