...
static int show_statistics(int argc, char **argv, void *userdata) {
        ...
        r = varlink_call_and_log(vl, "io.systemd.Resolve.Monitor.DumpStatistics", /* parameters= */ NULL, &reply, /* ret_error_id= */ NULL);
        if (r < 0)
                return r;
...
static int reset_statistics(int argc, char **argv, void *userdata) {
        ...
        r = varlink_call_and_log(vl, "io.systemd.Resolve.Monitor.ResetStatistics", /* parameters= */ NULL, &reply, /* ret_error_id= */ NULL);
        if (r < 0)
                return r;
...
static int verb_show_cache(int argc, char *argv[], void *userdata) {
        ...
        r = varlink_call_and_log(vl, "io.systemd.Resolve.Monitor.DumpCache", /* parameters= */ NULL, &reply, /* ret_error_id= */ NULL);
        if (r < 0)
                return r;
...
static int verb_show_server_state(int argc, char *argv[], void *userdata) {
        ...
        r = varlink_call_and_log(vl, "io.systemd.Resolve.Monitor.DumpServerState", /* parameters= */ NULL, &reply, /* ret_error_id= */ NULL);
        if (r < 0)
                return r;
