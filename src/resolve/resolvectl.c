...
static void monitor_query_dump(JsonVariant *v) {
        ...
        JsonDispatch dispatch_table[] = {
                ...
                { "collectedQuestions", JSON_VARIANT_ARRAY,   json_dispatch_variant,      (size_t) &collected_questions, 0              },
        ...
        /* And the show the questions that lead to this one if a CNAME chain */
