...
int main(int argc, char **argv) {
        ...
        if (system("openssl version >/dev/null 2>&1") != 0) {
                log_warning("Skipping TLS test since the 'openssl' command does not seem to be available");
                /* Magic exit code to skip the test, see https://mesonbuild.com/Unit-tests.html */
                return 77;
        }
