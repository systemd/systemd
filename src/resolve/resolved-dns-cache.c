...
struct DnsCacheItem {
        ...
        usec_t until;            /*  If StaleRetentionSec is greater than zero, until is set to a duration of StaleRetentionSec from the date of creation. If StaleRetentionSec is zero, both until and until_valid will be set to ttl. */
...
static int dns_cache_put_positive(
        ...
        /* When StaleRetentionSec is greater than zero, the 'until' property is set to a duration
