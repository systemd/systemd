...
void dns_cache_prune(DnsCache *c, int owner_family, const char *ifname, DnsProtocol protocol) {
        usec_t t = 0;
        int r;
...
int dns_cache_check_conflicts(DnsCache *cache, DnsResourceRecord *rr, int owner_family, const union in_addr_union *owner_address, const char *ifname, DnsProtocol protocol) {
