...
int manager_parse_config_file(Manager *m) {
        ...
        if (m->dnssec_mode != DNSSEC_NO) {
                log_warning("DNSSEC option cannot be enabled or set to allow-downgrade when systemd-resolved is built without a crypto library. Turning off DNSSEC support.");
