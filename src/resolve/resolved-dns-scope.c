...
int dns_scope_dump_cache_to_json(DnsScope *scope, sd_json_variant **ret) {
        ...
        return sd_json_buildo(
                        ...
                        SD_JSON_BUILD_PAIR_CONDITION(scope->protocol == DNS_PROTOCOL_DNS, "dnssec", SD_JSON_BUILD_STRING(dnssec_mode_to_string(scope->dnssec_mode))),
                        SD_JSON_BUILD_PAIR_CONDITION(scope->protocol == DNS_PROTOCOL_DNS, "dnsOverTLS", SD_JSON_BUILD_STRING(dns_over_tls_mode_to_string(scope->dns_over_tls_mode))));
}
