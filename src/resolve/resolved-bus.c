...
static int bus_method_discover(sd_bus_message *message, void *userdata, sd_bus_error *error) {
        _cleanup_(sd_bus_message_unrefp) sd_bus_message *reply = NULL;
        DnsScope *s;
        Manager *m = userdata;
        int r;
        ...
        LIST_FOREACH(scopes, s, m->dns_scopes) {
                ...
                r = dns_cache_filter(&s->cache, &answer);
                if (r < 0)
                        return r;
                if (r == 0)
                        continue;
...
static const sd_bus_vtable resolve_vtable[] = {
        ...
        SD_BUS_METHOD_WITH_ARGS("ResetServerFeatures",
                                ...
                                SD_BUS_VTABLE_UNPRIVILEGED),
        SD_BUS_METHOD_WITH_ARGS("Discover",
                                SD_BUS_NO_ARGS,
