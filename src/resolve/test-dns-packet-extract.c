...
TEST(packet_reply_opt_no_do_empty) {
        ...
        /* OPT */       0x00, 0x29,
        /* udp max */   0x02, 0x01,
        /* rcode */     0x7a,           /* TODO: parser treats any value over 0x80 as a zero TTL */
        /* version */   0x00,
        /* flags */     0x00, 0x00,
        /* rdata */     0x00, 0x00
        };
        ...
        /* TODO: ASSERT_EQ(DNS_PACKET_RCODE(packet), 1955u); */
...
/* RFC 9460 says that alias-mode RRs SHOULD NOT have the same owner and target.i
