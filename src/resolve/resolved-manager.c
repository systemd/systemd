...
static void manager_send_mdns_goodbyes(Manager *m) {
        ...
        HASHMAP_FOREACH(l, m->links) {
                ...
                FOREACH_ELEMENT(scope, scopes) {
                        ...
                        /* A pending RFC 6762 §8.3 re-announcement would emit positive TTLs during the
                         * goodbye grace second, racing the retransmitted goodbye and potentially
                         * resurrecting the very records being withdrawn. */
