...
int dns_manager_dump_statistics_json(Manager *m, JsonVariant **ret) {
        ...
        return json_build(ret,
                          JSON_BUILD_OBJECT(
                                        ...
                                        JSON_BUILD_PAIR_UNSIGNED("currentCacheSize", size),
                                        JSON_BUILD_PAIR_UNSIGNED("cacheHits", hit),
                                        JSON_BUILD_PAIR_UNSIGNED("cacheMisses", miss),
                                        JSON_BUILD_PAIR_UNSIGNED("dnssecSecureVerdicts", m->n_dnssec_verdict[DNSSEC_SECURE]),
                                        JSON_BUILD_PAIR_UNSIGNED("dnssecInsecureVerdicts", m->n_dnssec_verdict[DNSSEC_INSECURE]),
                                        JSON_BUILD_PAIR_UNSIGNED("dnssecBogusVerdicts", m->n_dnssec_verdict[DNSSEC_BOGUS]),
                                        JSON_BUILD_PAIR_UNSIGNED("dnssecIndeterminateVerdicts", m->n_dnssec_verdict[DNSSEC_INDETERMINATE])));
}
