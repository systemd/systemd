...
bool dns_service_match_and_update(DnssdDiscoveredService *services, DnsResourceRecord *rr, int owner_family, int ifindex, usec_t until);
bool dns_answer_contains_service(DnsServiceBrowser *sb, DnsAnswer *answer, DnssdDiscoveredService *service);
