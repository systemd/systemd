...
TEST(mdns_announcement_max_sizes_without_a_link) {
        ...
        /* No link, so no MTU: the packet size falls back to DNS_PACKET_SIZE_MAX, which section 17's
         * ceiling then caps -- 64K datagrams are not allowed on the wire either. */
