 ...
 * connection. A maintenance query in flight holds a reference that would otherwise keep the browser —
 * and its armed ladder — alive past the subscription, so abort it here too. */
