...
static int help(void) {
        ...
        printf("%1$s [OPTIONS...] [DEVICE]\n"
               ...
               "                          Install a credential with literal value to target system\n"
               "     --load-credential=ID:PATH\n"
               "                          Load a credential to install to new system from file or\n"
               ...
               "     --mute-console=yes   Tell kernel/PID 1 to not write to the console while running\n"
...
static int run(int argc, char *argv[]) {
        ...
        _cleanup_(sd_varlink_flush_close_unrefp) sd_varlink *repart_link = NULL, *mute_console_link = NULL;
