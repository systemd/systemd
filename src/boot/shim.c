 ...
 * loader protocol is available (shim v16 and newer), then it will have overridden BS->LoadImage and friends
 * in the system table, so no specific helper is needed, and the standard BS->LoadImage() and friends can be
 * called instead. */
