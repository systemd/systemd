...
static bool efifw_validate_header(
        ...
        size_t base_sz = sizeof_field(EfiFwHeader, magic) +
                sizeof_field(EfiFwHeader, header_len) +
                sizeof_field(EfiFwHeader, fwid_len) +
                sizeof_field(EfiFwHeader, payload_len);
        ...
        char *fwid_off    = (unsigned char*)blob + header_len;
        char *payload_off = fwid_off + fwid_len;
