...
static int print_efi_option(
        ...
        if (arg_json_format_flags != JSON_FORMAT_OFF) {
                ...
                _cleanup_(json_variant_unrefp) JsonVariant *status = NULL;
                ...
                r = json_variant_merge_objectb(&status, JSON_BUILD_OBJECT(
                        JSON_BUILD_PAIR("active", JSON_BUILD_BOOLEAN(active)),
                        JSON_BUILD_PAIR("inOrder", JSON_BUILD_BOOLEAN(in_order))
                ));
                ...
                r = json_variant_merge_objectb(&efi_obj, JSON_BUILD_OBJECT(
                                    JSON_BUILD_PAIR("Title", JSON_BUILD_STRING(strna(title))),
                                        ...
                                        JSON_BUILD_PAIR("Status", JSON_BUILD_VARIANT(status),
