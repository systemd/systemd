 ...
 * and implement the protocol for windows compatible graphical firmware updates. This extended header is
 * inserted right after the capsule header when the indicated GUID is used.
