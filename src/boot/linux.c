...
static EFI_STATUS load_with_shim(
                EFI_HANDLE parent,
...
EFI_STATUS linux_exec(
        ...
        if (secure_boot_enabled() && shim_load_image_is_shim())
                return load_with_shim(parent, compat_entry_point, kernel, initrd);
