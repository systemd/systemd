 ...
 */
#define LOADER_GUID GUID_DEF(0x4a67b082, 0x0a4c, 0x41cf, 0xb6, 0xc7, 0x44, 0x0b, 0x29, 0xbb, 0x8c, 0x4f)
...
void wait_for_debugger(EFI_HANDLE image, const char *identity, bool wait);
...
#else
static inline void beep(size_t beep_count) {}
#endif
