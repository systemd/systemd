...
EFI_STATUS efivar_set_uintn(const EFI_GUID *vendor, CHAR16 *name, UINTN i, BOOLEAN persistent) {
...
EFI_STATUS efivar_get_uintn(const EFI_GUID *vendor, const CHAR16 *name, UINTN *i) {
        assert_cc(sizeof(UINTN) == sizeof(UINT64) || sizeof(UINTN) == sizeof(UINT32));
