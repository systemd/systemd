                ...
                if (refresh) {
                        for (UINTN i = 0; i < config->entry_count; i++) {
                                ...
                                if ((INTN)i == idx_special)
                                        print_at(x_start + 1, y_start + i - idx_first,
                                                 (i == idx_highlight) ? COLOR_HIGHLIGHT : COLOR_NORMAL,
                                                 (CHAR16*) L"=>");
                        }
                        refresh = FALSE;
                        ...
                        if ((INTN)idx_highlight_prev == idx_special)
                                print_at(x_start + 1 , y_start + idx_highlight_prev - idx_first, COLOR_NORMAL, (CHAR16*) L"=>");
                        if ((INTN)idx_highlight == idx_special)
                                print_at(x_start + 1, y_start + idx_highlight - idx_first, COLOR_HIGHLIGHT, (CHAR16*) L"=>");
                        highlight = FALSE;
                }
