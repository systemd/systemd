...
_printf_(4, 0) int vsnprintf_status(
                ...
                const char * restrict format,
                va_list ap);
_printf_(2, 3) char16_t *xasprintf_status(EFI_STATUS status, const char * restrict format, ...);
_printf_(2, 0) char16_t *xvasprintf_status(EFI_STATUS status, const char * restrict format, va_list ap);

#ifdef SD_BOOT
_printf_(2, 3) EFI_STATUS printf_status(EFI_STATUS status, const char * restrict format, ...);
_printf_(2, 0) EFI_STATUS vprintf_status(EFI_STATUS status, const char * restrict format, va_list ap);
