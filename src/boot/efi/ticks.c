...
static BOOLEAN in_hypervisor(void) {
        ...
        /* The TSC might or might not be virtualized in VMs (an thus might not be accurate or start at zero
         * at boot), depending on supervisor and CPU functionality. If it's not virtualized it's not useful
