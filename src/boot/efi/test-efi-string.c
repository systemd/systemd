...
TEST(tolower8) {
        assert_se(tolower8('\0') == '\0');
        assert_se(tolower8('1') == '1');
        assert_se(tolower8('a') == 'a');
        assert_se(tolower8('A') == 'a');
        assert_se(tolower8('Z') == 'z');
        assert_se(tolower8('#') == '#');
}

TEST(tolower16) {
        assert_se(tolower16('\0') == '\0');
        assert_se(tolower16('1') == '1');
        assert_se(tolower16('a') == 'a');
        assert_se(tolower16('A') == 'a');
        assert_se(tolower16('Z') == 'z');
        assert_se(tolower16('#') == '#');
}
