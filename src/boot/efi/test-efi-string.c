...
TEST(vsnprintf_status) {
        test_vsnprintf_status_one("string");
        test_vsnprintf_status_one("%%-%%%%");

        test_vsnprintf_status_one("%p", &errno);
        ...
        assert_se(snprintf_status(0, buf, ELEMENTSOF(buf), "%p", NULL) == 6);
        assert_se(streq16(buf, u"(null)"));

        /* EFI Status codes. */
        assert_se(snprintf_status(0, buf, ELEMENTSOF(buf), "%m") == 7);
        assert_se(streq16(buf, u"Success"));
        assert_se(snprintf_status(7, buf, ELEMENTSOF(buf), "%m") == 14);
        assert_se(streq16(buf, u"Reset required"));
