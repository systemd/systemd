...
enum {
        ...
        CONSOLE_MODE_RANGE_MIN = 0LL,
        CONSOLE_MODE_RANGE_MAX = INT32_MAX,  /* This is just the theoretical limit. */
        CONSOLE_MODE_INVALID = -1LL,         /* UEFI uses -1 if the device is not in a valid text mode. */

        CONSOLE_MODE_80_25 = 0LL,            /* 80x25 is required by UEFI spec. */
        CONSOLE_MODE_80_50 = 1LL,            /* 80x50 may be supported. */
        CONSOLE_MODE_FIRMWARE_FIRST = 2LL,   /* First custom mode, if supported. */
