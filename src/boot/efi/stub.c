...
static EFI_STATUS load_addons(
        ...
        for (size_t i = 0; i < n_items; i++) {
                ...
                if (err != EFI_SUCCESS ||
                    (!pe_bsearch_section(sections, n_sections, unified_sections[UNIFIED_SECTION_CMDLINE]) &&
                        !pe_bsearch_section(sections, n_sections, unified_sections[UNIFIED_SECTION_DTB]))) {
                        if (err == EFI_SUCCESS)
                                err = EFI_NOT_FOUND;
                        log_error_status(err,
                ...
                if (pe_bsearch_section(sections, n_sections, unified_sections[UNIFIED_SECTION_LINUX])) {
                ...
                if (uname) {
                        struct PeSectionDescriptor *section_uname = pe_bsearch_section(sections, n_sections, unified_sections[UNIFIED_SECTION_UNAME]);
                ...
                if (ret_cmdline) {
                        struct PeSectionDescriptor *section_cmdline = pe_bsearch_section(sections, n_sections, unified_sections[UNIFIED_SECTION_CMDLINE]);
                        if (section_cmdline) {
                ...
                if (ret_dt_bases) {
                        struct PeSectionDescriptor *section_dtb = pe_bsearch_section(sections, n_sections, unified_sections[UNIFIED_SECTION_DTB]);
                        if (section_dtb) {
...
static EFI_STATUS run(EFI_HANDLE image) {
        ...
        if (err != EFI_SUCCESS || !pe_bsearch_section(sections, n_sections, unified_sections[UNIFIED_SECTION_LINUX])) {
                if (err == EFI_SUCCESS)
                        err = EFI_NOT_FOUND;
        ...
        for (UnifiedSection unified_section = 0; unified_section < _UNIFIED_SECTION_MAX; unified_section++) {
                ...
                struct PeSectionDescriptor *section = pe_bsearch_section(sections, n_sections, unified_sections[unified_section]);
                if (section)  {
                        m = false;
        ...
        struct PeSectionDescriptor *section_splash = pe_bsearch_section(sections, n_sections, unified_sections[UNIFIED_SECTION_SPLASH]);
        if (section_splash)
        ...
        struct PeSectionDescriptor *section_pcrsig = pe_bsearch_section(sections, n_sections, unified_sections[UNIFIED_SECTION_PCRSIG]);
        if (section_pcrsig)
         ...
         * cpio. */
        struct PeSectionDescriptor *section_pcrpkey = pe_bsearch_section(sections, n_sections, unified_sections[UNIFIED_SECTION_PCRPKEY]);
        if (section_pcrpkey)
                (void) pack_cpio_literal(
        ...
        struct PeSectionDescriptor *section_linux = ASSERT_PTR(pe_bsearch_section(sections, n_sections, unified_sections[UNIFIED_SECTION_LINUX]));
        linux_size = section_linux->size;
        linux_base = POINTER_TO_PHYSICAL_ADDRESS(loaded_image->ImageBase) + section_linux->offset;

        struct PeSectionDescriptor *section_initrd = pe_bsearch_section(sections, n_sections, unified_sections[UNIFIED_SECTION_INITRD]);
        if (section_initrd) {
