...
static EFI_STATUS run(EFI_HANDLE image) {
        ...
        size_t linux_size, initrd_size, dt_size, n_dts_addons_global = 0, n_dts_addons_uki = 0, ucode_size, n_ucode_addons_global = 0, n_ucode_addons_uki = 0;
        ...
        err = ucode_merge_and_measure_addons(
                ...
                ucode_sizes_addons_uki,
                n_ucode_addons_uki,
                ucode_size != 0 ? PHYSICAL_ADDRESS_TO_POINTER(POINTER_TO_PHYSICAL_ADDRESS(loaded_image->ImageBase) + addrs[UNIFIED_SECTION_UCODE]) : NULL,
