...
tpm1_measure_to_pcr_and_event_log(EFI_TCG * tcg, UINT32 pcrindex,
                                  EFI_PHYSICAL_ADDRESS buffer, UINTN buffer_size, CHAR16 * description) {
        EFI_STATUS status;
...
static EFI_STATUS tpm2_measure_to_pcr_and_event_log(EFI_TCG2 * tcg, UINT32 pcrindex,
                                                    EFI_PHYSICAL_ADDRESS buffer, UINT64 buffer_size, CHAR16 * description) {
        EFI_STATUS status;
...
static EFI_TCG * tcg1_interface_check() {
