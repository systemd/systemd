...
static int compare_name_to_section_descriptor(const char *key, const PeSectionDescriptor *elem) {
...
PeSectionDescriptor *pe_find_unified_section(PeSectionDescriptor *sections, size_t n_sections, UnifiedSection unified_section) {
        return bsearch_array(unified_sections[unified_section], sections, sizeof *sections, n_sections, (compare_func_t) compare_name_to_section_descriptor);
}