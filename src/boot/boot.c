...
static EFI_STATUS load_extras(
        ...
        _cleanup_(iovec_done) struct iovec extras = {};
        ...
        _cleanup_(iovec_done) struct iovec previous = {};
...
static EFI_STATUS call_image_start(
        ...
        _cleanup_pages_ Pages initrd_pages = {};                        /* Note: please keep order in tact: these pages should be released after the initrd handle is released */
