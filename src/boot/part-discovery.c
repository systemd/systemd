...
static EFI_STATUS try_gpt(
        ...
        gpt_pages = xmalloc_aligned_pages(AllocateMaxAddress, EfiLoaderData, EFI_SIZE_TO_PAGES(sizeof(GptHeader)), block_io->Media->IoAlign, UINT32_MAX);
        ...
        entries_pages = xmalloc_aligned_pages(AllocateMaxAddress, EfiLoaderData, EFI_SIZE_TO_PAGES(size), block_io->Media->IoAlign, UINT32_MAX);
