...
EFI_STATUS linux_exec_efi_handover(
        ...
        _cleanup_(free_pages) Pages linux_relocated = {};
        ...
        _cleanup_(free_pages) Pages initrd_relocated = {};
        ...
        _cleanup_(free_pages) Pages boot_params_page = xmalloc_pages(
        ...
        *boot_params = (BootParams){};
        ...
        _cleanup_(free_pages) Pages cmdline_pages = {};
        if (cmdline) {
