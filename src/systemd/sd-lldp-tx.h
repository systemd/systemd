...
int sd_lldp_tx_set_system_capabilities(sd_lldp_tx *lldp_tx, uint16_t system_capabilities);
int sd_lldp_tx_set_enabled_capabilities(sd_lldp_tx *lldp_tx, uint16_t enabled_capabilities);
