...
int sd_event_now(const sd_event *e, clockid_t clock, uint64_t *usec);

int sd_event_get_fd(const sd_event *e);
int sd_event_get_state(const sd_event *e);
...
sd_event *sd_event_source_get_event(const sd_event_source *s);
...
int sd_event_source_get_pending(const sd_event_source *s);
...
int sd_event_source_get_enabled(const sd_event_source *s, int *enabled);
...
int sd_event_source_get_io_revents(const sd_event_source *s, uint32_t* revents);
