...
int sd_event_add_signal(sd_event *e, sd_event_source **ret_event_source, int sig, sd_event_signal_handler_t callback, void *userdata);
...
int sd_event_add_post(sd_event *e, sd_event_source **ret_event_source, sd_event_handler_t callback, void *userdata);
int sd_event_add_exit(sd_event *e, sd_event_source **s, sd_event_handler_t callback, void *userdata);
int sd_event_add_memory_pressure(sd_event *e, sd_event_source **ret_event_source, sd_event_handler_t callback, void *userdata);
