...
int sd_pidfd_get_session(pid_t pid, char **ret_session);
int sd_pidfd_get_owner_uid(pid_t pid, uid_t *ret_uid);
int sd_pidfd_get_unit(pid_t pid, char **ret_unit);
int sd_pidfd_get_user_unit(pid_t pid, char **ret_unit);
int sd_pidfd_get_slice(pid_t pid, char **ret_slice);
int sd_pidfd_get_user_slice(pid_t pid, char **ret_slice);
int sd_pidfd_get_machine_name(pid_t pid, char **ret_machine);
int sd_pidfd_get_cgroup(pid_t pid, char **ret_cgroup);
...
/* Return primary display of user, if there is any */
 ...
 * If ret_sessions is NULL, this will just return the number of sessions. */
 ...
 * If ret_seats is NULL, this will just return the number of seats. */
...
int sd_session_get_tty(const char *session, char **ret_display);
 ...
 * If ret_sessions is NULL, this returns only the number of sessions. */
 ...
 * ret_seats is NULL, this only returns the number of seats. */
int sd_get_seats(char ***ret_seats);

/* Get all sessions, store in *sessions. Returns the number of
 * sessions. If ret_sessions is NULL, this only returns the number of sessions. */
int sd_get_sessions(char ***ret_sessions);

/* Get all logged in users, store in *users. Returns the number of
 * users. If ret_users is NULL, this only returns the number of users. */
 ...
 * (or all). */
int sd_login_monitor_new(const char *category, sd_login_monitor **ret_monitor);
