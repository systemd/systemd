...
#define SD_MESSAGE_REBOOT_KEY_PENDING     SD_ID128_MAKE(69,7f,30,59,da,e2,42,89,a5,17,8d,ed,d6,bb,ff,28)
#define SD_MESSAGE_REBOOT_KEY_PENDING_STR SD_ID128_MAKE_STR(69,7f,30,59,da,e2,42,89,a5,17,8d,ed,d6,bb,ff,28)
#define SD_MESSAGE_REBOOT_KEY_LONGPRESS   SD_ID128_MAKE(f1,c5,9a,58,c9,d9,43,66,89,65,c3,37,ca,ec,59,75)
#define SD_MESSAGE_REBOOT_KEY_LONGPRESS_STR \
                                          SD_ID128_MAKE_STR(f1,c5,9a,58,c9,d9,43,66,89,65,c3,37,ca,ec,59,75)
#define SD_MESSAGE_REBOOT_KEY_RELEASE     SD_ID128_MAKE(69,b6,71,64,83,6a,49,67,98,65,0d,a8,bc,4c,a3,93)
#define SD_MESSAGE_REBOOT_KEY_RELEASE_STR SD_ID128_MAKE_STR(69,b6,71,64,83,6a,49,67,98,65,0d,a8,bc,4c,a3,93)
