...
#define SD_MESSAGE_EK_ENROLLMENT_NEEDS_AUTHORIZATION      SD_ID128_MAKE(8d,81,3b,6b,ec,f0,4b,85,9d,99,76,0c,bb,56,df,f1)
#define SD_MESSAGE_EK_ENROLLMENT_NEEDS_AUTHORIZATION_STR  SD_ID128_MAKE_STR(8d,81,3b,6b,ec,f0,4b,85,9d,99,76,0c,bb,56,df,f1)
...
#define SD_MESSAGE_TPM_NVINDEX_EXHAUSTED              SD_ID128_MAKE(ab,98,4e,a0,08,96,4f,b8,8d,6e,38,9f,b5,13,fb,94)
#define SD_MESSAGE_TPM_NVINDEX_EXHAUSTED_STR          SD_ID128_MAKE_STR(ab,98,4e,a0,08,96,4f,b8,8d,6e,38,9f,b5,13,fb,94)
