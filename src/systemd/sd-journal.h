...
int sd_journal_enumerate_available_data(sd_journal *j, const void **data, size_t *size);
...
int sd_journal_get_usage(sd_journal *j, uint64_t *ret);

int sd_journal_query_unique(sd_journal *j, const char *field);
int sd_journal_enumerate_unique(sd_journal *j, const void **data, size_t *ret_size);
int sd_journal_enumerate_available_unique(sd_journal *j, const void **data, size_t *size);
