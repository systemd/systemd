...
#define sd_json_variant_set_fieldbo(v, field, ...) sd_json_variant_set_fieldb((v), (field), SD_JSON_BUILD_OBJECT(__VA_ARGS__))
...
#define sd_json_variant_append_arraybo(v, ...) sd_json_variant_append_arrayb((v), SD_JSON_BUILD_OBJECT(__VA_ARGS__))
...
#define sd_json_variant_merge_objectbo(v, ...) sd_json_variant_merge_objectb((v), SD_JSON_BUILD_OBJECT(__VA_ARGS__))
...
#define sd_json_buildo(ret, ...) sd_json_build((ret), SD_JSON_BUILD_OBJECT(__VA_ARGS__))
