...
enum {
        ...
        _SD_BUS_VTABLE_END               = '>',
        _SD_BUS_VTABLE_METHOD            = 'N',
        _SD_BUS_VTABLE_SIGNAL            = 'T',
        _SD_BUS_VTABLE_PROPERTY          = 'P',

        /* for ABI compatibility */
        _SD_BUS_VTABLE_METHOD_v1         = 'M',
        _SD_BUS_VTABLE_WRITABLE_PROPERTY = 'W',
        _SD_BUS_VTABLE_SIGNAL_v1         = 'S',
};
...
#define SD_BUS_METHOD_WITH_OFFSET(_member, _signature, _result, _handler, _offset, _flags) \
        SD_BUS_METHOD_WITH_OFFSET_AND_NAMES(_member, _signature, _result, _handler, 0, NULL, _flags)
