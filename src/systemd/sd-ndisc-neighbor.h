 ...
 * For solicited advertisements, the Target Address field in the Neighbor Solicitation (should be typo of
 * Advertisement) message that prompted this advertisement. For an unsolicited advertisement, the address
 * whose link-layer address has changed. The Target Address MUST NOT be a multicast address. */
