...
int sd_lldp_tlv_read_chassis_id(sd_lldp_tlv *tlv, uint8_t *type, uint16_t *length, uint8_t **data);
int sd_lldp_tlv_read_port_id(sd_lldp_tlv *tlv, uint8_t *type, uint16_t *length, uint8_t **data);
int sd_lldp_tlv_read_ttl(sd_lldp_tlv *tlv, uint16_t *ttl);
int sd_lldp_tlv_read_system_name(sd_lldp_tlv *tlv, uint16_t *length, char **data);
int sd_lldp_tlv_read_system_description(sd_lldp_tlv *tlv, uint16_t *length, char **data);
int sd_lldp_tlv_read_system_capability(sd_lldp_tlv *tlv, uint16_t *data);
int sd_lldp_tlv_read_port_description(sd_lldp_tlv *tlv, uint16_t *length, char **data);
