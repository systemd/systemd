...
int manager_parse_config_file(Manager *m) {
        ...
        const ConfigTableItem items[] = {
                { "OOM", "SwapUsedLimit",                    config_parse_permyriad, 0, offsetof(Manager, swap_used_limit_permyriad) },
                { "OOM", "DefaultMemoryPressureLimit",       config_parse_loadavg, 0, offsetof(Manager, default_mem_pressure_limit) },
                { "OOM", "DefaultMemoryPressureDurationSec", config_parse_duration,  0, offsetof(Manager, default_mem_pressure_duration_usec) },
                {}
        };
