...
static int verb_list(int argc, char *argv[], uintptr_t data, void *userdata) {
        ...
        JSON_VARIANT_ARRAY_FOREACH(i, reply) {
                ...
                static const sd_json_dispatch_field dispatch_table[] = {
                        ...
                        { "owner",        SD_JSON_VARIANT_OBJECT,        json_dispatch_pidref,          voffsetof(e, owner),         0 },
                        { "ownerUID",     _SD_JSON_VARIANT_TYPE_INVALID, sd_json_dispatch_uid_gid,      voffsetof(e, owner_uid),   0 },
                        {}
                };
