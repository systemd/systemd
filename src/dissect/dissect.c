...
static int action_dissect(DissectedImage *m, LoopDevice *d) {
        ...
        if (r == -EMEDIUMTYPE)
                ...
                const char *string_class = (m->image_class == IMAGE_SYSEXT) ? "sysext" : image_class_to_string(m->image_class);
                ...
                r = json_build(&v, JSON_BUILD_OBJECT(
                                               ...
                                               JSON_BUILD_PAIR("ExtensionClass", JSON_BUILD_STRING(image_class_to_string(m->image_class))),
