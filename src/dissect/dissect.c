...
static int get_extension_scopes(DissectedImage *m, char ***ret_scopes) {
        ...
        /* If there's no extension-release file its not a system extension. Otherwise the SYSEXT/CONFEXT_SCOPE field
        ...
        /* First check if extension is sysext, and if it is not, then check if it is confext */
...
static int action_dissect(DissectedImage *m, LoopDevice *d) {
        ...
        if (r == -EMEDIUMTYPE)
                ...
                printf("            %s extension for system\n",
                       COLOR_MARK_BOOL(strv_contains(extension_scopes, "system")));
                printf("            %s extension for initrd\n",
                       COLOR_MARK_BOOL(strv_contains(extension_scopes, "initrd")));
                printf("            %s extension for portable service\n",
                       COLOR_MARK_BOOL(strv_contains(extension_scopes, "portable")));
