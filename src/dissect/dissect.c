...
static int parse_argv(int argc, char *argv[]) {
        ...
        FOREACH_OPTION(c, argc, argv, /* on_error= */ return c)
                ...
                case OPTION_ROOT_HASH_SIG:
                        ...
                        // help: Specify signature of root hash for verity as DER-encoded PKCS7,
                        // help: either as a path to a file or as an ASCII base64-encoded string
                        // help: prefixed by 'base64:'
