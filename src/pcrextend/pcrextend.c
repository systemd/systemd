...
static int parse_argv(int argc, char *argv[]) {
        ...
        if (!!arg_file_system + arg_machine_id + arg_delete > 1)
                return log_error_errno(SYNTHETIC_ERRNO(EINVAL), "--file-system=, --machine-id, --delete may not be combined.");
...
static int vl_method_extend(Varlink *link, JsonVariant *parameters, VarlinkMethodFlags flags, void *userdata) {
        ...
        static const JsonDispatch dispatch_table[] = {
                { "pcr",      _JSON_VARIANT_TYPE_INVALID, json_dispatch_uint,           offsetof(MethodExtendParameters, pcr),      0 },
                { "nvpcr",    JSON_VARIANT_STRING,        json_dispatch_const_string,   offsetof(MethodExtendParameters, nvpcr),    0 },
                { "allocate", _JSON_VARIANT_TYPE_INVALID, json_dispatch_tristate,       offsetof(MethodExtendParameters, allocate), 0 },
...
static int vl_method_allocate_nvpcr(Varlink *link, JsonVariant *parameters, VarlinkMethodFlags flags, void *userdata) {

        static const JsonDispatch dispatch_table[] = {
                { "name", JSON_VARIANT_STRING, json_dispatch_const_string, offsetof(MethodAllocateNVExtendParameters, name), JSON_MANDATORY },
                {}
        };
...
static int vl_method_delete_nvpcr(Varlink *link, JsonVariant *parameters, VarlinkMethodFlags flags, void *userdata) {

        static const JsonDispatch dispatch_table[] = {
                { "name", JSON_VARIANT_STRING, json_dispatch_const_string, offsetof(MethodDeleteNVExtendParameters, name), JSON_MANDATORY },
                {}
        };
