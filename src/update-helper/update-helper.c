...
static int user_units_operation(char **users, UserUnitOperationFunc func, const UserUnitOperationArgs *args) {
        ...
        STRV_FOREACH(user, users) {
                ...
                *o = (UserUnitOperation) {
                ...
                r = sd_fiber_new(e, *user, user_unit_operation_fiber, o, free, &f);
                if (r < 0)
...
VERB_FULL(verb_install_units, "install-units", "UNIT...", 1, VERB_ANY, 0, UINTPTR_MAX,
          "Enable and preset units");
VERB_FULL(verb_install_units, "install-system-units", /* a= */ NULL, 1, VERB_ANY, 0, RUNTIME_SCOPE_SYSTEM,
          /* h= */ NULL);
VERB_FULL(verb_install_units, "install-user-units", /* a= */ NULL, 1, VERB_ANY, 0, RUNTIME_SCOPE_GLOBAL,
          /* h= */ NULL);
...
VERB_FULL(verb_remove_units, "remove-units", "UNIT...", 1, VERB_ANY, 0, UINTPTR_MAX,
          "Disable and stop units");
VERB_FULL(verb_remove_units, "remove-system-units", /* a= */ NULL, 1, VERB_ANY, 0, RUNTIME_SCOPE_SYSTEM,
          /* h= */ NULL);
VERB_FULL(verb_remove_units, "remove-user-units", /* a= */ NULL, 1, VERB_ANY, 0, RUNTIME_SCOPE_GLOBAL,
          /* h= */ NULL);
...
VERB_FULL(verb_mark_units, "mark-restart-units", "UNIT...", 1, VERB_ANY, 0, UINTPTR_MAX,
          "Mark units for restart");
VERB_FULL(verb_mark_units, "mark-restart-system-units", /* a= */ NULL, 1, VERB_ANY, 0, RUNTIME_SCOPE_SYSTEM,
          /* h= */ NULL);
VERB_FULL(verb_mark_units, "mark-restart-user-units", /* a= */ NULL, 1, VERB_ANY, 0, RUNTIME_SCOPE_GLOBAL,
          /* h= */ NULL);
VERB_FULL(verb_mark_units, "mark-reload-units", "UNIT...", 1, VERB_ANY, 0, UINTPTR_MAX,
          "Mark units for reload");
VERB_FULL(verb_mark_units, "mark-reload-system-units", /* a= */ NULL, 1, VERB_ANY, 0, RUNTIME_SCOPE_SYSTEM,
          /* h= */ NULL);
VERB_FULL(verb_mark_units, "mark-reload-user-units", /* a= */ NULL, 1, VERB_ANY, 0, RUNTIME_SCOPE_GLOBAL,
          /* h= */ NULL);
...
VERB_FULL(verb_daemon_reload_enqueue_marked, "daemon-reload", /* a= */ NULL, 1, 1, 0, UINTPTR_MAX,
          "Reload manager configuration");
VERB_FULL(verb_daemon_reload_enqueue_marked, "enqueue-marked", /* a= */ NULL, 1, 1, 0, UINTPTR_MAX,
          "Enqueue marked units");
VERB_FULL(verb_daemon_reload_enqueue_marked, "daemon-reload-enqueue-marked", /* a= */ NULL, 1, 1, 0, UINTPTR_MAX,
          "Reload configuration and enqueue marked units");
VERB_FULL(verb_daemon_reload_enqueue_marked, "system-reload-restart", /* a= */ NULL, 1, 1, 0, RUNTIME_SCOPE_SYSTEM,
          /* h= */ NULL);
VERB_FULL(verb_daemon_reload_enqueue_marked, "system-reload", /* a= */ NULL, 1, 1, 0, RUNTIME_SCOPE_SYSTEM,
          /* h= */ NULL);
VERB_FULL(verb_daemon_reload_enqueue_marked, "system-restart", /* a= */ NULL, 1, 1, 0, RUNTIME_SCOPE_SYSTEM,
          /* h= */ NULL);
VERB_FULL(verb_daemon_reload_enqueue_marked, "user-reload-restart", /* a= */ NULL, 1, 1, 0, RUNTIME_SCOPE_GLOBAL,
          /* h= */ NULL);
VERB_FULL(verb_daemon_reload_enqueue_marked, "user-reload", /* a= */ NULL, 1, 1, 0, RUNTIME_SCOPE_GLOBAL,
          /* h= */ NULL);
VERB_FULL(verb_daemon_reload_enqueue_marked, "user-restart", /* a= */ NULL, 1, 1, 0, RUNTIME_SCOPE_GLOBAL,
          /* h= */ NULL);
VERB_FULL(verb_daemon_reload_enqueue_marked, "user-reexec", /* a= */ NULL, 1, 1, 0, RUNTIME_SCOPE_GLOBAL,
          /* h= */ NULL);
