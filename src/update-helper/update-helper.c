...
static int run(int argc, char *argv[]) {
        ...
        static const Verb verbs[] = {
                { "install-units",             2, VERB_ANY, 0, verb_install_units             },
                { "remove-units",              2, VERB_ANY, 0, verb_remove_units              },
                ...
                { "install-system-units",      2, VERB_ANY, 0, verb_install_system_units      },
                { "install-user-units",        2, VERB_ANY, 0, verb_install_user_units        },
                { "remove-system-units",       2, VERB_ANY, 0, verb_remove_system_units       },
                { "remove-user-units",         2, VERB_ANY, 0, verb_remove_user_units         },
