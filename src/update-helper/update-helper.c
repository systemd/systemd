...
VERB_FULL(verb_install_units, "install-system-units", /* a= */ NULL, 1, VERB_ANY, 0, RUNTIME_SCOPE_SYSTEM,
          /* h= */ NULL);
VERB_FULL(verb_install_units, "install-user-units", /* a= */ NULL, 1, VERB_ANY, 0, RUNTIME_SCOPE_USER,
          /* h= */ NULL);
...
VERB_FULL(verb_remove_units, "remove-system-units", /* a= */ NULL, 1, VERB_ANY, 0, RUNTIME_SCOPE_SYSTEM,
          /* h= */ NULL);
VERB_FULL(verb_remove_units, "remove-user-units", /* a= */ NULL, 1, VERB_ANY, 0, RUNTIME_SCOPE_USER,
          /* h= */ NULL);
...
VERB_FULL(verb_mark_units, "mark-restart-system-units", /* a= */ NULL, 1, VERB_ANY, 0, RUNTIME_SCOPE_SYSTEM,
          /* h= */ NULL);
VERB_FULL(verb_mark_units, "mark-restart-user-units", /* a= */ NULL, 1, VERB_ANY, 0, RUNTIME_SCOPE_USER,
          /* h= */ NULL);
...
VERB_FULL(verb_mark_units, "mark-reload-system-units", /* a= */ NULL, 1, VERB_ANY, 0, RUNTIME_SCOPE_SYSTEM,
          /* h= */ NULL);
VERB_FULL(verb_mark_units, "mark-reload-user-units", /* a= */ NULL, 1, VERB_ANY, 0, RUNTIME_SCOPE_USER,
          /* h= */ NULL);
...
VERB_FULL(verb_daemon_reload_enqueue_marked, "system-restart", /* a= */ NULL, 1, 1, 0, RUNTIME_SCOPE_SYSTEM,
          /* h= */ NULL);
VERB_FULL(verb_daemon_reload_enqueue_marked, "user-reload-restart", /* a= */ NULL, 1, 1, 0, RUNTIME_SCOPE_USER,
          /* h= */ NULL);
VERB_FULL(verb_daemon_reload_enqueue_marked, "user-reload", /* a= */ NULL, 1, 1, 0, RUNTIME_SCOPE_USER,
          /* h= */ NULL);
VERB_FULL(verb_daemon_reload_enqueue_marked, "user-restart", /* a= */ NULL, 1, 1, 0, RUNTIME_SCOPE_USER,
          /* h= */ NULL);
VERB_FULL(verb_daemon_reload_enqueue_marked, "user-reexec", /* a= */ NULL, 1, 1, 0, RUNTIME_SCOPE_USER,
          /* h= */ NULL);
