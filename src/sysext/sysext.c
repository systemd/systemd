...
static int merge_subprocess(
        ...
        _cleanup_free_ char *host_os_release_id = NULL, char *host_os_release_id_like = NULL, *host_os_release_version_id = NULL, *host_os_release_api_level = NULL, *filename = NULL;
