...
static int seal_keyring(Keyring *k) {
        ...
        /* Needs the setattr permission that goes away below; -EEXIST: sealed by somebody else already */
...
static int run(int argc, char *argv[]) {
        ...
        bool failed = false, data_error = false;
        int r;
        ...
        FOREACH_ELEMENT(spec, keyring_specs) {
                ...
                failed = failed || r == EXIT_FAILURE;
                data_error = data_error || r == EX_DATAERR;
        }
