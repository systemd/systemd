...
static int run(int argc, char *argv[]) {
        ...
        if (r > 0) {
                ...
                if (asprintf(&message, "%s Battery level critically low. Please connect your charger or the system will power off in 10 seconds.", special_glyph_utf8(SPECIAL_GLYPH_LOW_BATTERY)) < 0)
                        return log_oom();
