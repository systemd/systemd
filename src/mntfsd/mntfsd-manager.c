...
static int start_one_worker(Manager *m) {
        ...
        if (r == 0) {
                ...
                /* execl("/home/lennart/projects/systemd/build/systemd-mntwork", "systemd-mntwork", "xxxxxxxxxxxxxxxx", NULL); */
                /* execl("/usr/bin/valgrind", "valgrind", "/home/lennart/projects/systemd/build/systemd-mntwork", "systemd-mntwork", "xxxxxxxxxxxxxxxx", NULL); */
