...
void manager_dump_by_patterns(Manager *s, FILE *f, char **patterns, const char *prefix);
...
static inline void manager_dump(Manager *m, FILE *f, const char *prefix) {
        manager_dump_by_patterns(m, f, NULL, prefix);
}
