...
#define log_exec_struct_errno(ec, ep, level, error, ...)                                                 \
        ({                                                                                               \
                ...
                _do_log ?                                                                                \
                        log_struct_errno(_l, error, __VA_ARGS__, LOG_EXEC_ID_FIELD_FORMAT(_p), _p->id) : \
                        -ERRNO_VALUE(error);                            \
        })
...
#define LOG_EXEC_MESSAGE(ep, fmt, ...) LOG_MESSAGE("%s: " fmt, (ep)->id, ##__VA_ARGS__)
#define LOG_EXEC_ID(ep) LOG_EXEC_ID_FIELD_FORMAT(ep), (ep)->id
...
#define _LOG_CONTEXT_PUSH_EXEC(ec, ep, p, c)                                                  \
        ...
        LOG_CONTEXT_PUSH_KEY_VALUE(LOG_EXEC_ID_FIELD(p), p->id);                              \
