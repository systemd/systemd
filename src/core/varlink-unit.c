...
/* TODO: This covers only a small subset of a service objects properties. Extend to make more available the
...
static int service_context_build_json(sd_json_variant **ret, const char *name, void *userdata) {
        ...
        return sd_json_buildo(
                        ASSERT_PTR(ret),
                        /* For invalid types dbus sents the empty string here, we omit it */
