...
static void exec_fuzz_one(FILE *f, FDSet *fdset) {
        ...
        (void) exec_deserialize_invocation(f, fdset, true, &context, &command, &params, &runtime, &cgroup_context);
        (void) exec_serialize_invocation(f, fdset, true, &context, &command, &params, &runtime, &cgroup_context);
