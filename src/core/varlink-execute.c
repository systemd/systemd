        ...
        return sd_json_buildo(
                        ...
                        SD_JSON_BUILD_PAIR("quota",
                                SD_JSON_BUILD_OBJECT(
                                        ...
                                        SD_JSON_BUILD_PAIR_UNSIGNED("quotaScale", quota->quota_absolute))));
}
...
static int syscall_error_number_build_json(sd_json_variant **ret, const char *name, void *userdata) {
        ...
        int syscall_errno = c->syscall_errno;
        if (syscall_errno == 0) {
                *ret = NULL;
                return 0;
        }

        return sd_json_variant_new_string(ret, ERRNO_NAME_FULL(syscall_errno));
}
...
int unit_exec_context_build_json(sd_json_variant **ret, const char *name, void *userdata) {
        ...
        return sd_json_buildo(
                        ...
                        SD_JSON_BUILD_PAIR_BOOLEAN("MountAPIVFS", exec_context_get_effective_mount_apivfs(c)),
                        ...
                        /* Process Properties */
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL("Limits", rlimit_table_with_defaults_build_json, u),
