...
static int apply_mount_namespace(
        ...
        _cleanup_free_ char *root_dir = NULL, *root_image = NULL, *creds_path = NULL, *incoming_dir = NULL, *propagate_dir = NULL,
                        *extension_dir = NULL;
        ...
        if (params->flags & EXEC_APPLY_CHROOT) {
                if (context->root_image) {
                        r = path_pick(context->root_image,
                                      S_IFREG,
                ...
                if (!root_image && context->root_directory) {
                        r = path_pick(context->root_directory,
                                      S_IFDIR,
                                      /* search_basename= */ NULL,
                                      /* search_version= */ NULL,
                                      _ARCHITECTURE_INVALID,
