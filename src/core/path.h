...
typedef struct ActivationEventInfoPath ActivationEventInfoPath;
...
struct ActivationEventInfoPath {
...
extern const ActivationEventInfoVTable activation_event_info_path_vtable;
...
DEFINE_EVENT_INFO_CAST(ACTIVATION_EVENT_INFO_PATH, ActivationEventInfoPath, PATH);
