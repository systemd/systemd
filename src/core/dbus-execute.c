...
const sd_bus_vtable bus_exec_vtable[] = {
        ...
        SD_BUS_PROPERTY("MemoryTHPMadvise", "b", bus_property_get_tristate, offsetof(ExecContext, memory_thp_madvise), SD_BUS_VTABLE_PROPERTY_CONST),
...
int bus_exec_context_set_transient_property(
        ...
        if (streq(name, "MemoryTHPMadvise"))
                return bus_set_transient_tristate(u, name, &c->memory_thp_madvise, message, flags, error);
