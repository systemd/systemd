...
const sd_bus_vtable bus_exec_vtable[] = {
        ...
        SD_BUS_PROPERTY("LogIncludeRegex", "s", NULL, offsetof(ExecContext, log_include_regex), SD_BUS_VTABLE_PROPERTY_CONST),
        SD_BUS_PROPERTY("LogExcludeRegex", "s", NULL, offsetof(ExecContext, log_exclude_regex), SD_BUS_VTABLE_PROPERTY_CONST),
...
int bus_exec_context_set_transient_property(
        ...
        if (streq(name, "LogIncludeRegex"))
                return bus_set_transient_string(u, name, &c->log_include_regex, message, flags, error);

        if (streq(name, "LogExcludeRegex"))
                return bus_set_transient_string(u, name, &c->log_exclude_regex, message, flags, error);
