...
const sd_bus_vtable bus_exec_vtable[] = {
        ...
        SD_BUS_PROPERTY("TTYRows", "q", bus_property_get_ushort, offsetof(ExecContext, tty_rows), SD_BUS_VTABLE_PROPERTY_CONST),
        SD_BUS_PROPERTY("TTYColumns", "q", bus_property_get_ushort, offsetof(ExecContext, tty_cols), SD_BUS_VTABLE_PROPERTY_CONST),
...
int bus_exec_context_set_transient_property(
        ...
        if (streq(name, "TTYRows"))
                return bus_set_transient_unsigned_short(u, name, &c->tty_rows, message, flags, error);

        if (streq(name, "TTYColumns"))
                return bus_set_transient_unsigned_short(u, name, &c->tty_cols, message, flags, error);
