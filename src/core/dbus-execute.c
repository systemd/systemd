...
const sd_bus_vtable bus_exec_vtable[] = {
        ...
        SD_BUS_PROPERTY("MemoryTHPDisable", "u", bus_property_get_unsigned, offsetof(ExecContext, memory_thp_disable), SD_BUS_VTABLE_PROPERTY_CONST),
...
int bus_exec_context_set_transient_property(
        ...
        if (streq(name, "MemoryTHPDisable"))
                return bus_set_transient_unsigned(u, name, &c->memory_thp_disable, message, flags, error);
