...
static int property_get_bpf_delegate_commands(
        ...
        s = bpf_delegate_to_string(*u, bpf_delegate_cmd_to_string);
        if (!s)
                return -ENOMEM;
...
static int property_get_bpf_delegate_maps(
        ...
        s = bpf_delegate_to_string(*u, bpf_delegate_map_type_to_string);
        if (!s)
                return -ENOMEM;
...
static int property_get_bpf_delegate_programs(
        ...
        s = bpf_delegate_to_string(*u, bpf_delegate_prog_type_to_string);
        if (!s)
                return -ENOMEM;
...
static int property_get_bpf_delegate_attachments(
        ...
        s = bpf_delegate_to_string(*u, bpf_delegate_attach_type_to_string);
        if (!s)
                return -ENOMEM;
