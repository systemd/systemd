...
const sd_bus_vtable bus_unit_vtable[] = {
        ...
        SD_BUS_PROPERTY("NeedsRestart", "b", bus_property_get_bool, offsetof(Unit, needs_restart), 0),
        SD_BUS_PROPERTY("NeedsReload", "b", bus_property_get_bool, offsetof(Unit, needs_reload), 0),
