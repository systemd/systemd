...
static int property_get_eff_limit(
                sd_bus *bus,
                const char *path,
                const char *interface,
                const char *property,
        ...
        static const char *const table[_CGROUP_LIMIT_MAX] = {
                [CGROUP_LIMIT_MEMORY_MAX]    = "MemoryMaxEffective",
                [CGROUP_LIMIT_MEMORY_HIGH]   = "MemoryHighEffective",
                [CGROUP_LIMIT_TASKS_MAX]     = "TasksMaxEffective",
        };
        ...
        (void) unit_get_eff_limit(u, type, &value);
        return sd_bus_message_append(reply, "t", value);
}
...
const sd_bus_vtable bus_unit_cgroup_vtable[] = {
        ...
        SD_BUS_PROPERTY("MemoryMaxEffective", "t", property_get_eff_limit, 0, 0),
        SD_BUS_PROPERTY("MemoryHighEffective", "t", property_get_eff_limit, 0, 0),
        SD_BUS_PROPERTY("CPUUsageNSec", "t", property_get_cpu_usage, 0, 0),
        SD_BUS_PROPERTY("EffectiveCPUs", "ay", property_get_cpuset_cpus, 0, 0),
        SD_BUS_PROPERTY("EffectiveMemoryNodes", "ay", property_get_cpuset_mems, 0, 0),
        SD_BUS_PROPERTY("TasksCurrent", "t", property_get_current_tasks, 0, 0),
        SD_BUS_PROPERTY("TasksMaxEffective", "t", property_get_eff_limit, 0, 0),
