...
const sd_bus_vtable bus_unit_vtable[] = {
        ...
        SD_BUS_PROPERTY("InterruptedBy", "as", property_get_dependencies, offsetof(Unit, dependencies[UNIT_INTERRUPTED_BY]), SD_BUS_VTABLE_PROPERTY_CONST),
        ...
        SD_BUS_PROPERTY("Interrupts", "as", property_get_dependencies, offsetof(Unit, dependencies[UNIT_INTERRUPTS]), SD_BUS_VTABLE_PROPERTY_CONST),
