...
const sd_bus_vtable bus_unit_vtable[] = {
        ...
        SD_BUS_PROPERTY("SurviveSoftReboot", "b", bus_property_get_bool, offsetof(Unit, survive_soft_reboot), SD_BUS_VTABLE_PROPERTY_CONST),
...
static int bus_unit_set_transient_property(
        ...
        if (streq(name, "SurviveSoftReboot"))
                return bus_set_transient_bool(u, name, &u->survive_soft_reboot, message, flags, error);
