...
static int manager_runtime_build_json(sd_json_variant **ret, const char *name, void *userdata) {
        ...
        return sd_json_buildo(
                ...
                JSON_BUILD_PAIR_DUAL_TIMESTAMP_NON_NULL("ShutdownBinaryStartTimestamp", &m->timestamps[MANAGER_TIMESTAMP_SHUTDOWN_BINARY_START]),
                JSON_BUILD_PAIR_DUAL_TIMESTAMP_NON_NULL("ShutdownBinaryFinishTimestamp", &m->timestamps[MANAGER_TIMESTAMP_SHUTDOWN_BINARY_FINISH]),
