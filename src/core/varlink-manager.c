...
static int manager_context_build_json(sd_json_variant **ret, const char *name, void *userdata) {
        ...
        return sd_json_buildo(
                        ...
                        JSON_BUILD_PAIR_ENUM("DefaultPrivateTmp", private_tmp_to_string(m->defaults.private_tmp)),
                        JSON_BUILD_PAIR_ENUM("DefaultProtectHome", protect_home_to_string(m->defaults.protect_home)),
