...
static int manager_context_build_json(sd_json_variant **ret, const char *name, void *userdata) {
        ...
        return sd_json_buildo(
                        ...
                        JSON_BUILD_PAIR_FINITE_USEC("DefaultMemoryPressureThresholdUSec", m->defaults.pressure_threshold_usec[CGROUP_PRESSURE_MEMORY]),
                        SD_JSON_BUILD_PAIR_STRING("DefaultMemoryPressureWatch", cgroup_pressure_watch_to_string(m->defaults.pressure_watch[CGROUP_PRESSURE_MEMORY])),
                        JSON_BUILD_PAIR_FINITE_USEC("DefaultCPUPressureThresholdUSec", m->defaults.pressure_threshold_usec[CGROUP_PRESSURE_CPU]),
                        SD_JSON_BUILD_PAIR_STRING("DefaultCPUPressureWatch", cgroup_pressure_watch_to_string(m->defaults.pressure_watch[CGROUP_PRESSURE_CPU])),
                        JSON_BUILD_PAIR_FINITE_USEC("DefaultIOPressureThresholdUSec", m->defaults.pressure_threshold_usec[CGROUP_PRESSURE_IO]),
                        SD_JSON_BUILD_PAIR_STRING("DefaultIOPressureWatch", cgroup_pressure_watch_to_string(m->defaults.pressure_watch[CGROUP_PRESSURE_IO])),
