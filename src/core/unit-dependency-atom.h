...
typedef enum UnitDependencyAtom {
        ...
        UNIT_ATOM_PULL_IN_MATTERS                     = UINT64_C(1) << 0,
        /* Similar, but if it doesn't work, ignore. */
        UNIT_ATOM_PULL_IN_DOESNT_MATTER               = UINT64_C(1) << 1,
        ...
        UNIT_ATOM_CONFLICT_MATTERS                    = UINT64_C(1) << 3,
        /* Same, but don't fail, ignore it. */
        UNIT_ATOM_CONFLICT_DOESNT_MATTER              = UINT64_C(1) << 4,
