...
const sd_bus_vtable bus_service_vtable[] = {
        ...
        SD_BUS_PROPERTY("RestartUSecStep", "t", bus_property_get_usec, offsetof(Service, restart_usec_step), SD_BUS_VTABLE_PROPERTY_CONST),
...
static int bus_service_set_transient_property(
        ...
        if (streq(name, "RestartUSecStep"))
                return bus_set_transient_usec(u, name, &s->restart_usec_step, message, flags, error);
