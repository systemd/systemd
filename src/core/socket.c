...
static int socket_deserialize_item(Unit *u, const char *key, const char *value, FDSet *fds) {
        ...
        if (streq(key, "state")) {
                ...
                if (safe_atoi(fdv, &fd) < 0 || fd < 0 || !fdset_contains(fds, fd)) {
                        log_unit_debug(u, "Invalid fifo value: %d", fd);
                        return 0;
                }
                ...
                if (safe_atoi(fdv, &fd) < 0 || fd < 0 || !fdset_contains(fds, fd)) {
                        log_unit_debug(u, "Invalid special value: %d", fd);
                        return 0;
                }
                ...
                if (safe_atoi(fdv, &fd) < 0 || fd < 0 || !fdset_contains(fds, fd)) {
                        log_unit_debug(u, "Invalid mqueue value: %d", fd);
                        return 0;
                }
                ...
                if (safe_atoi(fdv, &fd) < 0 || fd < 0 || !fdset_contains(fds, fd)) {
                        log_unit_debug(u, "Invalid socket fd: %d", fd);
                        return 0;
                }
                ...
                if (safe_atoi(typev, &type) < 0 || type < 0) {
                        log_unit_debug(u, "Invalid socket type: %d", type);
                        return 0;
                }
                ...
                if (safe_atoi(fdv, &fd) < 0 || fd < 0 || !fdset_contains(fds, fd)) {
                        log_unit_debug(u, "Invalid socket value: %d", fd);
                        return 0;
                }
                ...
                if (safe_atoi(fdv, &fd) < 0 || fd < 0 || !fdset_contains(fds, fd)) {
                        log_unit_debug(u, "Invalid ffs value: %d", fd);
                        return 0;
                }
