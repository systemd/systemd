...
int unit_can_live_mount(Unit *u, const char *src, const char *dst, sd_bus_error *error) {
        ...
        if (!UNIT_VTABLE(u)->live_mount) {
                ...
                return sd_bus_error_setf(
                                ...
                                "Live mounting '%s' on '%s' for unit '%s' cannot be scheduled: live mounting not supported for unit type '%s'",
                                src,
                                dst,
                                u->id,
        ...
        if (u->load_state != UNIT_LOADED) {
                ...
                return sd_bus_error_setf(
                                ...
                                "Live mounting '%s' on '%s' for unit '%s' cannot be scheduled: unit not loaded",
                                src,
                                dst,
                                u->id);
        }
