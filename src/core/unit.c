...
int activation_event_info_format(ActivationEventInfo *info, char ***strv) {
        assert(strv);
        ...
        if (ACTIVATION_EVENT_INFO_VTABLE(info)->format)
                return ACTIVATION_EVENT_INFO_VTABLE(info)->format(info, strv);
