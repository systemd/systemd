...
int unit_patch_contexts(Unit *u) {
         ...
         * unless AllowedCPUs= is configured. StartupAllowedCPUs= does not suffice either: outside the
         * startup states cgroup_context_allowed_cpus() falls back to the empty AllowedCPUs=. */
