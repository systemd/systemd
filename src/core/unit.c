...
#define MENTIONWORTHY_MEMORY_BYTES (64 * 1024 * 1024ULL) /* 64 MiB */
#define MENTIONWORTHY_IO_BYTES (1024 * 1024ULL)          /* 1 MiB */
...
#define NOTICEWORTHY_MEMORY_BYTES (512 * 1024 * 1024ULL) /* 512 MiB */
#define NOTICEWORTHY_IO_BYTES (10 * 1024 * 1024ULL)      /* 10 MiB */
#define NOTICEWORTHY_IP_BYTES (128 * 1024 * 1024ULL)     /* 128 MiB */
