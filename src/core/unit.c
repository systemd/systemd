...
int unit_install_bus_match(Unit *u, sd_bus *bus, const char *name) {
        ...
        /* NameOwnerChanged and GetNameOwner is used to detect when
         * a service finished starting up. The dbus call timeout
         * shouldn't be earlier than that. */
        timeout_usec = s->timeout_start_usec;
