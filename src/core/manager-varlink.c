...
static int default_rlimits_context_build_json(sd_json_variant **ret, const char *name, void *userdata) {
        Manager *m = ASSERT_PTR(userdata);
        return sd_json_buildo(ASSERT_PTR(ret),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL(rlimit_to_string(RLIMIT_CPU),        rlimit_build_json, m->defaults.rlimit[RLIMIT_CPU]),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL(rlimit_to_string(RLIMIT_FSIZE),      rlimit_build_json, m->defaults.rlimit[RLIMIT_FSIZE]),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL(rlimit_to_string(RLIMIT_DATA),       rlimit_build_json, m->defaults.rlimit[RLIMIT_DATA]),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL(rlimit_to_string(RLIMIT_STACK),      rlimit_build_json, m->defaults.rlimit[RLIMIT_STACK]),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL(rlimit_to_string(RLIMIT_CORE),       rlimit_build_json, m->defaults.rlimit[RLIMIT_CORE]),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL(rlimit_to_string(RLIMIT_RSS),        rlimit_build_json, m->defaults.rlimit[RLIMIT_RSS]),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL(rlimit_to_string(RLIMIT_NOFILE),     rlimit_build_json, m->defaults.rlimit[RLIMIT_NOFILE]),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL(rlimit_to_string(RLIMIT_AS),         rlimit_build_json, m->defaults.rlimit[RLIMIT_AS]),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL(rlimit_to_string(RLIMIT_NPROC),      rlimit_build_json, m->defaults.rlimit[RLIMIT_NPROC]),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL(rlimit_to_string(RLIMIT_MEMLOCK),    rlimit_build_json, m->defaults.rlimit[RLIMIT_MEMLOCK]),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL(rlimit_to_string(RLIMIT_LOCKS),      rlimit_build_json, m->defaults.rlimit[RLIMIT_LOCKS]),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL(rlimit_to_string(RLIMIT_SIGPENDING), rlimit_build_json, m->defaults.rlimit[RLIMIT_SIGPENDING]),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL(rlimit_to_string(RLIMIT_MSGQUEUE),   rlimit_build_json, m->defaults.rlimit[RLIMIT_MSGQUEUE]),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL(rlimit_to_string(RLIMIT_NICE),       rlimit_build_json, m->defaults.rlimit[RLIMIT_NICE]),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL(rlimit_to_string(RLIMIT_RTPRIO),     rlimit_build_json, m->defaults.rlimit[RLIMIT_RTPRIO]),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL(rlimit_to_string(RLIMIT_RTTIME),     rlimit_build_json, m->defaults.rlimit[RLIMIT_RTTIME]));
}
...
static int manager_context_build_json(sd_json_variant **ret, const char *name, void *userdata) {
        ...
        return sd_json_buildo(ASSERT_PTR(ret),
                        ...
                        SD_JSON_BUILD_PAIR_CALLBACK("DefaultLimits", default_rlimits_context_build_json, m),
