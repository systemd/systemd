...
enum {
        ...
        EVENT_PRIORITY_PID_FILE_RETRY    = SD_EVENT_PRIORITY_NORMAL-1,
        EVENT_PRIORITY_TIME_CHANGE       = SD_EVENT_PRIORITY_NORMAL,
        EVENT_PRIORITY_TIME_ZONE         = SD_EVENT_PRIORITY_NORMAL,
        EVENT_PRIORITY_IPC               = SD_EVENT_PRIORITY_NORMAL+1,
