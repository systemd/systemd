...
struct Manager {
         ...
         * outdated if such operations failed half-way. Therefore, we set this to true if changes to unit
         * files are made, and reset it after daemon-reload. And if this is true, report that daemon-reload
         * is needed through unit's NeedDaemonReload property. */
