...
struct Manager {
        ...
        /* The bus id of API bus acquired through org.freedesktop.DBus.GetId. It is used to verify the bus
         * we shall deserialize subscriptions for is still the same instance as before. */
        char *bus_id, *deserialized_bus_id;
