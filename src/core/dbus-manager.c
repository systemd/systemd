...
const sd_bus_vtable bus_manager_vtable[] = {
        ...
        SD_BUS_PROPERTY("DefaultCoredumpLimitInterval", "t", bus_property_get_usec, offsetof(Manager, defaults.coredump_limit_interval), SD_BUS_VTABLE_PROPERTY_CONST),
        SD_BUS_PROPERTY("DefaultCoredumpLimitBurst", "u", bus_property_get_unsigned, offsetof(Manager, defaults.coredump_limit_burst), SD_BUS_VTABLE_PROPERTY_CONST),
        SD_BUS_PROPERTY("DefaultCoredumpLimitPerBoot", "u", bus_property_get_unsigned, offsetof(Manager, defaults.coredump_limit_per_boot), SD_BUS_VTABLE_PROPERTY_CONST),
