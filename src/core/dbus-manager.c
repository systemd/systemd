...
static BUS_DEFINE_PROPERTY_GET_GLOBAL(property_get_watchdog_timeout, "s", watchdog_get_timeout());
static BUS_DEFINE_PROPERTY_GET_GLOBAL(property_get_watchdog_pretimeout, "s", watchdog_get_pretimeout());
