...
const sd_bus_vtable bus_manager_vtable[] = {
        ...
        BUS_PROPERTY_DUAL_TIMESTAMP("ShutdownBinaryStartTimestamp", offsetof(Manager, timestamps[MANAGER_TIMESTAMP_SHUTDOWN_BINARY_START]), SD_BUS_VTABLE_PROPERTY_CONST),
        BUS_PROPERTY_DUAL_TIMESTAMP("ShutdownBinaryFinishTimestamp", offsetof(Manager, timestamps[MANAGER_TIMESTAMP_SHUTDOWN_BINARY_FINISH]), SD_BUS_VTABLE_PROPERTY_CONST),
