...
const sd_bus_vtable bus_manager_vtable[] = {
        ...
        SD_BUS_PROPERTY("DefaultPrivateTmp", "b", bus_property_get_bool, offsetof(Manager, defaults.private_tmp), SD_BUS_VTABLE_PROPERTY_CONST),
        SD_BUS_PROPERTY("DefaultProtectHome", "b", bus_property_get_bool, offsetof(Manager, defaults.protect_home), SD_BUS_VTABLE_PROPERTY_CONST),
