...
static int property_get_transactions_with_cycle(
        ...
        sd_id128_t *i;
        SET_FOREACH(i, m->transactions_with_cycle) {
                r = sd_bus_message_append_array(reply, 'y', i->bytes, sizeof(sd_id128_t));
                if (r < 0)
                        return r;
        }
...
const sd_bus_vtable bus_manager_vtable[] = {
        ...
        SD_BUS_PROPERTY("TransactionsWithOrderingCycle", "aay", property_get_transactions_with_cycle, 0, 0),
