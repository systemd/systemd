...
static inline int method_disable_unit_files_with_flags(sd_bus_message *message, void *userdata, sd_bus_error *error) {
        return method_disable_unit_files_generic(message, userdata, unit_file_disable, /* carries_install_info = */ false, error);
}

static inline int method_disable_unit_files_with_instinfo(sd_bus_message *message, void *userdata, sd_bus_error *error) {
        return method_disable_unit_files_generic(message, userdata, unit_file_disable, /* carries_install_info = */ true, error);
}

static inline int method_disable_unit_files(sd_bus_message *message, void *userdata, sd_bus_error *error) {
        return method_disable_unit_files_generic(message, userdata, unit_file_disable, /* carries_install_info = */ false, error);
}

static inline int method_unmask_unit_files(sd_bus_message *message, void *userdata, sd_bus_error *error) {
...
const sd_bus_vtable bus_manager_vtable[] = {
        ...
        SD_BUS_METHOD_WITH_ARGS("DisableUnitFiles",
                                ...
                                SD_BUS_VTABLE_UNPRIVILEGED),
        SD_BUS_METHOD_WITH_ARGS("DisableUnitFilesWithInstallInfo",
                                SD_BUS_ARGS("as", files, "b", runtime),
                                SD_BUS_RESULT("b", carries_install_info, "a(sss)", changes),
                                method_disable_unit_files_with_instinfo,
                                SD_BUS_VTABLE_UNPRIVILEGED),
