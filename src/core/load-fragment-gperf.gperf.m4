...
$1.RuntimeDirectoryUser,         config_parse_user_group,            0,                             offsetof($1, exec_context.directories[EXEC_DIRECTORY_RUNTIME].user)
$1.RuntimeDirectoryGroup,        config_parse_user_group,            0,                             offsetof($1, exec_context.directories[EXEC_DIRECTORY_RUNTIME].group)
...
$1.StateDirectoryUser,           config_parse_user_group,            0,                             offsetof($1, exec_context.directories[EXEC_DIRECTORY_STATE].user)
$1.StateDirectoryGroup,          config_parse_user_group,            0,                             offsetof($1, exec_context.directories[EXEC_DIRECTORY_STATE].group)
...
$1.CacheDirectoryUser,           config_parse_user_group,            0,                             offsetof($1, exec_context.directories[EXEC_DIRECTORY_CACHE].user)
$1.CacheDirectoryGroup,          config_parse_user_group,            0,                             offsetof($1, exec_context.directories[EXEC_DIRECTORY_CACHE].group)
...
$1.LogsDirectoryUser,            config_parse_user_group,            0,                             offsetof($1, exec_context.directories[EXEC_DIRECTORY_LOGS].user)
$1.LogsDirectoryGroup,           config_parse_user_group,            0,                             offsetof($1, exec_context.directories[EXEC_DIRECTORY_LOGS].group)
...
$1.ConfigurationDirectoryUser,   config_parse_user_group,            0,                             offsetof($1, exec_context.directories[EXEC_DIRECTORY_CONFIGURATION].user)
$1.ConfigurationDirectoryGroup,  config_parse_user_group,            0,                             offsetof($1, exec_context.directories[EXEC_DIRECTORY_CONFIGURATION].group)
