...
$1.CapabilityBoundingSet,        config_parse_capability_set,        0,                             offsetof($1, exec_context)
$1.AmbientCapabilities,          config_parse_capability_set,        0,                             offsetof($1, exec_context)
