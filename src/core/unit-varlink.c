...
#define RLIMIT_WITH_DEFAULT(manager, ec, rl) \
        (ec)->rlimit[rl] ?: (manager)->defaults.rlimit[rl]
...
static int exec_context_build_json(sd_json_variant **ret, const char *name, void *userdata) {
        ...
        return sd_json_buildo(ASSERT_PTR(ret),
                        ...
                        /* Process Properties */
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL("LimitCPU", rlimit_build_json, RLIMIT_WITH_DEFAULT(m, c, RLIMIT_CPU)),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL("LimitFSIZE", rlimit_build_json, RLIMIT_WITH_DEFAULT(m, c, RLIMIT_FSIZE)),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL("LimitDATA", rlimit_build_json, RLIMIT_WITH_DEFAULT(m, c, RLIMIT_DATA)),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL("LimitSTACK", rlimit_build_json, RLIMIT_WITH_DEFAULT(m, c, RLIMIT_STACK)),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL("LimitCORE", rlimit_build_json, RLIMIT_WITH_DEFAULT(m, c, RLIMIT_CORE)),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL("LimitRSS", rlimit_build_json, RLIMIT_WITH_DEFAULT(m, c, RLIMIT_RSS)),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL("LimitNOFILE", rlimit_build_json, RLIMIT_WITH_DEFAULT(m, c, RLIMIT_NOFILE)),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL("LimitAS", rlimit_build_json, RLIMIT_WITH_DEFAULT(m, c, RLIMIT_AS)),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL("LimitNPROC", rlimit_build_json, RLIMIT_WITH_DEFAULT(m, c, RLIMIT_NPROC)),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL("LimitMEMLOCK", rlimit_build_json, RLIMIT_WITH_DEFAULT(m, c, RLIMIT_MEMLOCK)),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL("LimitLOCKS", rlimit_build_json, RLIMIT_WITH_DEFAULT(m, c, RLIMIT_LOCKS)),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL("LimitSIGPENDING", rlimit_build_json, RLIMIT_WITH_DEFAULT(m, c, RLIMIT_SIGPENDING)),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL("LimitMSGQUEUE", rlimit_build_json, RLIMIT_WITH_DEFAULT(m, c, RLIMIT_MSGQUEUE)),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL("LimitNICE", rlimit_build_json, RLIMIT_WITH_DEFAULT(m, c, RLIMIT_NICE)),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL("LimitRTPRIO", rlimit_build_json, RLIMIT_WITH_DEFAULT(m, c, RLIMIT_RTPRIO)),
                        JSON_BUILD_PAIR_CALLBACK_NON_NULL("LimitRTTIME", rlimit_build_json, RLIMIT_WITH_DEFAULT(m, c, RLIMIT_RTTIME)),
...
static int socket_context_build_json(sd_json_variant **ret, const char *name, void *userdata) {
        ...
        return sd_json_buildo(ASSERT_PTR(ret),
                        ...
                        JSON_BUILD_PAIR_CONDITION_BOOLEAN(!s->accept, "FlushPending", s->flush_pending),
                        JSON_BUILD_PAIR_CONDITION_UNSIGNED(s->accept, "MaxConnections", s->max_connections),
                        JSON_BUILD_PAIR_CONDITION_UNSIGNED(s->accept, "MaxConnectionsPerSource", s->max_connections_per_source),
                        ...
                        JSON_BUILD_PAIR_CONDITION_STRING(
                                        s->timestamping != SOCKET_TIMESTAMPING_OFF,
                                        "Timestamping",
                                        socket_timestamping_to_string(s->timestamping)),
