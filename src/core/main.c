...
int main(int argc, char *argv[]) {
        ...
        if (getpid_cached() == 1) {
                ...
                r = capability_get_ambient(&starting_ambient_set);
                if (r < 0) {
        ...
        m->starting_ambient_set = starting_ambient_set;
