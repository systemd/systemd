...
static void set_manager_settings(Manager *m) {
        ...
        manager_set_watchdog_pretimeout_governor(m, arg_watchdog_pretimeout_governor);
...
static int become_shutdown(
         ...
         * Disable the pretimeout watchdog, as we will not ping it from the shutdown binary. */
