...
static int parse_config_file(void) {
        const ConfigTableItem items[] = {
                ...
                { "Manager", "DefaultMemoryPressureThresholdSec", config_parse_sec,              0,                        &arg_defaults.pressure_threshold_usec[CGROUP_PRESSURE_MEMORY] },
                { "Manager", "DefaultMemoryPressureWatch",   config_parse_memory_pressure_watch, 0,                        &arg_defaults.pressure_watch[CGROUP_PRESSURE_MEMORY] },
                { "Manager", "DefaultCPUPressureThresholdSec", config_parse_sec,                 0,                        &arg_defaults.pressure_threshold_usec[CGROUP_PRESSURE_CPU] },
                { "Manager", "DefaultCPUPressureWatch",      config_parse_memory_pressure_watch, 0,                        &arg_defaults.pressure_watch[CGROUP_PRESSURE_CPU] },
                { "Manager", "DefaultIOPressureThresholdSec", config_parse_sec,                  0,                        &arg_defaults.pressure_threshold_usec[CGROUP_PRESSURE_IO] },
                { "Manager", "DefaultIOPressureWatch",       config_parse_memory_pressure_watch, 0,                        &arg_defaults.pressure_watch[CGROUP_PRESSURE_IO] },
