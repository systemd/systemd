...
static int parse_config_file(void) {
        const ConfigTableItem items[] = {
                ...
                { "Manager", "DefaultNotifyRateLimitIntervalSec", config_parse_sec,                   0,                        &arg_defaults.notify_ratelimit.interval                 },
                { "Manager", "DefaultNotifyRateLimitBurst",       config_parse_unsigned,              0,                        &arg_defaults.notify_ratelimit.burst                    },
