...
static void set_manager_defaults(Manager *m) {
        ...
        if (!arg_default_smack_process_label)
                m->default_smack_process_label = SMACK_DEFAULT_PROCESS_LABEL;
        else
#endif
        if (streq(arg_default_smack_process_label, "/"))
                m->default_smack_process_label = NULL;
        else
                m->default_smack_process_label = arg_default_smack_process_label;
