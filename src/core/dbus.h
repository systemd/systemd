...
int bus_verify_manage_units_async_full(Manager *m, const char *unit_name, const char *verb, const char *polkit_message, sd_bus_message *call, sd_bus_error *error);
