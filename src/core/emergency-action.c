...
static const char* const emergency_action_table[_EMERGENCY_ACTION_MAX] = {
        ...
        [EMERGENCY_ACTION_RENEW] =              "renew",
        [EMERGENCY_ACTION_RENEW_FORCE] =        "renew-force",
};
...
void emergency_action(
        ...
        if (IN_SET(action, EMERGENCY_ACTION_REBOOT, EMERGENCY_ACTION_RENEW, EMERGENCY_ACTION_POWEROFF, EMERGENCY_ACTION_EXIT)) {
        ...
        case EMERGENCY_ACTION_RENEW:
                log_and_status(m, warn, "Renewing", reason);

                (void) manager_add_job_by_name_and_warn(m, JOB_START, SPECIAL_RENEW_TARGET, JOB_REPLACE_IRREVERSIBLY, NULL, NULL);
                break;

        case EMERGENCY_ACTION_RENEW_FORCE:
                log_and_status(m, warn, "Forcibly renewing", reason);
