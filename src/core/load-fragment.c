...
DEFINE_CONFIG_PARSE_ENUM_WITH_DEFAULT(config_parse_exec_pam_set_credentials, exec_pam_set_credentials, ExecPamSetCredentials, -1, "Failed to parse PAM credentials mode");
