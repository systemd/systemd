...
static int build_managed_oom_json_array_element(Unit *u, const char *property, sd_json_variant **ret_v) {
        ...
        if (UNIT_IS_INACTIVE_OR_FAILED(unit_active_state(u)))
                ...
                inherited_limit = unit_get_managed_oom_memory_pressure_limit(u);
                use_limit = inherited_limit > 0;
        ...
        return sd_json_buildo(ret_v,
                              ...
                              SD_JSON_BUILD_PAIR_CONDITION(use_limit, "limit", SD_JSON_BUILD_UNSIGNED(inherited_limit)),
