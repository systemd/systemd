...
const sd_bus_vtable bus_scope_vtable[] = {
        ...
        SD_BUS_PROPERTY("RuntimeMaxDeltaUSec", "t", bus_property_get_usec, offsetof(Scope, runtime_max_delta_usec), SD_BUS_VTABLE_PROPERTY_CONST),
...
static int bus_scope_set_transient_property(
        ...
        if (streq(name, "RuntimeMaxDeltaUSec"))
                return bus_set_transient_usec(u, name, &s->runtime_max_delta_usec, message, flags, error);
