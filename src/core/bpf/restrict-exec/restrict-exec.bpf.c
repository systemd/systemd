...
/* 64 entries covers typical deployments (a handful of verity volumes). If the
 * map fills up, bpf_map_update_elem returns -E2BIG and the device is not
 * tracked — execution from it is denied (safe, deny-default). */
struct {
