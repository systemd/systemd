...
const sd_bus_vtable bus_cgroup_vtable[] = {
        ...
        SD_BUS_PROPERTY("MemoryPressureWatch", "s", bus_property_get_cgroup_pressure_watch, offsetof(CGroupContext, pressure_watch[PRESSURE_MEMORY]), 0),
        SD_BUS_PROPERTY("MemoryPressureThresholdUSec", "t", bus_property_get_usec, offsetof(CGroupContext, pressure_threshold_usec[PRESSURE_MEMORY]), 0),
        SD_BUS_PROPERTY("CPUPressureWatch", "s", bus_property_get_cgroup_pressure_watch, offsetof(CGroupContext, pressure_watch[PRESSURE_CPU]), 0),
        SD_BUS_PROPERTY("CPUPressureThresholdUSec", "t", bus_property_get_usec, offsetof(CGroupContext, pressure_threshold_usec[PRESSURE_CPU]), 0),
        SD_BUS_PROPERTY("IOPressureWatch", "s", bus_property_get_cgroup_pressure_watch, offsetof(CGroupContext, pressure_watch[PRESSURE_IO]), 0),
        SD_BUS_PROPERTY("IOPressureThresholdUSec", "t", bus_property_get_usec, offsetof(CGroupContext, pressure_threshold_usec[PRESSURE_IO]), 0),
