...
int cgroup_log_xattr_apply(Unit *u, const char *cgroup_path) {
        ...
        /* The actual allocated buffer size from set_make_str() is ret_len + 2 */
        allowed_patterns_len = allowed_patterns_len ? allowed_patterns_len + 1 : 2;
        denied_patterns_len = denied_patterns_len ? denied_patterns_len + 1 : 2;
