...
static void cgroup_context_apply(
        ...
        /* In fully unified mode these attributes don't exist on the host cgroup root. */
        ...
        /* In unified mode 'memory' attributes do not exist on the root cgroup. */
