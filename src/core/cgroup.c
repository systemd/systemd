...
static void set_bfq_weight(Unit *u, const char *controller, bool has_dev, dev_t dev, uint64_t io_weight) {
        ...
        if (!set_attribute_and_warn(u, controller, p, buf))
                log_unit_debug(u, "IO%sWeight=%" PRIu64 " scaled to %s=%" PRIu64,
                               has_dev ? "Device" : "", io_weight, p, bfq_weight);
}
...
static void set_io_weight(Unit *u, uint64_t weight) {
        ...
        set_bfq_weight(u, "io", false, 0, weight);
...
static void set_blkio_weight(Unit *u, uint64_t weight) {
        ...
        set_bfq_weight(u, "blkio", false, 0, weight);
