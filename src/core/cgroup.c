...
static void set_io_weight(Unit *u, uint64_t weight) {
        ...
        xsprintf(buf, "%" PRIu64 "\n", bfq_weight);
        if (!set_attribute_and_warn(u, "io", "io.bfq.weight", buf))
                log_unit_debug(u, "Weight scaled to io.bfq.weight=%" PRIu64, bfq_weight);
...
static void set_blkio_weight(Unit *u, uint64_t weight) {
        ...
        bfq_weight = BFQ_WEIGHT(weight);
        xsprintf(buf, "%" PRIu64 "\n", bfq_weight);
        if (!set_attribute_and_warn(u, "blkio", "blkio.bfq.weight", buf))
                log_unit_debug(u, "Weight scaled to blkio.bfq.weight=%" PRIu64, bfq_weight);
