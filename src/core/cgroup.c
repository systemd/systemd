...
static void cgroup_apply_device_memory_limits(Unit *u) {
        ...
        LIST_FOREACH(dev_limits, l, c->dev_mem_limits) {
                ...
                /* new_l->region and l->region temporarily share the same pointer here. new_l is a temporary
                 * struct that will be destroyed at the end of this function. At that point, l solely owns
                 * l->region again. */
