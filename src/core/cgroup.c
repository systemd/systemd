...
void unit_reset_memory_accounting_last(Unit *u) {
        ...
        FOREACH_ARRAY_ELEMENT(i, crt->memory_accounting_last)
                *i = UINT64_MAX;
}
...
CGroupRuntime *cgroup_runtime_new(void) {
        ...
        *crt = (CGroupRuntime) {
        ...
        FOREACH_ARRAY_ELEMENT(i, crt->memory_accounting_last)
                *i = UINT64_MAX;
        FOREACH_ARRAY_ELEMENT(i, crt->io_accounting_base)
                *i = UINT64_MAX;
        FOREACH_ARRAY_ELEMENT(i, crt->io_accounting_last)
                *i = UINT64_MAX;
        FOREACH_ARRAY_ELEMENT(i, crt->ip_accounting_extra)
                *i = UINT64_MAX;
