...
static const UnitActiveState state_translation_table[_SERVICE_STATE_MAX] = {
        ...
        [SERVICE_RESOURCES_PINNED] = UNIT_INACTIVE,
...
static ServiceState service_determine_dead_state(Service *s) {
        ...
        return s->fd_store && s->fd_store_preserve_mode == EXEC_PRESERVE_YES ? SERVICE_RESOURCES_PINNED : SERVICE_DEAD;
}
...
static int service_start(Unit *u) {
        ...
        assert(IN_SET(s->state, SERVICE_DEAD, SERVICE_FAILED, SERVICE_RESOURCES_PINNED));
...
static bool service_may_gc(Unit *u) {
        ...
        if (!IN_SET(s->state, SERVICE_DEAD, SERVICE_FAILED, SERVICE_RESOURCES_PINNED))
                return false;
