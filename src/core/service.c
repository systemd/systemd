...
static void service_dump(Unit *u, FILE *f, const char *prefix) {
        ...
        fprintf(f,
                ...
                prefix, yes_no(s->restart_with_debug),
...
static int service_spawn_internal(
        ...
        if (s->restart_with_debug && s->exec_context.log_level_max == LOG_PRI(LOG_DEBUG)) {
...
static void service_enter_dead(Service *s, ServiceResult f, bool allow_restart) {
        ...
        if (allow_restart) {
                ...
                if (s->restart_with_debug && s->exec_context.log_level_max != s->original_log_level_max) {
