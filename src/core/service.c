...
static int service_serialize(Unit *u, FILE *f, FDSet *fds) {
        ...
        (void) serialize_dual_timestamp(f, "handover-timestamp", &s->handover_timestamp);
...
static int service_deserialize_item(Unit *u, const char *key, const char *value, FDSet *fds) {
        ...
        if (streq(key, "state")) {
                ...
                deserialize_dual_timestamp(value, &s->handover_timestamp);
        ...
        for (;;) {
                ...
                if (n == 1) {
                        ...
                        if (s->state == SERVICE_START)
                                s->handover_timestamp = DUAL_TIMESTAMP_NULL;
                ...
                if (x == 0) {
                        ...
                        if (s->state == SERVICE_START) {
                                ...
                                dual_timestamp_from_monotonic(&s->handover_timestamp, (usec_t)x);
                        }
                }
        }
}
