...
typedef struct Machine {
        ...
        /* Leader: the top-level process that is encapsulates the machine itself. For containers that's PID
         * 1, for VMs that's qemu or whatever process wraps the actual VM code. This process defines the
         * runtime lifecycle of the machine. In case of containers we can use this reference to enter
         * namespace, send signals and so on.
         *
