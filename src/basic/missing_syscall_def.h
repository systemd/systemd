...
#ifndef __IGNORE_getxattrat
#  if defined(__aarch64__)
#    define systemd_NR_getxattrat 464
#  elif defined(__alpha__)
#    define systemd_NR_getxattrat 574
#  elif defined(__arc__) || defined(__tilegx__)
#    define systemd_NR_getxattrat 464
#  elif defined(__arm__)
#    define systemd_NR_getxattrat 464
...
#    define systemd_NR_getxattrat 464
#  elif defined(__ia64__)
#    define systemd_NR_getxattrat -1
#  elif defined(__loongarch_lp64)
#    define systemd_NR_getxattrat 464
#  elif defined(__m68k__)
#    define systemd_NR_getxattrat 464
#  elif defined(_MIPS_SIM)
#    if _MIPS_SIM == _MIPS_SIM_ABI32
#      define systemd_NR_getxattrat 4464
#    elif _MIPS_SIM == _MIPS_SIM_NABI32
#      define systemd_NR_getxattrat 6464
#    elif _MIPS_SIM == _MIPS_SIM_ABI64
#      define systemd_NR_getxattrat 5464
#    else
#      error "Unknown MIPS ABI"
#    endif
#  elif defined(__hppa__)
...
#  elif defined(__x86_64__)
#    if defined(__ILP32__)
#      define systemd_NR_getxattrat (464 | /* __X32_SYSCALL_BIT */ 0x40000000)
#    else
#      define systemd_NR_getxattrat 464
#    endif
#  elif !defined(missing_arch_template)
#    warning "getxattrat() syscall number is unknown for your architecture"
#  endif

/* may be an (invalid) negative number due to libseccomp, see PR 13319 */
#  if defined __NR_getxattrat && __NR_getxattrat >= 0
#    if defined systemd_NR_getxattrat
assert_cc(__NR_getxattrat == systemd_NR_getxattrat);
#    endif
#  else
#    if defined __NR_getxattrat
#      undef __NR_getxattrat
#    endif
#    if defined systemd_NR_getxattrat && systemd_NR_getxattrat >= 0
#      define __NR_getxattrat systemd_NR_getxattrat
#    endif
#  endif
#endif

#ifndef __IGNORE_listxattrat
#  if defined(__aarch64__)
#    define systemd_NR_listxattrat 465
#  elif defined(__alpha__)
#    define systemd_NR_listxattrat 575
#  elif defined(__arc__) || defined(__tilegx__)
#    define systemd_NR_listxattrat 465
#  elif defined(__arm__)
#    define systemd_NR_listxattrat 465
...
#    define systemd_NR_listxattrat 465
#  elif defined(__ia64__)
#    define systemd_NR_listxattrat -1
#  elif defined(__loongarch_lp64)
#    define systemd_NR_listxattrat 465
#  elif defined(__m68k__)
#    define systemd_NR_listxattrat 465
#  elif defined(_MIPS_SIM)
#    if _MIPS_SIM == _MIPS_SIM_ABI32
#      define systemd_NR_listxattrat 4465
#    elif _MIPS_SIM == _MIPS_SIM_NABI32
#      define systemd_NR_listxattrat 6465
#    elif _MIPS_SIM == _MIPS_SIM_ABI64
#      define systemd_NR_listxattrat 5465
#    else
#      error "Unknown MIPS ABI"
#    endif
#  elif defined(__hppa__)
...
#  elif defined(__x86_64__)
#    if defined(__ILP32__)
#      define systemd_NR_listxattrat (465 | /* __X32_SYSCALL_BIT */ 0x40000000)
#    else
#      define systemd_NR_listxattrat 465
#    endif
#  elif !defined(missing_arch_template)
#    warning "listxattrat() syscall number is unknown for your architecture"
#  endif

/* may be an (invalid) negative number due to libseccomp, see PR 13319 */
#  if defined __NR_listxattrat && __NR_listxattrat >= 0
#    if defined systemd_NR_listxattrat
assert_cc(__NR_listxattrat == systemd_NR_listxattrat);
#    endif
#  else
#    if defined __NR_listxattrat
#      undef __NR_listxattrat
#    endif
#    if defined systemd_NR_listxattrat && systemd_NR_listxattrat >= 0
#      define __NR_listxattrat systemd_NR_listxattrat
#    endif
#  endif
#endif
