...
#    endif
#  elif defined(__hppa__)
#    define systemd_NR_copy_file_range -1
#  elif defined(__powerpc__)
...
#    endif
#  elif defined(__hppa__)
#    define systemd_NR_epoll_pwait2 -1
#  elif defined(__powerpc__)
#    define systemd_NR_epoll_pwait2 441
#  elif defined(__riscv)
#    if __riscv_xlen == 32
...
#    endif
#  elif defined(__hppa__)
#    define systemd_NR_memfd_create -1
#  elif defined(__powerpc__)
...
#    endif
#  elif defined(__hppa__)
#    define systemd_NR_move_mount -1
#  elif defined(__powerpc__)
#    define systemd_NR_move_mount 429
#  elif defined(__riscv)
#    if __riscv_xlen == 32
...
#    endif
#  elif defined(__hppa__)
#    define systemd_NR_name_to_handle_at -1
#  elif defined(__powerpc__)
...
#    endif
#  elif defined(__hppa__)
#    define systemd_NR_pidfd_open -1
#  elif defined(__powerpc__)
#    define systemd_NR_pidfd_open 434
#  elif defined(__riscv)
#    if __riscv_xlen == 32
...
#    endif
#  elif defined(__hppa__)
#    define systemd_NR_pidfd_send_signal -1
#  elif defined(__powerpc__)
#    define systemd_NR_pidfd_send_signal 424
#  elif defined(__riscv)
#    if __riscv_xlen == 32
...
#    endif
#  elif defined(__hppa__)
#    define systemd_NR_pkey_mprotect -1
#  elif defined(__powerpc__)
