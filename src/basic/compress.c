...
int dlopen_lzma(void) {
        ELF_NOTE_DLOPEN("lzma", "Support lzma decompression in journal and coredump files", COMPRESSION_PRIORITY_XZ, "liblzma.so.5");
...
#if HAVE_LZ4
int dlopen_lz4(void) {
        ELF_NOTE_DLOPEN("lz4", "Support lz4 decompression in journal and coredump files", COMPRESSION_PRIORITY_LZ4, "liblz4.so.1");
...
int dlopen_zstd(void) {
        ELF_NOTE_DLOPEN("zstd", "Support zstd decompression in journal and coredump files", COMPRESSION_PRIORITY_ZSTD, "libzstd.so.1");
