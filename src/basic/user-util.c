...
static int name_to_uid_offline(
                const char *root,
                const char *user,
                uid_t *ret_uid,
                Hashmap **cache) {
...
static int name_to_gid_offline(
                const char *root,
                const char *group,
                gid_t *ret_gid,
                Hashmap **cache) {
...
int name_to_uid(const char *root, const char *user, uid_t *ret_uid, Hashmap **cache) {
        ...
        return name_to_uid_offline(root, user, ret_uid, cache);
}
...
int name_to_gid(const char *root, const char *group, gid_t *ret_gid, Hashmap **cache) {
        ...
        return name_to_gid_offline(root, group, ret_gid, cache);
}
