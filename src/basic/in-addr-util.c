...
static bool in6_addr_is_loopback(const struct in6_addr *a) {
        return memcmp(a->in6_u.u6_addr32, &(const struct in6_addr) IN6ADDR_LOOPBACK_INIT, sizeof(a->in6_u.u6_addr32)) == 0;
}
...
bool in6_addr_equal(const struct in6_addr *a, const struct in6_addr *b) {
        ...
        return memcmp(a->in6_u.u6_addr32, b->in6_u.u6_addr32, sizeof(a->in6_u.u6_addr32)) == 0;
}
