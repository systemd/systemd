...
#ifdef DEFAULT_EXEC_SEARCH_PATH
#define DEFAULT_PATH_WITH_FULL_SBIN PATH_SPLIT_BIN("/usr/local/") ":" PATH_SPLIT_BIN("/usr/") ":" DEFAULT_EXEC_SEARCH_PATH
#define DEFAULT_PATH_WITH_LOCAL_SBIN PATH_SPLIT_BIN("/usr/local/") ":" PATH_MERGED_BIN("/usr/") ":" DEFAULT_EXEC_SEARCH_PATH
#define DEFAULT_PATH_WITHOUT_SBIN PATH_MERGED_BIN("/usr/local/") ":" PATH_MERGED_BIN("/usr/") ":" DEFAULT_EXEC_SEARCH_PATH
#define DEFAULT_PATH_COMPAT  PATH_SPLIT_BIN("/usr/local/") ":" PATH_SPLIT_BIN("/usr/") ":" PATH_SPLIT_BIN("/") ":" DEFAULT_EXEC_SEARCH_PATH
#else
