...
char** _strv_env_merge(char **first, ...) {
        _cleanup_(strv_freep) char **merged = NULL;
        char **k;
        va_list ap;
...
char** strv_env_delete(char **x, size_t n_lists, ...) {
        size_t n, i = 0;
        _cleanup_(strv_freep) char **t = NULL;
        va_list ap;
...
int replace_env_full(
        ...
        for (e = format, i = 0; *e && i < length; e++, i++)
                ...
                case ALTERNATE_VALUE:
                        ...
                        nest--;
                        if (nest == 0) {
                                _cleanup_(strv_freep) char **u = NULL, **b = NULL;
...
int replace_env_argv(
        ...
        _cleanup_(strv_freep) char **n = NULL, **unset_variables = NULL, **bad_variables = NULL;
        size_t k = 0, l;
        int r;
