...
static inline int missing_fsopen(const char *fsname, unsigned int flags) {
...
static inline int missing_fsconfig(int fd, unsigned int cmd, const char *key, const void *value, int aux) {
