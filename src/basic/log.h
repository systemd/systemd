...
#define _LOG_CONTEXT_CONSUME_STR(s, c) \
        _unused_ _cleanup_(log_context_freep) LogContext *c = log_context_new(strv_new(s))

#define LOG_CONTEXT_CONSUME_STR(s) \
        _LOG_CONTEXT_CONSUME_STR(s, UNIQ_T(c, UNIQ))

#define _LOG_CONTEXT_CONSUME_STRV(strv, c) \
        _unused_ _cleanup_(log_context_freep) LogContext *c = log_context_new(strv);
