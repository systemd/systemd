...
#define _log_every_x_usec(rl, usec, level, ...)         \
        ({                                              \
                static RateLimit rl = {                 \
                        .interval = (usec),             \
                        .burst = 1                      \
...
#define log_every_x_usec(usec, level, ...) _log_every_x_usec(UNIQ_T(rl, UNIQ), usec, level, __VA_ARGS__)

#define _log_every_x_usec_errno(rl, usec, level, error, ...)            \
        ({                                                              \
                static RateLimit rl = {                                 \
                        .interval = (usec),                             \
                        .burst = 1                                      \
...
#define log_every_x_usec_errno(usec, level, error, ...) _log_every_x_usec_errno(UNIQ_T(rl, UNIQ), usec, level, error, __VA_ARGS__)
