...
({                                                                              \
        ...
        static ErrorRateLimit error_ratelimit = {                               \
                .ratelimit = {                                                  \
                        .interval = (1 * USEC_PER_SEC),                         \
                        .burst = 1                                              \
                },                                                              \
        };                                                                      \
        static size_t num_dropped_errors;                                       \
        if (error_is_ratelimited(_error, &error_ratelimit)) {                   \
                num_dropped_errors += 1;                                        \
        } else {                                                                \
