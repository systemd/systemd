...
#else
static_assert(CAP_AUDIT_READ == 37);
#endif
...
#else
static_assert(CAP_CHECKPOINT_RESTORE == 40);
#endif
...
#else
static_assert(CAP_LAST_CAP == SYSTEMD_CAP_LAST_CAP);
#endif
