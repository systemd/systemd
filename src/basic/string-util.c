...
bool version_is_valid(const char *s, VersionFlags flags) {
         ...
         * VERSION_ALLOW_UNDERSCORE|VERSION_ALLOW_PLUS. When validating our own versoined objects (e.g. vpick
         * or so) validate more strictly, and in particular refuse characters such as "_" and "+" that may be
         * used for separating component names or attempt counters.
         *
