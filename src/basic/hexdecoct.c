...
char hexchar(int x) {
        static const char table[] = LOWERCASE_HEXDIGITS;
...
char base32hexchar(int x) {
        static const char table[] = DIGITS "ABCDEFGHIJKLMNOPQRSTUV";
...
char base64char(int x) {
        static const char table[] = UPPERCASE_LETTERS LOWERCASE_LETTERS DIGITS "+/";
        return table[x & 63];
}
...
char urlsafe_base64char(int x) {
        static const char table[] = UPPERCASE_LETTERS LOWERCASE_LETTERS DIGITS "-_";
        return table[x & 63];
}
