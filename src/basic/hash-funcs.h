...
#define _DEFINE_HASH_OPS_FULL(uq, name, type, hash_func, compare_func, free_key_func, type_value, free_value_func, scope) \
        ...
        _DEFINE_HASH_OPS(                                                                                                 \
                uq, name, type, hash_func, compare_func, UNIQ_T(static_free_key_wrapper, uq), UNIQ_T(static_free_value_wrapper, uq), scope)

#define DEFINE_HASH_OPS(name, type, hash_func, compare_func) _DEFINE_HASH_OPS(UNIQ, name, type, hash_func, compare_func, NULL, NULL, )
