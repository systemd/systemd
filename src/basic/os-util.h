...
int _parse_extension_release(const char *root, const char *extension, bool extension_release_nonstrict, ...) _sentinel_;
int _parse_os_release(const char *root, ...) _sentinel_;
#define parse_extension_release(root, extension, extension_release_nonstrict, ...) _parse_extension_release(root, extension, extension_release_nonstrict, __VA_ARGS__, NULL)
