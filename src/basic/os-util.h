...
int path_is_configuration_tree(const char *path, const char *configuration, bool relax_configuration_release_check);
...
int open_configuration_release(const char *root, const char *configuration, bool relax_configuration_release_check, char **ret_path, int *ret_fd);
...
int fopen_configuration_release(const char *root, const char *configuration, bool relax_configuration_release_check, char **ret_path, FILE **ret_file);
...
int _parse_configuration_release(const char *root, bool relax_configuration_release_check, const char *configuration, ...) _sentinel_;
int _parse_os_release(const char *root, ...) _sentinel_;
int _parse_extension_os_release(const char *root, ...) _sentinel_;
int _parse_configuration_os_release(const char *root, ...) _sentinel_;
...
#define parse_configuration_release(root, relax_configuration_release_check, configuration, ...) _parse_configuration_release(root, relax_configuration_release_check, configuration, __VA_ARGS__, NULL)
...
#define parse_configuration_os_release(root, ...) _parse_configuration_os_release(root, __VA_ARGS__, NULL)

int load_extension_release_pairs(const char *root, const char *extension, bool relax_extension_release_check, char ***ret);
int load_configuration_release_pairs(const char *root, const char *configuration, bool relax_configuration_release_check, char ***ret);
