 ...
 * deadlocks if the parent uses threads and the child intends to do memory allocation. Hence: if the parent
 * is threaded these flags may not be used. Or conversely, if the forked of child uses malloc() these flags
 * may not be used. 💣 */
