...
void path_hash_func(const char *q, struct siphash *state) {
        ...
        /* Calculates a hash for a path in a way this duplicate inner slashes don't make a differences, and
         * also whether there's a trailing slash or not. This fits well with the semantics of path_compare(),
         * which does similar checks and also doesn't care for trailing slashes. Note that relative and
         * absolute paths (i.e. those which begin in a slash or not) will hash differently though. */
