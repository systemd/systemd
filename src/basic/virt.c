...
static Virtualization detect_vm_dmi_vendor(void) {
        ...
        static const struct {
                ...
                { "Alibaba Cloud ECS",   VIRTUALIZATION_KVM       }, /* Detect Alibaba Cloud ECS as KVM; narrower than the bare "Alibaba Cloud" sys_vendor value, VM-vs-bare-metal disambiguation via SMBIOS bit is a pending follow-up */
