 ...
 *          locks, which means they will be an undefined state in the child if the parent is threaded. This
 *          means: the parent must either never use threads, or the child cannot use memory allocation
 *          itself. This is a major pitfall, hence be careful! 💣
 *
