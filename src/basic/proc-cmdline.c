...
int proc_cmdline(char **ret) {
        ...
        if (detect_container() > 0) {
                ...
                _cleanup_free_ char *s = NULL, *joined = NULL;
                size_t n;
                ...
                /* Use the same flags used by proc_cmdline_extract_first(). */
                r = strv_split_full(&args, s, NULL, EXTRACT_UNQUOTE|EXTRACT_RELAX|EXTRACT_RETAIN_ESCAPE);
                if (r < 0)
                        return r;
