...
#define DEFINE_TRIVIAL_REF_FUNC(type, name) _DEFINE_TRIVIAL_REF_FUNC(type, name, )
#define DEFINE_PRIVATE_TRIVIAL_REF_FUNC(type, name) _DEFINE_TRIVIAL_REF_FUNC(type, name, static)
