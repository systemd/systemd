...
#define EFI_VENDOR_SHELL       SD_ID128_MAKE(15,8d,ef,5a,f6,56,41,9c,b0,27,7a,31,92,c0,79,d2)
#define EFI_VENDOR_SHELL_STR   SD_ID128_MAKE_UUID_STR(15,8d,ef,5a,f6,56,41,9c,b0,27,7a,31,92,c0,79,d2)
...
#define EFI_SHELL_VARIABLE_STR(name) EFI_VENDOR_VARIABLE_STR(EFI_VENDOR_SHELL_STR, name)
...
#define EFI_SHELL_VARIABLE(name) EFI_SHELL_VARIABLE_STR(STRINGIFY(name))
