...
#else
static_assert(OCFS2_SUPER_MAGIC == 0x7461636f);
#endif
...
#else
static_assert(TRACEFS_MAGIC == 0x74726163);
#endif
...
#else
static_assert(NSFS_MAGIC == 0x6e736673);
#endif
...
#else
static_assert(BPF_FS_MAGIC == 0xcafe4a11);
#endif
...
#else
static_assert(XFS_SB_MAGIC == 0x58465342);
#endif
...
#else
static_assert(CIFS_SUPER_MAGIC == 0xFF534D42);
#endif
...
#else
static_assert(SMB2_SUPER_MAGIC == 0xFE534D42);
#endif
...
#else
static_assert(OVERLAYFS_SUPER_MAGIC == 0x794c7630);
#endif
...
#else
static_assert(UDF_SUPER_MAGIC == 0x15013346);
#endif
...
#else
static_assert(DAXFS_MAGIC == 0x64646178);
#endif
...
#else
static_assert(RDTGROUP_SUPER_MAGIC == 0x7655821);
#endif
...
#else
static_assert(AAFS_MAGIC == 0x5a3c69f0);
#endif
...
#else
static_assert(AFS_FS_MAGIC == 0x6b414653);
#endif
...
#else
static_assert(XFS_SUPER_MAGIC == 0x58465342);
#endif
...
#else
static_assert(BINDERFS_SUPER_MAGIC == 0x6c6f6f70);
#endif
...
#else
static_assert(DMA_BUF_MAGIC == 0x444d4142);
#endif
...
#else
static_assert(EROFS_SUPER_MAGIC_V1 == 0xe0f5e1e2);
#endif
...
#else
static_assert(ZONEFS_MAGIC == 0x5a4f4653);
#endif
...
#else
static_assert(DEVMEM_MAGIC == 0x454d444d);
#endif
...
#else
static_assert(PID_FS_MAGIC == 0x50494446);
#endif
...
#else
static_assert(SECRETMEM_MAGIC == 0x5345434d);
#endif
...
#else
static_assert(FUSE_SUPER_MAGIC == 0x65735546);
#endif
...
#else
static_assert(CEPH_SUPER_MAGIC == 0x00c36400);
#endif
...
#else
static_assert(EXFAT_SUPER_MAGIC == 0x2011BAB0UL);
#endif
