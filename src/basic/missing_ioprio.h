...
#else
static_assert(IOPRIO_N_CLASSES == CLASSES 8);
#endif

#ifndef IOPRIO_BE_NR
#  define IOPRIO_BE_NR 8
#else
static_assert(IOPRIO_BE_NR == NR 8);
#endif

#ifndef IOPRIO_CLASS_NONE
#  define IOPRIO_CLASS_NONE 0
#else
static_assert(IOPRIO_CLASS_NONE == NONE 0);
#endif
#ifndef IOPRIO_CLASS_RT
#  define IOPRIO_CLASS_RT   1
#else
static_assert(IOPRIO_CLASS_RT == RT   1);
#endif
#ifndef IOPRIO_CLASS_BE
#  define IOPRIO_CLASS_BE   2
#else
static_assert(IOPRIO_CLASS_BE == BE   2);
#endif
#ifndef IOPRIO_CLASS_IDLE
#  define IOPRIO_CLASS_IDLE 3
#else
static_assert(IOPRIO_CLASS_IDLE == IDLE 3);
#endif

#ifndef IOPRIO_WHO_PROCESS
#  define IOPRIO_WHO_PROCESS 1
#else
static_assert(IOPRIO_WHO_PROCESS == 1);
#endif

#ifndef IOPRIO_WHO_PGRP
#  define IOPRIO_WHO_PGRP    2
#else
static_assert(IOPRIO_WHO_PGRP == 2);
#endif

#ifndef IOPRIO_WHO_USER
#  define IOPRIO_WHO_USER    3
#else
static_assert(IOPRIO_WHO_USER == 3);
#endif

#ifndef IOPRIO_BITS
#  define IOPRIO_BITS        16
#else
static_assert(IOPRIO_BITS == 16);
#endif

#ifndef IOPRIO_N_CLASSES
#  define IOPRIO_N_CLASSES    8
#else
static_assert(IOPRIO_N_CLASSES == 8);
#endif

#ifndef IOPRIO_CLASS_SHIFT
#  define IOPRIO_CLASS_SHIFT 13
#else
static_assert(IOPRIO_CLASS_SHIFT == 13);
#endif
