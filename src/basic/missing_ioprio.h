...
#else
assert_cc(IOPRIO_N_CLASSES == CLASSES 8);
#endif

#ifndef IOPRIO_BE_NR
#  define IOPRIO_BE_NR 8
#else
assert_cc(IOPRIO_BE_NR == NR 8);
#endif

#ifndef IOPRIO_CLASS_NONE
#  define IOPRIO_CLASS_NONE 0
#else
assert_cc(IOPRIO_CLASS_NONE == NONE 0);
#endif
#ifndef IOPRIO_CLASS_RT
#  define IOPRIO_CLASS_RT   1
#else
assert_cc(IOPRIO_CLASS_RT == RT   1);
#endif
#ifndef IOPRIO_CLASS_BE
#  define IOPRIO_CLASS_BE   2
#else
assert_cc(IOPRIO_CLASS_BE == BE   2);
#endif
#ifndef IOPRIO_CLASS_IDLE
#  define IOPRIO_CLASS_IDLE 3
#else
assert_cc(IOPRIO_CLASS_IDLE == IDLE 3);
#endif
