...
int setrlimit_closest(int resource, const struct rlimit *rlim) {
        ...
        log_warning("Failed at setting rlimit %lu for ressource RLIMIT_%s. Will attempt setting value %lu.", rlim->rlim_max, rlimit_to_string(resource), highest.rlim_max);
