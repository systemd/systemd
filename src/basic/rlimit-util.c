...
int setrlimit_closest(int resource, const struct rlimit *rlim) {
        ...
        log_warning("Failed at setting rlimit %" PRIu64 " for resource RLIMIT_%s. Will attempt setting value %" PRIu64 " instead.", rlim->rlim_max, rlimit_to_string(resource), fixed.rlim_max);
