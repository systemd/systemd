...
int pack_fds(int *fds, size_t n_fds) {
         ...
         * from SD_LISTEN_FDS_START. This should be called after close_all_fds,
         * or after safe_fork with FORK_CLOSE_ALL_FDS set, to prepare FDs to be
         * passed into a child process. The fds array is modified in place with the
         * new FD numbers. */
