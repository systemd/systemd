...
static int parse_release_internal(const char *root, bool extension_release_nonstrict, const char *extension, va_list ap) {
...
int _parse_extension_release(const char *root, bool extension_release_nonstrict, const char *extension, ...) {
        va_list ap;
        int r;

        va_start(ap, extension);
        r = parse_release_internal(root, extension_release_nonstrict, extension, ap);
        va_end(ap);
