...
#else
static_assert(INPUT_PROP_POINTING_STICK == 0x05);
#endif
...
#else
static_assert(INPUT_PROP_ACCELEROMETER == 0x06);
#endif
...
#else
static_assert(BTN_DPAD_UP    == 0x220);
static_assert(BTN_DPAD_DOWN  == 0x221);
static_assert(BTN_DPAD_LEFT  == 0x222);
static_assert(BTN_DPAD_RIGHT == 0x223);
#endif
...
#else
static_assert(KEY_ALS_TOGGLE == 0x230);
#endif
