...
#define strstr_ptr(haystack, needle) \
        const_generic(haystack, const char*, strstr_ptr_internal(haystack, needle))
...
static inline char* strstrafter_internal(const char *haystack, const char *needle) {
        ...
        p = (char*) strstr_ptr(haystack, needle);
        if (!p)
                return NULL;
...
#define strstrafter(haystack, needle) \
        const_generic(haystack, const char*, strstrafter_internal(haystack, needle))
...
#define find_line_startswith(haystack, needle) \
        const_generic(haystack, const char*, find_line_startswith_internal(haystack, needle))

char* find_line_internal(const char *haystack, const char *needle);
#define find_line(haystack, needle) \
        const_generic(haystack, const char*, find_line_internal(haystack, needle))

char* find_line_after_internal(const char *haystack, const char *needle);
#define find_line_after(haystack, needle) \
        const_generic(haystack, const char*, find_line_after_internal(haystack, needle))
...
#define strrstr(haystack, needle) \
        const_generic(haystack, const char*, strrstr_internal(haystack, needle))
