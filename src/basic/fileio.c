...
int read_full_stream_full(
        ...
        const size_t limit = FLAGS_SET(flags, READ_FULL_FILE_LARGE_FILE) ? READ_FULL_LARGE_BYTES_MAX : READ_FULL_BYTES_MAX;
        n_next = MIN(n_next, limit + 1);
