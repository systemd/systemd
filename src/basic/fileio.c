...
int fputs_with_newline(FILE *f, const char *s) {
        ...
        /* This is like fputs() but outputs a trailing newline char, but only if the string doesn't end in
         * a newline already. Returns 0 in case we didn't append a newline, > 0 otherwise. */
