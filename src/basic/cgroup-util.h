...
typedef enum CGroupController {
        ...
        CGROUP_CONTROLLER_PERF_EVENT, /* v1 only */
...
typedef enum CGroupMask {
        ...
        CGROUP_MASK_PERF_EVENT = CGROUP_CONTROLLER_TO_MASK(CGROUP_CONTROLLER_PERF_EVENT),

        /* All real cgroup v1 controllers */
        CGROUP_MASK_V1 = CGROUP_MASK_CPU|CGROUP_MASK_CPUACCT|CGROUP_MASK_BLKIO|CGROUP_MASK_MEMORY|CGROUP_MASK_DEVICES|CGROUP_MASK_PIDS|CGROUP_MASK_PERF_EVENT,
