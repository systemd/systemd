...
typedef enum CGroupController {
        ...
        CGROUP_CONTROLLER_BPFFS_PROGRAM,
...
typedef enum CGroupMask {
        ...
        CGROUP_MASK_BPFFS_PROGRAM = CGROUP_CONTROLLER_TO_MASK(CGROUP_CONTROLLER_BPFFS_PROGRAM),
        ...
        CGROUP_MASK_BPF = CGROUP_MASK_BPF_FIREWALL|CGROUP_MASK_BPF_DEVICES|CGROUP_MASK_BPFFS_PROGRAM,
