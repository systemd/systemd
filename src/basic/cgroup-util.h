...
typedef enum CGroupController {
        ...
        CGROUP_CONTROLLER_BPF_ALLOW_BIND,
...
typedef enum CGroupMask {
        ...
        CGROUP_MASK_BPF_ALLOW_BIND = CGROUP_CONTROLLER_TO_MASK(CGROUP_CONTROLLER_BPF_ALLOW_BIND),
        ...
        CGROUP_MASK_BPF = CGROUP_MASK_BPF_FIREWALL|CGROUP_MASK_BPF_DEVICES|CGROUP_MASK_BPF_ALLOW_BIND,
