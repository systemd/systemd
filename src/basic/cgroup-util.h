...
typedef enum CGroupController {
        ...
        CGROUP_CONTROLLER_BPF_VRF_BIND,
...
typedef enum CGroupMask {
        ...
        CGROUP_MASK_BPF_VRF_BIND = CGROUP_CONTROLLER_TO_MASK(CGROUP_CONTROLLER_BPF_VRF_BIND),
        ...
        CGROUP_MASK_BPF = CGROUP_MASK_BPF_FIREWALL|CGROUP_MASK_BPF_DEVICES|CGROUP_MASK_BPF_FOREIGN|CGROUP_MASK_BPF_SOCKET_BIND|CGROUP_MASK_BPF_RESTRICT_NETWORK_INTERFACES|CGROUP_MASK_BPF_VRF_BIND,
