...
char* format_timestamp_relative_full(char *buf, size_t l, usec_t t, bool implicit_left, bool monotonic) _warn_unused_result_;
...
static inline char* format_timestamp_relative(char *buf, size_t l, usec_t t)  {
        return format_timestamp_relative_full(buf, l, t, /* implicit_left = */ false, /* monotonic = */ false);
}
static inline char* format_timestamp_relative_monotonic(char *buf, size_t l, usec_t t)  {
        return format_timestamp_relative_full(buf, l, t, /* implicit_left = */ false, /* monotonic = */ true);
}
