...
const char *special_glyph_utf8(SpecialGlyph code) {

        /* A list of a number of interesting unicode glyphs we can use to decorate our output. This is useful when
         * we're more interested in getting the actual utf-8 characters and do not want to be as conservative.
         */
