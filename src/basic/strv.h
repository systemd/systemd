...
#define startswith_strv(s, l) const_generic(s, const sd_char*, startswith_strv_internal(s, l))
...
#define endswith_strv(s, l) const_generic(s, const char*, endswith_strv_internal(s, l))
