...
int strv_extend_strv_biconcat(char ***a, const char *prefix, char * const *b, const char *suffix);
static inline int strv_extend_strv_concat(char ***a, char * const *b, const char *suffix) {
