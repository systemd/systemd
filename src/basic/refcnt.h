...
#define DEFINE_ATOMIC_REF_FUNC(type, name) _DEFINE_ATOMIC_REF_FUNC(type, name, )
#define DEFINE_PUBLIC_ATOMIC_REF_FUNC(type, name) _DEFINE_ATOMIC_REF_FUNC(type, name, _public_)

#define DEFINE_ATOMIC_UNREF_FUNC(type, name, free_func) _DEFINE_ATOMIC_UNREF_FUNC(type, name, free_func, )
#define DEFINE_PUBLIC_ATOMIC_UNREF_FUNC(type, name, free_func) _DEFINE_ATOMIC_UNREF_FUNC(type, name, free_func, _public_)
