...
int chase_symlinks_at(
        ...
        assert(!FLAGS_SET(flags, CHASE_STEP|CHASE_FILENAME));
        assert(!FLAGS_SET(flags, CHASE_TRAIL_SLASH|CHASE_FILENAME));
        ...
        if (ret_path) {
                if (FLAGS_SET(flags, CHASE_FILENAME) && done) {
...
int chase_symlinks(
        ...
        if (ret_path) {
                if (!FLAGS_SET(flags, CHASE_FILENAME)) {
