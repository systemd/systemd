...
int search_and_open(const char *path, int mode, const char *root, char **search, ChaseFlags flags, int *ret_fd, char **ret_path);
int search_and_access(const char *path, int mode, const char *root, char**search, ChaseFlags flags, char **ret_path);
int search_and_fopen(const char *path, const char *mode, const char *root, const char **search, ChaseFlags flags, FILE **ret_file, char **ret_path);
int search_and_fopen_nulstr(const char *path, const char *mode, const char *root, const char *search, ChaseFlags flags, FILE **ret_file, char **ret_path);
