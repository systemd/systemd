...
int prctl_safe(int op, unsigned long arg2, unsigned long arg3, unsigned long arg4, unsigned long arg5) {
        ...
        /* prctl(2) is a a bit messy: it's a variadic function, defined with "unsigned long" arguments. This
         * means that unless people expicitly cast it's quite likely they end up passing a shorter type even
