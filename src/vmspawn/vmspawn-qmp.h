...
int vmspawn_qmp_setup(VmspawnQmpContext **ret, int qmp_fd, sd_event *event, const char *runtime_dir, RuntimeScope runtime_scope, uid_t owner_uid, char **ret_varlink_address);
