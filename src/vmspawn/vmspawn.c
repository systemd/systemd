...
static int start_virtiofsd(sd_bus *bus, const char *scope, const char *directory) {
        _cleanup_(rm_rf_physical_and_freep) char *state = NULL;
        _cleanup_strv_free_ char **cmdline = NULL, **cleanup = NULL;
        _cleanup_free_ char *virtiofsd = NULL, *sock_path = NULL, *rm_path = NULL, *unit_name = NULL;
        int r;
