...
static int cmdline_add_kernel_cmdline(char ***cmdline, const char *kernel, int smbios_dir_fd, const char *smbios_dir) {
        int r;
...
static int cmdline_add_credentials(char ***cmdline, const char *kernel, int smbios_dir_fd, const char *smbios_dir) {
        int r;
...
static int run_virtual_machine(int kvm_device_fd, int vhost_device_fd) {
        ...
        r = cmdline_add_credentials(&cmdline, kernel, smbios_dir_fd, smbios_dir);
        if (r < 0)
                return r;

        r = cmdline_add_kernel_cmdline(&cmdline, kernel, smbios_dir_fd, smbios_dir);
        if (r < 0)
                return r;
