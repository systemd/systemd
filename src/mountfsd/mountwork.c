...
static int vl_method_mount_image(
        ...
        static const sd_json_dispatch_field dispatch_table[] = {
                ...
                { "verityRootHash",              SD_JSON_VARIANT_ARRAY,    json_dispatch_byte_array_iovec, offsetof(MountImageParameters, verity_root_hash),     0 },
                { "verityRootHashSignature",     SD_JSON_VARIANT_ARRAY,    json_dispatch_byte_array_iovec, offsetof(MountImageParameters, verity_root_hash_sig), 0 },
