...
int varlink_acquire_pidfd(sd_varlink *v) {
        assert(v);
...
int sd_varlink_set_relative_timeout(sd_varlink *v, usec_t timeout) {
        assert_return(v, -EINVAL);
...
int sd_varlink_set_description(sd_varlink *v, const char *description) {
        assert_return(v, -EINVAL);
