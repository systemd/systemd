...
_public_ sd_event *sd_event_source_get_event(const sd_event_source *s) {
        assert_return(s, NULL);

        return s->event;
}

_public_ int sd_event_source_get_pending(const sd_event_source *s) {
        assert_return(s, -EINVAL);
...
_public_ int sd_event_source_get_io_revents(const sd_event_source *s, uint32_t* revents) {
        assert_return(s, -EINVAL);
...
_public_ int sd_event_source_get_enabled(const sd_event_source *s, int *m) {
        assert_return(s, -EINVAL);
...
_public_ int sd_event_get_state(const sd_event *e) {
        assert_return(e, -EINVAL);
        assert_return(!event_pid_changed(e), -ECHILD);
...
_public_ int sd_event_now(const sd_event *e, clockid_t clock, uint64_t *usec) {
        assert_return(e, -EINVAL);
        assert_return(usec, -EINVAL);
        assert_return(!event_pid_changed(e), -ECHILD);
