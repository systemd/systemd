...
int device_enumerator_add_match_sysname(sd_device_enumerator *enumerator, const char *sysname, bool match) {
        int r;
...
static bool match_sysname(sd_device_enumerator *enumerator, const char *sysname) {
        ...
        return set_fnmatch2(enumerator->match_sysname, enumerator->nomatch_sysname, sysname);
}
...
static bool match_subsystem(sd_device_enumerator *enumerator, const char *subsystem) {
        ...
        return set_fnmatch2(enumerator->match_subsystem, enumerator->nomatch_subsystem, subsystem);
}
