...
int device_clone_with_db(sd_device *device, sd_device **ret) {
        ...
        /* The device may be already removed. Let's copy minimal set of information that obtained through
         * netlink socket. */
        ...
        /* Seal device to prevent reading the uevent file, as the device may be already removed. */
        dest->sealed = true;
