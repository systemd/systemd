...
static int device_shall_ignore_diskseq(sd_device *device) {
        ...
        /* ENOENT means one of the two following cases: a) the device is not initialized yet and diskseq
         * support should remain disabled or b) the property is not defined and diskseq should not be ignored
