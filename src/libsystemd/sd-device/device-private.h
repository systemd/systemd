...
static inline int device_get_sysattr_safe_string(sd_device *device, const char *sysattr, const char **ret) {
        return device_get_sysattr_safe_string_full(device, NULL, sysattr, ret);
}
