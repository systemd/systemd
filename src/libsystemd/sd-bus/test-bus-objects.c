...
static int emit_interfaces_added(sd_bus_message *m, void *userdata, sd_bus_error *error) {
        ...
        assert_se(sd_bus_emit_interfaces_added(sd_bus_message_get_bus(m), "/value/a", "org.freedesktop.systemd.ValueTest", NULL) >= 0);
...
static int emit_interfaces_removed(sd_bus_message *m, void *userdata, sd_bus_error *error) {
        ...
        assert_se(sd_bus_emit_interfaces_removed(sd_bus_message_get_bus(m), "/value/a", "org.freedesktop.systemd.ValueTest", NULL) >= 0);
...
static int emit_object_removed(sd_bus_message *m, void *userdata, sd_bus_error *error) {
        ...
        assert_se(sd_bus_emit_object_removed(sd_bus_message_get_bus(m), "/value/a") >= 0);
