...
int sd_bus_reply(sd_bus_message *call, sd_bus_message *reply) {
        ...
        bool is_reply = reply->header->type == SD_BUS_MESSAGE_METHOD_RETURN ||
                reply->header->type == SD_BUS_MESSAGE_METHOD_ERROR;
        assert_return(is_reply, -EINVAL);
