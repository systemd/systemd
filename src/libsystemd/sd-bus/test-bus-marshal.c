...
static void test_bus_fds_truncated(void) {
        ...
        assert_se(blob_copy);
        r = bus_message_from_malloc(bus, blob_copy, blob_size, fds, 2, /* got_ctrunc= */ false, NULL, &m);
        assert_se(r >= 0);
        ...
        assert_se(blob_copy);
        r = bus_message_from_malloc(bus, blob_copy, blob_size, fds, 1, /* got_ctrunc= */ false, NULL, &m);
        assert_se(r == -EBADMSG);
        free(blob_copy);
        close(fds[0]);
        fds = mfree(fds);
        ...
        blob_copy = memdup(blob, blob_size);
        assert_se(blob_copy);
        r = bus_message_from_malloc(bus, blob_copy, blob_size, fds, 1, /* got_ctrunc= */ true, NULL, &m);
        assert_se(r >= 0);
        ...
        blob_copy = memdup(blob, blob_size);
        assert_se(blob_copy);
        r = bus_message_from_malloc(bus, blob_copy, blob_size, fds, 3, /* got_ctrunc= */ true, NULL, &m);
        assert_se(r == -EBADMSG);
        free(blob_copy);
        close(fds[0]);
        close(fds[1]);
        ...
        blob_copy = memdup(blob, blob_size);
        assert_se(blob_copy);
        r = bus_message_from_malloc(bus, blob_copy, blob_size, NULL, 0, /* got_ctrunc= */ true, NULL, &m);
        assert_se(r >= 0);
