...
static int prop_get(sd_bus *bus,
                    const char *path,
...
static int prop_set(sd_bus *bus,
                    const char *path,
                    const char *interface,
                    const char *property,
                    sd_bus_message *reply,
...
static const sd_bus_vtable vtable[] = {
        ...
        SD_BUS_METHOD(
                "DeprecatedHelloNoReply", "", "", NULL, SD_BUS_VTABLE_DEPRECATED | SD_BUS_VTABLE_METHOD_NO_REPLY),
        ...
        SD_BUS_PROPERTY(
                "Constant", "t", prop_get, 0, SD_BUS_VTABLE_PROPERTY_CONST | SD_BUS_VTABLE_PROPERTY_EXPLICIT),
        SD_BUS_VTABLE_END
};
