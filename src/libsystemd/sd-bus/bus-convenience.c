...
_public_ int sd_bus_message_send(sd_bus_message *reply) {
        ...
        assert_return(!sd_bus_origin_id_changed(reply->bus), -ECHILD);
...
_public_ int sd_bus_emit_signal_tov(
        ...
        assert_return(!sd_bus_origin_id_changed(bus), -ECHILD);
...
_public_ int sd_bus_call_methodv(
        ...
        bus_assert_return(!sd_bus_origin_id_changed(bus), -ECHILD, error);
...
_public_ int sd_bus_reply_method_returnv(
        ...
        assert_return(!sd_bus_origin_id_changed(call->bus), -ECHILD);
