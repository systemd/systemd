...
#define resolve_getaddrinfo(resolve, ret_query, node, service, hints, callback, destroy_callback, userdata) \
        ({                                                                                                  \
                int (*_callback_)(                                                                          \
                        sd_resolve_query *, int, const struct addrinfo *, typeof(userdata)) = callback;     \
                void (*_destroy_)(typeof(userdata)) = destroy_callback;                                     \
                resolve_getaddrinfo_with_destroy_callback(resolve,                                          \
                                                          ret_query,                                        \
                                                          node,                                             \
                                                          service,                                          \
                                                          hints,                                            \
...
#define resolve_getnameinfo(resolve, ret_query, sa, salen, flags, get, callback, destroy_callback, userdata) \
        ({                                                                                                   \
                int (*_callback_)(                                                                           \
                        sd_resolve_query *, int, const char *, const char *, typeof(userdata)) = callback;   \
                void (*_destroy_)(typeof(userdata)) = destroy_callback;                                      \
                resolve_getaddrinfo_with_destroy_callback(resolve,                                           \
                                                          ret_query,                                         \
                                                          sa,                                                \
