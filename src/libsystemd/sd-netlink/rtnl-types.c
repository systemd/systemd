...
/* and this is for sit. */
static const NLType rtnl_link_info_data_iptun_sit_types[] = {
        [IFLA_IPTUN_LINK]                = { .type = NETLINK_TYPE_U32 },
        [IFLA_IPTUN_LOCAL]               = { .type = NETLINK_TYPE_IN_ADDR, .size = sizeof(struct in_addr) },
        [IFLA_IPTUN_REMOTE]              = { .type = NETLINK_TYPE_IN_ADDR, .size = sizeof(struct in_addr) },
        [IFLA_IPTUN_TTL]                 = { .type = NETLINK_TYPE_U8 },
        [IFLA_IPTUN_TOS]                 = { .type = NETLINK_TYPE_U8 },
        [IFLA_IPTUN_FLAGS]               = { .type = NETLINK_TYPE_U16 },
        [IFLA_IPTUN_PROTO]               = { .type = NETLINK_TYPE_U8 },
        [IFLA_IPTUN_PMTUDISC]            = { .type = NETLINK_TYPE_U8 },
        [IFLA_IPTUN_6RD_PREFIX]          = { .type = NETLINK_TYPE_IN_ADDR, .size = sizeof(struct in6_addr) },
...
static const NLTypeSystem rtnl_link_info_data_macvlan_type_system;
...
static const NLType rtnl_link_info_data_macvlan_types[] = {
        ...
        [IFLA_MACVLAN_MACADDR_DATA]      = { .type = NETLINK_TYPE_NESTED, .type_system = &rtnl_link_info_data_macvlan_type_system },
...
DEFINE_TYPE_SYSTEM(rtnl_link_info_data_macvlan);
...
static const NLTypeSystemUnionElement rtnl_link_info_data_type_systems[] = {
        ...
        { .name = "sit",       .type_system = TYPE_SYSTEM_FROM_TYPE(rtnl_link_info_data_iptun_sit), },
...
static const NLTypeSystemUnion rtnl_link_info_slave_data_type_system_union = {
        .count = ELEMENTSOF(rtnl_link_info_slave_data_type_systems),
        .elements = rtnl_link_info_slave_data_type_systems,
        .match_type = NL_MATCH_SIBLING,
        .match_attribute = IFLA_INFO_SLAVE_KIND,
};
...
static const NLType rtnl_link_info_types[] = {
        ...
        /* TODO: Currently IFLA_INFO_XSTATS is used by only can devices. When multiple devices use this
         * attribute in the future, then convert it to NETLINK_TYPE_UNION. */
...
/*
        Kernel does not use these attributes anymore.
        [IFLA_COST]                = {},
        [IFLA_PRIORITY]            = {},
*/
