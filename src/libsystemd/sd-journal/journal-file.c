...
static int journal_file_init_header(JournalFile *f, JournalFileFlags file_flags, JournalFile *template) {
        ...
        seal = FLAGS_SET(file_flags, JOURNAL_SEAL) ? journal_file_fss_load(f) >= 0 : false;
#endif
        ...
        h.incompatible_flags |= htole32(
                ...
                FLAGS_SET(file_flags, JOURNAL_COMPRESS) * HEADER_INCOMPATIBLE_COMPRESSED_ZSTD |
#elif DEFAULT_COMPRESSION == COMPRESSION_LZ4
                FLAGS_SET(file_flags, JOURNAL_COMPRESS) * HEADER_INCOMPATIBLE_COMPRESSED_LZ4 |
#elif DEFAULT_COMPRESSION == COMPRESSION_XZ
                FLAGS_SET(file_flags, JOURNAL_COMPRESS) * HEADER_INCOMPATIBLE_COMPRESSED_XZ |
#endif
