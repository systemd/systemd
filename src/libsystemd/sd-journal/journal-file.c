...
enum {
        TEST_FOUND,         /* The current object pass the test. */
        TEST_LEFT,          /* The current object is in an earlier position, and the requested object that
                             * matches the specified test should exist in a later position. */
        TEST_RIGHT,         /* The current object is in a later position, and the requested object that
                             * matches the specified test should exist in an earlier position. */
