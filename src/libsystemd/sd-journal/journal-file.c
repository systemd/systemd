...
int journal_file_append_entry(
        ...
        r = journal_file_append_entry_internal(f, ts, boot_id, machine_id, xor_hash, items, n_iovec, seqnum, seqnum_id, ret_object, ret_offset);
...
int journal_file_copy_entry(
        ...
        r = journal_file_append_entry_internal(to, &ts, boot_id, &from->header->machine_id, xor_hash, items, n, seqnum, seqnum_id, NULL, NULL);
