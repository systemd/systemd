...
int main(int argc, char *argv[]) {
        ...
        FOREACH_OPTION(c, &state, /* on_error= */ return c)
                ...
                OPTION_LONG("start-offset", "OFFSET",
                        ...
                        r = safe_atou64(state.argument, &start_offset);
                        if (r < 0)
                ...
                OPTION_LONG("iterations", "ITER",
                        ...
                        r = safe_atou64(state.argument, &iterations);
                        if (r < 0)
