...
#  define DEFAULT_OBJECT_COMPRESSED OBJECT_COMPRESSED_ZSTD
#elif DEFAULT_COMPRESSION_LZ4
#  define DEFAULT_OBJECT_COMPRESSED OBJECT_COMPRESSED_LZ4
#elif DEFAULT_COMPRESSION_XZ
#  define DEFAULT_OBJECT_COMPRESSED OBJECT_COMPRESSED_XZ
#else
#  define DEFAULT_OBJECT_COMPRESSED 0
#endif
