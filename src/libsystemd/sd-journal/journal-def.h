...
enum {
        ...
        HEADER_COMPATIBLE_SEALED_CONTINOUS   = 1 << 2,
        HEADER_COMPATIBLE_ANY                = HEADER_COMPATIBLE_SEALED |
                                               HEADER_COMPATIBLE_TAIL_ENTRY_BOOT_ID |
                                               HEADER_COMPATIBLE_SEALED_CONTINOUS,

        HEADER_COMPATIBLE_SUPPORTED          = (HAVE_GCRYPT ? HEADER_COMPATIBLE_SEALED | HEADER_COMPATIBLE_SEALED_CONTINOUS  : 0) |
                                               HEADER_COMPATIBLE_TAIL_ENTRY_BOOT_ID,
};
