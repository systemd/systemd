...
int compress_stream_zstd(int fdf, int fdt, uint64_t max_bytes, size_t *ret_uncompressed_size);
...
#else
static inline int compress_stream(int fdf, int fdt, uint64_t max_size, size_t *ret_uncompressed_size) {
        return -EOPNOTSUPP;
}
