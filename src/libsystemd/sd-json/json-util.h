...
#define JSON_BUILD_PAIR_IN_ADDR_WITH_STRING(name, v, f) _JSON_BUILD_PAIR_IN_ADDR_WITH_STRING, (const char*) { name }, (const union in_addr_union*) { v }, (int) { f }
...
#define JSON_BUILD_PAIR_IN_ADDR_WITH_STRING_NON_NULL(name, v, f) _JSON_BUILD_PAIR_IN_ADDR_WITH_STRING_NON_NULL, (const char*) { name }, (const union in_addr_union*) { v }, (int) { f }
