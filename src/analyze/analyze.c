...
static int verb_unit_runtime_properties(int argc, char *argv[], void *userdata) {
        assert(argc == 2);

        UnitType t = unit_type_from_string(ASSERT_PTR(argv[1]));
        if (t < 0)
                return log_error_errno(t, "Invalid unit type '%s'.", argv[1]);
...
static int help(int argc, char *argv[], void *userdata) {
        ...
        printf("%1$s [OPTIONS...] COMMAND ...\n\n"
               ...
               "  unit-runtime-properties TYPE\n"
               "                             List runtime properties for unit TYPE\n"
...
static int run(int argc, char *argv[]) {
        ...
        static const Verb verbs[] = {
                ...
                { "unit-runtime-properties", 2,   2,        0,           verb_unit_runtime_properties },
                {}
        };
