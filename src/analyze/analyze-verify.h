...
typedef enum ReturnErrorOn {
        RETURN_ERROR_ON_NONE,                             /* Never returns errors */
        ...
        RETURN_ERROR_ON_WARNING_IN_SELECTED_AND_CHILDREN, /* Returns errors when warnings arise in the selected unit or its children dependencies */
