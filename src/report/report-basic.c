...
static const MetricFamily metric_family_table[] = {
        ...
        {
                METRIC_IO_SYSTEMD_BASIC_PREFIX "SMBIOS.sys_vendor",
                "Firmware/hardware identification (sys_vendor field from SMBIOS/DMI)",
                METRIC_FAMILY_TYPE_STRING,
                .generate = smbios_generate,
        },
        SMBIOS_STANDARD_FIELD("product_name"),
        SMBIOS_STANDARD_FIELD("product_version"),
        SMBIOS_STANDARD_FIELD("product_sku"),
        SMBIOS_STANDARD_FIELD("product_family"),
        SMBIOS_STANDARD_FIELD("product_serial"),
        SMBIOS_STANDARD_FIELD("product_uuid"),
        SMBIOS_STANDARD_FIELD("board_vendor"),
        SMBIOS_STANDARD_FIELD("board_name"),
        SMBIOS_STANDARD_FIELD("board_version"),
        SMBIOS_STANDARD_FIELD("board_serial"),
        SMBIOS_STANDARD_FIELD("board_asset_tag"),
        SMBIOS_STANDARD_FIELD("bios_vendor"),
        SMBIOS_STANDARD_FIELD("bios_version"),
        SMBIOS_STANDARD_FIELD("bios_date"),
        SMBIOS_STANDARD_FIELD("chassis_type"),
        SMBIOS_STANDARD_FIELD("chassis_vendor"),
