...
static int reply_report(sd_varlink *link, const Tpm2Report *report, const struct iovec *voucher) {
        ...
        FOREACH_ARRAY(c, report->components, report->n_components) {
                ...
                r = sd_json_variant_append_arraybo(
                                ...
                                JSON_BUILD_PAIR_CONDITION_STRING(c->nv_pcr_name != NULL, "nvpcrName", c->nv_pcr_name),
                                JSON_BUILD_PAIR_VARIANT_NON_NULL("nvPublic", nv_public),
                                JSON_BUILD_PAIR_CONDITION_STRING(c->authenticated_data != NULL, "authenticatedData", c->authenticated_data),
                                SD_JSON_BUILD_PAIR_CONDITION(
                                                IN_SET(c->type, TPM2_REPORT_TYPE_CAPABILITY_TPM_PROPERTY, TPM2_REPORT_TYPE_CAPABILITY_AUTH_POLICY),
                                                "capabilityMoreData", SD_JSON_BUILD_BOOLEAN(c->more_caps)),
                                ...
                                JSON_BUILD_PAIR_CONDITION_STRING(sig_pem != NULL, "signaturePEM", sig_pem));
                if (r < 0)
