...
static int resize_pt(int fd) {
         ...
         * possession of the enlarged backing file. For this it suffices to open the device with libfdisk an
         * immediately writing it again, with no changes. */
        ...
        if (r == 0) {
                log_debug("Not resizign partition table, as there currently is none.");
                return 0;
        }
