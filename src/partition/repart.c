...
static int finalize_private_key(EVP_PKEY **ret_private_key, AskPasswordUserInterface **ret_user_interface) {
        int r;
...
static int run(int argc, char *argv[]) {
        ...
        r = finalize_private_key(&context->private_key, &context->ui);
        if (r < 0)
                return r;
