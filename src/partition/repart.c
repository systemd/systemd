...
static int partition_read_definition(Partition *p, const char *path, const char *const *conf_file_dirs) {
        ...
        ConfigTableItem table[] = {
                ...
                { "Verity"   , "DataBlockSizeBytes", config_parse_block_size,    0, &p->verity_data_block_size },
                { "Verity"   , "HashBlockSizeBytes", config_parse_block_size,    0, &p->verity_hash_block_size },
                {}
        };
        int r;
...
static int partition_format_verity_hash(
        ...
        if (p->verity_data_block_size == UINT64_MAX)
                p->verity_data_block_size = context->sector_size;
        if (p->verity_hash_block_size == UINT64_MAX)
                p->verity_hash_block_size = context->sector_size;
