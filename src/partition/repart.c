...
static int partition_read_definition(Partition *p, const char *path, const char *const *conf_file_dirs) {
        ...
        ConfigTableItem table[] = {
                ...
                { "Verity"   , "VerityDataBlockSize", config_parse_block_size,    0, &p->verity_data_block_size },
                { "Verity"   , "VerityHashBlockSize", config_parse_block_size,    0, &p->verity_hash_block_size },
        };
        int r;
