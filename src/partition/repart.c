                ...
                if (r < 0) {
                        ...
                        if (tfd < 0) {
                                ...
                                r = copy_tree_at(
                                                ...
                                                COPY_REFLINK|COPY_HOLES|COPY_MERGE|COPY_REPLACE|COPY_SIGINT|COPY_HARDLINKS|COPY_ALL_XATTRS|COPY_GRACEFUL_WARN|COPY_TRUNCATE|COPY_FREEZE_DIRECTORY_TIMESTAMPS,
