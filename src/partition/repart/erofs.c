...
int parse_erofs_options(const char* root, const char *path, const char *const *conf_file_dirs, char ***ret_options) {
        ...
        ConfigTableItem erofs_table[] = {
                ...
                { "ErofsOptions", "ForceUseFragments",           config_parse_bool,                        0, &e->fragments         },
                { "ErofsOptions", "ForceDeduplicate",            config_parse_bool,                        0, &e->dedupe            },
                { "ErofsOptions", "ForcePackTail",               config_parse_bool,                        0, &e->ztailpacking      },
                {}
        };
        int r;
