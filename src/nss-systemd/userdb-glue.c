 ...
 * length of all contained strings in len. */
static void nss_count_strv(char **strv, size_t *n, size_t *len) {
...
static size_t nss_deep_copy_strv(char **src, char ***dst, char **buf) {
        char *p = *buf;
        size_t i = 0;
