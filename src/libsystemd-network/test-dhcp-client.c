...
TEST(dhcp_client_setters) {
        ...
        ASSERT_OK(sd_dhcp_client_set_hostname(client, "host"));
        ASSERT_OK(sd_dhcp_client_set_hostname(client, "host.domain"));
        ASSERT_OK(sd_dhcp_client_set_hostname(client, NULL));
