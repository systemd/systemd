...
static int ipv6_only_io_handler(sd_event_source *s, int fd, uint32_t revents, void *userdata) {
        ...
        switch (count) {
        case 1:   /* test case: bfore discover */
...
TEST(ipv6_only_before_discover) {
