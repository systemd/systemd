...
#define log_dhcp_client_errno(client, error, fmt, ...) log_internal(LOG_DEBUG, error, PROJECT_FILE, __LINE__, __func__, elf_build_id_get(__func__), "DHCP CLIENT (0x%x): " fmt, client->xid, ##__VA_ARGS__)
