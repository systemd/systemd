...
DEFINE_TRIVIAL_CLEANUP_FUNC(sd_lldp_tlv_packet*, sd_lldp_tlv_packet_unref);
#define _cleanup_tlv_packet_unref_ _cleanup_(sd_lldp_tlv_packet_unrefp)
...
int lldp_tlv_packet_enter_container_org(tlv_packet *m, const uint8_t *oui, uint8_t subtype);
