...
typedef struct DHCP6VendorOption {
        LIST_FIELDS(struct DHCP6VendorOption, options);
...
struct sd_dhcp6_lease {
        ...
        LIST_HEAD(DHCP6VendorOption, vendor_options);
};
...
DEFINE_TRIVIAL_CLEANUP_FUNC(DHCP6VendorOption*, dhcp6_vendor_sub_option_free);
