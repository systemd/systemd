...
int ndisc_neighbor_parse(sd_ndisc *nd, sd_ndisc_neighbor *na) {
         ...
         * For solicited advertisements, the Target Address field in the Neighbor Solicitation (should be
         * typo of Advertisement) message that prompted this advertisement. For an unsolicited advertisement,
         * the address whose link-layer address has changed. The Target Address MUST NOT be a multicast
         * address.
         *
        ...
        /* TODO: parse SD_NDISC_OPTION_TARGET_LL_ADDRESS option. */
        return 0;
}
