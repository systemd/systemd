...
tlv_packet *sd_lldp_tlv_packet_ref(tlv_packet *m) {
...
tlv_packet *sd_lldp_tlv_packet_unref(tlv_packet *m) {
        tlv_section *s, *n;
...
int lldp_tlv_packet_enter_container_org(tlv_packet *m,
                                        const uint8_t *oui,
                                        uint8_t subtype) {
        tlv_section *s;
...
int sd_lldp_tlv_packet_read_port_vlan_id(tlv_packet *tlv, uint16_t *id) {
        ...
        r = lldp_tlv_packet_enter_container_org(tlv, LLDP_OUI_802_1, LLDP_OUI_SUBTYPE_802_1_PORT_VLAN_ID);
        if (r < 0)
                goto out;
...
int sd_lldp_tlv_packet_read_port_protocol_vlan_id(sd_lldp_tlv_packet *tlv, uint8_t *flags, uint16_t *id) {
        ...
        r = lldp_tlv_packet_enter_container_org(tlv, LLDP_OUI_802_1, LLDP_OUI_SUBTYPE_802_1_PORT_PROTOCOL_VLAN_ID);
        if (r < 0)
                goto out;
...
int sd_lldp_tlv_packet_read_vlan_name(tlv_packet *tlv, uint16_t *vlan_id, char **name, uint16_t *length) {
        ...
        r = lldp_tlv_packet_enter_container_org(tlv, LLDP_OUI_802_1, LLDP_OUI_SUBTYPE_802_1_VLAN_NAME);
        if (r < 0)
                goto out;
...
int sd_lldp_tlv_packet_read_management_vid(tlv_packet *tlv, uint16_t *id) {
        ...
        r = lldp_tlv_packet_enter_container_org(tlv, LLDP_OUI_802_1, LLDP_OUI_SUBTYPE_802_1_MANAGEMENT_VID);
        if (r < 0)
                goto out;
...
int sd_lldp_tlv_packet_read_link_aggregation(sd_lldp_tlv_packet *tlv, uint8_t *status, uint32_t *id) {
        ...
        r = lldp_tlv_packet_enter_container_org(tlv, LLDP_OUI_802_1, LLDP_OUI_SUBTYPE_802_1_LINK_AGGREGATION);
        if (r < 0)
                goto out;
