 ...
 * Default: 600 seconds */
#define SD_RADV_MIN_MAX_TIMEOUT_USEC                 (4 * USEC_PER_SEC)
#define SD_RADV_MAX_MAX_TIMEOUT_USEC                 (1800 * USEC_PER_SEC)
...
#define SD_RADV_MIN_MIN_TIMEOUT_USEC                 (3 * USEC_PER_SEC)
...
#define SD_RADV_MIN_ROUTER_LIFETIME_USEC             SD_RADV_MIN_MAX_TIMEOUT_USEC
#define SD_RADV_MAX_ROUTER_LIFETIME_USEC             (9000 * USEC_PER_SEC)
#define SD_RADV_DEFAULT_ROUTER_LIFETIME_USEC         (3 * SD_RADV_DEFAULT_MAX_TIMEOUT_USEC)
...
#define SD_RADV_DEFAULT_PREFERRED_LIFETIME_USEC      CONST_MAX(SD_RADV_DEFAULT_ROUTER_LIFETIME_USEC, 3 * SD_RADV_DEFAULT_MAX_TIMEOUT_USEC)
#define SD_RADV_DEFAULT_VALID_LIFETIME_USEC          (2 * SD_RADV_DEFAULT_PREFERRED_LIFETIME_USEC)
/* RFC 4861 section 10.
