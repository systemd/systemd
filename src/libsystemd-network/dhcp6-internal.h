...
int dhcp6_option_parse_ia(const sd_dhcp6_client *client, DHCP6Option *iaoption, DHCP6IA *ia, uint16_t *ret_status_code);
...
#define log_dhcp6_client_errno(client, error, fmt, ...)          \
        log_interface_full_errno(sd_dhcp6_client_get_ifname(client), LOG_DEBUG, error, "DHCPv6 client: " fmt, ##__VA_ARGS__)
