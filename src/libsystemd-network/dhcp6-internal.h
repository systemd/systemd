...
#define log_dhcp6_client_errno(p, error, fmt, ...) log_internal(LOG_DEBUG, error, PROJECT_FILE, __LINE__, __func__, elf_build_id_get(__func__), "DHCPv6 CLIENT: " fmt, ##__VA_ARGS__)
