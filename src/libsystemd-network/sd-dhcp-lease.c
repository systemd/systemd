...
static int lease_parse_dnr(const uint8_t *option, size_t len, sd_dns_resolver **ret_dnr, size_t *ret_n_dnr) {
        ...
        CLEANUP_ARRAY(res_list, n_resolvers, sd_dns_resolver_done_many);
        ...
        typesafe_qsort(*ret_dnr, *ret_n_dnr, sd_dns_resolver_prio_compare);

        sd_dns_resolver_done_many(*ret_dnr, *ret_n_dnr);
