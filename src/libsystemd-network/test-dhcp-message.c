...
TEST(dhcp_message) {
        ...
        struct in_addr ntp[4] = {
                (struct in_addr) { .s_addr = htobe32(0xC0000201) },
                (struct in_addr) { .s_addr = htobe32(0xC0000202) },
                (struct in_addr) { .s_addr = htobe32(0xC0000203) },
                (struct in_addr) { .s_addr = htobe32(0xC0000204) },
        };

        /* 192.0.2.17 - 20 */
        struct in_addr sip[4] = {
                (struct in_addr) { .s_addr = htobe32(0xC0000211) },
                (struct in_addr) { .s_addr = htobe32(0xC0000212) },
                (struct in_addr) { .s_addr = htobe32(0xC0000213) },
                (struct in_addr) { .s_addr = htobe32(0xC0000214) },
        };
