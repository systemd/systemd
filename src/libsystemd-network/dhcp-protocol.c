...
static const char * const dhcp_option_code_table[] = {
        ...
        [SD_DHCP_OPTION_HOME_AGENT_ADDRESSES]           = "home agent address",
        ...
        [SD_DHCP_OPTION_MOS_ADDRESS]                    = "MDS address",
        [SD_DHCP_OPTION_MOS_FQDN]                       = "MDS FQDN",
        ...
        [SD_DHCP_OPTION_PRIVATE_PROXY_AUTODISCOVERY]    = "(private) proxy auto discovery",
