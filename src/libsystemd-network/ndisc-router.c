...
int ndisc_router_parse(sd_ndisc *nd, sd_ndisc_router *rt) {
        ...
        rt->lifetime_usec = be16_sec_to_usec(a->nd_ra_router_lifetime);
        rt->icmp6_ratelimit_usec = be32_msec_to_usec(a->nd_ra_retransmit);
...
int sd_ndisc_router_prefix_get_valid_lifetime(sd_ndisc_router *rt, uint64_t *ret) {
        ...
        *ret = be32_sec_to_usec(ri->nd_opt_pi_valid_time);
        return 0;
}
...
int sd_ndisc_router_prefix_get_preferred_lifetime(sd_ndisc_router *rt, uint64_t *ret) {
        ...
        *ret = be32_sec_to_usec(pi->nd_opt_pi_preferred_time);
        return 0;
}
...
int sd_ndisc_router_route_get_lifetime(sd_ndisc_router *rt, uint64_t *ret) {
        ...
        *ret = be32_sec_to_usec(*(uint32_t*) (ri + 4));
        return 0;
}
