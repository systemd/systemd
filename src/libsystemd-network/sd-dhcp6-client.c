...
int sd_dhcp6_client_set_mac(
        ...
        /* Unlike the other setters, it is OK to set new MAC address during the client is running,
...
static void client_stop(sd_dhcp6_client *client, int error) {
        ...
        /* Reset IRT here. Otherwise, we cannot restart the client in information requesting mode,
         * even the lease is freed below. */
...
int sd_dhcp6_client_start(sd_dhcp6_client *client) {
        ...
        /* Even the client in STOPPED state, the lease acquired in the previous information request may stored. */
        client->lease = sd_dhcp6_lease_unref(client->lease);
