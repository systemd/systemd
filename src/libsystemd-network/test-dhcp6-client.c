...
#define VENDOR_SUBOPTION1_BYTES                                         \
        0x01
...
static sd_dhcp6_option vendor_suboption = {
        ...
        .option = 247,
        .data = (void *)VENDOR_SUBOPTION1_BYTES,
        .length = 1,
};
...
static const uint8_t msg_reply[] = {
        ...
        0x00, 0x00, 0x00, 0x20, 0x00, 0xf7, 0x00, 0x01, VENDOR_SUBOPTION1_BYTES,
};
...
static void test_lease_common(sd_dhcp6_client *client) {
        ...
        assert_se(memcmp_nn((*suboption)->data, (*suboption)->length, &vendor_suboption.data, vendor_suboption.length) == 0);
}
