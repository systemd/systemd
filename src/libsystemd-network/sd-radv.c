...
int sd_radv_pref64_prefix_set_prefix(
        ...
        uint16_t plc = DIV_ROUND_UP(valid_lifetime * 7, UINT16_MAX);
        uint32_t m1 = 0x00000000, m2 = 0x00000000;
        ...
        p->opt.lifetime_prefixlen = htobe16((0xfff8 & plc) | (0x7 & prefixlen_code));
