...
#define MONITOR_VARLINK_XATTR_NAME "user.varlink"
#define MONITOR_VARLINK_MAX_PACKETS 8U
#define MONITOR_VARLINK_RINGBUF_SIZE (256U * 1024U)
#define MONITOR_VARLINK_MAX_SOCKETS (128U * 1024U)
#define MONITOR_VARLINK_MAX_SOCKETS_FALLBACK (16U * 1024U)
