...
static int query_and_print_bpf_maps(void) {
        ...
        JSON_VARIANT_ARRAY_FOREACH(i, o) {
                ...
                // _cleanup_free_ const char *map_type = NULL;

                r = json_dispatch(i, dispatch_table, 0, &p);
                if (r < 0)
                ...
                // if (!map_type)
                //         return log_error_errno(r, "Failed to translate bpf_map_type to a valid string: %m");
...
static int query_and_print_bpf_progs(void) {
        ...
        JSON_VARIANT_ARRAY_FOREACH(i, o) {
                static const JsonDispatch dispatch_table[] = {
                        ...
                        { "type",        _JSON_VARIANT_TYPE_INVALID, json_dispatch_uint64, offsetof(struct BpfProgramData, type),        JSON_MANDATORY },
                        { "memlock",     _JSON_VARIANT_TYPE_INVALID, json_dispatch_uint64, offsetof(struct BpfProgramData, memlock),     JSON_MANDATORY },
                        ...
                        { "run_time_ns", _JSON_VARIANT_TYPE_INVALID, json_dispatch_uint64, offsetof(struct BpfProgramData, run_time_ns), JSON_MANDATORY },
                        { "run_count",   _JSON_VARIANT_TYPE_INVALID, json_dispatch_uint64, offsetof(struct BpfProgramData, run_cnt),     JSON_MANDATORY },
                        {}
                };
                _cleanup_(bpf_program_data_done) BpfProgramData p = {};
                // _cleanup_free_ const char *prog_type = NULL;
                ...
                // if (!prog_type)
                //         return log_error_errno(r, "Failed translate bpf_prog_type to a valid string: %m");
