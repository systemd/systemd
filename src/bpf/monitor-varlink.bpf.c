...
static __always_inline __u64 pidfd_ino_from_pid(struct pid *p) {
...
int BPF_PROG(
        ...
        __u64 pidfd_ino = pidfd_ino_from_pid(cur_pid_s);
        ...
        __u64 peer_pidfd_ino = pidfd_ino_from_pid(peer_pid_s);
