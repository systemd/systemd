...
VERB_NOARG_SCOPE(verb_remove, "remove",,
           "Remove systemd-boot from the ESP and EFI variables");

VERB_NOARG_SCOPE(verb_is_installed, "is-installed",,
           "Test whether systemd-boot is installed in the ESP");

VERB_NOARG_SCOPE(verb_random_seed, "random-seed",,
...
static int parse_argv(int argc, char *argv[], char ***ret_args) {
        ...
        FOREACH_OPTION(&state, c, &arg, /* on_error= */ return c)
                ...
                OPTION_SHORT('R', NULL,
                             ...
                             " (return e.g. /dev/nvme0n1p5)"): {}
                OPTION_LONG_FLAGS(OPTION_HELP_ENTRY_VERBATIM, "-RR", NULL,
                ...
                OPTION_LONG("make-entry-directory", "BOOL", "Create $BOOT/ENTRY-TOKEN/ directory"): {}
                ...
                OPTION_LONG("certificate", "PATH", "PEM certificate for Secure Boot auto-enrollment"):
                ...
                OPTION_LONG("certificate-source", "SOURCE",
                            "Specify how to interpret the certificate (file|provider:PROVIDER)"):
