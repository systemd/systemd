...
static int parse_argv(int argc, char *argv[]) {
        ...
        FOREACH_OPTION(c, &opts, /* on_error= */ return c)
                ...
                OPTION_LONG("list-devices", NULL,
                        ...
                        r = blockdev_list(BLOCKDEV_LIST_REQUIRE_PARTITION_SCANNING|BLOCKDEV_LIST_SHOW_SYMLINKS|BLOCKDEV_LIST_IGNORE_ZRAM|BLOCKDEV_LIST_IGNORE_READ_ONLY, /* ret_devices= */ NULL, /* ret_n_devices= */ NULL);
                        if (r < 0)
                                return r;
