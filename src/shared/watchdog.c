...
static unsigned usec_to_sec(usec_t val) {
...
static int update_pretimeout(void) {
        ...
        if (watchdog_pretimeout == USEC_INFINITY || watchdog_timeout == USEC_INFINITY)
                ...
                unsigned t_sec = usec_to_sec(watchdog_timeout);
                unsigned pt_sec = usec_to_sec(watchdog_pretimeout);
                ...
                unsigned sec = usec_to_sec(watchdog_pretimeout);
