...
int release_file_validate(
        ...
        const char *syscfg_or_sysext_level = (image_class == IMAGE_SYSCFG) ? "SYSCFG_LEVEL" : "SYSEXT_LEVEL";
        const char *syscfg_or_sysext_scope = (image_class == IMAGE_SYSCFG) ? "SYSCFG_SCOPE" : "SYSEXT_SCOPE";
