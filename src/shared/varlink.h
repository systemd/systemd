...
int varlink_call_and_log(Varlink *v, const char *method, JsonVariant *parameters, JsonVariant **ret_parameters, const char **ret_error_id);
...
int varlink_callb_and_log(Varlink *v, const char *method, JsonVariant **ret_parameters, const char **ret_error_id, ...);
