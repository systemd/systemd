...
#define varlink_sendbo(v, method, ...) varlink_sendb((v), (method), SD_JSON_BUILD_OBJECT(__VA_ARGS__))
...
#define varlink_callbo_full(v, method, ret_parameters, ret_error_id, ret_flags, ...) varlink_callb_full((v), (method), (ret_parameters), (ret_error_id), (ret_flags), SD_JSON_BUILD_OBJECT(__VA_ARGS__))
...
#define varlink_callbo(v, method, ret_parameters, ret_error_id, ...) varlink_callb((v), (method), (ret_parameters), (ret_error_id), SD_JSON_BUILD_OBJECT(__VA_ARGS__))
int varlink_callb_and_log(Varlink *v, const char *method, sd_json_variant **ret_parameters, ...);
#define varlink_callbo_and_log(v, method, ret_parameters, ...) varlink_callb_and_log((v), (method), (ret_parameters), SD_JSON_BUILD_OBJECT(__VA_ARGS__))
...
#define varlink_collectbo(v, method, ret_parameters, ret_error_id, ...) varlink_collectb((v), (method), (ret_parameters), (ret_error_id), SD_JSON_BUILD_OBJECT(__VA_ARGS__))
...
#define varlink_invokebo(v, method, ...) varlink_invokeb((v), (method), SD_JSON_BUILD_OBJECT(__VA_ARGS__))
...
#define varlink_observebo(v, method, ...) varlink_observeb((v), (method), SD_JSON_BUILD_OBJECT(__VA_ARGS__))

/* Enqueue a final reply */
int varlink_reply(Varlink *v, sd_json_variant *parameters);
int varlink_replyb(Varlink *v, ...);
#define varlink_replybo(v, ...) varlink_replyb((v), SD_JSON_BUILD_OBJECT(__VA_ARGS__))
...
#define varlink_errorbo(v, error_id, ...) varlink_errorb((v), (error_id), SD_JSON_BUILD_OBJECT(__VA_ARGS__))
...
#define varlink_notifybo(v, ...) varlink_notifyb((v), SD_JSON_BUILD_OBJECT(__VA_ARGS__))
