...
const GptPartitionType gpt_partition_type_table[] = {
        ...
        { GPT_ROOT_ARM64,                  "root-arm64"                  },
        { GPT_ROOT_ARM64_VERITY,           "root-arm64-verity"           },
        { GPT_ROOT_ARM64_VERITY_SIG,       "root-arm64-verity-sig"       },
        ...
        { GPT_USR_ARM64,                   "usr-arm64"                   },
        { GPT_USR_ARM64_VERITY,            "usr-arm64-verity"            },
        { GPT_USR_ARM64_VERITY_SIG,        "usr-arm64-verity-sig"        },
