                ...
                for (size_t i = mstack->n_mounts; i > 0; i--) {
                        ...
                        case MSTACK_RW: {
                                if (mount_is_ro(m, flags)) {
                                        ...
                                        if (r < 0) {
                                                log_error_errno(r, "Failed to set mount layer lowerdir+=%s/data: %m", m->what);
                                        ...
                                        if (r < 0) {
                                                log_error_errno(r, "Failed to set mount layer upperdir=%s/data: %m", m->what);
                                                report_errno_and_exit(errno_pipe_fds[1], r);
                                        }
                                        ...
                                        if (r < 0) {
                                                log_error_errno(r, "Failed to set mount layer workdir=%s/work: %m", m->what);
                                                report_errno_and_exit(errno_pipe_fds[1], r);
                                        }
                        ...
                        case MSTACK_LAYER:
                                ...
                                if (r < 0) {
                                        log_error_errno(r, "Failed to set mount layer lowerdir+=%s: %m", m->what);
                                        report_errno_and_exit(errno_pipe_fds[1], r);
                                }
