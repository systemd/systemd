...
static int voa_collect(
        ...
        FOREACH_ARRAY(i, de->entries, de->n_entries) {
                ...
                /* The VOA spec mandates that verifiers may not point outside of the hierarchy. So ignore them. */
 ...
 * Adhere to merging semantics, meaning every copy of a verifiers counts and a verifiers masked in any load
 * path is treated as masked in all of them.
 *
