...
static SD_VARLINK_DEFINE_STRUCT_TYPE(
                ...
                SD_VARLINK_DEFINE_FIELD(TableString, SD_VARLINK_STRING, 0),
                ...
                SD_VARLINK_DEFINE_FIELD(IncomingInterface, SD_VARLINK_STRING, 0),
                SD_VARLINK_DEFINE_FIELD(OutgoingInterface, SD_VARLINK_STRING, 0),
...
static SD_VARLINK_DEFINE_STRUCT_TYPE(
                ...
                SD_VARLINK_DEFINE_FIELD(LifetimeUSec, SD_VARLINK_INT, 0),
                SD_VARLINK_DEFINE_FIELD(ConfigProvider, SD_VARLINK_INT, SD_VARLINK_ARRAY|SD_VARLINK_NULLABLE));
