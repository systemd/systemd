...
SD_VARLINK_DEFINE_STRUCT_TYPE(
                ...
                SD_VARLINK_FIELD_COMMENT("OVS port type: internal, patch, or bond (if this is an OVS port)"),
                ...
                SD_VARLINK_FIELD_COMMENT("OVS port member interface names (if this is an OVS bridge or bond port)"),
