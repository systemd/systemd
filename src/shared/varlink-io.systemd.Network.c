...
static SD_VARLINK_DEFINE_STRUCT_TYPE(
                ...
                SD_VARLINK_FIELD_COMMENT("VLAN identifier for this port"),
...
static SD_VARLINK_DEFINE_STRUCT_TYPE(
                ...
                SD_VARLINK_FIELD_COMMENT("NTP server hostname or FQDN"),
...
static SD_VARLINK_DEFINE_STRUCT_TYPE(
                ...
                SD_VARLINK_FIELD_COMMENT("Maximum Transmission Unit in bytes"),
                ...
                SD_VARLINK_DEFINE_FIELD(AdministrativeState, SD_VARLINK_STRING, 0),
                ...
                SD_VARLINK_DEFINE_FIELD(AddressState, SD_VARLINK_STRING, 0),
                SD_VARLINK_FIELD_COMMENT("IPv4 address configuration state"),
                SD_VARLINK_DEFINE_FIELD(IPv4AddressState, SD_VARLINK_STRING, 0),
                SD_VARLINK_FIELD_COMMENT("IPv6 address configuration state"),
                SD_VARLINK_DEFINE_FIELD(IPv6AddressState, SD_VARLINK_STRING, 0),
                ...
                /* DNR Addresses fied (json array or arrays) is incompatible with Varlink type system */
                ...
                /* DHCPv4Client has 6rdPrefix field that is incompatible with Varlink naming */
