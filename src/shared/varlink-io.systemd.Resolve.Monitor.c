...
static SD_VARLINK_DEFINE_STRUCT_TYPE(
                ...
                SD_VARLINK_FIELD_COMMENT("DNS protocol used to communicate with the server, one of \"dns\" or \"https\"."),
                SD_VARLINK_DEFINE_FIELD(Protocol, SD_VARLINK_STRING, SD_VARLINK_NULLABLE),
                SD_VARLINK_FIELD_COMMENT("Normalized DNS-over-HTTPS request URI, when the transport is HTTPS."),
                ...
                SD_VARLINK_DEFINE_FIELD(VerifiedTransport, SD_VARLINK_STRING, 0),
                SD_VARLINK_DEFINE_FIELD(PossibleTransport, SD_VARLINK_STRING, 0),
                SD_VARLINK_DEFINE_FIELD(VerifiedCapabilityLevel, SD_VARLINK_STRING, 0),
                SD_VARLINK_DEFINE_FIELD(PossibleCapabilityLevel, SD_VARLINK_STRING, 0),
