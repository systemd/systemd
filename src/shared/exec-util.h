...
int _fork_agent(const char *name, const int except[], size_t n_except, pid_t *ret_pid, char **argv);
#define fork_agent(name, except, n_except, ret_pid, ...) _fork_agent(name, except, n_except, ret_pid, STRV_MAKE(__VA_ARGS__))
