...
static SD_VARLINK_DEFINE_STRUCT_TYPE(
                MetricValue,
                SD_VARLINK_FIELD_COMMENT("A string value type"),
                SD_VARLINK_DEFINE_FIELD(string, SD_VARLINK_STRING, SD_VARLINK_NULLABLE),
                SD_VARLINK_FIELD_COMMENT("A int value type"),
                SD_VARLINK_DEFINE_FIELD(int, SD_VARLINK_INT, SD_VARLINK_NULLABLE),
                SD_VARLINK_FIELD_COMMENT("A boolean value type"),
                SD_VARLINK_DEFINE_FIELD(bool, SD_VARLINK_BOOL, SD_VARLINK_NULLABLE));
...
static SD_VARLINK_DEFINE_METHOD_FULL(
                ...
                SD_VARLINK_FIELD_COMMENT(
                                "Metric name, e.g. io.systemd.Manager.units_by_type_total or io.systemd.Manager.unit_active_state"),
                ...
                SD_VARLINK_DEFINE_OUTPUT_BY_TYPE(value, MetricValue, SD_VARLINK_NULLABLE),
                SD_VARLINK_FIELD_COMMENT(
                                "Metric object name can be unit name, process name, etc, e.g. dev-hvc0.device"),
                SD_VARLINK_DEFINE_OUTPUT(object, SD_VARLINK_STRING, SD_VARLINK_NULLABLE),
                SD_VARLINK_FIELD_COMMENT(
                                "Metric fields are values to deferentiate between different metrics in the same metric family"),
...
SD_VARLINK_DEFINE_INTERFACE(
                ...
                SD_VARLINK_SYMBOL_COMMENT(
                                "Method to get a list of metrics among which the collection of related metrics forms a metric family"),
                &vl_type_MetricValue,
                SD_VARLINK_SYMBOL_COMMENT(
