...
static SD_VARLINK_DEFINE_METHOD(
                ...
                SD_VARLINK_FIELD_COMMENT("Returns an index into the array of file descriptors associated with this reply. This may be used to get the file descriptor of the volume. Must be an opened file descriptor, not an O_PATH."),
...
SD_VARLINK_DEFINE_INTERFACE(
                ...
                SD_VARLINK_SYMBOL_COMMENT("The specified request as storage volume type is inappropriate for the specified volume."),
                &vl_error_InvalidRequestAs,
                SD_VARLINK_SYMBOL_COMMENT("This backend does not support storage volume creation."),
