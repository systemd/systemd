...
static int sync_departing_file_systems(const char *new_root) {
        ...
        for (;;) {
                ...
                /* Anything strictly below new_root remains mounted and reachable after the switch as part
                 * of its subtree, hence doesn't need to be synced out defensively here. */
