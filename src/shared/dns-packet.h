...
/* RFC 1035 §4.1.4 compression pointers carry 14 bits of offset: only names starting below this
 * bound can ever be referenced by one. */
#define DNS_PACKET_COMPRESSION_OFFSET_MAX 0x4000u
