...
int luo_serialization_add_shutdown_timestamps(sd_json_variant **serialization, const dual_timestamp *shutdown_binary_start, const dual_timestamp *shutdown_binary_finish);
