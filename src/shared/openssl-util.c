...
int rsa_oaep_encrypt_bytes(
        ...
        /* Handle label: empty string → NULL, non-empty → duplicate and transfer ownership.
         * This supports both PKCS#11 enrollment (empty label) and TPM2 (label="DUPLICATE"). */
        ...
        if (label_len > 0) {
                ...
                if (EVP_PKEY_CTX_set0_rsa_oaep_label(ctx, TAKE_PTR(duplabel), label_len) <= 0)
