...
int rsa_oaep_encrypt_bytes(
        ...
        /* EVP_PKEY_CTX_set0_rsa_oaep_label takes ownership, use TAKE_PTR to prevent cleanup */
        if (EVP_PKEY_CTX_set0_rsa_oaep_label(ctx, TAKE_PTR(duplabel), strlen(label)) <= 0)
