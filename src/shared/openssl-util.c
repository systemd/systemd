        ...
        if (private_key_source_type == OPENSSL_KEY_SOURCE_FILE) {
                ...
                *ret_user_interface = NULL;
                ...
                case OPENSSL_KEY_SOURCE_ENGINE:
                        r = load_key_from_engine(private_key_source, private_key, ui->method, ret_private_key);
                        break;
                case OPENSSL_KEY_SOURCE_PROVIDER:
                        r = load_key_from_provider(private_key_source, private_key, ui->method, ret_private_key);
                        break;
                default:
                        assert_not_reached();
                }
