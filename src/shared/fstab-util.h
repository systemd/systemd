...
static inline int fstab_is_mount_point(const char *where) {
        return fstab_is_mount_point_full(where, /* path= */ NULL);
}
static inline int fstab_has_node(const char *path) {
        return fstab_is_mount_point_full(/* where= */ NULL, path);
}
...
static inline bool fstab_test_option(const char *opts, const char *names) {
        return fstab_filter_options(opts, names, /* ret_namefound= */ NULL, /* ret_value= */ NULL, /* ret_values= */ NULL, /* ret_filtered= */ NULL);
}
static inline bool fstab_test_yes_no_option(const char *opts, const char *yes_no) {
        ...
        assert_se(fstab_filter_options(opts, yes_no, &opt_found, /* ret_value= */ NULL, /* ret_values= */ NULL, /* ret_filtered= */ NULL) >= 0);
