...
static int get_os_indications(uint64_t *ret) {
        ...
        _cleanup_free_ void *v = NULL;
        static uint64_t cache = 0; /* avoid false maybe-uninitialized warning */
...
int efi_get_reboot_to_firmware(void) {
        int r;
        uint64_t b = 0; /* avoid false maybe-uninitialized warning */
...
int efi_set_reboot_to_firmware(bool value) {
        int r;
        uint64_t b = 0, b_new; /* avoid false maybe-uninitialized warning */
