...
int block_device_new_from_fd(int fd, BlockDeviceFlag flag, sd_device **ret);
int block_device_new_from_path(const char *path, BlockDeviceFlag flag, sd_device **ret);
