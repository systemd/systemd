...
static SD_VARLINK_DEFINE_STRUCT_TYPE(
                ...
                SD_VARLINK_FIELD_COMMENT("Indicates whether this partition is marked for writable (non-read-only) operation."),
                ...
                SD_VARLINK_FIELD_COMMENT("Indicates the numeric partition number of for this partition, or null if the image does not carry a partition table, and this PartitionInfo object covers the whole block device."),
...
SD_VARLINK_DEFINE_INTERFACE(
                ...
                SD_VARLINK_SYMBOL_COMMENT("The specified image policy disallows mounting of this disk image"),
