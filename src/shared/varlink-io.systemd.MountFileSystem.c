...
static SD_VARLINK_DEFINE_METHOD(
                ...
                SD_VARLINK_FIELD_COMMENT("The expected dm-verity root hash, if the image is a bare filesystem rather than a DDI."),
                SD_VARLINK_DEFINE_INPUT(verityRootHash, SD_VARLINK_INT, SD_VARLINK_NULLABLE|SD_VARLINK_ARRAY),
                SD_VARLINK_FIELD_COMMENT("The expected signature for the dm-verity root hash, if the image is a bare filesystem rather than a DDI."),
                SD_VARLINK_DEFINE_INPUT(verityRootHashSignature, SD_VARLINK_INT, SD_VARLINK_NULLABLE|SD_VARLINK_ARRAY),
