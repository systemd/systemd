...
int ask_password_tty(
        ...
        if (FLAGS_SET(flags, ASK_PASSWORD_SHOW_EMOJI) && emoji_enabled())
...
int ask_password_agent(
        ...
        fprintf(f,
                ...
                getpid_cached(),
                socket_name,
                FLAGS_SET(flags, ASK_PASSWORD_ACCEPT_CACHED) ? 1 : 0,
                FLAGS_SET(flags, ASK_PASSWORD_ECHO) ? 1 : 0,
                until,
                FLAGS_SET(flags, ASK_PASSWORD_SILENT) ? 1 : 0);
