...
int mstack_apply(const char *dir, int dir_fd, const char *where, const ImagePolicy *image_policy, const ImageFilter *image_file, MStackFlags flags, int *ret_root_fd);
