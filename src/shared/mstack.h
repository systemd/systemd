...
#include "forward.h"
/* Not forward-declarable: MStack stores a RemountIdmapping by value, so the enum has to be
 * complete here. VolatileMode only appears in a prototype below and is forward-declared in
 * forward.h instead, per docs/CODING_STYLE.md. */
