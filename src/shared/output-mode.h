...
/* The output flags definitions are shared by the logs and process tree output. Some apply to both, some only
 * to the logs output, others only to the process tree output. */
