...
static SD_VARLINK_DEFINE_METHOD(
                ...
                SD_VARLINK_DEFINE_INPUT(varlinkAddress,          SD_VARLINK_STRING, SD_VARLINK_NULLABLE),
...
static SD_VARLINK_DEFINE_METHOD_FULL(
                ...
                SD_VARLINK_FIELD_COMMENT("Varlink socket address for direct VM control"),
                SD_VARLINK_DEFINE_OUTPUT(varlinkAddress, SD_VARLINK_STRING, SD_VARLINK_NULLABLE),
