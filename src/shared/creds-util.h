...
#define CRED_KEY_IS_VALID(key) sd_id128_in_set((key), CRED_AES256_GCM_BY_HOST, CRED_AES256_GCM_BY_HOST_SCOPED, CRED_AES256_GCM_BY_TPM2_HMAC, CRED_AES256_GCM_BY_TPM2_HMAC_WITH_PK, CRED_AES256_GCM_BY_HOST_AND_TPM2_HMAC, CRED_AES256_GCM_BY_HOST_AND_TPM2_HMAC_SCOPED, CRED_AES256_GCM_BY_HOST_AND_TPM2_HMAC_WITH_PK, CRED_AES256_GCM_BY_HOST_AND_TPM2_HMAC_WITH_PK_SCOPED, CRED_AES256_GCM_BY_NULL)
#define CRED_KEY_IS_AUTO(key) sd_id128_in_set((key), _CRED_AUTO, _CRED_AUTO_TPM2, _CRED_AUTO_HOST_AND_TPM2, _CRED_AUTO_INITRD, _CRED_AUTO_SCOPED)
#define CRED_KEY_IS_SCOPED(key) sd_id128_in_set((key), _CRED_AUTO_SCOPED, CRED_AES256_GCM_BY_HOST_SCOPED, CRED_AES256_GCM_BY_HOST_AND_TPM2_HMAC_SCOPED, CRED_AES256_GCM_BY_HOST_AND_TPM2_HMAC_WITH_PK_SCOPED)
#define CRED_KEY_REQUIRES_HOST(key) sd_id128_in_set((key), _CRED_AUTO_HOST_AND_TPM2, CRED_AES256_GCM_BY_HOST, CRED_AES256_GCM_BY_HOST_SCOPED, CRED_AES256_GCM_BY_HOST_AND_TPM2_HMAC, CRED_AES256_GCM_BY_HOST_AND_TPM2_HMAC_SCOPED, CRED_AES256_GCM_BY_HOST_AND_TPM2_HMAC_WITH_PK, CRED_AES256_GCM_BY_HOST_AND_TPM2_HMAC_WITH_PK_SCOPED)
#define CRED_KEY_WANTS_HOST(key) sd_id128_in_set((key), _CRED_AUTO, _CRED_AUTO_SCOPED)
#define CRED_KEY_REQUIRES_TPM2(key) sd_id128_in_set((key), _CRED_AUTO_TPM2, _CRED_AUTO_HOST_AND_TPM2, CRED_AES256_GCM_BY_TPM2_HMAC, CRED_AES256_GCM_BY_TPM2_HMAC_WITH_PK, CRED_AES256_GCM_BY_HOST_AND_TPM2_HMAC, CRED_AES256_GCM_BY_HOST_AND_TPM2_HMAC_SCOPED, CRED_AES256_GCM_BY_HOST_AND_TPM2_HMAC_WITH_PK, CRED_AES256_GCM_BY_HOST_AND_TPM2_HMAC_WITH_PK_SCOPED)
#define CRED_KEY_WANTS_TPM2(key) sd_id128_in_set((key), _CRED_AUTO, _CRED_AUTO_INITRD, _CRED_AUTO_SCOPED)
#define CRED_KEY_REQUIRES_TPM2_PK(key) sd_id128_in_set((key), CRED_AES256_GCM_BY_TPM2_HMAC_WITH_PK, CRED_AES256_GCM_BY_HOST_AND_TPM2_HMAC_WITH_PK, CRED_AES256_GCM_BY_HOST_AND_TPM2_HMAC_WITH_PK_SCOPED)
#define CRED_KEY_WANTS_TPM2_PK(key) sd_id128_in_set((key), _CRED_AUTO, _CRED_AUTO_TPM2, _CRED_AUTO_HOST_AND_TPM2, _CRED_AUTO_INITRD, _CRED_AUTO_SCOPED)
