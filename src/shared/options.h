...
#define introspect_options_and_dummy_verbs(flags)                       \
        (dump_introspection_header(flags) ?:                            \
         introspect_options(flags) ?:                                   \
         introspect_verbs_dummy())

#define introspect_options_and_verbs(flags)                             \
        (dump_introspection_header(flags) ?:                            \
         introspect_options(flags) ?:                                   \
         introspect_verbs(flags))
