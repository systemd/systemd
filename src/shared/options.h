...
typedef struct OptionParser {
        ...
        /* Those two variables encompass the state of the last option_parse() call: */
        const Option *current;        /* … the matched option or NULL */
        const char *argument;         /* … the argument or NULL */
} OptionParser;
