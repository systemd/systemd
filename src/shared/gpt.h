...
#define GPT_ROOT_POWERPC64   SD_ID128_MAKE(91,2a,de,1d,a8,39,49,13,89,64,a1,0e,ee,08,fb,d2)
#define GPT_ROOT_POWERPC64LE SD_ID128_MAKE(c3,1c,45,e6,3f,39,41,2e,80,fb,48,09,c4,98,05,99)
...
#define GPT_USR_POWERPC64    SD_ID128_MAKE(2c,97,39,e2,f0,68,46,b3,9f,d0,01,c5,a9,af,bc,ca)
#define GPT_USR_POWERPC64LE  SD_ID128_MAKE(15,bb,03,af,77,e7,4d,4a,b1,2b,c0,d0,84,f7,49,1c)
...
#define GPT_ROOT_POWERPC64LE_VERITY SD_ID128_MAKE(90,6b,d9,44,45,89,4a,ae,a4,e4,dd,98,39,17,44,6a)
#define GPT_ROOT_POWERPC64_VERITY   SD_ID128_MAKE(92,25,a9,a3,3c,19,4d,89,b4,f6,ee,ff,88,f1,76,31)
#define GPT_ROOT_POWERPC_VERITY     SD_ID128_MAKE(98,cf,e6,49,15,88,46,dc,b2,f0,ad,d1,47,42,49,25)
...
#define GPT_USR_POWERPC64LE_VERITY  SD_ID128_MAKE(ee,2b,99,83,21,e8,41,53,86,d9,b6,90,1a,54,d1,ce)
#define GPT_USR_POWERPC64_VERITY    SD_ID128_MAKE(bd,b5,28,a5,a2,59,47,5f,a8,7d,da,53,fa,73,6a,07)
#define GPT_USR_POWERPC_VERITY      SD_ID128_MAKE(df,76,5d,00,27,0e,49,e5,bc,75,f4,7b,b2,11,8b,09)
...
#define GPT_ROOT_POWERPC64LE_VERITY_SIG SD_ID128_MAKE(d4,a2,36,e7,e8,73,4c,07,bf,1d,bf,6c,f7,f1,c3,c6)
#define GPT_ROOT_POWERPC64_VERITY_SIG   SD_ID128_MAKE(f5,e2,c2,0c,45,b2,4f,fa,bc,e9,2a,60,73,7e,1a,af)
#define GPT_ROOT_POWERPC_VERITY_SIG     SD_ID128_MAKE(1b,31,b5,aa,ad,d9,46,3a,b2,ed,bd,46,7f,c8,57,e7)
...
#define GPT_USR_POWERPC64LE_VERITY_SIG  SD_ID128_MAKE(c8,bf,bd,1e,26,8e,45,21,8b,ba,bf,31,4c,39,95,57)
#define GPT_USR_POWERPC64_VERITY_SIG    SD_ID128_MAKE(0b,88,88,63,d7,f8,4d,9e,97,66,23,9f,ce,4d,58,af)
#define GPT_USR_POWERPC_VERITY_SIG      SD_ID128_MAKE(70,07,89,1d,d3,71,4a,80,86,a4,5c,b8,75,b9,30,2e)
...
#  define GPT_ROOT_NATIVE GPT_ROOT_POWERPC64LE
#  define GPT_ROOT_NATIVE_VERITY GPT_ROOT_POWERPC64LE_VERITY
#  define GPT_ROOT_NATIVE_VERITY_SIG GPT_ROOT_POWERPC64LE_VERITY_SIG
#  define GPT_USR_NATIVE GPT_USR_POWERPC64LE
#  define GPT_USR_NATIVE_VERITY GPT_USR_POWERPC64LE_VERITY
#  define GPT_USR_NATIVE_VERITY_SIG GPT_USR_POWERPC64LE_VERITY_SIG
#elif defined(__powerpc__) && defined(__powerpc64__) && __BYTE_ORDER__ == __ORDER_BIG_ENDIAN__
#  define GPT_ROOT_NATIVE GPT_ROOT_POWERPC64
#  define GPT_ROOT_NATIVE_VERITY GPT_ROOT_POWERPC64_VERITY
#  define GPT_ROOT_NATIVE_VERITY_SIG GPT_ROOT_POWERPC64_VERITY_SIG
#  define GPT_USR_NATIVE GPT_USR_POWERPC64
#  define GPT_USR_NATIVE_VERITY GPT_USR_POWERPC64_VERITY
#  define GPT_USR_NATIVE_VERITY_SIG GPT_USR_POWERPC64_VERITY_SIG
#elif defined(__powerpc__)
#  define GPT_ROOT_NATIVE GPT_ROOT_POWERPC
#  define GPT_ROOT_NATIVE_VERITY GPT_ROOT_POWERPC_VERITY
#  define GPT_ROOT_NATIVE_VERITY_SIG GPT_ROOT_POWERPC_VERITY_SIG
#  define GPT_USR_NATIVE GPT_USR_POWERPC
#  define GPT_USR_NATIVE_VERITY GPT_USR_POWERPC_VERITY
#  define GPT_USR_NATIVE_VERITY_SIG GPT_USR_POWERPC_VERITY_SIG
