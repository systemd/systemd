...
static int entry_fill_basics(struct ipt_entry *entry,
                             int protocol,
...
int fw_add_masquerade(bool add,
                      int af,
                      int protocol,
                      const union in_addr_union *source,
                      unsigned source_prefixlen,
        ...
        sz = XT_ALIGN(sizeof(struct ipt_entry)) + XT_ALIGN(sizeof(struct ipt_entry_target)) +
...
int fw_add_local_dnat(bool add,
                      int af,
                      int protocol,
                      const char *in_interface,
                      const union in_addr_union *source,
        ...
        if (protocol == IPPROTO_TCP)
                ...
                msz = XT_ALIGN(sizeof(struct ipt_entry_match)) + XT_ALIGN(sizeof(struct xt_udp));
