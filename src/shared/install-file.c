...
int install_file(int source_atfd, const char *source_name,
        ...
        if ((flags & (INSTALL_FSYNC|INSTALL_FSYNC_FULL|INSTALL_SYNCFS|INSTALL_READ_ONLY|INSTALL_READ_ONLY_GRACEFUL|INSTALL_SYNC_GRACEFUL)) != 0) {
                ...
                case S_IFREG: {
                        ...
                        if (regfd < 0) {
                                if ((flags & (INSTALL_FSYNC|INSTALL_FSYNC_FULL|INSTALL_SYNCFS) &&
                                     !(FLAGS_SET(flags, INSTALL_SYNC_GRACEFUL))) ||
                                    ((flags & INSTALL_READ_ONLY) &&
                                     !(FLAGS_SET(flags, INSTALL_READ_ONLY_GRACEFUL))))
        ...
        if (rofd >= 0) {
                ...
                if (r < 0) {
                        if (!FLAGS_SET(flags, INSTALL_READ_ONLY_GRACEFUL))
