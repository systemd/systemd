...
#define BUS_AUTOMOUNT_PROPERTIES                  \
        "Where",                                  \
        "ExtraOptions",                           \
        "DirectoryMode",                          \
        "TimeoutIdleSec"
...
void bus_dump_runtime_properties(FILE *out, UnitType t) {
        STRV_FOREACH(s,
                     t == UNIT_SERVICE ? STRV_MAKE_CONST(
                                     BUS_CGROUP_PROPERTIES,
                                     BUS_EXECUTE_PROPERTIES,
                                     BUS_KILL_PROPERTIES,
                                     BUS_SERVICE_PROPERTIES,
                                     BUS_UNIT_PROPERTIES
                     ) : t == UNIT_SOCKET ? STRV_MAKE_CONST(
                                     BUS_CGROUP_PROPERTIES,
                                     BUS_EXECUTE_PROPERTIES,
                                     BUS_KILL_PROPERTIES,
                                     BUS_SOCKET_PROPERTIES,
                                     BUS_UNIT_PROPERTIES
                     ) : t == UNIT_TIMER ? STRV_MAKE_CONST(
                                     BUS_TIMER_PROPERTIES,
                                     BUS_UNIT_PROPERTIES
                                     ...
                                     BUS_CGROUP_PROPERTIES,
                                     BUS_KILL_PROPERTIES,
                                     BUS_SCOPE_PROPERTIES,
                                     BUS_UNIT_PROPERTIES
                     ) : t == UNIT_MOUNT ? STRV_MAKE_CONST(
                                     BUS_CGROUP_PROPERTIES,
                                     BUS_EXECUTE_PROPERTIES,
                                     BUS_KILL_PROPERTIES,
                                     BUS_MOUNT_PROPERTIES,
                                     BUS_UNIT_PROPERTIES
                     ) : t == UNIT_AUTOMOUNT ? STRV_MAKE_CONST(
                                     BUS_AUTOMOUNT_PROPERTIES,
                                     BUS_UNIT_PROPERTIES
                     ) : STRV_MAKE_CONST(
                                     BUS_UNIT_PROPERTIES
                     ))
