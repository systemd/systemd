...
int device_is_processed(sd_device *dev) {
         ...
         * for the device have RUN tokens. See issue #30056. Hence, to check the device is really processed
         * by systemd-udevd, we also need to read ID_PROCESSING property. */
