...
/* Generic unit-level fields that are shared between UnitContextInput (input) and UnitContext (output).
   Unit-type-specific fields like Service are declared on each type separately. */
