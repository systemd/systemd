...
static SD_VARLINK_DEFINE_STRUCT_TYPE(
                ...
                SD_VARLINK_DEFINE_FIELD(NConnections, SD_VARLINK_INT, 0),
                SD_VARLINK_FIELD_COMMENT("Number of accepted connections"),
                SD_VARLINK_DEFINE_FIELD(NAccepted, SD_VARLINK_INT, 0),
                SD_VARLINK_FIELD_COMMENT("Number of refused connections"),
                SD_VARLINK_DEFINE_FIELD(NRefused, SD_VARLINK_INT, 0),
