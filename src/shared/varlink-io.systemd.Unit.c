...
static SD_VARLINK_DEFINE_STRUCT_TYPE(
                ...
                SD_VARLINK_FIELD_COMMENT("https://www.freedesktop.org/software/systemd/man/latest/systemd.resource-control.html#OOMRules="),
                SD_VARLINK_DEFINE_FIELD(OOMRules, SD_VARLINK_ARRAY|SD_VARLINK_NULLABLE, 0),
