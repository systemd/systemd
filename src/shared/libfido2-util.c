...
static int fido2_is_cred_in_specific_token(
        ...
        r = verify_features(d, path, LOG_ERR, /* ret_has_rk= */ NULL, /* ret_has_client_pin= */ NULL, &has_up, &has_uv, /* has_always_uv= */ NULL);
...
static int fido2_use_hmac_hash_specific_token(
        ...
        r = verify_features(d, path, LOG_ERR, /* ret_has_rk= */ NULL, &has_client_pin, &has_up, &has_uv, /* has_always_uv= */ NULL);
        if (r < 0)
                return r;
