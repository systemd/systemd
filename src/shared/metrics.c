...
static int metric_build_send(
                MetricFamilyContext *context, const char *object, sd_json_variant *value, char **field_pairs) {
                        ...
                        SD_JSON_BUILD_PAIR(
                                        ...
                                        SD_JSON_BUILD_OBJECT(
                                                        SD_JSON_BUILD_PAIR_CONDITION(
                                                                        ...
                                                                        "string",
                                                                        SD_JSON_BUILD_VARIANT(value)),
                                                        SD_JSON_BUILD_PAIR_CONDITION(
                                                                        sd_json_variant_is_integer(value),
                                                                        "int",
                                                                        SD_JSON_BUILD_VARIANT(value)),
                                                        SD_JSON_BUILD_PAIR_CONDITION(
                                                                        sd_json_variant_is_boolean(value),
                                                                        "bool",
                                                                        SD_JSON_BUILD_VARIANT(value)))));
...
int metric_build_send_string(
                MetricFamilyContext *context, const char *object, const char *value, char **field_pairs) {
...
int metric_build_send_unsigned(
                MetricFamilyContext *context, const char *object, uint64_t value, char **field_pairs) {
