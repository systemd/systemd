...
static int metric_set_fields(sd_json_variant **v, char **fields) {
...
static int metric_build_send(MetricFamilyContext* context, const char *object, sd_json_variant *value, char **fields) {
        _cleanup_(sd_json_variant_unrefp) sd_json_variant *v = NULL;
        int r;
        ...
        if (fields) { /* NULL => no fields object, empty strv => fields:{} */
