...
static int parse_line(
        ...
        if (l[0] == '[') {
                ...
                if (!string_is_safe(n, STRING_NON_EMPTY|STRING_NO_BACKSLASHES|STRING_NO_QUOTES))
...
int config_parse_string(
        ...
        if (FLAGS_SET(ltype, CONFIG_PARSE_STRING_SAFE) && !string_is_safe(rvalue, STRING_NO_BACKSLASHES|STRING_NO_QUOTES)) {
