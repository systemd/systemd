...
int openssl_load_key_from_provider(const char *provider, const char *private_key_uri, EVP_PKEY **private_key);
...
static inline int openssl_load_key_from_provider(const char *provider, const char *private_key_uri, EVP_PKEY **private_key) {
        return -EOPNOTSUPP;
}
