...
typedef enum OpensslKeySourceType {
...
} OpensslKeySourceType;

int parse_openssl_key_source_argument(const char *argument, char **ret_private_key_source, OpensslKeySourceType *ret_private_key_source_type);
...
int openssl_load_key_from_token(OpensslKeySourceType private_key_source_type, const char *private_key_source, const char *private_key, EVP_PKEY **ret);
