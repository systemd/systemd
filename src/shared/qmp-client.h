...
typedef enum QmpClientState {
        QMP_CLIENT_HANDSHAKING,    /* greeting + qmp_capabilities exchange in progress */
        QMP_CLIENT_IDLE,           /* connected, ready for commands */
        QMP_CLIENT_CALLING,        /* blocking call in progress, waiting for response */
        QMP_CLIENT_CALLED,         /* blocking call response received */
...
QmpClient *qmp_client_ref(QmpClient *p);
