...
typedef struct u32_with_set {
        uint32_t sz; /* a value of 0 indicates the hardware advertised maximum should be used.*/
        bool set;
} u32_with_set;
...
typedef struct netdev_channels {
        ...
        u32_with_set tx;
        u32_with_set other;
        u32_with_set combined;
} netdev_channels;

typedef struct netdev_ring_param {
        u32_with_set rx;
        u32_with_set rx_mini;
        u32_with_set rx_jumbo;
        u32_with_set tx;
} netdev_ring_param;
