...
static SD_VARLINK_DEFINE_STRUCT_TYPE(
                ...
                SD_VARLINK_FIELD_COMMENT("Encodes how many consecutive kexec reboots were successfully completed since the last full boot. Only reported when the Live Update Orchestrator is available."),
                SD_VARLINK_DEFINE_FIELD(KexecsCount, SD_VARLINK_INT, SD_VARLINK_NULLABLE),
