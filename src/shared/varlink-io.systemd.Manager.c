...
static SD_VARLINK_DEFINE_STRUCT_TYPE(
                ...
                SD_VARLINK_FIELD_COMMENT("Timestamp when systemd-shutdown began execution"),
                SD_VARLINK_DEFINE_FIELD_BY_TYPE(ShutdownBinaryStartTimestamp, Timestamp, SD_VARLINK_NULLABLE),
                SD_VARLINK_FIELD_COMMENT("Timestamp when systemd-shutdown is about to exit, e.g. to kexec into a new kernel"),
                SD_VARLINK_DEFINE_FIELD_BY_TYPE(ShutdownBinaryFinishTimestamp, Timestamp, SD_VARLINK_NULLABLE),
