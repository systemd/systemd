...
void unit_freezer_cancel(UnitFreezer *freezer);

DEFINE_TRIVIAL_CLEANUP_FUNC_FULL(UnitFreezer*, unit_freezer_cancel, NULL);

int unit_freezer_restore(const char *name, UnitFreezer *ret);
