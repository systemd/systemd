...
int table_add_cellf(Table *t, TableCell **ret_cell, TableDataType type, const char *format, ...) _printf_(4, 5);
#define table_add_cell_stringf(t, ret_cell, format, ...) table_add_cellf(t, ret_cell, TABLE_STRING, format, __VA_ARGS__)
