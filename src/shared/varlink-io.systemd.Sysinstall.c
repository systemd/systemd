...
static SD_VARLINK_DEFINE_METHOD_FULL(
                ...
                SD_VARLINK_FIELD_COMMENT("A list of credentials with literal value in format 'ID:VALUE' to be install to new system."),
                SD_VARLINK_DEFINE_INPUT(setCredentials, SD_VARLINK_STRING, SD_VARLINK_ARRAY|SD_VARLINK_NULLABLE),
                SD_VARLINK_FIELD_COMMENT("A list of credentials to be loaded in format 'ID:PATH' to be install to new system."),
