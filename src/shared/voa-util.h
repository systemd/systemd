...
/* The ephemeral load path, where verifiers retrieved from elsewhere are placed */
#define VOA_EPHEMERAL_LOAD_PATH "/run/voa"

/* X.509 certificates, one per file */
#define VOA_TECHNOLOGY_X509 "x509"
#define VOA_X509_CERTIFICATE_SUFFIX "-certificate.pem"
