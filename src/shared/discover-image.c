...
int image_read_metadata(Image *i) {
        ...
        case IMAGE_SUBVOLUME:
        case IMAGE_DIRECTORY: {
                _cleanup_strv_free_ char **machine_info = NULL, **os_release = NULL, **release_file = NULL;
                ...
                r = load_extension_release_pairs(i->path, i->class, i->name, /* relax_extension_release_check= */ false, &release_file);
                if (r < 0)
                ...
                strv_free_and_replace(i->release_file, release_file);
        ...
        case IMAGE_BLOCK: {
                ...
                strv_free_and_replace(i->release_file, m->extension_release);
