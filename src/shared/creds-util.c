...
static const CredentialsVarlinkError credentials_varlink_error_table[] = {
        ...
        { "io.systemd.Credentials.PCRsKeptChanging",       EUCLEAN,      "PCR values kept changing while unsealing the TPM2 secret, giving up. Something on this system extends a PCR continuously." },
