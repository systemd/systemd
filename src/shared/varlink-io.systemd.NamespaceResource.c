...
static SD_VARLINK_DEFINE_METHOD(
                ...
                SD_VARLINK_FIELD_COMMENT("The target UID inside the user namespace. If not specified defaults to 0. If identity is true, must be 0 or unset."),
                ...
                SD_VARLINK_FIELD_COMMENT("If true, create a user namespace that maps the peer UID/GID to root or itself instead of allocating a transient UID range. Defaults to false."),
