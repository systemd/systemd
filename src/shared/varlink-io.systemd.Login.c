...
static SD_VARLINK_DEFINE_METHOD(
                ...
                SD_VARLINK_FIELD_COMMENT("The identifier string of the session. "
                                         "If unspecified or 'self', returns the caller's own session. "
                                         "If 'auto', returns the caller's session, or their display session if they have none."),
...
static SD_VARLINK_DEFINE_METHOD(
                DescribeSeat,
                SD_VARLINK_FIELD_COMMENT("The identifier string of the seat. "
                                         "If unspecified or 'self', returns the seat of the caller's own session. "
                                         "If 'auto', returns the seat of the caller's session, or their display session if they have none."),
                SD_VARLINK_DEFINE_INPUT(Id, SD_VARLINK_STRING, SD_VARLINK_NULLABLE),
...
static SD_VARLINK_DEFINE_STRUCT_TYPE(
                ...
                SD_VARLINK_DEFINE_FIELD(Id, SD_VARLINK_STRING, 0),
                SD_VARLINK_FIELD_COMMENT("What is being inhibited, as an array of any combination of: shutdown, sleep, idle, handle-power-key, handle-suspend-key, handle-hibernate-key, handle-lid-switch, handle-reboot-key"),
                SD_VARLINK_DEFINE_FIELD(What, SD_VARLINK_STRING, SD_VARLINK_ARRAY),
