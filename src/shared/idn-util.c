...
int dlopen_idn(void) {
        ELF_NOTE_DLOPEN("libidn2.so.0", "idn", "Support for internationalized domain names.", "suggested");
...
int dlopen_idn(void) {
        ...
        ELF_NOTE_DLOPEN("libidn.so.11", "idn", "Support for internationalized domain names.", "suggested");
        ELF_NOTE_DLOPEN("libidn.so.12", "idn", "Support for internationalized domain names.", "suggested");
