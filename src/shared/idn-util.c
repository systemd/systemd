...
int dlopen_idn(void) {
        ELF_NOTE_DLOPEN("idn", "Support for internationalized domain names.", ELF_NOTE_DLOPEN_PRIORITY_SUGGESTED, "libidn2.so.0");
...
int dlopen_idn(void) {
        ...
        ELF_NOTE_DLOPEN("idn", "Support for internationalized domain names.", ELF_NOTE_DLOPEN_PRIORITY_SUGGESTED, "libidn.so.12", "libidn.so.11");
