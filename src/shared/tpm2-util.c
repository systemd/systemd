...
int dlopen_tpm2(void) {
        ...
        ELF_NOTE_DLOPEN("libtss2-esys.so.0", "tss2-esys", "Support for TPM2.", "suggested");
        ...
        ELF_NOTE_DLOPEN("libtss2-rc.so.0", "tss2-rc", "Support for TPM2.", "suggested");
        ...
        ELF_NOTE_DLOPEN("libtss2-mu.so.0", "tss2-mu", "Support for TPM2.", "suggested");
