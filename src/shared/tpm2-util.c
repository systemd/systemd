...
#define _tpm2_marshal_size(desc, src, sizep, _newsize_, _rc_, _r_)      \
        ({                                                              \
                ...
                int _r_ = __tpm2_marshal(desc, src, NULL, SIZE_MAX, &_newsize_, _rc_); \
                if (_r_ == 0) {                                         \
...
#define _tpm2_marshal_realloc(desc, src, bufp, sizep, _newsize_, _buf_, _rc_, _r_) \
        ({                                                              \
                ...
                if (_r_ == 0) {                                         \
                        typeof(*bufp) _buf_ = realloc(*bufp, _newsize_); \
                        if (!_buf_)                                     \
                                _r_ = log_oom();                        \
                        else {                                          \
                                *bufp = _buf_;                          \
                                _r_ = __tpm2_marshal(desc, src, _buf_, _newsize_, sizep, _rc_); \
                        }                                               \
                }                                                       \
                _r_;                                                    \
        })
