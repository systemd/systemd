...
static int tpm2_create_key_from_template(
        ...
        primary_str = parent->esys_handle == ESYS_TR_RH_OWNER ? "primary " : "";
...
static int tpm2_create_primary_from_template(
        ...
        return tpm2_create_key_from_template(
                        c,
                        &TPM2_HANDLE_RH_OWNER,
                        &TPM2_HANDLE_PASSWORD,
                        public_template,
                        sensitive,
                        ret_public,
                        ret_private,
...
static int tpm2_policy_authorize(
        ...
        r = tpm2_load_external_key(c, &TPM2_HANDLE_NONE, &pubkey_tpm2, NULL, &pubkey_handle);
        if (r < 0)
                return r;
