...
static int tpm2_get_srk(
        ...
        /* Did Not find SRK, indicate this be returning 0 and ESYS_TR_NONE */
...
static int tpm2_make_primary(
        ...
        _cleanup_(Esys_Freep) TPM2B_PUBLIC *out_public = NULL;
        _cleanup_(Esys_Freep) TPMS_CAPABILITY_DATA *cap_data = NULL;
        _cleanup_(Esys_Freep) TPM2B_NAME *out_name = NULL;
        _cleanup_(Esys_Freep) TPM2B_NAME *out_qname = NULL;
...
int tpm2_parse_luks2_json(
        ...
        _cleanup_free_ void *blob = NULL, *policy_hash = NULL, *pubkey = NULL, *salt = NULL, *primary_buf;
