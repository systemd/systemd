...
int tpm2_nvpcr_extend_bytes(Tpm2Context *c, const char *name, const struct iovec *data, const struct iovec *secret, Tpm2UserspaceEventType event_type, const char *description);
int tpm2_nvpcr_allocate(Tpm2Context *c, const Tpm2Handle *session, const char *name, bool sync_secondary);
int tpm2_nvpcr_acquire_anchor_secret(struct iovec *ret, bool sync_secondary);
int tpm2_nvpcr_initialize_raw(Tpm2Context *c, const Tpm2Handle *session, const char *text, const struct iovec *anchor_secret, bool sync_secondary);
int tpm2_nvpcr_initialize(Tpm2Context *c, const Tpm2Handle *session, const char *name, const struct iovec *anchor_secret, bool sync_secondary);
int tpm2_nvpcr_delete(Tpm2Context *c, const Tpm2Handle *session, const char *name, bool sync_secondary);
int tpm2_nvpcr_read(Tpm2Context *c, const Tpm2Handle *session, const char *name, struct iovec *ret, uint32_t *ret_nvindex);
...
int tpm2_define_nvpcr_nv_index(Tpm2Context *c, const Tpm2Handle *session, TPMI_ALG_HASH algoritm, TPM2_HANDLE *ret_nv_index, Tpm2Handle **ret_nv_handle);
