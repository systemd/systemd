...
int tpm2_index_to_handle(Tpm2Context *c, TPM2_HANDLE index, const Tpm2Handle *session, TPM2B_NAME **ret_qname, Tpm2Handle **ret_handle);
...
int tpm2_nv_index_to_handle(Tpm2Context *c, TPM2_HANDLE index, const Tpm2Handle *session, TPM2B_NV_PUBLIC **ret_public, TPM2B_NAME **ret_name, Tpm2Handle **ret_handle);
