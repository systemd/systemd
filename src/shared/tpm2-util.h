...
typedef enum Tpm2Support {
        /* NOTE! The systemd-analyze has-tpm2 command shows these flags. Hence these flags are pretty
        ...
        TPM2_SUPPORT_LIBTSS2_ESYS = 1 << 4,  /* we can dlopen libtss2-esys.so.0 */
        TPM2_SUPPORT_LIBTSS2_RC   = 1 << 5,  /* we can dlopen libtss2-rc.so.0 */
        TPM2_SUPPORT_LIBTSS2_MU   = 1 << 6,  /* we can dlopen libtss2-mu.so.0 */
        TPM2_SUPPORT_LIBRARIES    = TPM2_SUPPORT_LIBTSS2_ESYS | TPM2_SUPPORT_LIBTSS2_RC | TPM2_SUPPORT_LIBTSS2_MU,
