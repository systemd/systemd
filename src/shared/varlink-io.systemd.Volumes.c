...
static SD_VARLINK_DEFINE_ENUM_TYPE(
                VolumeType,
                SD_VARLINK_FIELD_COMMENT("Block device volumes, block-addressable"),
...
static SD_VARLINK_DEFINE_METHOD(
                ...
                SD_VARLINK_FIELD_COMMENT("Controls read/write access to the volume. If false and the volume cannot be opened in writable mode the call will fail. If null, volume will be acquired in writable mode if possible, read-only otherwise."),
                ...
                SD_VARLINK_FIELD_COMMENT("The size of the volume, if one is created. Has no effect if no volume is created."),
