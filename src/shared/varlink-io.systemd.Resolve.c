...
SD_VARLINK_DEFINE_STRUCT_TYPE(
                ...
                SD_VARLINK_DEFINE_FIELD(name, SD_VARLINK_STRING, SD_VARLINK_NULLABLE),
                SD_VARLINK_FIELD_COMMENT("Transport used to communicate with the server, one of \"dns\" or \"https\"."),
                SD_VARLINK_DEFINE_FIELD(transport, SD_VARLINK_STRING, SD_VARLINK_NULLABLE),
                SD_VARLINK_FIELD_COMMENT("DNS-over-HTTPS request URI, when the transport is HTTPS."),
...
SD_VARLINK_DEFINE_INTERFACE(
                ...
                &vl_type_ServiceData,
                SD_VARLINK_SYMBOL_COMMENT("Encapsulates a configured DNS server endpoint, including its transport and optional DNS-over-HTTPS URI."),
                &vl_type_DNSServer,
