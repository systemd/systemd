...
static SD_VARLINK_DEFINE_METHOD_FULL(
                ...
                SD_VARLINK_FIELD_COMMENT("In dry-run mode returns the number of partitions currently on the selected block device. Omitted if not determined, i.e. if the existing partition table is not read because empty mode 'force' or 'require' is selected."),
