...
typedef enum NamingSchemeFlags {
        ...
        NAMING_SINGLE_FUNCTION_NO_SLOT  = 1 << 14, /* Don't use PCI hotplug slot information if associated PCI device has only single function */
        ...
        NAMING_V251 = NAMING_V250 | NAMING_SINGLE_FUNCTION_NO_SLOT,
