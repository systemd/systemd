...
typedef enum NamingSchemeFlags {
        ...
        NAMING_BRIDGE_MUTLIFUNCTION_SLOT = 1 << 14, /* Use PCI hotplug slot information associated with bridge, but only if PCI device is multifunction */
        ...
        NAMING_V251 = NAMING_V250 | NAMING_BRIDGE_MUTLIFUNCTION_SLOT,
