...
static int find_matching_component(
        ...
        /* Find the *earliest* matching time specified by one of the CalendardCompoment items in chain c.
         * If no matches can be found, returns -ENOENT.
         * Otherwise, *val is updated to the matching time. 1 is returned if *val was moved, 0 otherwise.
         */
