...
static int log_job_error_with_service_result(
        ...
        static const struct {
                ...
                { "resources",       EBUSY,           "of unavailable resources or another system error"                      },
                ...
                { "exit-code",       EPIPE,           "the control process exited with error code"                            },
                { "signal",          EINTR,           "a fatal signal was delivered to the control process"                   },
                { "core-dump",       EFAULT,          "a fatal signal was delivered causing the control process to dump core" },
