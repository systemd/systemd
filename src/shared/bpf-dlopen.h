...
extern DLSYM_PROTOTYPE(bpf_map_get_next_id);
...
extern DLSYM_PROTOTYPE(bpf_prog_get_fd_by_id);
extern DLSYM_PROTOTYPE(bpf_prog_get_next_id);
...
extern DLSYM_PROTOTYPE(btf__load_from_kernel_by_id);
extern DLSYM_PROTOTYPE(btf__name_by_offset);
extern DLSYM_PROTOTYPE(btf__type_by_id);
extern DLSYM_PROTOTYPE(libbpf_get_error);
