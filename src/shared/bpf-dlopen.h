...
extern int (*sym_bpf_map_create)(enum bpf_map_type,  const char *map_name, uint32_t key_size, uint32_t value_size, uint32_t max_entries, const struct bpf_map_create_opts *opts);
