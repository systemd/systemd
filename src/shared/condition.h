...
typedef int (*condition_test_logger_t)(void *userdata, int level, int error, const char *file, int line, const char *func, const build_id_ref *build_id, const char *format, ...) _printf_(8, 9);
