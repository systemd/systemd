...
static int nft_set_element_op_uint32(bool add, const NFTSetContext *nft_set_context, uint32_t element) {
        _cleanup_(sd_netlink_unrefp) sd_netlink *nfnl = NULL;
...
int nft_set_element_add_uint32(const NFTSetContext *nft_set_context, uint32_t element) {
        return nft_set_element_op_uint32(true, nft_set_context, element);
}

int nft_set_element_del_uint32(const NFTSetContext *nft_set_context, uint32_t element) {
        return nft_set_element_op_uint32(false, nft_set_context, element);
}
