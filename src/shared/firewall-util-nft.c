...
int fw_nftables_add_masquerade(
        ...
        r = nft_set_element_modify_in_addr(ctx, add, af_to_nfproto(af), af, NFT_SYSTEMD_TABLE_NAME, NFT_SYSTEMD_MASQ_SET_NAME,
        ...
        return nft_set_element_modify_in_addr(ctx, add, af_to_nfproto(af), af, NFT_SYSTEMD_TABLE_NAME, NFT_SYSTEMD_MASQ_SET_NAME,
                                              source, source_prefixlen);
}
...
static int nft_set_add(NFTSetContext *s, int nfproto, const char *table, const char *set) {
