...
static int dmi_table(int64_t base, uint32_t len, uint16_t num, const char *devmem) {
         ...
         * parse error.
         */
        r = read_full_file_full(AT_FDCWD, devmem, base, len,
