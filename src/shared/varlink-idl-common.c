...
SD_VARLINK_DEFINE_STRUCT_TYPE(
                ...
                SD_VARLINK_DEFINE_FIELD(ignoreFailure, SD_VARLINK_BOOL, 0),
                SD_VARLINK_FIELD_COMMENT("Run with full privileges"),
                SD_VARLINK_DEFINE_FIELD(privileged, SD_VARLINK_BOOL, 0),
                SD_VARLINK_FIELD_COMMENT("Skip setuid handling"),
                SD_VARLINK_DEFINE_FIELD(noSetuid, SD_VARLINK_BOOL, 0),
                SD_VARLINK_FIELD_COMMENT("Skip environment variable expansion"),
                SD_VARLINK_DEFINE_FIELD(noEnvExpand, SD_VARLINK_BOOL, 0),
                SD_VARLINK_FIELD_COMMENT("Run via shell"),
                SD_VARLINK_DEFINE_FIELD(viaShell, SD_VARLINK_BOOL, 0));
