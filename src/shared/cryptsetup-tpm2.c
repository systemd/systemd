...
int acquire_tpm2_key(
        ...
        /* When TPM2+FIDO2 is set, and the FIDO2 does not require a PIN, recover the hmac-secret a bit early
         * and avoid requesting the user presence in each loop later, when the PIN is asked and the user fail
         * to enter. */
