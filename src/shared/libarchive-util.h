...
extern int archive_entry_gid_is_set(struct archive_entry *e);      /* NOLINT(readability-redundant-declaration) */
extern int archive_entry_hardlink_is_set(struct archive_entry *e); /* NOLINT(readability-redundant-declaration) */
extern int archive_entry_uid_is_set(struct archive_entry *e);      /* NOLINT(readability-redundant-declaration) */
REENABLE_WARNING;
