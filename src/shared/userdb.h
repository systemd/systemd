...
typedef enum UserDBFlags {
        ...
        USERDB_PREFER_SYNTHESIZED        = 1 << 8,  /* Prefer synthesizes records over others */
        ...
        USERDB_SYNTHESIZED_ONLY = USERDB_EXCLUDE_NSS|USERDB_EXCLUDE_VARLINK|USERDB_EXCLUDE_DROPIN,
