...
int blockdev_partscan_enabled(int fd) {
         ...
         * the value of GENHD_FL_NO_PART is changed from 0x0200 to 0x004. 💣💣💣
         *
         ...
         * 1) check 'partscan' sysattr where the information is made directly available,
         * 2) check 'loop/partscan' sysattr for loopback block devices,
         * 3) then, fall back to 'ext_range' sysfs attribute, and if '1' we can conclude partition scanning
         *    is disabled; otherwise check 'capability' sysattr for ancient version. */
        ...
        /* For loopback block device, especially for v5.19 or newer. */
