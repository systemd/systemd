...
int blockdev_partscan_enabled(int fd) {
         ...
         * attribute, and '1' means'GENHD_FL_NO_PART_SCAN' is (possibly effectively) set, otherwise check
         * 'capability' sysattr for older version. */
...
#endif
        return !FLAGS_SET(capability, GENHD_FL_NO_PART_SCAN);
}
