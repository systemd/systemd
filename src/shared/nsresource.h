...
int nsresource_allocate_userns(sd_varlink *link, const char *name, uint64_t size);
int nsresource_register_userns(sd_varlink *link, const char *name, int userns_fd);
int nsresource_add_mount(sd_varlink *link, int userns_fd, int mount_fd);
int nsresource_add_cgroup(sd_varlink *link, int userns_fd, int cgroup_fd);
int nsresource_add_netif_veth(sd_varlink *link, int userns_fd, int netns_fd, const char *namespace_ifname, char **ret_host_ifname, char **ret_namespace_ifname);
int nsresource_add_netif_tap(sd_varlink *link, int userns_fd, char **ret_host_ifname);
