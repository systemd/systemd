...
int dlopen_many_sym_or_warn_sentinel(void **dl, const char *filename, int log_level, ...) _sentinel_;

#define dlsym_many_or_warn(dl, log_level, ...) \
        dlsym_many_or_warn_sentinel(dl, log_level, __VA_ARGS__, NULL)
#define dlopen_many_sym_or_warn(dl, filename, log_level, ...) \
        dlopen_many_sym_or_warn_sentinel(dl, filename, log_level, __VA_ARGS__, NULL)
