...
static void edit_file_context_done_internal(
...
void edit_file_context_done(EditFileContext *context) {
        return edit_file_context_done_internal(context, /* clear= */ false);
}

void edit_file_context_clear(EditFileContext *context) {
        return edit_file_context_done_internal(context, /* clear= */ true);
}
