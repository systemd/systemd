...
int inspect_kernel(
        ...
        if (pe_is_uki(pe_header, sections)) {
                r = inspect_uki(kernel_fd, pe_header, sections, ret_cmdline, ret_uname, ret_pretty_name, ret_osrel);
                if (r < 0)
                        return r;
                ...
                r = inspect_uki(kernel_fd, pe_header, sections, ret_cmdline, ret_uname, /* ret_pretty_name= */ NULL, /* ret_osrel= */ NULL);
                if (r < 0)
                        return r;
