...
static int generator_add_ordering(
        ...
        _cleanup_free_ char *instantiated = NULL, *p = NULL;
         ...
         * specified, it is inserted into <fst> first as an instance */
        ...
        p = strjoin(dir, src, ".d/50-order-", to, ".conf");
        if (!p)
                return log_oom();
...
int generator_hook_up_growfs(
        ...
        const char *growfs_unit, *growfs_unit_path, *instance;
