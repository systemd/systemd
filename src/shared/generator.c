...
int generator_open_unit_file(const char *dest, const char *source, const char *name, FILE **file) {
...
int generator_write_fsck_deps(FILE *f, const char *dir, const char *what, const char *where, const char *fstype) {
...
int generator_write_timeouts(
        ...
        return write_drop_in_format(dir,
                                    unit,
                                    50,
                                    "device-timeout",
...
int generator_write_initrd_root_device_deps(const char *dir, const char *what) {
        ...
        if (r < 0)
                return log_error_errno(r, "Failed to make unit name from path \"%s\": %m", what);
...
int generator_hook_up_mkswap(const char *dir, const char *what) {
        ...
        if (r < 0)
                return log_error_errno(r, "Failed to make unit instance name from path \"%s\": %m", node);
        ...
        if (!f)
                return log_error_errno(errno, "Failed to create unit file %s: %m", unit_file);
...
int generator_hook_up_mkfs(const char *dir, const char *what, const char *where, const char *type) {
...
int generator_hook_up_growfs(const char *dir, const char *where, const char *target) {
        ...
        if (r < 0)
                return log_error_errno(r, "Failed to make unit instance name from path \"%s\": %m", where);
