...
int generator_hook_up_quotacheck(
        ...
        if (path_equal(where, "/"))
                return generator_add_symlink_full(dir, where_unit, "wants", SPECIAL_QUOTACHECK_ROOT_SERVICE);
...
int generator_hook_up_quotaon(
        ...
        if (path_equal(where, "/"))
                return generator_add_symlink_full(dir, SPECIAL_QUOTACHECK_ROOT_SERVICE, "wants", SPECIAL_QUOTAON_ROOT_SERVICE);
