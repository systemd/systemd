...
int generator_write_veritysetup_unit_section(FILE *f, const char *source) {
        ...
        fprintf(f,
                 ...
                 * device is closed via an ioctl carrying a udev cookie that blocks in dm_udev_wait() until
                 * udev releases it (95-dm-notify.rules). Stopping before udevd keeps it around to service the
                 * cookie; otherwise during soft-reboot/shutdown udevd may exit first and the close hangs. */
