...
static inline PartitionDesignator PARTITION_ROOT_VERITY_OF_ARCH(Architecture arch) {
        switch (arch) {
...
static inline PartitionDesignator PARTITION_ROOT_VERITY_SIG_OF_ARCH(Architecture arch) {
        switch (arch) {
...
static inline PartitionDesignator PARTITION_USR_VERITY_OF_ARCH(Architecture arch) {
        switch (arch) {
...
static inline PartitionDesignator PARTITION_USR_VERITY_SIG_OF_ARCH(Architecture arch) {
        switch (arch) {
