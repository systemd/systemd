...
int verity_dissect_and_mount(const char *src, const char *dest, const MountOptions *options, const char *host_os_release_id, const char *host_os_release_version_id, const char *host_os_release_sysext_level, char **ret_image_name);
