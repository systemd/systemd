...
int mountfsd_mount_image_fd(sd_varlink *link, int image_fd, int userns_fd, const MountOptions *options, const ImagePolicy *image_policy, const VeritySettings *verity, DissectImageFlags flags, DissectedImage **ret);
int mountfsd_mount_image(sd_varlink *link, const char *path, int userns_fd, const MountOptions *options, const ImagePolicy *image_policy, const VeritySettings *verity, DissectImageFlags flags, DissectedImage **ret);
int mountfsd_mount_directory_fd(sd_varlink *link, int directory_fd, int userns_fd, DissectImageFlags flags, int *ret_mount_fd);
int mountfsd_mount_directory(sd_varlink *link, const char *path, int userns_fd, DissectImageFlags flags, int *ret_mount_fd);

int mountfsd_make_directory_fd(sd_varlink *link, int parent_fd, const char *name, mode_t mode, DissectImageFlags flags, int *ret_directory_fd);
int mountfsd_make_directory(sd_varlink *link, const char *path, mode_t mode, DissectImageFlags flags, int *ret_directory_fd);
