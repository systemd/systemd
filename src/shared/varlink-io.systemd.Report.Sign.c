...
SD_VARLINK_DEFINE_INTERFACE(
                io_systemd_Report_Sign,
                "io.systemd.Report.Sign",
                ...
                SD_VARLINK_SYMBOL_COMMENT("Sign a report, identified by a digest. This may return zero, one or more signatures, as appropriate. For example some backend might have multiple keys or algorithms available, that are appropiate, in which case it can generate multiple signatures."),
                &vl_method_Sign);
