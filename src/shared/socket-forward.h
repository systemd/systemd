 ...
 *
 * The SocketForward takes unconditional ownership of both fds: they are closed even on failure.
 * Callers must not close fds after calling socket_forward_new(), regardless of the return value. */
