 ...
 * "chpriv", "subcontext", "session", "sevice".
 *
...
int osc_context_open_service(const char *unit, sd_id128_t invocation_id, char **ret_seq) {
        ...
        return osc_context_outro(TAKE_PTR(seq), invocation_id, ret_seq, /* ret_context_id= */ NULL);
}
...
int osc_context_id_from_invocation_id(sd_id128_t id, sd_id128_t *ret) {
         ...
         * as we have the invocation ID). We dont use the invocation ID literally in order not to make it too
