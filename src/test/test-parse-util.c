...
TEST(pcr_from_string) {
        ...
        assert_se(pcr_number_from_string((char*)"boot-gpt") == 5);
        assert_se(pcr_number_from_string((char*)"power-state") == 6);
        ...
        assert_se(pcr_number_from_string((char*)"kernel-configuration") == 12);
