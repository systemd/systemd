...
int main(int argc, char *argv[]) {
        ...
        /* load idle ok */
        assert_se(manager_load_startable_unit_or_warn(m, "sched_idle_ok.service", /* path= */ NULL, LOG_ERR, &idle_ok) >= 0);
        ser = SERVICE(idle_ok);
         ...
         */
        assert_se(manager_load_startable_unit_or_warn(m, "sched_idle_bad.service", /* path= */ NULL, LOG_ERR, &idle_bad) >= 0);
        ser = SERVICE(idle_ok);
        assert_se(ser->exec_context.cpu_sched_policy == SCHED_OTHER);
        assert_se(ser->exec_context.cpu_sched_priority == 0);
         ...
         */
        assert_se(manager_load_startable_unit_or_warn(m, "sched_rr_ok.service", /* path= */ NULL, LOG_ERR, &rr_ok) >= 0);
        ser = SERVICE(rr_ok);
         ...
         */
        assert_se(manager_load_startable_unit_or_warn(m, "sched_rr_bad.service", /* path= */ NULL, LOG_ERR, &rr_bad) >= 0);
        ser = SERVICE(rr_bad);
        assert_se(ser->exec_context.cpu_sched_policy == SCHED_RR);
        assert_se(ser->exec_context.cpu_sched_priority == 1);
         ...
         */
        assert_se(manager_load_startable_unit_or_warn(m, "sched_rr_change.service", /* path= */ NULL, LOG_ERR, &rr_sched) >= 0);
        ser = SERVICE(rr_sched);
        assert_se(ser->exec_context.cpu_sched_policy == SCHED_RR);
        assert_se(ser->exec_context.cpu_sched_priority == 99);

        /* load ext ok */
        assert_se(manager_load_startable_unit_or_warn(m, "sched_ext_ok.service", /* path= */ NULL, LOG_ERR, &ext_ok) >= 0);
        ser = SERVICE(ext_ok);
