...
TEST(xsetxattr) {
        ...
        /* by full path */
        r = xsetxattr(AT_FDCWD, x, 0, "user.foo", "fullpath", SIZE_MAX);
        ...
        ASSERT_OK(xsetxattr(fd, "", 0, "user.foo", "fd_opath_empty", SIZE_MAX));
        ...
        ASSERT_OK(xsetxattr(fd, "", 0, "user.foo", "fd_regular_empty", SIZE_MAX));
