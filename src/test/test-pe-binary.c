...
TEST(pe_load_sections_valid_in_bounds) {
        ...
        _cleanup_close_ int fd = build_pe_file(&s, /* n_sections= */ 1, /* override = */ 4096);
...
TEST(pe_load_sections_size_zero_with_huge_pointer) {
        ...
        _cleanup_close_ int fd = build_pe_file(&s, /* n_sections= */ 1, /* override = */ 0);
        _cleanup_free_ IMAGE_DOS_HEADER *dos = NULL;
        _cleanup_free_ PeHeader *pe = NULL;
        _cleanup_free_ IMAGE_SECTION_HEADER *sections = NULL;
...
TEST(pe_load_sections_zero_sections) {
        _cleanup_close_ int fd = build_pe_file(NULL, /* n_sections= */ 0, /* override = */ 0);
        _cleanup_free_ IMAGE_DOS_HEADER *dos = NULL;
        _cleanup_free_ PeHeader *pe = NULL;
        _cleanup_free_ IMAGE_SECTION_HEADER *sections = NULL;
...
TEST(pe_load_sections_multi_all_valid) {
        ...
        _cleanup_close_ int fd = build_pe_file(specs, /* n_sections= */ 3, /* override = */ 0);
        _cleanup_free_ IMAGE_DOS_HEADER *dos = NULL;
        _cleanup_free_ PeHeader *pe = NULL;
        _cleanup_free_ IMAGE_SECTION_HEADER *sections = NULL;
...
TEST(pe_load_sections_multi_one_past_eof) {
        ...
        _cleanup_close_ int fd = build_pe_file(specs, /* n_sections= */ 3, /* override = */ 4096);
        _cleanup_free_ IMAGE_DOS_HEADER *dos = NULL;
        _cleanup_free_ PeHeader *pe = NULL;
        _cleanup_free_ IMAGE_SECTION_HEADER *sections = NULL;
...
static int call_uki_hash_with(SectionSpec spec) {
        _cleanup_close_ int fd = build_pe_file(&spec, /* n_sections= */ 1, /* override = */ 0);
        _cleanup_free_ IMAGE_DOS_HEADER *dos = NULL;
        _cleanup_free_ PeHeader *pe = NULL;
        _cleanup_free_ IMAGE_SECTION_HEADER *sections = NULL;
...
TEST_RET(uki_hash_one_bad_among_many_rejected) {
        ...
        _cleanup_close_ int fd = build_pe_file(specs, /* n_sections= */ 2, /* override = */ 0);
        _cleanup_free_ IMAGE_DOS_HEADER *dos = NULL;
        _cleanup_free_ PeHeader *pe = NULL;
        _cleanup_free_ IMAGE_SECTION_HEADER *sections = NULL;
