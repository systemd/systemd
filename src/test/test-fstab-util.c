...
static void do_fstab_filter_options(
                const char *opts,
                const char *remove,
                int r_expected,
        ...
        log_info("1: \"%s\" → %d, \"%s\", \"%s\", \"%s\", expected %d, \"%s\", \"%s\", \"%s\"",
                 ...
                 filtered,
                 r_expected,
                 strnull(name_expected),
                 strnull(value_expected),
...
TEST(fstab_filter_options) {
        ...
        do_fstab_filter_options(
                        "opt=0,other,x-opt\\,foobar", "x-opt\0opt\0", 1, 1, "opt", "0", "0", "other,x-opt\\,foobar");
        do_fstab_filter_options(
                        "opt,other,x-opt\\,part", "opt\0x-opt\0", 1, 0, "opt", NULL, "", "other,x-opt\\,part");
        do_fstab_filter_options(
                        "opt,other,part\\,x-opt", "x-opt\0opt\0", 1, 0, "opt", NULL, "", "other,part\\,x-opt");
        do_fstab_filter_options(
                        "opt,other\\,\\,\\,opt,x-part",
                        "opt\0x-opt\0",
                        1,
                        0,
                        "opt",
        ...
        do_fstab_filter_options(
                        "first=1,opt=0,last=2", "x-opt\0opt\0", 1, 1, "opt", "0", "0", "first=1,last=2");
        ...
        do_fstab_filter_options(
                        "first,opt=0,noopt=1,last=1", "opt\0noopt\0", 1, 1, "noopt", "1", "0:1", "first,last=1");
        do_fstab_filter_options(
                        "first=1,opt=0,last=2,opt=1", "opt\0", 1, 1, "opt", "1", "0:1", "first=1,last=2");
