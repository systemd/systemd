...
/*
 * Test helper for TrustedExec= BPF enforcement tests.
 *
 * Usage:
 *   test-bpf-trusted-exec attach   — Load, attach, pin BPF links
 *   test-bpf-trusted-exec detach   — Remove pinned BPF links
 *   test-bpf-trusted-exec check    — Check BPF LSM + require_signatures preconditions
 *
...
#define PIN_PATH_PREFIX "/sys/fs/bpf/test_trusted_exec_"
