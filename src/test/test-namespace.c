...
TEST(namespace_cleanup_tmpdir) {
        ...
        {
                _cleanup_(namespace_cleanup_tmpdirp) char *dir;
                ASSERT_NOT_NULL(dir = strdup("/tmp/systemd-test-namespace.XXXXXX"));
...
TEST(tmpdir) {
        ...
        z = ASSERT_NOT_NULL(strjoin("/tmp/systemd-private-", SD_ID128_TO_STRING(bid), "-sys-devices-pci0000:00-0000:00:1a.0-usb3-3\\x2d1-3\\x2d1:1.0-bluetooth-hci0.device-"));
        zz = ASSERT_NOT_NULL(strjoin("/var/tmp/systemd-private-", SD_ID128_TO_STRING(bid), "-sys-devices-pci0000:00-0000:00:1a.0-usb3-3\\x2d1-3\\x2d1:1.0-bluetooth-hci0.device-"));
