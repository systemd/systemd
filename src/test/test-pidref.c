...
TEST(pidref_kill) {
        ...
        ASSERT_OK_EQ_ERRNO(pidref_safe_fork("(test-pidref-kill)", FORK_DEATHSIG_SIGKILL|FORK_FREEZE, &pidref), 1);
...
TEST(pidref_kill_and_sigcont) {
        ...
        ASSERT_OK_EQ_ERRNO(pidref_safe_fork("(test-pidref-kill-and-sigcont)", FORK_DEATHSIG_SIGTERM|FORK_FREEZE, &pidref), 1);
...
TEST(pidref_sigqueue) {
        ...
        ASSERT_OK_EQ_ERRNO(pidref_safe_fork("(test-pidref-sigqueue)", FORK_DEATHSIG_SIGTERM|FORK_FREEZE, &pidref), 1);
...
TEST(pidref_done_sigkill_wait) {
        ...
        ASSERT_OK_EQ_ERRNO(pidref_safe_fork("(test-pidref-done-sigkill-wait)", FORK_DEATHSIG_SIGKILL|FORK_FREEZE, &pidref), 1);
}
