...
TEST_RET(bits_constant) {
        assert_se(__builtin_constant_p(INDEX_TO_MASK(uint8_t, 1)));
        assert_se(__builtin_constant_p(INDEX_TO_MASK(uint16_t, 1)));
        assert_se(__builtin_constant_p(INDEX_TO_MASK(uint32_t, 1)));
        assert_se(__builtin_constant_p(INDEX_TO_MASK(uint64_t, 1)));

        assert_se(__builtin_constant_p(BIT_SET((uint8_t)2, 1)));
        assert_se(__builtin_constant_p(BIT_SET((uint16_t)2, 1)));
        assert_se(__builtin_constant_p(BIT_SET((uint32_t)2, 1)));
        assert_se(__builtin_constant_p(BIT_SET((uint64_t)2, 1)));
