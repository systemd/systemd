...
TEST(path_pick) {
        ...
        if (IN_SET(native_architecture(), ARCHITECTURE_X86, ARCHITECTURE_X86_64)) {
                ...
                assert_se(path_pick(pp, MODE_INVALID, NULL, NULL, _ARCHITECTURE_INVALID, ".raw", &rp, NULL, &rm, &rv, &ra) > 0);
        ...
        assert_se(path_pick(pp, MODE_INVALID, NULL, NULL, ARCHITECTURE_X86_64, ".raw", &rp, NULL, &rm, &rv, &ra) > 0);
        assert_se(S_ISREG(rm));
        ...
        assert_se(path_pick(pp, MODE_INVALID, NULL, NULL, ARCHITECTURE_IA64, ".raw", &rp, NULL, &rm, &rv, &ra) > 0);
        assert_se(S_ISREG(rm));
        ...
        assert_se(path_pick(pp, MODE_INVALID, NULL, "5", _ARCHITECTURE_INVALID, ".raw", &rp, NULL, &rm, &rv, &ra) > 0);
        assert_se(S_ISREG(rm));
        assert_se(streq_ptr(rv, "5"));
        ...
        assert_se(path_pick(pp, MODE_INVALID, NULL, "5", ARCHITECTURE_IA64, ".raw", &rp, NULL, &rm, &rv, &ra) > 0);
        assert_se(S_ISREG(rm));
        assert_se(streq_ptr(rv, "5"));
        assert_se(ra == ARCHITECTURE_IA64);
        assert_se(endswith(rp, "/foo_5_ia64.raw"));
        ...
        assert_se(path_pick(pp, MODE_INVALID, NULL, "5", ARCHITECTURE_CRIS, ".raw", &rp, NULL, &rm, &rv, &ra) == 0);
        ...
        assert_se(path_pick(pp, S_IFREG, NULL, NULL, _ARCHITECTURE_INVALID, ".raw", &rp, NULL, &rm, &rv, &ra) == -ENOTDIR);

        /* Specify an explicit path */
        free(pp);
        pp = path_join(p, "foo.v/foo_5.raw");
        assert_se(pp);
        assert_se(path_pick(pp, S_IFDIR, NULL, NULL, _ARCHITECTURE_INVALID, ".raw", &rp, NULL, &rm, &rv, &ra) == -ENOTDIR);
        assert_se(path_pick(pp, S_IFREG, NULL, NULL, _ARCHITECTURE_INVALID, ".raw", &rp, NULL, &rm, &rv, &ra) > 0);
        assert_se(S_ISREG(rm));
        assert_se(!rv);
        assert_se(ra == _ARCHITECTURE_INVALID);
