...
TEST(strv_env_merge) {
        ...
        _cleanup_(strv_freep) char **r = strv_env_merge(NULL, a, NULL, b, NULL, a, b, b, NULL);
        assert_se(r);
...
TEST(replace_env_argv_bad) {
        ...
        _cleanup_(strv_freep) char **bad = NULL, **unset = NULL, **replaced = NULL;
...
TEST(env_clean) {
        _cleanup_(strv_freep) char **e = strv_new("FOOBAR=WALDO",
                                                "FOOBAR=WALDO",
                                                "FOOBAR",
                                                "F",
                                                "X=",
...
TEST(getenv_path_list) {
        _cleanup_(strv_freep) char **path_list = NULL;
