...
static void test_cg_mask_to_string(void) {
        ...
        test_cg_mask_to_string_one(_CGROUP_MASK_ALL, "cpu cpuacct cpuset io blkio memory devices pids bpf-firewall bpf-devices perf_event");
        ...
        test_cg_mask_to_string_one(CGROUP_MASK_PERF_EVENT, "perf_event");
        ...
        test_cg_mask_to_string_one(CGROUP_MASK_CPU|CGROUP_MASK_PERF_EVENT, "cpu perf_event");
