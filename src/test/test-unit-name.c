...
static void test_unit_name_replace_instance_one(
                const char *pattern, const char *repl, const char *expected, int ret) {
...
TEST(unit_name_is_hashed) {
        ...
        assert_se(!unit_name_is_hashed(
                        "waldoaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa_7736D9ED33C2EC55.mount"));
        assert_se(!unit_name_is_hashed(
                        "waldoaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa!7736d9ed33c2ec55.mount"));
        assert_se(!unit_name_is_hashed(
                        "waldoaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa_7736d9gd33c2ec55.mount"));
        assert_se(!unit_name_is_hashed(
                        "waldoaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa_.mount"));
        assert_se(!unit_name_is_hashed(
                        "waldoaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa_2103e1466b87f7f7@waldo.mount"));
        assert_se(!unit_name_is_hashed(
                        "waldoaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa_2103e1466b87f7f7@.mount"));
}
...
static void test_unit_name_mangle_one(bool allow_globs, const char *pattern, const char *expect, int ret) {
        ...
        assert_se(unit_name_mangle(pattern, (allow_globs * UNIT_NAME_MANGLE_GLOB) | UNIT_NAME_MANGLE_WARN, &t) ==
                  ret);
        puts(strna(t));
        ...
        if (t) {
                ...
                assert_se(unit_name_mangle(t, (allow_globs * UNIT_NAME_MANGLE_GLOB) | UNIT_NAME_MANGLE_WARN, &k) ==
                          0);
...
TEST_RET(unit_printf, .sd_booted = true) {
        _cleanup_free_ char *architecture, *os_image_version, *boot_id, *os_build_id, *hostname,
                        *short_hostname, *pretty_hostname, *machine_id, *os_image_id, *os_id, *os_version_id,
                        *os_variant_id, *user, *group, *uid, *gid, *home, *shell, *tmp_dir, *var_tmp_dir;
...
TEST(unit_name_from_dbus_path) {
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/accounts_2ddaemon_2eservice",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/dracut_2dcmdline_2eservice",
                        0,
                        "dracut-cmdline.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/dracut_2dinitqueue_2eservice",
                        0,
                        "dracut-initqueue.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/dracut_2dmount_2eservice", 0, "dracut-mount.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/dracut_2dpre_2dmount_2eservice",
                        0,
                        "dracut-pre-mount.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/dracut_2dpre_2dpivot_2eservice",
                        0,
                        "dracut-pre-pivot.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/dracut_2dpre_2dtrigger_2eservice",
                        0,
                        "dracut-pre-trigger.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/dracut_2dpre_2dudev_2eservice",
                        0,
                        "dracut-pre-udev.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/dracut_2dshutdown_2eservice",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/fedora_2dimport_2dstate_2eservice",
                        0,
                        "fedora-import-state.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/fedora_2dreadonly_2eservice",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/initrd_2dcleanup_2eservice",
                        0,
                        "initrd-cleanup.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/initrd_2dfs_2etarget", 0, "initrd-fs.target");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/initrd_2dparse_2detc_2eservice",
                        0,
                        "initrd-parse-etc.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/initrd_2droot_2ddevice_2etarget",
                        0,
                        "initrd-root-device.target");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/initrd_2droot_2dfs_2etarget",
                        0,
                        "initrd-root-fs.target");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/initrd_2dswitch_2droot_2eservice",
                        0,
                        "initrd-switch-root.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/initrd_2dswitch_2droot_2etarget",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/kmod_2dstatic_2dnodes_2eservice",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/remote_2dcryptsetup_2etarget",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/sshd_2dkeygen_40ecdsa_2eservice",
                        0,
                        "sshd-keygen@ecdsa.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/sshd_2dkeygen_40ed25519_2eservice",
                        0,
                        "sshd-keygen@ed25519.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/sshd_2dkeygen_40rsa_2eservice",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/sys_2dkernel_2dconfig_2emount",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/sys_2dmodule_2dconfigfs_2edevice",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/system_2dsshd_5cx2dkeygen_2eslice",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2dbinfmt_2eservice",
                        0,
                        "systemd-binfmt.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2dcoredump_2esocket",
                        0,
                        "systemd-coredump.socket");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2dcoredump_400_2eservice",
                        0,
                        "systemd-coredump@0.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2dfirstboot_2eservice",
                        0,
                        "systemd-firstboot.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2dfsck_2droot_2eservice",
                        0,
                        SPECIAL_FSCK_ROOT_SERVICE);
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2dhwdb_2dupdate_2eservice",
                        0,
                        "systemd-hwdb-update.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2dinitctl_2eservice",
                        0,
                        "systemd-initctl.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2dinitctl_2esocket",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2dlogind_2eservice",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2dnetworkd_2esocket",
                        0,
                        "systemd-networkd.socket");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2drandom_2dseed_2eservice",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2dresolved_2eservice",
                        0,
                        "systemd-resolved.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2drfkill_2eservice",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2dsysusers_2eservice",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2dudevd_2dkernel_2esocket",
                        0,
                        "systemd-udevd-kernel.socket");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2dudevd_2eservice", 0, "systemd-udevd.service");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2dupdate_2ddone_2eservice",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/systemd_2dupdate_2dutmp_2eservice",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/unbound_2danchor_2eservice",
                        0,
        ...
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/usr_2dlocal_2dtexlive_2emount",
                        0,
                        "usr-local-texlive.mount");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/var_2dlib_2dmachines_2emount",
                        0,
                        "var-lib-machines.mount");
        test_unit_name_from_dbus_path_one(
                        "/org/freedesktop/systemd1/unit/wpa_5fsupplicant_2eservice",
                        0,
