...
TEST(pidref_from_same_root_fs) {
        ...
        ASSERT_OK_EQ_ERRNO(pidref_from_same_root_fs(&self, &self), true);

        r = pidref_from_same_root_fs(&pid1, &pid1);
        ASSERT_OK_EQ_ERRNO(r, true);
        ...
        ASSERT_OK_EQ_ERRNO(pidref_from_same_root_fs(&self, &child1), true);
        ...
        ASSERT_OK_EQ_ERRNO(pidref_from_same_root_fs(&self, &child2), false);
}
