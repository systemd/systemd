 ...
 *
 * Without checking si_code first, exit codes would be confused with signal numbers. For example, if a child
 * exits with code 6, it would incorrectly look like SIGABRT.
 *
