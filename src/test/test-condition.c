...
TEST(condition_test_systemd_version) {
        Condition *condition;
        const char *v;
        char ver[8];

        ASSERT_NOT_NULL(condition = condition_new(CONDITION_SYSTEMD_VERSION, "*thisreallyshouldntbeinthesystemdversion*", false, false));
        ASSERT_OK_ZERO(condition_test(condition, environ));
        condition_free(condition);

        ASSERT_NOT_NULL(condition = condition_new(CONDITION_SYSTEMD_VERSION, "*", false, false));
        ASSERT_OK_POSITIVE(condition_test(condition, environ));
        condition_free(condition);
        ...
        ASSERT_NOT_NULL(condition = condition_new(CONDITION_SYSTEMD_VERSION, "> 42", false, false));
        ASSERT_OK_POSITIVE(condition_test(condition, environ));
        condition_free(condition);
        ...
        ASSERT_NOT_NULL(condition = condition_new(CONDITION_SYSTEMD_VERSION, "'>42' '<9000'", false, false));
        ASSERT_OK_POSITIVE(condition_test(condition, environ));
        condition_free(condition);
        ...
        ASSERT_NOT_NULL(condition = condition_new(CONDITION_SYSTEMD_VERSION, "< 9000", false, false));
        ASSERT_OK_POSITIVE(condition_test(condition, environ));
        condition_free(condition);
        ...
        v = strjoina(">=", ver);
        ASSERT_NOT_NULL(condition = condition_new(CONDITION_SYSTEMD_VERSION, v, false, false));
        ASSERT_OK_POSITIVE(condition_test(condition, environ));
        condition_free(condition);
