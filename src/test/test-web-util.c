...
TEST(url_add_port) {
        ...
        ASSERT_STREQ(u, "http://192.0.2.0:19532/journal/upload");
        u = mfree(u);
        u = http_url_add_port("http://192.0.2.0/journal", "19532");
        ASSERT_STREQ(u, "http://192.0.2.0:19532/journal/upload");
        u = mfree(u);
        u = http_url_add_port("http://[2001:db8::1]/journal", "19532");
        ASSERT_STREQ(u, "http://[2001:db8::1]:19532/journal/upload");
        u = mfree(u);
        u = http_url_add_port("http://test.example.com/journal", "19532");
        ASSERT_STREQ(u, "http://test.example.com:19532/journal/upload");
        u = mfree(u);
        u = http_url_add_port("http://ssyytteemmdd", "19532");
        ASSERT_STREQ(u, "http://ssyytteemmdd:19532/upload");
        u = mfree(u);
        u = http_url_add_port("https://192.0.2.0:443/journal/", "19532");
        ASSERT_STREQ(u, "https://192.0.2.0:443/journal/upload");
        u = mfree(u);
        u = http_url_add_port("https://192.0.2.0/journal/", "19532");
        ASSERT_STREQ(u, "https://192.0.2.0:19532/journal/upload");
        u = mfree(u);
        u = http_url_add_port("https://[2001:db8::1]:443/journal", "19532");
        ASSERT_STREQ(u, "https://[2001:db8::1]:443/journal/upload");
        u = mfree(u);
        u = http_url_add_port("https://[2001:db8::1]/journal", "19532");
        ASSERT_STREQ(u, "https://[2001:db8::1]:19532/journal/upload");
        u = mfree(u);
        u = http_url_add_port("ssyytteemmdd/journal", "19532");
        ASSERT_STREQ(u, "https://ssyytteemmdd:19532/journal/upload");
        u = mfree(u);
        u = http_url_add_port("ssyytteemmdd:443", "19532");
        ASSERT_STREQ(u, "https://ssyytteemmdd:443/upload");
        u = mfree(u);
        u = http_url_add_port("ssyytteemmdd", "19532");
        ASSERT_STREQ(u, "https://ssyytteemmdd:19532/upload");
        u = mfree(u);
}
