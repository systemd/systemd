...
static void test_dns_name_between(void) {
        ...
        test_dns_name_between_one("zABC.a.EXAMPLE", "z.example", "\001.z.example", true);
        test_dns_name_between_one("z.example", "\001.z.example", "*.z.example", true);
        test_dns_name_between_one("\001.z.example", "*.z.example", "\200.z.example", true);
