...
TEST(format_bytes) {
        test_format_bytes_one(900, /* trailing_B= */ true, "900B", "900B", "900B", "900B", "900B", "900B");
        test_format_bytes_one(900, /* trailing_B= */ false, "900", "900", "900", "900", "900", "900");
        test_format_bytes_one(1023, /* trailing_B= */ true, "1023B", "1023B", "1023B", "1K", "1K", "1.0K");
        test_format_bytes_one(1023, /* trailing_B= */ false, "1023", "1023", "1023", "1K", "1K", "1.0K");
        test_format_bytes_one(1024, /* trailing_B= */ true, "1K", "1K", "1.0K", "1K", "1K", "1.0K");
        test_format_bytes_one(1024, /* trailing_B= */ false, "1K", "1K", "1.0K", "1K", "1K", "1.0K");
        test_format_bytes_one(1100, /* trailing_B= */ true, "1K", "1K", "1.0K", "1.1K", "1K", "1.1K");
        test_format_bytes_one(1500, /* trailing_B= */ true, "1.4K", "1K", "1.4K", "1.5K", "1K", "1.5K");
        test_format_bytes_one(UINT64_C(3)*1024*1024, /* trailing_B= */ true, "3M", "3M", "3.0M", "3.1M", "3M", "3.1M");
        test_format_bytes_one(UINT64_C(3)*1024*1024*1024, /* trailing_B= */ true, "3G", "3G", "3.0G", "3.2G", "3G", "3.2G");
        test_format_bytes_one(UINT64_C(3)*1024*1024*1024*1024, /* trailing_B= */ true, "3T", "3T", "3.0T", "3.2T", "3T", "3.2T");
        test_format_bytes_one(UINT64_C(3)*1024*1024*1024*1024*1024, /* trailing_B= */ true, "3P", "3P", "3.0P", "3.3P", "3P", "3.3P");
        test_format_bytes_one(UINT64_C(3)*1024*1024*1024*1024*1024*1024, /* trailing_B= */ true, "3E", "3E", "3.0E", "3.4E", "3E", "3.4E");
