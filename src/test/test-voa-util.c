...
TEST(voa_list_verifiers) {
        ...
        add_symlink(root, "/usr/local/share/voa/testos" X509_DIR "d-certificate.pem", "../../../../../../../share/voa/testos" X509_DIR "d-certificate.pem");
        ...
        add_symlink(root, "/etc/voa/testos" X509_DIR "e-certificate.pem", "/usr/share/voa/testos" X509_DIR "f-certificate.pem");
        add_symlink(root, "/usr/share/voa/testos" X509_DIR "g-certificate.pem", "/etc/voa/testos" X509_DIR "g-certificate.pem");
        ...
        add_symlink(root, "/etc/voa/testos" X509_DIR "i-certificate.pem", "/run/voa/testos" X509_DIR "i-certificate.pem");
        add_file(root, "/run/voa/testos" X509_DIR "i-certificate.pem");
        add_symlink(root, "/etc/voa/testos" X509_DIR "j-certificate.pem", "/usr/share/voa/testos" X509_DIR "j-certificate.pem");
...
TEST(voa_list_verifiers_symlinked_load_path_parent) {
        ...
        add_symlink(root, "/etc/voa/testos" X509_DIR "a-certificate.pem", "../../../../../../usr/local/share/voa/testos" X509_DIR "a-certificate.pem");
