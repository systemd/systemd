...
TEST(parse_timestamp) {
        ...
        /* Japan (+0900) */
        test_parse_timestamp_one("Thu 1970-01-01 09:01 Japan", 0, USEC_PER_MINUTE);
        test_parse_timestamp_one("Thu 1970-01-01 09:00:01 Japan", 0, USEC_PER_SEC);
        test_parse_timestamp_one("Thu 1970-01-01 09:00:01.001 Japan", 0, USEC_PER_SEC + 1000);
        test_parse_timestamp_one("Thu 1970-01-01 09:00:01.0010 Japan", 0, USEC_PER_SEC + 1000);

        test_parse_timestamp_one("Thu 70-01-01 09:01 Japan", 0, USEC_PER_MINUTE);
        test_parse_timestamp_one("Thu 70-01-01 09:00:01 Japan", 0, USEC_PER_SEC);
        test_parse_timestamp_one("Thu 70-01-01 09:00:01.001 Japan", 0, USEC_PER_SEC + 1000);
        test_parse_timestamp_one("Thu 70-01-01 09:00:01.0010 Japan", 0, USEC_PER_SEC + 1000);

        test_parse_timestamp_one("1970-01-01 09:01 Japan", 0, USEC_PER_MINUTE);
        test_parse_timestamp_one("1970-01-01 09:00:01 Japan", 0, USEC_PER_SEC);
        test_parse_timestamp_one("1970-01-01 09:00:01.001 Japan", 0, USEC_PER_SEC + 1000);
        test_parse_timestamp_one("1970-01-01 09:00:01.0010 Japan", 0, USEC_PER_SEC + 1000);

        test_parse_timestamp_one("70-01-01 09:01 Japan", 0, USEC_PER_MINUTE);
        test_parse_timestamp_one("70-01-01 09:00:01 Japan", 0, USEC_PER_SEC);
        test_parse_timestamp_one("70-01-01 09:00:01.001 Japan", 0, USEC_PER_SEC + 1000);
        test_parse_timestamp_one("70-01-01 09:00:01.0010 Japan", 0, USEC_PER_SEC + 1000);
