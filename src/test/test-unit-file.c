...
TEST(unit_file_build_name_map) {
        ...
        _cleanup_(hashmap_freep) Hashmap *unit_ids = NULL;
        _cleanup_(hashmap_freep) Hashmap *unit_names = NULL;
        const char *k, *dst;
        char **v, **ids;
        usec_t mtime = 0;
        int r;
...
static bool test_unit_file_remove_from_name_map_trail(const LookupPaths *lp, size_t trial) {
        ...
        _cleanup_(set_freep) Set *path_cache = NULL;
        ...
        _cleanup_(hashmap_freep) Hashmap *unit_ids_2 = NULL, *unit_names_2 = NULL;
        _cleanup_(set_freep) Set *path_cache_2 = NULL;
