...
int main(int argc, char *argv[]) {
        ...
        assert_se(test_socket_bind(m, "socket_bind_test.service", netcat_path, "10000", STRV_MAKE("ipv6:6:9999-10000"), STRV_MAKE("any")) >= 0);
        ...
        assert_se(test_socket_bind(m, "socket_bind_test.service", netcat_path, "6666", STRV_MAKE("ipv6:dccp:any"), STRV_MAKE("any")) >= 0);
        assert_se(test_socket_bind(m, "socket_bind_test.service", netcat_path, "6666", STRV_MAKE("ipv6:ip:any"), STRV_MAKE("any")) >= 0);
