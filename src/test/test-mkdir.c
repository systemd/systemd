...
TEST(mkdir_p_root_full) {
        ...
        ASSERT_EQ((nsec_t) st.st_mtim.tv_nsec, 2 * NSEC_PER_SEC);
        ASSERT_EQ((nsec_t) st.st_atim.tv_nsec, 2 * NSEC_PER_SEC);
        ...
        ASSERT_OK_ERRNO(stat(p, &st));
        ASSERT_EQ((nsec_t) st.st_mtim.tv_nsec, 90 * NSEC_PER_HOUR);
        ASSERT_EQ((nsec_t) st.st_atim.tv_nsec, 90 * NSEC_PER_HOUR);
}
