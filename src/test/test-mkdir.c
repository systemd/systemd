...
TEST(mkdir_p_root) {
        ...
        assert_se(mkdir_p_root(tmp, "/foo", UID_INVALID, GID_INVALID, 0755, NULL, 1234) >= 0);
        assert_se(is_dir(p, false) > 0);
        assert_se(is_dir(p, true) > 0);
        ...
        assert_se(mkdir_p_root(tmp, "/dir-not-exists/foo", UID_INVALID, GID_INVALID, 0755, NULL, 5678) >= 0);
        assert_se(is_dir(p, false) > 0);
        assert_se(is_dir(p, true) > 0);
