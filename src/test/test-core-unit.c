...
static void test_unit_escape_setting_one(
        ...
        ASSERT_TRUE(streq(t, expected_exec_env));
        ...
        ASSERT_TRUE(streq(t, expected_exec));
        ...
        ASSERT_TRUE(streq(t, expected_c));
}
