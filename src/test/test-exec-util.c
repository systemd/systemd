...
static void test_execute_directory_one(bool gather_stdout) {
        ...
        execute_directories(dirs, CALLOUT_TIMEOUT_USEC,
...
TEST(stdout_gathering) {
        ...
        r = execute_directories(dirs, CALLOUT_TIMEOUT_USEC,
                                gather_stdouts, args, NULL, NULL,
                                EXEC_DIR_PARALLEL | EXEC_DIR_IGNORE_ERRORS);
        assert_se(r >= 0);
...
TEST(error_catching) {
        ...
        r = execute_directories(dirs, CALLOUT_TIMEOUT_USEC, NULL, NULL, NULL, NULL, EXEC_DIR_NONE);
