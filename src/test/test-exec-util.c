...
static void test_execute_directory_one(bool gather_stdout) {
        static const char template_lo[] = "/tmp/test-exec-util.lo.XXXXXXX";
        static const char template_hi[] = "/tmp/test-exec-util.hi.XXXXXXX";
        ...
        assert_se(mkdtemp_malloc(template_lo, &tmp_lo) >= 0);
        assert_se(mkdtemp_malloc(template_hi, &tmp_hi) >= 0);
...
TEST(stdout_gathering) {
        static const char template[] = "/tmp/test-exec-util.XXXXXXX";
        ...
        assert_se(mkdtemp_malloc(template, &tmpdir) >= 0);
