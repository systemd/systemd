...
TEST(copy_tree_replace_file) {
        ...
        assert_se(read_full_file(dst, &buf, NULL) == 0);
...
TEST(copy_tree_replace_dirs) {
        _cleanup_free_ char *buf = NULL, *src_path1 = NULL, *src_path2 = NULL, *dst_path1 = NULL, *dst_path2 = NULL;
        _cleanup_(rm_rf_physical_and_freep) char *src_directory = NULL;
        _cleanup_(rm_rf_physical_and_freep) char *dst_directory = NULL;
        ...
        {
                assert_se(read_full_file(src_path1, &buf, NULL) == 0);
                assert_se(streq(buf, "src file 1\n"));

                assert_se(read_full_file(src_path2, &buf, NULL) == 0);
                assert_se(streq(buf, "src file 2\n"));

                assert_se(read_full_file(dst_path1, &buf, NULL) == 0);
                assert_se(streq(buf, "dest file 1\n"));

                assert_se(read_full_file(dst_path2, &buf, NULL) == 0);
