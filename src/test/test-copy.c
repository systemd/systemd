...
TEST(copy_tree_replace_dirs) {
        ...
        src_path1 = path_join(src_directory, file1);
        src_path2 = path_join(src_directory, file2);
        dst_path1 = path_join(dst_directory, file1);
        dst_path2 = path_join(dst_directory, file2);
