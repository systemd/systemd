...
TEST(set_steal_first) {
        _cleanup_(set_freep) Set *m = NULL;
        int seen[3] = {};
        char *val;
...
TEST(set_copy) {
        _cleanup_(set_freep) Set *s = NULL, *copy = NULL;
...
TEST(set_equal) {
        _cleanup_(set_freep) Set *a = NULL, *b = NULL;
        void *p;
        int r;
...
TEST(set_fnmatch) {
        _cleanup_(set_freep) Set *match = NULL, *nomatch = NULL;
