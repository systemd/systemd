...
TEST(mount_fd_clone) {
        ...
        _cleanup_close_ int first_clone = ASSERT_OK(mount_fd_clone(foreign_mount_fd, /* recursive= */ true, &foreign_mount_fd));
        _cleanup_close_ int second_clone = ASSERT_OK(mount_fd_clone(foreign_mount_fd, /* recursive= */ true, /* second_clone= */ NULL));
