...
TEST(strv_extend_strv_prepend_append) {
        ...
        assert_se(strv_extend_strv_prepend_append(&a, "prefix_", b, "_suffix") >= 0);
...
TEST(strv_extend_strv_append) {
        ...
        assert_se(strv_extend_strv_append(&a, b, "_suffix") >= 0);
