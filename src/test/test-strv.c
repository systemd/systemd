...
TEST(strv_sort_uniq) {
        ...
        _cleanup_(strv_freep) char **a = NULL, **b = NULL, **c = NULL;
...
TEST(strv_extend_strv) {
        _cleanup_(strv_freep) char **a = NULL, **b = NULL, **n = NULL;
...
TEST(strv_extend_strv_consume) {
        _cleanup_(strv_freep) char **a = NULL, **b = NULL, **c = NULL, **n = NULL;
        const char *s1, *s2, *s3;
...
TEST(strv_compare) {
        ...
        _cleanup_(strv_freep) char **c = NULL;
...
TEST(strv_is_uniq) {
        _cleanup_(strv_freep) char **a = NULL, **b = NULL, **c = NULL, **d = NULL;
...
TEST(strv_filter_prefix) {
        ...
        _cleanup_(strv_freep) char **x = ASSERT_PTR(strv_filter_prefix(base, "fo"));
