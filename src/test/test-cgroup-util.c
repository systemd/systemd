...
TEST(path_get_leaf_unit_path) {
        ...
        check_p_g_l_u_p("/system.slice/foo.service/bar.service", 0, "/system.slice/foo.service");
        ...
        check_p_g_l_u_p("/user.slice/user-1000.slice/user@1000.service/init.scope", 0, "/user.slice/user-1000.slice/user@1000.service/init.scope");
        ...
        check_p_g_l_u_p("", -ENXIO, NULL);
        check_p_g_l_u_p("/", -ENXIO, NULL);
        check_p_g_l_u_p("/foo.slice/bar.slice", -ENXIO, NULL);
        check_p_g_l_u_p("sadfdsafsda", -ENXIO, NULL);
}
