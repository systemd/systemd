...
int main(int argc, char *argv[]) {
        ...
        assert_se(unit_has_dependency(a, UNIT_ATOM_PULL_IN_MATTERS, manager_get_unit(m, "non-existing.mount")));
        ...
        UNIT_FOREACH_DEPENDENCY(other, a, UNIT_ATOM_PULL_IN_MATTERS)
