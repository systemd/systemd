...
TEST(gpt_probe_sector_512) {
        ...
        ASSERT_EQ(memcmp(e[0].unique_partition_guid, entries[0].unique_partition_guid, 16), 0);
        ASSERT_EQ(memcmp(e[1].unique_partition_guid, entries[1].unique_partition_guid, 16), 0);
...
TEST(gpt_probe_sector_4096) {
        ...
        GptPartitionEntry *e = ret_entries;
        ASSERT_EQ(memcmp(e[0].unique_partition_guid, entry.unique_partition_guid, 16), 0);
