...
TEST(align_to) {
        ...
        assert_se(ALIGN_TO_64(0, 1) == 0);
        assert_se(ALIGN_TO_64(1, 1) == 1);
        assert_se(ALIGN_TO_64(2, 1) == 2);
        assert_se(ALIGN_TO_64(3, 1) == 3);
        assert_se(ALIGN_TO_64(4, 1) == 4);
        assert_se(ALIGN_TO_64(UINT64_MAX-1, 1) == UINT64_MAX-1);
        assert_se(ALIGN_TO_64(UINT64_MAX, 1) == UINT64_MAX);

        assert_se(ALIGN_TO_64(0, 2) == 0);
        assert_se(ALIGN_TO_64(1, 2) == 2);
        assert_se(ALIGN_TO_64(2, 2) == 2);
        assert_se(ALIGN_TO_64(3, 2) == 4);
        assert_se(ALIGN_TO_64(4, 2) == 4);
        assert_se(ALIGN_TO_64(UINT64_MAX-3, 2) == UINT64_MAX-3);
        assert_se(ALIGN_TO_64(UINT64_MAX-2, 2) == UINT64_MAX-1);
        assert_se(ALIGN_TO_64(UINT64_MAX-1, 2) == UINT64_MAX-1);
        assert_se(ALIGN_TO_64(UINT64_MAX, 2) == UINT64_MAX); /* overflow */

        assert_se(ALIGN_TO_64(0, 4) == 0);
        assert_se(ALIGN_TO_64(1, 4) == 4);
        assert_se(ALIGN_TO_64(2, 4) == 4);
        assert_se(ALIGN_TO_64(3, 4) == 4);
        assert_se(ALIGN_TO_64(4, 4) == 4);
        assert_se(ALIGN_TO_64(UINT64_MAX-3, 4) == UINT64_MAX-3);
        assert_se(ALIGN_TO_64(UINT64_MAX-2, 4) == UINT64_MAX); /* overflow */
        assert_se(ALIGN_TO_64(UINT64_MAX-1, 4) == UINT64_MAX); /* overflow */
        assert_se(ALIGN_TO_64(UINT64_MAX, 4) == UINT64_MAX);   /* overflow */
...
TEST(align_down) {
        ...
        assert_se(ALIGN_DOWN_64(0, 1) == 0);
        assert_se(ALIGN_DOWN_64(1, 1) == 1);
        assert_se(ALIGN_DOWN_64(2, 1) == 2);
        assert_se(ALIGN_DOWN_64(3, 1) == 3);
        assert_se(ALIGN_DOWN_64(4, 1) == 4);
        assert_se(ALIGN_DOWN_64(UINT64_MAX-1, 1) == UINT64_MAX-1);
        assert_se(ALIGN_DOWN_64(UINT64_MAX, 1) == UINT64_MAX);

        assert_se(ALIGN_DOWN_64(0, 2) == 0);
        assert_se(ALIGN_DOWN_64(1, 2) == 0);
        assert_se(ALIGN_DOWN_64(2, 2) == 2);
        assert_se(ALIGN_DOWN_64(3, 2) == 2);
        assert_se(ALIGN_DOWN_64(4, 2) == 4);
        assert_se(ALIGN_DOWN_64(UINT64_MAX-1, 2) == UINT64_MAX-1);
        assert_se(ALIGN_DOWN_64(UINT64_MAX, 2) == UINT64_MAX-1);

        assert_se(ALIGN_DOWN_64(0, 4) == 0);
        assert_se(ALIGN_DOWN_64(1, 4) == 0);
        assert_se(ALIGN_DOWN_64(2, 4) == 0);
        assert_se(ALIGN_DOWN_64(3, 4) == 0);
        assert_se(ALIGN_DOWN_64(4, 4) == 4);
        assert_se(ALIGN_DOWN_64(UINT64_MAX-1, 4) == UINT64_MAX-3);
        assert_se(ALIGN_DOWN_64(UINT64_MAX, 4) == UINT64_MAX-3);
}
...
TEST(align_offset) {
        ...
        assert_se(ALIGN_OFFSET_64(0, 1) == 0);
        assert_se(ALIGN_OFFSET_64(1, 1) == 0);
        assert_se(ALIGN_OFFSET_64(2, 1) == 0);
        assert_se(ALIGN_OFFSET_64(3, 1) == 0);
        assert_se(ALIGN_OFFSET_64(4, 1) == 0);
        assert_se(ALIGN_OFFSET_64(UINT64_MAX-1, 1) == 0);
        assert_se(ALIGN_OFFSET_64(UINT64_MAX, 1) == 0);

        assert_se(ALIGN_OFFSET_64(0, 2) == 0);
        assert_se(ALIGN_OFFSET_64(1, 2) == 1);
        assert_se(ALIGN_OFFSET_64(2, 2) == 0);
        assert_se(ALIGN_OFFSET_64(3, 2) == 1);
        assert_se(ALIGN_OFFSET_64(4, 2) == 0);
        assert_se(ALIGN_OFFSET_64(UINT64_MAX-1, 2) == 0);
        assert_se(ALIGN_OFFSET_64(UINT64_MAX, 2) == 1);

        assert_se(ALIGN_OFFSET_64(0, 4) == 0);
        assert_se(ALIGN_OFFSET_64(1, 4) == 1);
        assert_se(ALIGN_OFFSET_64(2, 4) == 2);
        assert_se(ALIGN_OFFSET_64(3, 4) == 3);
        assert_se(ALIGN_OFFSET_64(4, 4) == 0);
        assert_se(ALIGN_OFFSET_64(UINT64_MAX-1, 4) == 2);
        assert_se(ALIGN_OFFSET_64(UINT64_MAX, 4) == 3);
}
