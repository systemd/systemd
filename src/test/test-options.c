...
static void test_macros_parse_one(
        ...
        OptionParser state = { argc, argv, .return_positional_args = return_positional_args };
        const Option *opt;
        const char *arg;
