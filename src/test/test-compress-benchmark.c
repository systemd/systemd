...
typedef int(decompress_t)(const void *src, uint64_t src_size, void **dst, size_t *dst_size, size_t dst_max);
...
static void test_compress_decompress(
                const char *label, const char *type, compress_t compress, decompress_t decompress) {
        usec_t n, n2 = 0;
        float dt;
