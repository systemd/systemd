...
static void test_parse_cpu_set(void) {
        ...
        ncpus = parse_cpu_set("3-0", &c, NULL, "fake", 1, "CPUAffinity");
        assert_se(ncpus >= 1024);
        assert_se(CPU_COUNT_S(CPU_ALLOC_SIZE(ncpus), c) == 0);
        c = mfree(c);

        /* Overlapping ranges */
        ncpus = parse_cpu_set("0-7 4-11", &c, NULL, "fake", 1, "CPUAffinity");
        assert_se(ncpus >= 1024);
        ...
        ncpus = parse_cpu_set("0,1 4-11", &c, NULL, "fake", 1, "CPUAffinity");
        assert_se(ncpus >= 1024);
        ...
        /* Range with garbage */
        ncpus = parse_cpu_set("0-3 8-garbage", &c, NULL, "fake", 1, "CPUAffinity");
        assert_se(ncpus < 0);
        assert_se(!c);
