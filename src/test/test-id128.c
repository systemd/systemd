...
int main(int argc, char *argv[]) {
        ...
        assert_se(sd_id128_equals(id, id));
        assert_se(sd_id128_equals(id, id2));
        assert_se(sd_id128_equals(id, id2, id));
        assert_se(sd_id128_equals(id, ID128_WALDI, id));
        assert_se(!sd_id128_equals(id));
        assert_se(!sd_id128_equals(id, ID128_WALDI));
        assert_se(!sd_id128_equals(id, ID128_WALDI, ID128_WALDI));
