...
TEST(id128) {
        ...
        assert_se(id128_from_string_not_null(STR_WALDI, &id) == 0);
        assert_se(id128_from_string_not_null(STR_NULL, &id) == -ENXIO);
        assert_se(id128_from_string_not_null("01020304-0506-0708-090a-0b0c0d0e0f101", &id) < 0);
        assert_se(id128_from_string_not_null("01020304-0506-0708-090a-0b0c0d0e0f10-", &id) < 0);
        assert_se(id128_from_string_not_null("01020304-0506-0708-090a0b0c0d0e0f10", &id) < 0);
        assert_se(id128_from_string_not_null("010203040506-0708-090a-0b0c0d0e0f10", &id) < 0);
