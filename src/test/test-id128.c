...
TEST(id128) {
        ...
        ASSERT_TRUE(sd_id128_equal(id, id2));
        ...
        ASSERT_TRUE(sd_id128_equal(id, SD_ID128_MAKE(1d,ee,59,54,e7,5c,4d,6f,b9,6c,c6,c0,4c,a1,8a,86)));
        ...
        if (sd_booted() > 0 && sd_id128_get_machine(NULL) >= 0) {
                ...
                ASSERT_FALSE(sd_id128_equal(id, id2));
        }
...
TEST(id128_at) {
        ...
        ASSERT_OK(tfd);
        ASSERT_OK(mkdirat(tfd, "etc", 0755));
        ASSERT_OK(symlinkat("etc", tfd, "etc2"));
        ...
        ASSERT_TRUE(sd_id128_equal(id, i));
