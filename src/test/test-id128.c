...
TEST(id128) {
        ...
        assert_se(id128_read_fd(fd, ID128_FORMAT_PLAIN, &id2) == -EIO);
        ...
        assert_se(lseek(fd, 0, SEEK_SET) == 0);
        assert_se(id128_read_fd(fd, ID128_FORMAT_UUID, &id2) == -EIO);
        ...
        assert_se(lseek(fd, 0, SEEK_SET) == 0);
        assert_se(id128_read_fd(fd, ID128_FORMAT_ANY, NULL) == -EIO);
