...
TEST(json_dispatch) {
        ...
        sd_json_dispatch_field table[] = {
                ...
                { "o", _SD_JSON_VARIANT_TYPE_INVALID, sd_json_dispatch_int16,  offsetof(struct foobar, o) },
                { "p", _SD_JSON_VARIANT_TYPE_INVALID, sd_json_dispatch_int16,  offsetof(struct foobar, p) },
                {}
        };
