...
static void test_float_match(JsonVariant *v) {
        ...
        assert_se(json_variant_integer(json_variant_by_index(v, 7)) == (json_variant_is_integer(json_variant_by_index(v, 7)) ? 10 : 0));
        assert_se(json_variant_is_real(json_variant_by_index(v, 8)));
        assert_se(json_variant_is_integer(json_variant_by_index(v, 8)));
        assert_se(json_variant_integer(json_variant_by_index(v, 8)) == (json_variant_is_integer(json_variant_by_index(v, 8)) ? -10 : 0));
