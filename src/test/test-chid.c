...
static const char16_t *const test_fields[_CHID_SMBIOS_FIELDS_MAX] = {
        ...
        [CHID_SMBIOS_BIOS_VENDOR]            = u"American Megatrends International, LLC.",
        [CHID_SMBIOS_BIOS_VERSION]           = u"1.E5",
        [CHID_SMBIOS_BIOS_MAJOR]             = u"05",
        [CHID_SMBIOS_BIOS_MINOR]             = u"20",
...
static const EFI_GUID actual_chids[CHID_TYPES_MAX] = {
        {0xf59668ca, 0x22bc, 0x52a0, {0xb6, 0xb5, 0x1f, 0x6c, 0xe8, 0x1b, 0x08, 0xe0}},
        {0xf735f7a0, 0x40da, 0x5bfe, {0x8a, 0xc2, 0x00, 0x90, 0x53, 0x2e, 0xe6, 0xd0}},
        {0x25880e68, 0xe005, 0x5ca7, {0x88, 0xb6, 0x65, 0x0d, 0xe5, 0x96, 0x60, 0x4f}},
