...
static int pre_labelling_func(int dir_fd, const char *path, mode_t mode, void *label_userdata) {
        int r;
...
static int post_labelling_func(int dir_fd, const char *path, bool created, void *label_userdata) {
       int r;
