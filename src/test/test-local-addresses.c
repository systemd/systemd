...
TEST(local_addresses_with_dummy) {
        ...
        union in_addr_union u;
        int ifindex, ifindex2, p2p_ifindex = 0, r;
        ...
        uint32_t gatewayless_weight = 17;
        ASSERT_OK(sd_rtnl_message_new_route(rtnl, &message, RTM_NEWROUTE, AF_INET, RTPROT_STATIC));
        ASSERT_OK(sd_rtnl_message_route_set_scope(message, RT_SCOPE_LINK));
        ASSERT_OK(sd_rtnl_message_route_set_type(message, RTN_UNICAST));
        ASSERT_OK(sd_netlink_message_append_u32(message, RTA_PRIORITY, 3345));
        ASSERT_OK(sd_netlink_message_append_u32(message, RTA_TABLE, RT_TABLE_MAIN));
        ...
        check_local_gateway_peer(rtnl, p2p_ifindex, 0, AF_UNSPEC, 3345, gatewayless_weight, AF_INET, "10.124.0.2", NULL);
        check_local_gateway_peer(
                        rtnl, p2p_ifindex, p2p_ifindex, AF_UNSPEC, 3345, gatewayless_weight,
                        AF_INET, "10.124.0.2", NULL);
        check_local_gateway_peer(
                        rtnl, p2p_ifindex, 0, AF_UNSPEC, 2345, 0,
                        AF_INET6, "2001:db8:2:123::2", NULL);
        check_local_gateway_peer(
                        rtnl, p2p_ifindex, p2p_ifindex, AF_UNSPEC, 2345, 0,
                        AF_INET6, "2001:db8:2:123::2", NULL);
        check_local_gateway_peer(rtnl, p2p_ifindex, 0, AF_INET, 3345, gatewayless_weight, AF_INET, "10.124.0.2", NULL);
        check_local_gateway_peer(
                        rtnl, p2p_ifindex, p2p_ifindex, AF_INET, 3345, gatewayless_weight,
                        AF_INET, "10.124.0.2", NULL);
        check_local_gateway_peer(
                        rtnl, p2p_ifindex, 0, AF_INET6, 2345, 0,
                        AF_INET6, "2001:db8:2:123::2", NULL);
        check_local_gateway_peer(
                        rtnl, p2p_ifindex, p2p_ifindex, AF_INET6, 2345, 0,
                        AF_INET6, "2001:db8:2:123::2", NULL);
        ...
        check_no_local_gateway_with_priority(rtnl, 0, AF_INET6, 2346);
        check_no_local_gateway_with_priority(rtnl, p2p_ifindex, AF_INET6, 2346);
        ...
        check_local_outbound_address(rtnl, 0, AF_INET6, p2p_ifindex, AF_INET6, "2001:db8:2:123::1", true);
        check_local_outbound_address(rtnl, p2p_ifindex, AF_INET6, p2p_ifindex, AF_INET6, "2001:db8:2:123::1", true);
