...
TEST(keyring_ops) {
        ...
        ASSERT_OK(keyring_count(ring, &n));
        ASSERT_EQ(n, 0u);
        ...
        ASSERT_OK(keyring_restrict(ring, NULL, NULL));
        ASSERT_ERROR(keyring_restrict(ring, NULL, NULL), EEXIST);
        ...
        ASSERT_ERROR(keyring_restrict(ring, NULL, NULL), EACCES);
