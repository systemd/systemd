...
int main(int argc, const char *argv[]) {
        ...
        FOREACH_ELEMENT(item, items) {
                LIST_INIT(item_list, items);
                assert_se(LIST_JUST_US(item_list, items));
                assert_se(LIST_PREPEND(item_list, head, items) == items);
        }
        ...
        FOREACH_ELEMENT(item, items) {
                assert_se(LIST_JUST_US(item_list, items));
                assert_se(LIST_APPEND(item_list, head, items) == item);
        }
