...
TEST(uid_range_intersect) {
        ...
        ASSERT_OK(uid_range_intersect(p, 0, 1000));
        ASSERT_EQ(uid_range_entries(p), 3U);
        ...
        ASSERT_OK(uid_range_intersect(p, 200, 499));
        ASSERT_EQ(uid_range_entries(p), 1U);
        ...
        ASSERT_OK(uid_range_add_str(&p, "100-199"));
        ASSERT_OK(uid_range_intersect(p, 150, 180));
        ASSERT_EQ(uid_range_entries(p), 1U);
        ...
        ASSERT_OK(uid_range_add_str(&p, "100-199"));
        ASSERT_OK(uid_range_intersect(p, 500, 600));
        ASSERT_TRUE(uid_range_is_empty(p));
        ...
        ASSERT_OK(uid_range_add_str(&p, "100-199"));
        ASSERT_ERROR(uid_range_intersect(p, 200, 100), EINVAL);
}
