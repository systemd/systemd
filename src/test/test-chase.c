...
TEST(chase_and_open) {
        ...
        fd = ASSERT_OK(chase_and_open("/usr/lib", NULL, 0, O_PATH|O_DIRECTORY, &result));
        ...
        fd = ASSERT_OK(chase_and_open("/usr/lib", NULL, CHASE_PARENT, O_PATH|O_DIRECTORY, &result));
        ASSERT_OK(fd_verify_directory(fd));
        ...
        fd = ASSERT_OK(chase_and_open("/usr/lib", NULL, CHASE_PARENT|CHASE_EXTRACT_FILENAME, O_PATH|O_DIRECTORY, &result));
        ASSERT_OK(fd_verify_directory(fd));
        ASSERT_OK_ERRNO(faccessat(fd, "lib", F_OK, 0));
        ...
        fd = ASSERT_OK(chase_and_open("/usr/lib", NULL, CHASE_EXTRACT_FILENAME, O_PATH|O_DIRECTORY, &result));
        ASSERT_OK(fd_verify_directory(fd));
        ASSERT_STREQ(result, "lib");
        fd = safe_close(fd);
        result = mfree(result);
        ...
        fd = ASSERT_OK(chase_and_open("/etc/os-release", NULL, CHASE_EXTRACT_FILENAME, O_PATH, &result));
        ...
        fd = ASSERT_OK(chase_and_open("/etc/os-release", NULL, CHASE_PARENT, O_PATH|O_DIRECTORY, &result));
        ASSERT_OK(fd_verify_directory(fd));
         ...
         * symlink is opened. */
        fd = ASSERT_OK(chase_and_open("/etc/os-release", NULL, CHASE_PARENT|CHASE_NOFOLLOW, O_PATH|O_DIRECTORY, &result));
        ASSERT_OK(fd_verify_directory(fd));
        ...
        fd = ASSERT_OK(chase_and_open("/etc/os-release", NULL, CHASE_PARENT|CHASE_NOFOLLOW|CHASE_EXTRACT_FILENAME, O_PATH|O_DIRECTORY, &result));
        ASSERT_OK(fd_verify_directory(fd));
        ASSERT_OK_ERRNO(faccessat(fd, "os-release", F_OK, AT_SYMLINK_NOFOLLOW));
        ASSERT_STREQ(result, "os-release");
        fd = safe_close(fd);
        ...
        fd = ASSERT_OK(chase_and_open(link_path, tmpdir, 0, O_PATH|O_DIRECTORY, &result));
        ASSERT_OK(fd_verify_directory(fd));
...
TEST(chaseat) {
        ...
        fd = ASSERT_OK(open_mkdir_at(tfd, "chase", 0, 0755));
        ...
        fd = ASSERT_OK(chase_and_openat(XAT_FDROOT, tfd, "o/p/e/n/f/i/l/e", CHASE_MKDIR_0755, O_CREAT|O_EXCL, NULL));
        ASSERT_OK(fd_verify_regular(fd));
        fd = safe_close(fd);

        fd = ASSERT_OK(chase_and_openat(XAT_FDROOT, tfd, "o/p/e/n/d/i/r", CHASE_MKDIR_0755, O_DIRECTORY|O_CREAT|O_EXCL, NULL));
        ASSERT_OK(fd_verify_directory(fd));
        fd = safe_close(fd);

        fd = ASSERT_OK(chase_and_openat(XAT_FDROOT, tfd, NULL, CHASE_PARENT|CHASE_EXTRACT_FILENAME, O_PATH|O_DIRECTORY, &result));
        ASSERT_STREQ(result, ".");
        fd = safe_close(fd);
        result = mfree(result);
        ...
        fd = ASSERT_OK(chase_and_openat(XAT_FDROOT, tfd, "mkopen/p/a/r/file.txt", CHASE_MKDIR_0755|CHASE_PARENT, O_RDONLY, NULL));
        ASSERT_OK(fd_verify_directory(fd));
        ...
        fd = ASSERT_OK(chase_and_openat(XAT_FDROOT, tfd, "mkopen/d/i/r/target", CHASE_MKDIR_0755|CHASE_MUST_BE_DIRECTORY, O_CREAT|O_RDONLY, NULL));
        ASSERT_OK(fd_verify_directory(fd));
        ...
        /* No CHASE_PARENT, no CHASE_EXTRACT_FILENAME, with ret_path — opens the target, returns full path. */
        fd = ASSERT_OK(chase_and_openat(XAT_FDROOT, tfd, "o/p/e/n/d/i/r", 0, O_PATH|O_DIRECTORY, &result));
        ASSERT_OK(fd_verify_directory(fd));
