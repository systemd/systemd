...
TEST(chase_and_open) {
        ...
        /* CHASE_EXTRACT_FILENAME without CHASE_PARENT should open the target file and return just the
         * filename. This is a regression test for a bug where chase_and_open() skipped filename
         * extraction when CHASE_EXTRACT_FILENAME was set, causing it to reopen the parent directory
