...
static void log_audit_op(
        ...
        /* Note: we send id == -1, even though we know the number, in particular on success. This is because
         * if we send the id, the generated audit message will not contain the name. The name seems more
         * useful than the number, hence send just the name:
         *
