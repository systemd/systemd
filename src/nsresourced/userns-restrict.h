...
int userns_restrict_put_by_inode(struct userns_restrict_bpf *obj, uint64_t inode, bool replace, const int mount_fds[], size_t n_mount_fds);

int userns_restrict_reset_by_inode(struct userns_restrict_bpf *obj, uint64_t inode);
