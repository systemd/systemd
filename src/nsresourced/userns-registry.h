...
void release_userns_by_info(struct userns_restrict_bpf *bpf, int dir_fd, UserNamespaceInfo *info);
void release_userns_by_inode(struct userns_restrict_bpf *bpf, int dir_fd, uint64_t inode);
