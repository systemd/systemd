...
static int verb_inspect(int argc, char *argv[], void *userdata) {
        ...
        /* Unfortunately because of backwards compatibility the argument order is reversed here compared to
         * "add". */
        ...
        if (argc >= 3) {
                r = context_set_version(c, argv[2]);
                if (r < 0)
                        return r;
        }
...
static int help(void) {
        ...
        printf("%1$s [OPTIONS...] COMMAND ...\n\n"
               ...
               "  kernel-install [OPTIONS...] inspect [KERNEL-IMAGE] [KERNEL-VERSION]\n"
               "\n"
               "Options:\n"
