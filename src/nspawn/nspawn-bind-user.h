...
int bind_user_prepare(const char *directory, char **bind_user, char *bind_user_shell, uid_t uid_shift, uid_t uid_range, CustomMount **custom_mounts, size_t *n_custom_mounts, BindUserContext **ret);
