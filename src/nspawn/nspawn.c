...
static bool arg_private_network; /* initialized depending on arg_runtime_scope in initialize_defaults() */
...
static UserNamespaceMode arg_userns_mode; /* initialized depending on arg_runtime_scope in initialize_defaults(),
                                           * -U sets to _USER_NAMESPACE_MODE_INVALID which is resolved in
                                           * verify_arguments() once arg_runtime_scope has its final value. */
