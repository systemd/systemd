...
static int outer_child(
        ...
        if (mount_fd >= 0) {
                ...
                MStackBindMountStrategy mstack_bindmount_strategy = MSTACK_BINDMOUNT_ALL;
                ...
                if (IN_SET(arg_volatile_mode, VOLATILE_YES, VOLATILE_OVERLAY)) {
                        /* Defer all binds. */
                        mstack_bindmount_strategy = MSTACK_BINDMOUNT_NONE;
                        ...
                        mstack_bindmount_strategy = MSTACK_BINDMOUNT_EXCEPT_VAR;
