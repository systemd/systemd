...
/* Returns:
 *  - <0 (-errno) : major/minor are unmodified : failed to determine the FUSE version
 *  - 0           : major/minor = 0/0          : FUSE does not appear to be present
 *  - 1           : major/minor are set        : successfully determined the FUSE version
 */
...
static int outer_child(
        ...
        bool idmap = false, enable_fuse = false;
        const char *p;
        pid_t pid;
        ssize_t l;
        int r;
