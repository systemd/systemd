...
static int help(void) {
        ...
        printf("%1$s [OPTIONS...] [PATH] [ARGUMENTS...]\n\n"
               ...
               "\n%3$sImage:%4$s\n"
               OPTION_HELP_GENERATED_IMAGE
               "\n%3$sExecution:%4$s\n"
               OPTION_HELP_GENERATED_EXECUTION
               "\n%3$sSystem Identity:%4$s\n"
               OPTION_HELP_GENERATED_SYSTEM_IDENTITY
               "\n%3$sProperties:%4$s\n"
               OPTION_HELP_GENERATED_PROPERTIES
               "\n%3$sUser Namespacing:%4$s\n"
               OPTION_HELP_GENERATED_USER_NAMESPACING
               "\n%3$sNetworking:%4$s\n"
               OPTION_HELP_GENERATED_NETWORKING
               "\n%3$sSecurity:%4$s\n"
               OPTION_HELP_GENERATED_SECURITY
               "\n%3$sResources:%4$s\n"
               OPTION_HELP_GENERATED_RESOURCES
               "\n%3$sIntegration:%4$s\n"
               OPTION_HELP_GENERATED_INTEGRATION
               "\n%3$sMounts:%4$s\n"
               OPTION_HELP_GENERATED_MOUNTS
               "\n%3$sInput/Output:%4$s\n"
               OPTION_HELP_GENERATED_IO
               "\n%3$sCredentials:%4$s\n"
               OPTION_HELP_GENERATED_CREDENTIALS
...
static int parse_argv(int argc, char *argv[]) {
        uint64_t caps_plus = 0, caps_minus = 0;
        bool mask_all_settings = false, mask_no_settings = false;
        int r;

        r = parse_argv_generated(argc, argv, &caps_plus, &caps_minus, &mask_all_settings, &mask_no_settings);
        if (r <= 0)
                return r;
