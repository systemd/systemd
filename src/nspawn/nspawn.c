...
static int run(int argc, char *argv[]) {
        ...
        * the child. Functions like copy_devnodes() change the umask temporarily. */
        ...
        if (arg_forward_journal) {
                ...
                r = fork_journal_remote(socket_path, arg_forward_journal,
                                        arg_forward_journal_max_use, arg_forward_journal_keep_free,
                                        arg_forward_journal_max_file_size, arg_forward_journal_max_files,
