                ...
                case ARG_NETWORK_VETH:
                        {
                                ...
                                if (strempty(optarg))
                                        return log_error_errno(r, "--network-veth= arguments missing .");
                                ...
                                for (;;) {
                                        ...
                                        if (r < 0)
                                                return log_error_errno(r,"Invalid veth pair specified: %s", optarg);
                                ...
                                if (l > 2) {
                                        ...
                                        for (l = 0; l < 2; l++) {
                                                r = strv_extend(&arg_network_veth_interface, *a);
                                                if (r < 0)
                                                        return log_oom();
                                        }
                                }
