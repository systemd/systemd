...
CONFIG_PARSER_PROTOTYPE(config_parse_network_interface);
CONFIG_PARSER_PROTOTYPE(config_parse_network_macvlan);
CONFIG_PARSER_PROTOTYPE(config_parse_network_ipvlan);
