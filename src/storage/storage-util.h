...
static inline bool volume_name_is_valid(const char *n) {
        return string_is_safe(n, /* flags= */ 0);
}

static inline bool template_name_is_valid(const char *n) {
        return string_is_safe(n, /* flags= */ 0);
}

static inline bool provider_name_is_valid(const char *n) {
