...
/* since cryptsetup 2.3.0 (Feb 2020) */
                ...
                arg_link_keyring = TAKE_PTR(keyring);
                arg_link_key_type = TAKE_PTR(key_type);
                arg_link_key_description = TAKE_PTR(key_description);
#else
...
/* since cryptsetup 2.7.0 (Jan 2024) */
                        ...
                        if (arg_link_key_description && streq(crypt_get_type(cd), CRYPT_LUKS2)) {
