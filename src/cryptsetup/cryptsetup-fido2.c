...
int find_fido2_auto_data(
        ...
        for (int token = 0; token < sym_crypt_token_max(CRYPT_LUKS2); token ++) {
                ...
                if (w) {
                        ...
                        required = UPDATE_FLAG(required, FIDO2ENROLL_PIN, json_variant_boolean(w));
                }
                ...
                if (w) {
                        ...
                        required = UPDATE_FLAG(required, FIDO2ENROLL_UP, json_variant_boolean(w));
                }
                ...
                if (w) {
                        ...
                        required = UPDATE_FLAG(required, FIDO2ENROLL_UV, json_variant_boolean(w));
                }
        }
