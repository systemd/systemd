...
const char *devlink_kind_to_string(DevlinkKind i) _const_;
DevlinkKind devlink_kind_from_string(const char *s) _pure_;

CONFIG_PARSER_PROTOTYPE(config_parse_devlink_kind);

/* gperf */
const struct ConfigPerfItem* devlink_kind_gperf_lookup(const char *str, GPERF_LEN_TYPE length);
