...
static int dispatch_sigusr1(sd_event_source *es, const struct signalfd_siginfo *si, void *userdata) {
        ...
        if (!si_code_from_process(si->ssi_code)) {
                log_warning("Received SIGUSR1 with unexpected .si_code, ignoring.");
                return 0;
        }
...
static int dispatch_sigusr2(sd_event_source *es, const struct signalfd_siginfo *si, void *userdata) {
        ...
        if (!si_code_from_process(si->ssi_code)) {
                log_warning("Received SIGUSR2 with unexpected .si_code, ignoring.");
                return 0;
        }
...
static int dispatch_sigrtmin1(sd_event_source *es, const struct signalfd_siginfo *si, void *userdata) {
        ...
        if (!si_code_from_process(si->ssi_code)) {
                log_warning("Received SIGRTMIN1 with unexpected .si_code, ignoring.");
                return 0;
        }
