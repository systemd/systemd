...
void manager_merge_configs(Manager *m) {
        ...
        MERGE_NON_NEGATIVE(set_audit, m->namespace ? AUDIT_KEEP : AUDIT_ENABLE);
...
DEFINE_PRIVATE_STRING_TABLE_LOOKUP_FROM_STRING_WITH_BOOLEAN(audit_set_mode, AuditSetMode, AUDIT_ENABLE);
/* Historically, an empty string has special meaning and equals to 'keep'. */
