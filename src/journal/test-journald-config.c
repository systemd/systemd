...
#define _FORWARD_ADDRESS_PARSE_CHECK_FAILS(str, addr, varname)             \
        do {                                                               \
                SocketAddress varname = {};                                \
                config_parse_forward_address("", "", 0, "", 0, "", 0, str, \
                                             &varname, NULL);              \
                assert_se(socket_address_verify(&varname, true) < 0);      \
        } while (0)

#define FORWARD_ADDRESS_PARSE_CHECK_FAILS(str) \
        _FORWARD_ADDRESS_PARSE_CHECK_FAILS(str, addr, conf##__COUNTER__)

#define _FORWARD_ADDRESS_PARSE_CHECK(str, addr, varname)                   \
        do {                                                               \
                SocketAddress varname = {};                                \
                config_parse_forward_address("", "", 0, "", 0, "", 0, str, \
                                      &varname, NULL);                     \
...
#define FORWARD_ADDRESS_PARSE_CHECK(str, addr)                     \
        _FORWARD_ADDRESS_PARSE_CHECK(str, addr, conf##__COUNTER__)

TEST(config_forward_address) {
        SocketAddress addr;
        ...
        FORWARD_ADDRESS_PARSE_CHECK("/run/host/journal/socket", addr);
        ...
        FORWARD_ADDRESS_PARSE_CHECK("192.168.0.1:1234", addr);
        ...
        FORWARD_ADDRESS_PARSE_CHECK("[2001:db8:4006:812::200e]:8080", addr);
        ...
        FORWARD_ADDRESS_PARSE_CHECK("vsock:123456:654321", addr);

        /* Invalid IPv4 */
        FORWARD_ADDRESS_PARSE_CHECK_FAILS("256.123.45.12:1235");
        FORWARD_ADDRESS_PARSE_CHECK_FAILS("252.123.45.12:123500");
        FORWARD_ADDRESS_PARSE_CHECK_FAILS("252.123.45.12:0");
        FORWARD_ADDRESS_PARSE_CHECK_FAILS("252.123.45.12:-1");
        FORWARD_ADDRESS_PARSE_CHECK_FAILS("-1.123.45.12:22");

        /* Invalid IPv6 */
        FORWARD_ADDRESS_PARSE_CHECK_FAILS("[2001:db8:4006:812::200e]:80800");
        FORWARD_ADDRESS_PARSE_CHECK_FAILS("[1ffff:db8:4006:812::200e]:8080");
        FORWARD_ADDRESS_PARSE_CHECK_FAILS("[-1:db8:4006:812::200e]:8080");
        FORWARD_ADDRESS_PARSE_CHECK_FAILS("[2001:db8:4006:812::200e]:-1");

        /* Invalid UNIX */
        FORWARD_ADDRESS_PARSE_CHECK_FAILS("a/b/c");

        /* Invalid VSock */
        FORWARD_ADDRESS_PARSE_CHECK_FAILS("vsock:4294967296:1234");
        FORWARD_ADDRESS_PARSE_CHECK_FAILS("vsock:1234:4294967296");
        FORWARD_ADDRESS_PARSE_CHECK_FAILS("vsock:abcd:1234");
        FORWARD_ADDRESS_PARSE_CHECK_FAILS("vsock:1234:abcd");
        FORWARD_ADDRESS_PARSE_CHECK_FAILS("vsock:1234");

        /* Invalid Case */
        FORWARD_ADDRESS_PARSE_CHECK_FAILS("");
        FORWARD_ADDRESS_PARSE_CHECK_FAILS("ahh yes sockets, mmh");
}
