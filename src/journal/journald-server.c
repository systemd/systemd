...
static void server_load_credentials(Server *s) {
        ...
        if (s->forward_address.sockaddr.sa.sa_family != AF_MAX) {
...
int server_new(Server **ret) {
        ...
        *s = (Server) {
                ...
                .forward_address = { .sockaddr.sa.sa_family = AF_MAX },
...
int server_init(Server *s, const char *namespace) {
        ...
        if (s->forward_address.sockaddr.sa.sa_family != AF_MAX && !s->namespace)
