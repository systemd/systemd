...
static int display_emergency_message_fullscreen(char * message) {
        ...
        unsigned int qr_code_start_row = 1, qr_code_start_column = 1;
        ...
        r = print_positioned_qrcode(out, "Scan the code for help", (const char *) message, qr_code_start_row, qr_code_start_column);
        if (r < 0)
