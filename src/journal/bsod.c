...
static int display_emergency_message_fullscreen(const char *message, char *message_id) {
...
static int run(int argc, char *argv[]) {
        ...
        r = display_emergency_message_fullscreen((const char*) message, message_id);
        if (r < 0)
