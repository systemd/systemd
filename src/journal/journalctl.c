...
static int help(void) {
        ...
        printf("%1$s [OPTIONS...] [MATCHES...]\n\n"
               ...
               "  -H --no-hostname           Suppress output of hostname field\n"
...
static int parse_argv(int argc, char *argv[]) {
        ...
        static const struct option options[] = {
                ...
                { "no-hostname",          no_argument,       NULL, 'H'                      },
        ...
        while ((c = getopt_long(argc, argv, "hHefo:aln::qmb::kD:p:g:c:S:U:t:T:u:INF:xrM:i:", options, NULL)) >= 0)
