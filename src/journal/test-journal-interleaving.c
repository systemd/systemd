...
static ManagedJournalFile *test_open(const char *name) {
        ...
        assert_ret(managed_journal_file_open(name, O_RDWR|O_CREAT, JOURNAL_COMPRESS, 0644, UINT64_MAX, NULL, m, NULL, NULL, &f));
        return f;
}
...
static void test_sequence_numbers_one(void) {
        ...
        assert_se(managed_journal_file_open("one.journal", O_RDWR|O_CREAT, JOURNAL_COMPRESS, 0644,
        ...
        assert_se(managed_journal_file_open("two.journal", O_RDWR|O_CREAT, JOURNAL_COMPRESS, 0644,
        ...
        assert_se(managed_journal_file_open("two.journal", O_RDWR, JOURNAL_COMPRESS, 0,
