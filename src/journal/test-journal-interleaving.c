...
static ManagedJournalFile *test_open(const char *name) {
        ...
        assert_ret(managed_journal_file_open(name, O_RDWR|O_CREAT, 0644, true, UINT64_MAX, false, NULL, m, NULL, NULL, &f));
        return f;
}
...
TEST(sequence_numbers) {
        ...
        assert_se(managed_journal_file_open("one.journal", O_RDWR|O_CREAT, 0644,
        ...
        assert_se(managed_journal_file_open("two.journal", O_RDWR|O_CREAT, 0644,
        ...
        assert_se(managed_journal_file_open("two.journal", O_RDWR, 0,
