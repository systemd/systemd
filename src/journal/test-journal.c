...
TEST(non_empty) {
        ...
        assert_se(managed_journal_file_open("test.journal", O_RDWR|O_CREAT, 0666, true, UINT64_MAX, true, NULL, m, NULL, NULL, &f) == 0);
...
TEST(empty) {
        ...
        assert_se(managed_journal_file_open("test.journal", O_RDWR|O_CREAT, 0666, false, UINT64_MAX, false, NULL, m, NULL, NULL, &f1) == 0);
        assert_se(managed_journal_file_open("test-compress.journal", O_RDWR|O_CREAT, 0666, true, UINT64_MAX, false, NULL, m, NULL, NULL, &f2) == 0);
        assert_se(managed_journal_file_open("test-seal.journal", O_RDWR|O_CREAT, 0666, false, UINT64_MAX, true, NULL, m, NULL, NULL, &f3) == 0);
        assert_se(managed_journal_file_open("test-seal-compress.journal", O_RDWR|O_CREAT, 0666, true, UINT64_MAX, true, NULL, m, NULL, NULL, &f4) == 0);
...
static bool check_compressed(uint64_t compress_threshold, uint64_t data_size) {
        ...
        assert_se(managed_journal_file_open("test.journal", O_RDWR|O_CREAT, 0666, true, compress_threshold, true, NULL, m, NULL, NULL, &f) == 0);
