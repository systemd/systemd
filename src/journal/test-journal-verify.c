...
static int raw_verify(const char *fn, const char *verification_key) {
        ...
        r = journal_file_open(fn, O_RDONLY, 0666, true, !!verification_key, NULL, NULL, NULL, NULL, NULL, &f);
        if (r < 0)
                return r;
...
int main(int argc, char *argv[]) {
        ...
        assert_se(journal_file_open("test.journal", O_RDWR|O_CREAT, 0666, true, !!verification_key, NULL, NULL, NULL, NULL, NULL, &f) == 0);
        ...
        assert_se(journal_file_open("test.journal", O_RDONLY, 0666, true, !!verification_key, NULL, NULL, NULL, NULL, NULL, NULL, &f) == 0);
