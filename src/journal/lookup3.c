...
#define final(a, b, c)           \
        ...
        --------------------------------------------------------------------
        */
        uint32_t jenkins_hashword(const uint32_t *k, /* the key, an array of uint32_t values */
...
--------------------------------------------------------------------
*/
void jenkins_hashword2(const uint32_t *k, /* the key, an array of uint32_t values */
                       size_t length,     /* the length of the key, in uint32_ts */
 ...
 */
void jenkins_hashlittle2(const void *key, /* the key to hash */
