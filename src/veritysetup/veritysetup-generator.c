...
static int create_device(const char *name, const char *service, const char *hash, const char *data_what, const char *hash_what, const char *options) {
...
static int determine_device(const char *hash, char **data_what, char **hash_what) {
