...
static int run(int argc, char *argv[]) {
        ...
        pty_forward_set_handler(forward, pty_forward_handler, NULL);
        ...
        r = pidref_safe_fork_full(
                        ...
                        /*except_fds=*/ NULL,
                        /*n_except_fds=*/ 0,
                        /*flags=*/ FORK_RESET_SIGNALS|FORK_DEATHSIG_SIGTERM|FORK_LOG|FORK_REARRANGE_STDIO|FORK_SETSID|FORK_TIOCSCTTY,
                        &pidref);
        if (r < 0)
