...
static int vl_method_prepare_secure_boot_update(
        ...
        static const sd_json_dispatch_field dispatch_table[] = {
                ...
                { "regenerate", SD_JSON_VARIANT_BOOLEAN, sd_json_dispatch_stdbool,      offsetof(MethodPrepareSecureBootUpdateParameters, regenerate), SD_JSON_NULLABLE  },
                {}
        };
        ...
        r = recover_secure_boot_update_backups(p.regenerate);
        if (r < 0)
                return r;
