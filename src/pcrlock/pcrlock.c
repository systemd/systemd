...
struct EventLogRecord {
        ...
        UserspaceMeasurementEventType userspace_event_type;
...
static EventLogRecord* event_log_record_new(EventLog *el) {
        ...
        *record = (EventLogRecord) {
                ...
                .userspace_event_type = _USERSPACE_MEASUREMENT_EVENT_TYPE_INVALID,
...
static int event_log_record_parse_json(EventLogRecord *record, sd_json_variant *j) {
        ...
        if (streq_ptr(rectype, "systemd")) {
                ...
                if (y) {
                        ...
                        record->userspace_event_type = userspace_measurement_event_type_from_string(sd_json_variant_string(y));
...
static int show_log_table(EventLog *el, sd_json_variant **ret_variant) {
        ...
        FOREACH_ARRAY(rr, el->records, el->n_records) {
                ...
                if (EVENT_LOG_RECORD_IS_FIRMWARE(record)) {
                        ...
                        r = table_add_cell(table, NULL, TABLE_STRING, userspace_measurement_event_type_to_string(record->userspace_event_type));
                else
