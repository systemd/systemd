 ...
 *    4. pre-calc cryptsetup root key measurement (why isn't that automatically measured in mkosi builds?)
 ...
 *    13. automatically install PE measurement of sd-boot on "bootctl install"
 *    13. check for consistency of SB authority and SB databases before signing authority. authority must be in database
 */
