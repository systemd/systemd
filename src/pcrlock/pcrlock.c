 ...
 *
 * pre-merge:
 *    1. make cryptsetup honour two PCR authnv
 *    2. include multiple --location= in generated policy
 *    3. My sure "make-policy" is a quick NOP if policy doesn't change.
 *    4. add kernel-install plugin that automatically creates UKI .pcrlock file when UKI is installed, and removes it when it is removed again
 *    5. automatically install PE measurement of sd-boot on "bootctl install"
 ...
 *    8. add integration + unit tests
 *    9. document everything
 *
 * post-merge:
 *    10. pre-calc sysext + kernel cmdline measurements
 *    11. pre-calc cryptsetup root key measurement
 *    12. maybe make systemd-repart generate .pcrlock for old and new GPT header in /run?
 *    13. Add support for more than 8 branches per PCR OR
 */
...
static int help(int argc, char *argv[], void *userdata) {
        ...
        printf("%1$s  [OPTIONS...] COMMAND ...\n"
               ...
               "  unlock-kernel-initrd        Remove .pcrlock file for kernel initrd cpio archive\n"
