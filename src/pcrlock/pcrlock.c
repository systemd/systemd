 ...
 *    2. pre-calc kernel's own initrd + kernel cmdline measurements
 *    3. pre-calc cryptsetup root key measurement (why isn't that automatically measured in mkosi builds?)
