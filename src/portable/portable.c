...
static void log_portable_verb(
        ...
        log_struct(LOG_INFO,
                   LOG_MESSAGE("Successfully %s '%s%s%s'",
                               verb,
                               image_path,
...
int portable_attach(
        ...
        log_portable_verb("attached", image->path, extension_images, /* extension_image_paths= */ NULL);
...
int portable_detach(
        ...
        log_portable_verb("detached", name_or_path, /* extension_images= */ NULL, extension_image_paths);
