...
static int portable_extract_by_path(
        ...
        if (r == -EISDIR) {
                ...
                if (r == 0) {
                        ...
                        if (path_is_extension)
                                flags |= DISSECT_IMAGE_VALIDATE_OS_EXT | (relax_extension_release_check ? DISSECT_IMAGE_OS_EXT_NON_STRICT : 0);
                        else
...
int portable_extract(
        ...
        r = extract_image_and_extensions(
                        ...
                        /* relax_extension_release_check= */ FLAGS_SET(flags, PORTABLE_FORCE),
                        &image,
                        &extension_images,
                        &extension_releases,
                        &os_release,
