...
static int get_image_metadata_impl(sd_bus *bus, const char *image, char **matches, sd_bus_error *error, sd_bus_message **reply) {
...
static int get_image_metadata(sd_bus *bus, const char *image, char **matches, sd_bus_message **reply) {
        ...
        r = get_image_metadata_impl(bus, image, matches, &error, reply);
        if (r < 0) {
