...
const sd_bus_vtable image_vtable[] = {
        ...
        SD_BUS_METHOD_WITH_NAMES("GetMetadata",
                                 "as",
                                 ...
                                 SD_BUS_VTABLE_UNPRIVILEGED),
        SD_BUS_METHOD_WITH_NAMES("GetState",
                                 NULL,,
                                 "s",
                                 SD_BUS_PARAM(state),
                                 bus_image_method_get_state,
                                 SD_BUS_VTABLE_UNPRIVILEGED),
        SD_BUS_METHOD_WITH_NAMES("Attach",
                                 "assbs",
                                 SD_BUS_PARAM(matches)
                                 ...
                                 SD_BUS_VTABLE_UNPRIVILEGED),
        SD_BUS_METHOD_WITH_NAMES("Detach",
                                 "b",
                                 SD_BUS_PARAM(runtime),
                                 "a(sss)",
                                 SD_BUS_PARAM(changes),
                                 ...
                                 SD_BUS_VTABLE_UNPRIVILEGED),
        SD_BUS_METHOD_WITH_NAMES("Reattach",
                                 "assbs",
                                 SD_BUS_PARAM(matches)
                                 SD_BUS_PARAM(profile)
                                 SD_BUS_PARAM(runtime)
                                 ...
                                 SD_BUS_VTABLE_UNPRIVILEGED),
        SD_BUS_METHOD("Remove",
                      NULL,
                      NULL,
                      bus_image_method_remove,
                      SD_BUS_VTABLE_UNPRIVILEGED),
        SD_BUS_METHOD_WITH_NAMES("MarkReadOnly",
                                 "b",
                                 SD_BUS_PARAM(read_only),
                                 NULL,,
                                 bus_image_method_mark_read_only,
                                 SD_BUS_VTABLE_UNPRIVILEGED),
        SD_BUS_METHOD_WITH_NAMES("SetLimit",
                                 "b",
                                 SD_BUS_PARAM(limit),
                                 NULL,,
