...
static int show_one(
        ...
        static const struct bus_properties_map property_map[] = {
                ...
                { "StateDirectoryQuotaUsage",       "(bbtt)",          map_quota,      offsetof(UnitStatusInfo, exec_directories_quota[EXEC_DIRECTORY_STATE])   },
                { "CacheDirectoryQuotaUsage",       "(bbtt)",          map_quota,      offsetof(UnitStatusInfo, exec_directories_quota[EXEC_DIRECTORY_CACHE])   },
                { "LogsDirectoryQuotaUsage",        "(bbtt)",          map_quota,      offsetof(UnitStatusInfo, exec_directories_quota[EXEC_DIRECTORY_LOGS])    },
