...
static int shutdown_help(void) {
         ...
         * compatibility command rest in peace. It's interface is not even owned by us as much as it is by
        ...
        printf("%s [OPTIONS...] [TIME] [WALL...]\n"
               ...
               "\n%sThis is a compatibility interface, please use the me powerful 'systemctl reboot',\n"
