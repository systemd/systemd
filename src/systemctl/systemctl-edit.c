...
int verb_cat(int argc, char *argv[], void *userdata) {
        ...
        STRV_FOREACH(name, names) {
                ...
                /* In client-side mode (no bus), always do client-side lookups */
                bool force_client_side = !bus;

                r = unit_find_paths(bus, *name, &lp, force_client_side, &cached_id_map, &cached_name_map, &fragment_path, &dropin_paths);
                if (r == -ERFKILL) {
...
static int find_paths_to_edit(
        ...
        STRV_FOREACH(name, names) {
                ...
                r = unit_find_paths(bus, *name, &lp, force_client_side, &cached_id_map, &cached_name_map, &path, &unit_paths);
